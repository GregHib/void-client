...
final class Class348_Sub42_Sub3 extends Class348_Sub42
{
	...
	if (i_6_ >= Class367_Sub8.aShort7355) {
		...
		if ((Class348_Sub42_Sub8.aShort9555 ^ 0xffffffff)
			...
			Class348_Sub8.aHa6654.method3675(i_1_, (byte) -125, i,
							 i_0_, i_8_,
							 -16777216);
			Class348_Sub8.aHa6654.method3675(i_1_, (byte) -125, i,
							 i_3_ + i_0_ - i_8_,
		...
		if (bool) {
		    Class348_Sub8.aHa6654.la();
		    Class348_Sub8.aHa6654.method3675(i_10_, (byte) -125, i,
						     i_0_, i_3_, -16777216);
		    Class348_Sub8.aHa6654.method3675(i_10_, (byte) -125,
						     -i_10_ + i + i_1_, i_0_,
						     i_3_, -16777216);
		}
		i += i_10_;
	...
	if (!Class348_Sub42_Sub8.method3196(Class240.anInt4674, -114)
	    && !Class340.method2672(Class240.anInt4674, -103)) {
		...
		Class346_Sub1.method2703(5000, i_12_, i_13_, (byte) -13);
	} else
	    Class346_Sub1.method2703(5000,
    ...
    static final void method3178(Class45 class45, int i, int[] is,
				 Class45 class45_15_) {
	try {
	    anInt9506++;
	    if (is != null)
	...
	anInt9508++;
	int i_16_ = ((Class348_Sub51) Class316.aClass348_Sub51_3959)
