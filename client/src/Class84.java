...
final class Class84 {
    ...
    static final Class318_Sub1_Sub3_Sub3 method817(int i, int i_0_, int i_1_,
        ...
        anInt1456++;
        Class357 class357
                = Class147.aClass357ArrayArrayArray2029[i_1_][i_0_][i_2_];
        if (class357 == null)
            return null;
        if (i != 252)
            return null;
    ...
    static final void method824(int i) {
        ...
        for (int i_22_ = 0; i_22_ < Class318_Sub7.anInt6451; i_22_++) {
            for (int i_23_ = 0; i_23_ < Class348_Sub41.anInt7054; i_23_++) {
                if (Class147.aClass357ArrayArrayArray2029[i][i_22_][i_23_]
                        == null)
                    Class147.aClass357ArrayArrayArray2029[i][i_22_][i_23_]
                            = new Class357(i);
            }
        }
    }
    ...
    static final void method826(int i, int i_24_, int i_25_, int i_26_,
        ...
        if ((Class174.aClass105_2309 == null
            ...
            Class207 class207 = Class207.method1521(Class21.aClass45_322,
            ...
            Class174.aClass105_2309
                    ...
                    (Class207.method1521(Class21.aClass45_322,
                            ...
                            true));
            Class207 class207_29_ = Class207.method1521(Class21.aClass45_322,
                    Class79.anInt1387, 0);
        ...
        if (Class174.aClass105_2309 != null
                && Class348_Sub42_Sub15.aClass105_9658 != null
                && Class348_Sub42_Sub15.aClass105_9659 != null) {
            int i_30_ = (-(Class348_Sub42_Sub15.aClass105_9659.method971() * 2)
                    + i_25_) / Class174.aClass105_2309.method971();
            for (int i_31_ = 0; i_31_ < i_30_; i_31_++)
                Class174.aClass105_2309.method974
                        (i_24_ + (Class348_Sub42_Sub15.aClass105_9659.method971()
                                        - -(i_31_
                                        * Class174.aClass105_2309.method971())),
                                -Class174.aClass105_2309.method969() + (i_28_ + i_26_));
            int i_32_
                    = ((i_26_
                    - (i + Class348_Sub42_Sub15.aClass105_9659.method969()))
                    / Class348_Sub42_Sub15.aClass105_9658.method969());
            for (int i_33_ = 0; i_33_ < i_32_; i_33_++) {
                Class348_Sub42_Sub15.aClass105_9658.method974
                        (i_24_,
                                (Class348_Sub42_Sub15.aClass105_9658.method969() * i_33_
                                        + (i_28_ + i)));
                Class309.aClass105_4808.method974
                        (-Class309.aClass105_4808.method971() + i_25_ + i_24_,
                                (Class348_Sub42_Sub15.aClass105_9658.method969() * i_33_
                                        + i + i_28_));
            }
            Class348_Sub42_Sub15.aClass105_9659.method974
                    (i_24_, (-Class348_Sub42_Sub15.aClass105_9659.method969()
                            + i_28_ + i_26_));
            Class110.aClass105_1706.method974
                    (i_24_ + (i_25_
                                    + -Class348_Sub42_Sub15.aClass105_9659.method971()),
                            i_28_ - (-i_26_
                                    + Class348_Sub42_Sub15.aClass105_9659.method969()));
        }
