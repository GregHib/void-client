    ...
    final void method3069(int i, int[] is, byte i_8_) {
        ...
        if (i_8_ > 91) {
            if (this.anInt9150 == 1) {
                ...
                int i_42_ = (i_39_ * this.anInt9158 >> -143668820);
                int i_43_ = (this.anInt9164 * i_39_ >> 16261868);
                ...
                if (this.aBoolean9160) {
                    for (int i_52_ = 0; (Class348_Sub40_Sub6.anInt9139 > i_52_); i_52_++) {
                        ...
                        int i_54_ = method3070(i_46_, i_41_, i_42_, i_53_ * i_39_ >> 455686348, i_47_, true, i_48_);
                    ...
                    for (int i_49_ = 0; i_49_ < Class348_Sub40_Sub6.anInt9139; i_49_++) {
                        ...
                        int i_51_ = method3070(i_46_, i_41_, i_42_, i_39_ * i_50_ >> 1548502028, i_47_, true, i_48_);
                ...
                if (i_10_ > 8 || i_10_ < -8) {
                    ...
                    int i_13_ = (this.anInt9158 * i_11_ >> -435649908);
                    int i_14_ = (this.anInt9164 * i_11_ >> 973957388);
                    ...
                    for (int i_20_ = 0; Class348_Sub40_Sub6.anInt9139 > i_20_; i_20_++) {
                        ...
                        int i_22_ = method3070(i_17_, i_12_, i_13_, i_11_ * i_21_ >> -751471604, i_19_, true, i_18_);
                ...
                for (int i_23_ = 1; this.anInt9150 > i_23_; i_23_++) {
                    ...
                    if (i_10_ > 8 || i_10_ < -8) {
                        ...
                        int i_26_ = (this.anInt9158 * i_24_ >> -1052080788);
                        int i_27_ = (this.anInt9164 * i_24_ >> 341876908);
                        ...
                        if (this.aBoolean9160 && (this.anInt9150 - 1 == i_23_)) {
                            for (int i_33_ = 0; Class348_Sub40_Sub6.anInt9139 > i_33_; i_33_++) {
                                ...
                                int i_35_ = method3070(i_32_, i_25_, i_26_, i_34_ * i_24_ >> -1332497012, i_31_, true, i_30_);
                                i_35_ = is[i_33_] - -(i_35_ * i_10_ >> -967838868);
                            ...
                            for (int i_36_ = 0; (i_36_ < Class348_Sub40_Sub6.anInt9139); i_36_++) {
                                ...
                                int i_38_ = method3070(i_32_, i_25_, i_26_, i_37_ * i_24_ >> -1718948756, i_31_, true, i_30_);
