        ...
        do {
            if (this.aClass322_7033.aBoolean4035) {
                                            ...
                                            do {
                                                ...
                                                do {
                                                    ...
                                                    for (i_14_ = 0; (i_14_ < (Class348_Sub40_Sub6.anInt9139)); i_14_++) {
                                                        is_5_[i_14_] = ((is_11_[i_14_] * is_8_[i_14_]) >> 1160349676);
                                                        is_6_[i_14_] = ((is_12_[i_14_] * is_9_[i_14_]) >> -1801876756);
                                                        is_7_[i_14_] = ((is_10_[i_14_] * (is_13_[i_14_])) >> 1740144556);
                                                    }
                                                    break while_168_;
                                                } while (false);
                                                for (i_14_ = 0; (i_14_ < (Class348_Sub40_Sub6.anInt9139)); i_14_++) {
                                                    ...
                                                    is_5_[i_14_] = (i_15_ != 0 ? ((is_8_[i_14_] << -1739348) / i_15_) : 4096);
                                                    is_6_[i_14_] = (i_17_ == 0 ? 4096 : ((is_9_[i_14_] << -897296884) / i_17_));
                                                    is_7_[i_14_] = (i_16_ == 0 ? 4096 : ((is_10_[i_14_] << -349390100) / i_16_));
                                                }
                                                break while_168_;
                                            } while (false);
                                            for (i_14_ = 0; (i_14_ < (Class348_Sub40_Sub6.anInt9139)); i_14_++) {
                                                is_5_[i_14_] = (4096 + -(((-is_11_[i_14_] + 4096) * (4096 - is_8_[i_14_])) >> -817956052));
                                                is_6_[i_14_] = (4096 + -(((4096 + -is_12_[i_14_]) * (4096 - is_9_[i_14_])) >> -896762484));
                                                is_7_[i_14_] = (4096 - (((-is_13_[i_14_] + 4096) * (4096 - is_10_[i_14_])) >> 250373644));
                                            }
                                            break while_168_;
                                        } while (false);
                                        for (i_14_ = 0; (Class348_Sub40_Sub6.anInt9139 > i_14_); i_14_++) {
                                            ...
                                            is_5_[i_14_] = ((i_18_ >= 2048) ? -(((4096 - is_8_[i_14_]) * (-i_18_ + 4096)) >> 584860011) + 4096 : (is_8_[i_14_] * i_18_ >> 1136299595));
                                            is_6_[i_14_] = (i_20_ >= 2048 ? -(((-i_20_ + 4096) * (4096 - is_9_[i_14_])) >> 1616611947) + 4096 : (i_20_ * is_9_[i_14_] >> 1261661579));
                                            is_7_[i_14_] = (i_19_ < 2048 ? (i_19_ * is_10_[i_14_] >> 62304971) : -(((-is_10_[i_14_] + 4096) * (-i_19_ + 4096)) >> -580516597) + 4096);
                                        }
                                        break while_168_;
                                    } while (false);
                                    for (i_14_ = 0; Class348_Sub40_Sub6.anInt9139 > i_14_; i_14_++) {
                                        ...
                                        is_5_[i_14_] = (i_23_ == 4096 ? 4096 : ((is_11_[i_14_] << 793720908) / (-i_23_ + 4096)));
                                        is_6_[i_14_] = (i_22_ != 4096 ? ((is_12_[i_14_] << 1322569740) / (-i_22_ + 4096)) : 4096);
                                        is_7_[i_14_] = (i_21_ == 4096 ? 4096 : ((is_13_[i_14_] << -491071796) / (4096 - i_21_)));
                                    }
                                    break while_168_;
                                } while (false);
                                for (i_14_ = 0; (Class348_Sub40_Sub6.anInt9139 > i_14_); i_14_++) {
                                    ...
                                    is_5_[i_14_] = (i_25_ == 0 ? 0 : -((-is_11_[i_14_] + 4096 << -2081436308) / i_25_) + 4096);
                                    is_6_[i_14_] = i_24_ != 0 ? -((4096 + -is_12_[i_14_] << -188922932) / i_24_) + 4096 : 0;
                                    is_7_[i_14_] = (i_26_ == 0 ? 0 : -((-is_13_[i_14_] + 4096 << 533328524) / i_26_) + 4096);
                                }
                                break while_168_;
                            } while (false);
                            for (i_14_ = 0; i_14_ < Class348_Sub40_Sub6.anInt9139; i_14_++) {
                ...
                for (i_14_ = 0; (Class348_Sub40_Sub6.anInt9139 > i_14_); i_14_++) {
                    ...
                    is_5_[i_14_] = -(i_45_ * i_48_ >> -243207381) + (i_48_ + i_45_);
                    is_6_[i_14_] = -(i_49_ * i_50_ >> 1689874027) + (i_49_ + i_50_);
                    is_7_[i_14_] = i_47_ + i_46_ - (i_46_ * i_47_ >> 1428550955);
                }
            }
        } while (false);
        return is;
        ...
        do {
            if (this.aClass191_7032.aBoolean2570) {
                                        ...
                                        do {
                                            ...
                                            do {
                                                ...
                                                do {
                                                    ...
                                                    for (i_54_ = 0; ((Class348_Sub40_Sub6.anInt9139) > i_54_); i_54_++)
                                                        is[i_54_] = ((is_53_[i_54_] * (is_52_[i_54_])) >> 1120836364);
                                                    break while_178_;
                                                } while (false);
                                                for (i_54_ = 0; ((Class348_Sub40_Sub6.anInt9139) > i_54_); i_54_++) {
                                                    int i_55_ = is_53_[i_54_];
                                                    is[i_54_] = (i_55_ != 0 ? ((is_52_[i_54_] << -1026493268) / i_55_) : 4096);
                                                }
                                                break while_178_;
                                            } while (false);
                                            for (i_54_ = 0; (Class348_Sub40_Sub6.anInt9139 > i_54_); i_54_++)
                                                is[i_54_] = -(((4096 - is_52_[i_54_]) * (4096 - is_53_[i_54_])) >> -1689830068) + 4096;
                                            break while_178_;
                                        } while (false);
                                        for (i_54_ = 0; (i_54_ < Class348_Sub40_Sub6.anInt9139); i_54_++) {
                                            int i_56_ = is_53_[i_54_];
                                            is[i_54_] = (i_56_ >= 2048 ? (4096 + -(((-i_56_ + 4096) * (4096 - is_52_[i_54_])) >> 200853131)) : (i_56_ * is_52_[i_54_] >> -231262293));
                                        }
                                        break while_178_;
                                    } while (false);
                                    for (i_54_ = 0; i_54_ < Class348_Sub40_Sub6.anInt9139; i_54_++) {
                                        int i_57_ = is_52_[i_54_];
                                        is[i_54_] = (i_57_ != 4096 ? ((is_53_[i_54_] << -1569874612) / (-i_57_ + 4096)) : 4096);
                                    }
                                    break while_178_;
                                } while (false);
                                for (i_54_ = 0; i_54_ < Class348_Sub40_Sub6.anInt9139; i_54_++) {
                                    int i_58_ = is_52_[i_54_];
                                    is[i_54_] = (i_58_ == 0 ? 0 : -((4096 - is_53_[i_54_] << 2042088204) / i_58_) + 4096);
                                }
                                break while_178_;
                            } while (false);
                            for (i_54_ = 0; i_54_ < Class348_Sub40_Sub6.anInt9139; i_54_++) {
                ...
                for (i_54_ = 0; Class348_Sub40_Sub6.anInt9139 > i_54_; i_54_++) {
                    ...
                    is[i_54_] = i_66_ - -i_65_ - (i_66_ * i_65_ >> -1838192565);
                }
            }
        } while (false);
        return is;
