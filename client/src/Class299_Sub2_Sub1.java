...
final class Class299_Sub2_Sub1 extends Class299_Sub2 {
    ...
    static final void method2270(int i, int i_4_, ha var_ha, String string,
                                 boolean bool, int i_5_, int i_6_, int i_7_) {
        try {
            if (OutputStream_Sub2.aClass105_106 == null
                    || Class121.aClass105_1800 == null) {
                if (Class21.aClass45_322.method421(false, Class231.anInt2996)
                        && Class21.aClass45_322
                        .method421(false, Class348_Sub40_Sub16.anInt9231)) {
                    OutputStream_Sub2.aClass105_106
                            = (var_ha.method3691
                    ...
                    var_ha.aa(i_4_, i_5_, i, i_7_,
                            (255 + -Class51.anInt948 << -833477000
                                    | Class264.anInt3376),
                            1);
            }
            anInt8709++;
            ...
            if (bool == false) {
                Class262.aClass324_3326.method2576(string,
                        (Class348_Sub42_Sub11
                                .anInt9586) | ~0xffffff,
                        14 + i_5_, 3 + i_4_, -1,
                        -127);
                var_ha.aa(i_4_, i_7_ + i_5_, i, i_6_ + -i_7_,
                        (Class264.anInt3376
                                | 255 + -Class51.anInt948 << 602467960),
                        1);
            }
    ...
    Class299_Sub2_Sub1(ha_Sub3 var_ha_Sub3, int i, int i_10_, int i_11_,
