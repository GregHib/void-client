    ...
    static final void method1479(int i, byte i_1_, int i_2_, int i_3_) {
        ...
        if (Class147.aClass357ArrayArrayArray2029 != null && i_2_ >= 0
            ...
            Class348_Sub37 class348_sub37
                    = ((Class348_Sub37)
                    Class130.aClass356_1895.method3480(l, -6008));
            if (class348_sub37 == null)
                ...
                if (class348_sub34 == null)
                    ...
                    class318_sub1_sub2_sub1.anInt6388
                            = i << 1186653097;
                    class318_sub1_sub2_sub1.aByte6381
                            = (byte) i_3_;
                    class318_sub1_sub2_sub1
                            .anInt10196
                            = 0;
                    class318_sub1_sub2_sub1.anInt6377
                            = i_2_ << -1403769975;
                    class318_sub1_sub2_sub1.anInt6382 = i_8_;
                    class318_sub1_sub2_sub1.aByte6376
                            = (byte) i_3_;
                    if (Class79.method802(i, i_2_, true))
                        class318_sub1_sub2_sub1.aByte6376++;
