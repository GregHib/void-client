...
final class Class88
{
	...
	if (Class138.aClass46Array1942 != null) {
		...
		(i, Class136.anInt4792, true, Class348_Sub1.anInt6555, i_1_,
		 ((Class46) Class331.aClass46_4130).anInt760,
	...
	if (Class225.anInt2955 != 0
		...
		if ((Class225.anInt2955 ^ 0xffffffff) == -3) {
			...
			(false, ((Class29) Class178.aClass29_2339).anInt400);
		...
		if ((Class225.anInt2955 ^ 0xffffffff) == -4) {
			...
			class348_sub49_sub2.method3378
			    (false,
			     ((Class29) Class178.aClass29_2345).anInt400);
			...
			class348_sub49_sub2.method3378
			    (false, ((Class230) (Class348_Sub42_Sub8_Sub2
			...
			class348_sub49_sub2.method3383
			    (1809639944,
			     -i_4_ + (((Class348_Sub49) class348_sub49_sub2)
				      .anInt7197));
		    } else {
			if (Class240.anInt4674 != 13)
			    class348_sub49_sub2.method3378
				(false,
				 ((Class29) Class178.aClass29_2342).anInt400);
			else
			    class348_sub49_sub2.method3378
				(false,
				 ((Class29) Class178.aClass29_2344).anInt400);
			class348_sub49_sub2.method3337((byte) 107, 0);
			int i_6_
			    = ((Class348_Sub49) class348_sub49_sub2).anInt7197;
			...
			class348_sub49_sub2.method3378(false,
							...
							.anInt7197));
			class348_sub49_sub2.method3380
			    (((Class348_Sub49) class348_sub49_8_).anInt7197, 0,
			     (((Class348_Sub49) class348_sub49_8_)
			      .aByteArray7154),
			     74);
			r.aBoolean9719 = true;
			...
			class348_sub49_sub2.method3383
			    (1809639944,
			     -i_6_ + (((Class348_Sub49) class348_sub49_sub2)
				      .anInt7197));
		    }
		...
		if ((Class225.anInt2955 ^ 0xffffffff) == -7) {
		    ...
		    class348_sub49_sub2.method3408((((Class29)
			...
			if ((Class239_Sub12.anInt5969 ^ 0xffffffff) != -3) {
				...
				(Class76.anInt1288, 0, (byte) 85,
				 (((Class348_Sub49) class348_sub49_sub2)
				  .aByteArray7154));
			    ((Class348_Sub49) class348_sub49_sub2).anInt7197
				= 0;
			    Class192.anInt2581
			    ...
			    ((Class161) aa_Sub2.aClass161_5199).anInt2143
				= class348_sub49_sub2.method3330(842397944);
			    if ((((Class161) aa_Sub2.aClass161_5199).anInt2143
				 ^ 0xffffffff)
				== -65536)
				((Class161) aa_Sub2.aClass161_5199).anInt2143
				    = -1;
			    ((Class161) aa_Sub2.aClass161_5199).aString2147
				= class348_sub49_sub2.method3371(-13487);
			    if (Class55_Sub1.aClass364_5271
				!= Class8.aClass364_165) {
				((Class161) aa_Sub2.aClass161_5199).anInt2138
				    = (50000
				       + (((Class161) aa_Sub2.aClass161_5199)
					  .anInt2143));
				((Class161) aa_Sub2.aClass161_5199).anInt2148
				    = (40000
				       + (((Class161) aa_Sub2.aClass161_5199)
					  .anInt2143));
			    }
			...
			Class348_Sub49_Sub2 class348_sub49_sub2
			    = Class299.aClass348_Sub49_Sub2_3813;
			((Class348_Sub49) class348_sub49_sub2).anInt7197 = 0;
