...
abstract class Class238 {
    ...
    abstract int method1701(int i, int i_0_, byte i_1_, byte[] is)
            throws IOException;

    abstract void method1702(int i);

    static final void method1703(int i, int i_2_, int i_3_, int i_4_,
                                 int i_5_) {
        anInt3132++;
    ...
    abstract void method1706(int i, int i_7_, int i_8_, byte[] is)
            throws IOException;
}
