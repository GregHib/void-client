...
final class i extends Class64 implements Interface19 {
    ...
    final void method620(Class101 class101) {
        ...
        if (this.aClass129Array5119 != null) {
            for (int i_74_ = 0; i_74_ < this.aClass129Array5119.length;
                 i_74_++) {
    ...
    i(oa var_oa, ya var_ya, Class124 class124, int i, int i_79_, int i_80_,
      int i_81_) {
        anOa5117 = var_oa;
        aYa5120 = var_ya;
        this.aClass129Array5119
                = class124.aClass129Array1846;
        this.aClass342Array5118
                = class124.aClass342Array1866;
        int i_82_ = (class124.aClass129Array1846 == null ? 0
                : class124.aClass129Array1846.length);
        int i_83_ = (class124.aClass342Array1866 == null ? 0
                : class124.aClass342Array1866.length);
        int i_84_ = 0;
        int[] is = new int[i_82_ * 3 + i_83_];
        for (int i_85_ = 0; i_85_ < i_82_; i_85_++) {
            is[i_84_++]
                    = this.aClass129Array5119[i_85_].anInt1881;
            is[i_84_++]
                    = this.aClass129Array5119[i_85_].anInt1877;
            is[i_84_++]
                    = this.aClass129Array5119[i_85_].anInt1892;
        }
        for (int i_86_ = 0; i_86_ < i_83_; i_86_++)
            is[i_84_++]
                    = this.aClass342Array5118[i_86_].anInt4244;
        int i_87_ = (class124.aClass162Array1832 == null ? 0
                : class124.aClass162Array1832.length);
        int[] is_88_ = new int[i_87_ * 8];
        int i_89_ = 0;
        for (int i_90_ = 0; i_90_ < i_87_; i_90_++) {
            Class162 class162
                    = class124.aClass162Array1832[i_90_];
            Class189 class189
        ...
        for (int i_91_ = 0; i_91_ < i_87_; i_91_++) {
            Class162 class162
                    = class124.aClass162Array1832[i_91_];
            is_88_[i_89_++] = class162.anInt2156;
        }
        R(anOa5117, aYa5120, class124.anInt1836,
                class124.anInt1821,
                ...
                class124.anIntArray1865, is, i_82_, i_83_, i, i_79_,
                i_80_, i_81_, is_88_);
    }
