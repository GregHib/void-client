...
final class Class348_Sub40_Sub35 extends Class348_Sub40 {
    ...
    private final void method3143(int i) {
        ...
        int i_3_ = (int) (4096.0 * Math.sqrt(i_1_ + i_0_ + i_2_ >> 1001438988));
        if (i_3_ != 0) {
    ...
    final int[] method3042(int i, int i_4_) {
        ...
        if (this.aClass191_7032.aBoolean2570) {
            ...
            for (int i_9_ = 0; Class348_Sub40_Sub6.anInt9139 > i_9_; i_9_++) {
                ...
                int i_11_ = (i_5_ * (-is_7_[Class239_Sub22.anInt6076 & i_9_ - -1] + is_7_[-1 + i_9_ & Class239_Sub22.anInt6076]) >> 1636786828);
                ...
                int i_14_ = (Class46.aByteArray821[i_12_ + (i_13_ * (1 + i_13_) >> 1034972801)] & 0xff);
    ...
    final void method3049(Class348_Sub49 class348_sub49, int i, int i_18_) {
        ...
        do {
            do {
                if (i_19_ == 0) {
                    anInt9448 = class348_sub49.readShort(i_18_ ^ 0x323581df);
                    break while_210_;
                } else if (i_19_ != 1) {
                    if (i_19_ == 2) break;
                    break while_210_;
                }
                anInt9447 = class348_sub49.readShort(842397944);
                break while_210_;
            } while (false);
            anInt9445 = class348_sub49.readShort(842397944);
        } while (false);
        anInt9442++;
