...
final class Class368
{
    ...
    final Class64 method3558(int i, int i_0_, ha var_ha, int i_1_, int i_2_,
			     Class87 class87, int i_3_) {
	try {
	    if (i_2_ != 3172)
	...
	if (i < -119) {
		...
		if (i_11_ == 4)
			...
			if ((i_11_ ^ 0xffffffff) != -8) {
					...
					if ((i_11_ ^ 0xffffffff) == -13)
						...
						if (i_11_ != 40) {
							...
							for (int i_13_ = 0;
							    ...
							    aShortArray4499
								[i_13_]
								= (short) (class348_sub49.method3330
									   (842397944));
							    aShortArray4504
								[i_13_]
								= (short) (class348_sub49.method3330
			    ...
			    anInt4489 = class348_sub49.method3387(255);
		    } else
			anInt4508 = class348_sub49.method3330(842397944);
		} else
    ...
    final Class64 method3565(int i, int i_16_, int i_17_, int i_18_,
			     boolean bool, ha var_ha, int i_19_, int i_20_,
			     int i_21_, Class87 class87, s var_s, int i_22_,
			     s var_s_23_) {
	try {
	    anInt4496++;
	    if (i_21_ != -129)
    ...
    private final Class64 method3566
	(ha var_ha, int i, int i_24_, s var_s, int i_25_, Class87 class87,
