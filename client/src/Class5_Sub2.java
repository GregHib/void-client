...
final class Class5_Sub2 extends Class5 {
    ...
    static final boolean method195(int i, boolean bool, int i_11_) {
        anInt8364++;
        Class51 class51
                = Class348_Sub40_Sub12.aClass263_9195.method2005(0, i_11_);
        if (i == 11)
            i = 10;
        if (bool != false)
            return false;
    ...
    static final void method196(boolean bool, int i, int i_13_, int i_14_,
        ...
        if (Class132.anInt1910 <= i_15_ && Class38.anInt513 >= i_15_) {
            i_14_ = Class85.method831(Class113.anInt1745, i_14_,
                    Class369.anInt4960, 71);
            i = Class85.method831(Class113.anInt1745, i, Class369.anInt4960,
                    -87);
