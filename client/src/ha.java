...
abstract class ha
{
    ...
    abstract Class64 method3625(Class124 class124, int i, int i_4_, int i_5_,
				int i_6_);
    ...
    abstract Interface4 method3634(Interface3 interface3,
    ...
    final void method3660(int i, int i_79_, int i_80_, int i_81_,
			  boolean bool) {
	if (bool != true)
	    H(-122, 91, -22, null);
	anInt4570++;
    ...
    final Class105 method3662(int i, int[] is, byte i_84_, int i_85_,
			      int i_86_, int i_87_) {
	anInt4565++;
	if (i_84_ != 94)
	    return null;
    ...
    abstract void Q(int i, int i_98_, int i_99_, int i_100_, int i_101_,
	...
	method3687(method3634(class105, method3624(class105.method971(),
						   class105.method969())));
	anInt4561++;
	if (i != 0)
	    DA(-75, -67, 18, -116);
    ...
    abstract Class105 method3683(int i, int i_143_, int i_144_, int i_145_,
				 boolean bool);
    ...
    abstract Class324 method3686(Class143 class143, Class207[] class207s,
				 boolean bool);
    ...
    static final synchronized ha method3692
	(int i, int i_168_, int i_169_, Class45 class45, int i_170_, d var_d,
	 Canvas canvas, int i_171_) {
	try {
	    anInt4576++;
	    if (i_170_ == i_171_)
		return Class348_Sub5.method2753(true, i_168_, i_169_, canvas,
						var_d);
	    if (i_171_ == 2)
    ...
    abstract void method3707(Rectangle[] rectangles, int i, int i_205_,
			     int i_206_) throws Exception_Sub1;
    ...
    abstract Class105 method3711(int[] is, int i, int i_212_, int i_213_,
