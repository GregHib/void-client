...
final class Class348_Sub42_Sub10 extends Class348_Sub42 {
    ...
    final void method3209(boolean bool) {
        ...
        if (this.anIntArray9566 != null) {
            for (int i = 0;
                 this.anIntArray9566.length > i; i++)
                this.anIntArray9566[i]
    ...
    private final void method3214(int i, Class348_Sub49 class348_sub49,
                                  int i_6_) {
        if (i_6_ == 60) {
            if (i != 1) {
                if (i == 2) {
                        ...
                        if (class138 != null) {
                            ...
                            for (int i_12_ = 0;
                                ...
                                anIntArrayArray9565[i_10_][i_12_]
                                        = class348_sub49
                                        .method3330(i_6_ + 842397884);
                        }
                    }
                } else if (i == 4)
                    this.aBoolean9562 = false;
            } else
                aStringArray9564
                        = (Class348_Sub40_Sub23.method3113
                        ('<', true, class348_sub49.method3377((byte) -82)));
            anInt9575++;
        }
    }
    ...
    final String method3216(Class348_Sub49 class348_sub49, byte i) {
        ...
        if (anIntArray9574 != null) {
            for (int i_13_ = 0; i_13_ < anIntArray9574.length; i_13_++) {
                ...
                stringbuffer.append
                        (this.aClass355_9567.method3472
