...
final class Class34
{
	...
	if (aShortArray474 != null) {
		...
		class124.method1098(aShortArray474[i_8_], (byte) 126,
				    aShortArray480[i_8_]);
	}
	if (aShortArray465 != null) {
	    for (int i_9_ = 0;
	...
	if ((i ^ 0xffffffff) != -2) {
	    ...
	    class348_sub49.method3387(i_10_ + 320);
	anInt479++;
	if (i_10_ != -65)
	    aLong482 = -90L;
    }
	...
	for (int i_33_ = 0; i_33_ < i_32_; i_33_++) {
		...
		= Class294.aClass318_Sub1_Sub3_Sub3_Sub2Array5058[is[i_33_]];
