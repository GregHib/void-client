...
final class Class119_Sub1 extends Class119 implements Interface2 {
    ...
    static final void method1077(ha var_ha, byte i) {
        ...
        if ((Class73.anInt4776 >= 2 || r.aBoolean9722)
            ...
            String string;
            if (r.aBoolean9722 && Class73.anInt4776 < 2)
                ...
                string
                        = Class316.method2367((byte) 125,
                        Class316.aClass348_Sub42_Sub12_3963);
            if (Class73.anInt4776 > 2)
                string += ("<col=ffffff> / " + (Class73.anInt4776 - 2)
                        + Class274.aClass274_3508
                        .method2063(Class348_Sub33.anInt6967, 544));
            if (Class348_Sub36.aClass46_6990 != null) {
                Class324 class324
                        = Class348_Sub36.aClass46_6990.method426(var_ha,
                        (byte) 68);
                if (class324 == null)
                ...
                Class13.method226(Class195.anIntArray5007[0],
                        Class195.anIntArray5007[2],
                        Class195.anIntArray5007[1], 0,
                        Class195.anIntArray5007[3]);
            } else if (Class21.aClass46_323 != null
                    && (Class348_Sub42_Sub8_Sub2.aClass230_10434
                    == Class10.aClass230_186)) {
                int i_1_
                        = (Class262.aClass324_3326.method2571
                        (-1, Class356.anInt4383, Class175.anIntArray2330,
                                string, 16777215, 0, Class341.aClass105Array4234,
                                16 + Class238_Sub1.anInt5832, 4 + Class120.anInt4911,
                                OutputStream_Sub1.aRandom93));
                Class13.method226(Class120.anInt4911 - -4,
                        (Class369.aClass143_4962.method1183(true,
                                string)
                                + i_1_),
                        Class238_Sub1.anInt5832, 0, 16);
            }
        }
    }
