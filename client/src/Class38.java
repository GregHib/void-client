...
final class Class38 {
    ...
    private final void method361(int i, Class348_Sub49 class348_sub49, int i_2_) {
        ...
        anInt497++;
        if (i_2_ == 1) this.anInt501 = class348_sub49.method3330(842397944);
        ...
        } else if (i_2_ == 4) this.anInt498 = class348_sub49.method3387(255);
        else if (i_2_ == 5) this.anInt504 = class348_sub49.method3330(842397944);
