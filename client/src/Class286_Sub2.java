...
final class Class286_Sub2 extends Class286 {
    ...
    static final void method2144(String string, int i, byte i_0_, int i_1_,
                                 String string_2_, String string_3_,
                                 String string_4_) {
        do {
            try {
                Class318_Sub1_Sub3_Sub5.method2477(string, string_2_,
                        (byte) -110, -1, string_3_,
                        null, i, i_1_, string_4_);
                anInt6203++;
                if (i_0_ < -86)
                    break;
