...
final class Class6 {
    ...
    static final void method203(int i, int i_0_, int i_1_, int i_2_,
        ...
        int i_6_ = -i_3_;
        int i_7_ = -1;
        int i_8_ = Class85.method831(Class113.anInt1745, i_3_ + i_0_,
                Class369.anInt4960, -108);
        int i_9_ = Class85.method831(Class113.anInt1745, -i_3_ + i_0_,
                Class369.anInt4960, 81);
        Class135_Sub2.method1156(-27, i_8_, Class17.anIntArrayArray255[i_2_],
                i_9_, i_1_);
        while (i_5_ > i_4_) {
            i_7_ += 2;
            i_6_ += i_7_;
            if (i_6_ > 0) {
                ...
                int i_10_ = -i_5_ + i_2_;
                int i_11_ = i_5_ + i_2_;
                if (i_11_ >= Class132.anInt1910
                        && Class38.anInt513 >= i_10_) {
                    int i_12_
                            = Class85.method831(Class113.anInt1745, i_4_ + i_0_,
                            Class369.anInt4960, 74);
                    int i_13_
                            = Class85.method831(Class113.anInt1745, i_0_ + -i_4_,
            ...
            int i_14_ = -++i_4_ + i_2_;
            int i_15_ = i_2_ - -i_4_;
            if (Class132.anInt1910 <= i_15_
                    && Class38.anInt513 >= i_14_) {
                int i_16_ = Class85.method831(Class113.anInt1745, i_0_ + i_5_,
                        Class369.anInt4960, 52);
                int i_17_ = Class85.method831(Class113.anInt1745, i_0_ + -i_5_,
                        Class369.anInt4960, -106);
                if (i_15_ <= Class38.anInt513)
                    Class135_Sub2.method1156(-27, i_16_,
                            Class17.anIntArrayArray255[i_15_],
                            i_17_, i_1_);
                if (i_14_ >= Class132.anInt1910)
                    Class135_Sub2.method1156(-27, i_16_,
                            Class17.anIntArrayArray255[i_14_],
                            i_17_, i_1_);
            }
        }
    }
    ...
    static final void method204(int i) {
        ...
        while (Class299.aClass348_Sub49_Sub2_3813
                .method3415(-62, Class348_Sub40_Sub25.anInt9341)
                >= 15) {
            int i_18_
            ...
            Class348_Sub22 class348_sub22
                    = ((Class348_Sub22)
                    Class282.aClass356_3654.method3480(i_18_, -6008));
            if (class348_sub22 == null) {
                ...
                Class282.aClass356_3654.method3483((byte) 57, i_18_,
                        class348_sub22);
                bool = true;
            ...
            int i_19_
                    = Class299.aClass348_Sub49_Sub2_3813.method3410((byte) -24, 2);
            int i_20_
                    = Class299.aClass348_Sub49_Sub2_3813.method3410((byte) -24, 1);
            int i_21_
                    = Class299.aClass348_Sub49_Sub2_3813.method3410((byte) -24, 5);
            if (i_21_ > 15)
                i_21_ -= 32;
            int i_22_
                    = Class299.aClass348_Sub49_Sub2_3813.method3410((byte) -24, 5);
            if (i_22_ > 15)
                i_22_ -= 32;
            int i_23_
                    = 0x3d01 & 4 + Class299.aClass348_Sub49_Sub2_3813
            ...
            class318_sub1_sub3_sub3_sub1.method2434
                    ((byte) 111, class318_sub1_sub3_sub3_sub1
                            .aClass79_10505.anInt1399);
            class318_sub1_sub3_sub3_sub1.anInt10310
                    = (class318_sub1_sub3_sub3_sub1.aClass79_10505
                    .anInt1329) << -233569405;
            if (bool)
    ...
    static final void method205(int i, int i_25_, int i_26_, String string,
        ...
        try {
            ...
            class318_sub5.anInt6421
                    = i + Class367_Sub11.anInt7396;
            if (i_28_ >= -48)
                method206(-90, -126, -8);
    ...
    static final void method207(ha var_ha, byte i) {
        do {
            try {
                ...
                var_ha.KA(i_35_, i_36_, Class321.anInt4017 + i_35_,
                        i_36_ + 350);
                var_ha.aa(i_35_, i_36_, Class321.anInt4017, 350,
                        0x332277 | Class168.anInt2254 << -61075752, 1);
                Class338.method2663(-5590, i_35_, Class321.anInt4017 + i_35_,
                        i_36_, i_36_ + 350);
                int i_37_ = 350 / Class68.anInt1188;
                if (Class369_Sub2.anInt8587 > 0) {
                    int i_38_ = 342 + -Class68.anInt1188;
                    int i_39_ = (i_37_ * i_38_
                            / (-1 + (i_37_ - -Class369_Sub2.anInt8587)));
                    int i_40_ = 4;
                    if (Class369_Sub2.anInt8587 > 1)
                        i_40_ += ((Class369_Sub2.anInt8587
                                + (-1 + -Class284.anInt3676))
                                * (i_38_ - i_39_)
                                / (Class369_Sub2.anInt8587 + -1));
                    var_ha.aa(-16 + (Class321.anInt4017 + i_35_),
                            i_36_ + i_40_, 12, i_39_,
                            0x332277 | Class168.anInt2254 << 1028581656, 2);
                    for (int i_41_ = Class284.anInt3676;
                         ((i_41_ < i_37_ + Class284.anInt3676)
                                 && Class369_Sub2.anInt8587 > i_41_);
                         i_41_++) {
                        String[] strings
                                = (Class348_Sub40_Sub23.method3113
                                ('\010', true,
                                        Class286_Sub1.aStringArray6200[i_41_]));
                        int i_42_
                                = (-16 + Class321.anInt4017 + -8) / strings.length;
                        for (int i_43_ = 0; i_43_ < strings.length; i_43_++) {
                            int i_44_ = i_42_ * i_43_ + 8;
                            var_ha.KA(i_35_ + i_44_, i_36_,
                                    i_42_ + i_35_ - (-i_44_ - -8),
                                    i_36_ + 350);
                            Applet_Sub1.aClass324_20.method2576
                                    (Class250.method1909((byte) 31,
                                            strings[i_43_]),
                                            -1,
                                            (-((-Class284.anInt3676 + i_41_)
                                                    * Class68.anInt1188)
                                                    + (-Class348_Sub31_Sub2.anInt9077 + i_36_
                                                    - (-350
                                                    - (-2 + -(Class246.aClass143_3179
                                                    .anInt1993))))),
                                            i_35_ + i_44_, -16777216, -110);
                        }
                    }
                }
                Class240.aClass324_4684.method2569("Build: 634",
                        350 + (i_36_ + -20), -1,
                        (Class321.anInt4017 + i_35_
                                + -25),
                        -121, -16777216);
                var_ha.KA(i_35_, i_36_, i_35_ - -Class321.anInt4017,
                        i_36_ - -350);
                var_ha.method3649((byte) -80, Class321.anInt4017,
                        -Class348_Sub31_Sub2.anInt9077 + (350
                                + i_36_),
                        -1, i_35_);
                Class262.aClass324_3326.method2576
                        ("--> " + Class250.method1909((byte) 31,
                                ...
                                -1,
                                (i_36_
                                        - (-350 + Class369.aClass143_4962.anInt1993)
                                        - 1),
                                10 + i_35_, -16777216, -127);
                if (!Class175.aBoolean2329)
                    break;
                int i_45_ = -1;
                if (Class367_Sub11.anInt7396 % 30 > 15)
                    i_45_ = 16777215;
                var_ha.method3660
                        (10 + (i_35_
