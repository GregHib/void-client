...
final class Class286_Sub3 extends Class286 {
    ...
    final void method2136(int i, int i_0_, byte i_1_) {
        ...
        if (aClass61_6222 != null) {
            ...
            if ((i & 0x80) != 0)
                this.aHa_Sub2_3684.method3771((byte) -122, null);
            else if ((0x1 & i_0_) != 1) {
                if (!aClass83_6227.aBoolean1442)
                    this.aHa_Sub2_3684.method3771
                            ((byte) -84,
                                    aClass83_6227.aClass258_Sub3Array1444[0]);
                else
                    this.aHa_Sub2_3684.method3771
                            ((byte) -97,
            ...
            if ((0x40 & i) == 0) {
                ...
                Class348_Sub42_Sub1.aFloatArray9491[0]
                        = (this.aHa_Sub2_3684.aFloat7781
                        * (this.aHa_Sub2_3684
                        .aFloat7768));
                Class348_Sub42_Sub1.aFloatArray9491[1]
                        = (this.aHa_Sub2_3684.aFloat7768
                        * (this.aHa_Sub2_3684
                        .aFloat7816));
    ...
    static final Class348_Sub47 method2148(Class351 class351, Class77 class77,
        ...
        try {
            ...
            if (class348_sub47.anInt7122 != -1) {
                if (class348_sub47.anInt7122 == -2)
                    class348_sub47.aClass348_Sub49_Sub2_7116
                            = new Class348_Sub49_Sub2(10000);
                else if (class348_sub47.anInt7122 <= 18)
                    class348_sub47.aClass348_Sub49_Sub2_7116
                            = new Class348_Sub49_Sub2(20);
                else if (class348_sub47.anInt7122 <= 98)
                    class348_sub47.aClass348_Sub49_Sub2_7116
        ...
        do {
            try {
                ...
                if (!this.aHa_Sub2_3684.aBoolean7841
                        || (this.aHa_Sub2_3684.anInt7795
                        < 2))
                    break;
                aClass171_6220
                        = (Class50.method459
                        (34336, this.aHa_Sub2_3684,
                    ...
                    if (strings != null) {
                        for (int i = 4; i >= 0; i--) {
                            if (strings[i] != null
                                ...
                                if (i == 3)
                                    i_16_ = 46;
                                if (class79.anInt1335 == i)
                                    i_17_ = class79.anInt1371;
                                if (i == 4)
                                    i_16_ = 60;
                                if (i == class79.anInt1385)
                                    i_17_ = class79.anInt1338;
                                Class229.anInt2976++;
                                Class50_Sub3.method466
    ...
    static final void method2152(boolean bool) {
        for (int i = 0; i < Class69.anInt1200;
             i++)
                ...
                for (int i_21_ = 0; (i_21_ < Class348_Sub41.anInt7054); i_21_++) {
                    ...
                    if (class357 != null) {
                        if (class357.aShort4398 > 0)
                            class357.aShort4398 *= -1;
                        if (class357.aShort4409 > 0)
                            class357.aShort4409 *= -1;
                    }
                }
            }
        }
                        ...
                        if (class357.aShort4409 < 0) {
                            ...
                            for (i_30_ = (Class348_Sub1_Sub1.aSArray8801[i]
                                 ...
                                 (i_25_ > 0 && class357_29_ != null
                                         && class357_29_.aShort4409 < 0
                                         && (class357_29_.aShort4409 == class357.aShort4409)
                                         && (class357.aShort4401
                                         == class357_29_.aShort4401)
                                         && ((Class348_Sub1_Sub1.aSArray8801
                                         [i].method3982
                                         ((byte) -86, -1 + i_25_, i_23_)) == i_30_));
                                 class357_29_
                            ...
                            for (class357_29_
                                         = (Class147.aClass357ArrayArrayArray2029
                                    [i][i_23_][1 + i_26_]);
                                 ((Class348_Sub41.anInt7054 > i_26_)
                                         && class357_29_ != null
                                         && class357_29_.aShort4409 < 0
                                         && (class357_29_.aShort4409 == class357.aShort4409)
                                         && (class357.aShort4401
                                         == class357_29_.aShort4401)
                                         && i_30_ == (Class348_Sub1_Sub1.aSArray8801[i]
                                         .method3982
                                                 ((byte) -86, i_26_ - -1, i_23_)));
                                 class357_29_
                                         = (Class147.aClass357ArrayArrayArray2029
                                         [i][i_23_][i_26_ + 1])) {
                                if ((Class348_Sub41.anInt7054 > 1 + i_26_)
                                        && i_30_ != (Class348_Sub1_Sub1
                                        .aSArray8801[i].method3982
                                        ((byte) -86, i_26_ + 2,
                                                i_23_)))
                        ...
                        if (class357.aShort4398 < 0) {
                            ...
                            for (i_46_ = (Class348_Sub1_Sub1.aSArray8801[i]
                                 ...
                                 (i_41_ > 0 && class357_45_ != null
                                         && class357_45_.aShort4398 < 0
                                         && (class357.aShort4398 == class357_45_.aShort4398)
                                         && (class357.aShort4397
                                         == class357_45_.aShort4397)
                            ...
                            Class318_Sub1_Sub3_Sub4.aClass338Array10330
                                    ...
                                    (2, i_44_, i_52_, i_53_, i_53_, i_52_,
                                            ...
                                            i_54_ + class357.aShort4397,
                                            i_54_ + class357.aShort4397,
                                            class357.aShort4397 + i_54_,
                                            (i_54_
                                                    - -class357.aShort4397)));
                            for (int i_55_ = i_43_;
                                 i_55_ <= i_44_;
