...
final class Class55_Sub1 extends Class55 {
        ...
        if (anIntArray5269 != null && i < -27) {
            for (int i_0_ = 0;
                ...
                if (aByteArrayArray5275[i_0_] == null
                        && aClass45_5267.method420(-10499,
                        (anIntArray5269
                                [i_0_ + anInt5270]),
                        0))
                    aByteArrayArray5275[i_0_]
                            = aClass45_5267.method410(-1860,
                            (anIntArray5269
                                    [anInt5270 + i_0_]),
                            0);
            }
    ...
    final int method516(byte i, byte[] is) throws IOException {
        ...
        if (anIntArray5269 == null) {
            if (!aClass45_5267.method420(-10499, anInt5272, 0))
                return 0;
            ...
            for (int i_6_ = 0; i_6_ < i_5_;
                 i_6_++)
                anIntArray5269[i_6_]
                        = aClass348_Sub49_5276.method3330(842397944);
        }
