...
final class Class258_Sub1 extends Class258 {
    ...
    Class258_Sub1(GlToolkit var_ha_Sub2, int i, int i_7_, int i_8_, int i_9_, byte[] is, int i_10_) {
    ...
    static final void method1960(int i, int i_12_, int i_13_, int i_14_, byte[][][] is, int[] is_15_, int[] is_16_, int[] is_17_, int[] is_18_, int[] is_19_, int i_20_, byte i_21_, int i_22_, int i_23_, boolean bool, boolean bool_24_, int i_25_, int i_26_, boolean bool_27_) {
        ...
        if (Class348_Sub40_Sub5.aBoolean9121) {
            ...
            if (Npc.anInt10503 == 2) {
                ...
                } else if ((VarBitType.aLongArray2013[0] > VarBitType.aLongArray2013[1]) && ((Class17.anIntArray256[0] + Class345.anIntArray4271[0]) < Class348_Sub40_Sub10.anIntArray9183[2])) Class345.anIntArray4271[0]--;
            }
        }
        if (!Class348_Sub40_Sub17.aBoolean9242) {
    ...
    Class258_Sub1(GlToolkit var_ha_Sub2, int i, int i_49_, int i_50_, int i_51_) {
