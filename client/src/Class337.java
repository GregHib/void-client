...
final class Class337 {
    ...
    static final boolean method2659(byte i, int i_0_, int i_1_) {
        int i_2_ = 24 % ((i - 76) / 42);
        anInt4176++;
        return (0x70000 & i_0_) != 0 | Class348.method2709(i_1_, i_0_, -1)
    ...
    static final Class288_Sub1 method2660(byte i,
        ...
        return new Class288_Sub1(class288.anInt4958,
                class288.aClass221_4955,
                class288.aClass341_4952,
                class288.anInt4950,
                class288.anInt4951, i_3_);
    }
}
