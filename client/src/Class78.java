...
final class Class78 {
    ...
    final void method783(int i, int i_0_, boolean bool, byte[] is)
        ...
        anInt1310++;
        try {
            if (aLong1324 - -(long) i_0_ > aLong1323)
                aLong1323 = (long) i_0_ + aLong1324;
            if (aLong1321 != -1
                    && (aLong1321 > aLong1324
                    || (aLong1324 > (long) anInt1314 + aLong1321)))
                method791(-1);
            if (aLong1321 != -1L
                    && (aLong1324 + (long) i_0_
            ...
            if (aByteArray1305.length < i_0_) {
                ...
                if (aLong1317 < aLong1315)
                    aLong1317 = aLong1315;
                long l = -1L;
                if ((aLong1319 <= aLong1324)
                        && (aLong1319 + (long) anInt1320 > aLong1324))
                    l = aLong1324;
                else if ((aLong1324 <= aLong1319)
                ...
                else if ((aLong1324 < (long) anInt1320 + aLong1319)
                        && ((long) i_0_ + aLong1324
                        >= aLong1319 + (long) anInt1320))
                    l_2_ = (long) anInt1320 + aLong1319;
                if (l > -1L && l_2_ > l) {
                    int i_3_ = (int) (l_2_ + -l);
                    Class214.method1577(is, (int) (-aLong1324 + l + (long) i),
    ...
    final void method788(int i, byte[] is, int i_5_, int i_6_)
        ...
        try {
            ...
            if (aLong1321 != -1
                    && aLong1324 >= aLong1321
                    && (aLong1324 - -(long) i_5_ <= (long) anInt1314 + aLong1321)) {
            ...
            if (aLong1321 != -1L) {
                ...
                long l_13_ = -1L;
                if (aLong1321 < l
                        || (l - -(long) i_8_ <= aLong1321)) {
                    if (aLong1321 <= l
                            && l < aLong1321 - -(long) anInt1314)
                        l_13_ = l;
                } else
                    l_13_ = aLong1321;
                long l_14_ = -1L;
                if ((long) anInt1314 + aLong1321 <= l
                        || ((long) i_8_ + l < (long) anInt1314 + aLong1321)) {
                    if ((aLong1321 < l - -(long) i_8_)
                            && ((long) anInt1314 + aLong1321 >= l - -(long) i_8_))
                        l_14_ = l + (long) i_8_;
                } else
    ...
    private final void method791(int i) throws IOException {
        ...
        if (aLong1321 != -1) {
            ...
            long l = -1L;
            long l_18_ = -1L;
            if (aLong1319 <= aLong1321
                    && (aLong1321 < (long) anInt1320 + aLong1319))
                l = aLong1321;
            else if ((aLong1319 >= aLong1321)
                    && (aLong1319 < aLong1321 - -(long) anInt1314))
                l = aLong1319;
            if (((long) anInt1314 + aLong1321 > aLong1319)
                    && ((long) anInt1314 + aLong1321
                    <= (long) anInt1320 + aLong1319))
                l_18_ = aLong1321 - -(long) anInt1314;
            else if ((aLong1321 < aLong1319 + (long) anInt1320)
                    && (aLong1319 + (long) anInt1320
                    <= (long) anInt1314 + aLong1321))
                l_18_ = (long) anInt1320 + aLong1319;
            if (l > -1 && l < l_18_) {
                int i_19_ = (int) (-l + l_18_);
                Class214.method1577(aByteArray1305, (int) (l - aLong1321),
                        aByteArray1311, (int) (-aLong1319 + l),
                        i_19_);
            }
            aLong1321 = -1L;
    ...
    private final void method792(byte i) throws IOException {
        ...
        while (anInt1320 < aByteArray1311.length) {
            ...
            if (i_20_ > 200000000)
                i_20_ = 200000000;
            int i_21_ = aClass234_1312.method1656(aByteArray1311, anInt1320,
                    (byte) 125, i_20_);
            if (i_21_ == -1)
                break;
            anInt1320 += i_21_;
