...
final class Class151
{
    ...
    static final void method1211(int i, Class105 class105, int i_2_,
				 Class46 class46, aa var_aa, int i_3_,
				 int i_4_, int i_5_) {
	try {
	    anInt2064++;
	    if (class105 != null) {
		...
		if (i_7_ * i_7_ >= i_8_) {
		    ...
		    if (Class348_Sub40_Sub21.anInt9282 != 4) {
			i_10_ = 256 * i_10_ / (Class348_Sub49_Sub1.anInt9750
					       - -256);
			i_9_ = i_9_ * 256 / (Class348_Sub49_Sub1.anInt9750
					     - -256);
		    }
	...
	if (i_14_ == i_13_ && !Class74.aBoolean1236)
	    Class104.method960(1);
		 ...
		 && (i_13_ != Class267.anInt3428 || !Class167.method1296(true))
		 && i != 0 && !Class74.aBoolean1236) {
	    Class40.method368(i, 18002, false, i_13_,
			      Class59_Sub2_Sub1.aClass45_8667, 0, i_15_);
	    Class348_Sub40_Sub17_Sub1.method3093(93);
	}
	if (Class267.anInt3428 != i_13_)
