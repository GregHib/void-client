...
final class Class318_Sub2 extends Class318 {
    ...
    static final void method2494(int i, int i_0_, int i_1_, ha var_ha,
            ...
            try {
                ...
                if (!Class148.method1197(-12081,
                    ...
                    is = (Exception_Sub1.aClass255_112.method1940
                            ...
                            .anIntArray2772);
                String string
                        = Class316.method2367((byte) 125, class348_sub42_sub12);
                if (is != null)
                    string += Class163.method1273(is, true);
                Class262.aClass324_3326.method2567(i_1_, string, (byte) 116,
                        i_4_, 0, i_7_ - -3,
                ...
                Class239_Sub24.aClass105_6097.method974
                        (Class369.aClass143_4962.method1183(true, string) + (i_7_
                                        - -5),
                                -12 + i_1_);
    ...
    static final void method2498(Class338 class338, ha var_ha, byte i,
                                 int i_18_) {
        try {
            anInt6395++;
            if (i > -101)
            ...
            if (Class318_Sub1_Sub3_Sub3_Sub2.anIntArray10566 != null
                ...
                for (int i_19_ = 0;
                    ...
                    if ((Class318_Sub1_Sub3_Sub3_Sub2.anIntArray10566[i_19_]
                            ...
                            && ((class338.anIntArray4187[0]
                            <= Class59_Sub1_Sub2.anIntArray8666[i_19_])
                            || (class338.anIntArray4187[1]
                            <= Class59_Sub1_Sub2.anIntArray8666[i_19_])
                            || (class338.anIntArray4187[2]
                            <= Class59_Sub1_Sub2.anIntArray8666[i_19_])
                            || (Class59_Sub1_Sub2.anIntArray8666[i_19_]
                ...
                if (i_20_ >= 0
                    ...
                    if (bool) {
                        ...
                        if (!(f < (float) Class11.anInt194)
                            ...
                            Class348_Sub42_Sub19.aClass338Array9700
            ...
            } else if (class338.aByte4192 == 16
                    || class338.aByte4192 == 8) {
