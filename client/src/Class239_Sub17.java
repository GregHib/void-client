                ...
                if (i_5_ >= 224) {
                    if (i_5_ < 240) {
                        if (i_3_ + 1 < i_4_ && (is[i_3_] & 0xc0) == 128 && (0xc0 & is[1 + i_3_]) == 128) {
                            i_6_ = ((i_5_ & 0xf) << 640802508 | is[i_3_++] << 393745350 & 0xfc0 | is[i_3_++] & 0x3f);
                        ...
                        i_6_ = (i_5_ << -564067822 & 0x1c0000 | (is[i_3_++] & 0x3f) << 1045214124 | 0xfc0 & is[i_3_++] << -1022009914 | 0x3f & is[i_3_++]);
    ...
    static final void method1797(int i, int i_11_, Class46 class46, byte i_12_) {
        if (r.aBoolean9722) {
            ...
            if (client.method105(class46).method3303(1) && (Class38.anInt500 & 0x20) != 0 && (class254 == null || (class46.method428(class254.anInt3256, Class246.anInt3176, -128) != class254.anInt3256))) {
                Class31.anInt436++;
                Class50_Sub3.method466(false, (Class28.aString5000 + " -> " + class46.aString752), class46.anInt830, (byte) -90, false, class46.anInt704, class46.anInt812, true, 6, class46.anInt830 | (class46.anInt704 << -1824897120), Class28.aString5001, 0L, Class348_Sub49_Sub1.anInt9747);
            }
        }
        anInt6022++;
        for (int i_13_ = 9; i_13_ >= 5; i_13_--) {
            ...
            if (string != null) {
                Class50_Sub3.method466(false, class46.aString752, class46.anInt830, (byte) -122, false, class46.anInt704, class46.anInt812, true, 1011, (class46.anInt704 << 987307680) | class46.anInt830, string, 1 + i_13_, Class100.method888((byte) 57, i_13_, class46));
                Class335.anInt4169++;
            }
        }
        String string = Class239_Sub8.method1753(0, class46);
        if (string != null) {
            Class50_Sub3.method466(false, class46.aString752, class46.anInt830, (byte) -83, false, class46.anInt704, class46.anInt812, true, 13, (class46.anInt704 << 973259008) | class46.anInt830, string, 0L, class46.anInt713);
            Class178.anInt2340++;
        }
        ...
        for (int i_14_ = 4; i_14_ >= 0; i_14_--) {
            ...
            if (string_15_ != null) {
                Class50_Sub3.method466(false, class46.aString752, class46.anInt830, (byte) -67, false, class46.anInt704, class46.anInt812, true, 18, (class46.anInt704 << 617873312) | class46.anInt830, string_15_, 1 + i_14_, Class100.method888((byte) 57, i_14_, class46));
                Class335.anInt4169++;
            }
        }
        if (client.method105(class46).method3305(0)) {
            if (class46.aString816 != null) Class50_Sub3.method466(false, "", class46.anInt830, (byte) -118, false, class46.anInt704, class46.anInt812, true, 16, (class46.anInt704 << -1427066464) | class46.anInt830, class46.aString816, 0L, -1);
            else Class50_Sub3.method466(false, "", class46.anInt830, (byte) -79, false, class46.anInt704, class46.anInt812, true, 16, class46.anInt704 << -477045792 | class46.anInt830, Class274.aClass274_3492.method2063(Class348_Sub33.anInt6967, 544), 0L, -1);
