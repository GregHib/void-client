...
final class Class124 {
    ...
    final int[][] method1093(byte i) {
        ...
        int[] is = new int[256];
        int i_3_ = 0;
        for (int i_4_ = 0; this.aClass162Array1832.length > i_4_;
             i_4_++) {
            int i_5_ = (this.aClass162Array1832[i_4_]
                    .anInt2156);
            if (i_5_ >= 0) {
                is[i_5_]++;
                if (i_3_ < i_5_)
        ...
        if (i > -68)
            return null;
        for (int i_8_ = 0; i_8_ < this.aClass162Array1832.length;
             i_8_++) {
            int i_9_ = (this.aClass162Array1832[i_8_]
                    .anInt2156);
            if (i_9_ >= 0)
    ...
    final void method1095(short i, int i_17_, short i_18_) {
        ...
        if (this.aShortArray1822 != null) {
            for (int i_19_ = i_17_; this.anInt1817 > i_19_;
                 i_19_++) {
                if (i == this.aShortArray1822[i_19_])
                    this.aShortArray1822[i_19_] = i_18_;
            }
        }
    }
    ...
    final int method1101(int i, int i_39_, int i_40_, int i_41_) {
        ...
        for (/**/; i_42_ < this.anInt1836; i_42_++) {
            if (this.anIntArray1841[i_42_] == i_40_
                    && i == this.anIntArray1847[i_42_]
                    && this.anIntArray1852[i_42_] == i_39_)
                return i_42_;
        }
    ...
    final int method1102(int i, byte i_44_, byte i_45_, short i_46_,
                         ...
                         int i_51_) {
        this.aShortArray1863[this.anInt1817]
                = (short) i;
        anInt1860++;
        this.aShortArray1835[this.anInt1817]
                = (short) i_49_;
        this.aShortArray1855[this.anInt1817]
                = (short) i_51_;
        if (i_47_ < 30)
            return -92;
    ...
    private final void method1103(int i, byte[] is) {
        ...
        for (int i_97_ = 0;
            ...
            this.aShortArray1829[i_97_]
                    = (short) class348_sub49.method3330(842397944);
            this.aShortArray1849[i_97_]
                    = (short) class348_sub49.method3330(842397944);
            this.aShortArray1825[i_97_]
                    = (short) class348_sub49.method3330(842397944);
        }
            ...
            for (int i_99_ = 0; i_99_ < this.anInt1817; i_99_++) {
                ...
                if ((i_100_ ^ 0xffffffff) != -256) {
                    if (((0xffff & this.aShortArray1829[i_100_])
                            ...
                            != (0xffff
                            & this.aShortArray1849[i_100_]))
                            || ((0xffff
                            & this.aShortArray1825[i_100_])
                            != this.aShortArray1855[i_99_]))
                        bool_98_ = true;
                    else
                        this.aByteArray1820[i_99_] = (byte) -1;
                }
            }
            if (!bool_98_)
                this.aByteArray1820 = null;
        }
        if (!bool)
            this.aByteArray1843 = null;
        if (!bool_52_)
            this.aShortArray1822 = null;
    }
    ...
    private final int method1104(Class124 class124_101_, int i, int i_102_,
        ...
        this.aShortArray1842[this.anInt1836]
                = i_103_;
        this.anIntArray1868[this.anInt1836]
                = (class124_101_.anIntArray1868 != null
                ? class124_101_.anIntArray1868[i_102_] : -1);
        return this.anInt1836++;
    }
    ...
    final byte method1105(int i, byte i_108_, byte i_109_, short i_110_,
        ...
        anInt1838++;
        if (this.anInt1818 >= 255)
            throw new IllegalStateException();
        this.aByteArray1823[this.anInt1818]
                = (byte) 3;
        this.aShortArray1829[this.anInt1818]
                = i_110_;
        this.aShortArray1849[this.anInt1818]
                = i_114_;
        this.aShortArray1825[this.anInt1818]
                = i_113_;
    ...
    private final void method1106(byte[] is, byte i) {
        ...
        this.anInt1836 = class348_sub49.method3330(842397944);
        this.anInt1817 = class348_sub49.method3330(842397944);
        this.anInt1818 = class348_sub49.method3387(255);
        ...
        if (bool_127_) {
            ...
            this.anInt1830 = class348_sub49.method3387(255);
        ...
        for (int i_174_ = 0;
            ...
            if (i_129_ == 1)
                this.aByteArray1834[i_174_]
                        = class348_sub49_120_.method3388(-99);
            if (i_130_ == 1)
                this.anIntArray1824[i_174_]
                        = class348_sub49_121_.method3387(255);
            if (i_131_ == 1)
                this.aShortArray1822[i_174_]
                        = (short) (class348_sub49_122_.method3330(842397944) + -1);
            if (this.aByteArray1820 != null) {
                if (this.aShortArray1822[i_174_] == -1)
                    this.aByteArray1820[i_174_] = (byte) -1;
                else
                    this.aByteArray1820[i_174_]
        ...
        for (int i_182_ = 0; this.anInt1818 > i_182_; i_182_++) {
            ...
            if ((i_183_ ^ 0xffffffff) == -2) {
                ...
                this.aByteArray1833[i_182_]
                        = class348_sub49_120_.method3388(-86);
                this.aByteArray1853[i_182_]
                        = class348_sub49_121_.method3388(-116);
                this.anIntArray1867[i_182_]
            ...
            if (i_183_ == 2) {
                ...
                this.anIntArray1857[i_182_]
                        = class348_sub49_122_.method3388(-112);
                this.anIntArray1865[i_182_]
        ...
        if (bool_125_) {
            ...
            if ((i_184_ ^ 0xffffffff) < -1) {
                ...
                for (int i_185_ = 0; i_184_ > i_185_; i_185_++) {
                    ...
                    this.aClass129Array1846[i_185_]
                            = (new Class129
                            (i_186_, this.aShortArray1863[i_187_],
                                    this.aShortArray1835[i_187_],
                                    this.aShortArray1855[i_187_],
                                    i_188_));
                }
            }
            ...
            if ((i_189_ ^ 0xffffffff) < -1) {
                ...
                for (int i_190_ = 0; i_189_ > i_190_; i_190_++) {
                    ...
                    this.aClass342Array1866[i_190_]
        ...
        if (bool_126_) {
            ...
            if ((i_193_ ^ 0xffffffff) < -1) {
                ...
                for (int i_194_ = 0;
                    ...
                    this.aClass162Array1832[i_194_]
    ...
    final void method1107(int i, int i_199_, int i_200_, int i_201_) {
        if ((i_200_ ^ 0xffffffff) != -1) {
            ...
            for (int i_204_ = 0; i_204_ < this.anInt1836;
                 i_204_++) {
                int i_205_
                        = ((i_203_ * this.anIntArray1841[i_204_]
                        + this.anIntArray1847[i_204_] * i_202_)
                        >> 53081646);
                this.anIntArray1847[i_204_]
                        = ((-(this.anIntArray1841[i_204_] * i_202_)
                        + this.anIntArray1847[i_204_] * i_203_)
                        >> 788620462);
                this.anIntArray1841[i_204_] = i_205_;
            }
        }
        if (i != 6875)
            this.aShortArray1835 = null;
        anInt1837++;
        if (i_201_ != 0) {
            int i_206_ = Class70.anIntArray1207[i_201_];
            int i_207_ = Class70.anIntArray1204[i_201_];
            for (int i_208_ = 0; i_208_ < this.anInt1836;
                 i_208_++) {
                int i_209_
                        = ((this.anIntArray1847[i_208_] * i_207_
                        + -(i_206_ * this.anIntArray1852[i_208_]))
                        >> -723657074);
                this.anIntArray1852[i_208_]
                        = ((this.anIntArray1847[i_208_] * i_206_
                        - -(i_207_ * this.anIntArray1852[i_208_]))
                        >> 1866464078);
        ...
        if (i_199_ != 0) {
            ...
            for (int i_212_ = 0; this.anInt1836 > i_212_;
                 i_212_++) {
                int i_213_
                        = ((i_211_ * this.anIntArray1841[i_212_]
                        + this.anIntArray1852[i_212_] * i_210_)
                        >> -1869821682);
                this.anIntArray1852[i_212_]
                        = ((i_211_ * this.anIntArray1852[i_212_]
                        + -(this.anIntArray1841[i_212_] * i_210_))
                        >> -1993052722);
    ...
    Class124(Class124[] class124s, int i) {
        ...
        for (int i_224_ = 0; i > i_224_; i_224_++) {
            ...
            if (class124_225_ != null) {
                this.anInt1817
                        += class124_225_.anInt1817;
                this.anInt1836
                        += class124_225_.anInt1836;
                this.anInt1818
                        += class124_225_.anInt1818;
                bool
                        = bool | class124_225_.aByteArray1843 != null;
                if (class124_225_.aClass162Array1832 != null)
                    i_218_ += (class124_225_
                            .aClass162Array1832).length;
                if (class124_225_.aClass129Array1846 != null)
                    i_216_ += (class124_225_
                            .aClass129Array1846).length;
                if (class124_225_.aClass342Array1866 != null)
                    i_217_ += (class124_225_
                            .aClass342Array1866).length;
                bool_222_
                        = (bool_222_
                        | class124_225_.aShortArray1822 != null);
                bool_221_
                        = (bool_221_
                ...
                bool_223_
                        = (bool_223_
                        | class124_225_.anIntArray1824 != null);
            }
        }
        this.aShortArray1835
                = new short[this.anInt1817];
        ...
        this.anIntArray1847
                = new int[this.anInt1836];
        if (i_216_ > 0)
            this.aClass129Array1846 = new Class129[i_216_];
        this.aShortArray1855
                = new short[this.anInt1817];
        if (bool_220_)
            this.aByteArray1834
                    = new byte[this.anInt1817];
        this.aShortArray1842
                = new short[this.anInt1836];
        this.anInt1818 = 0;
        i_217_ = 0;
        i_218_ = 0;
        i_216_ = 0;
        ...
        for (int i_226_ = 0; (i_226_ ^ 0xffffffff) > (i ^ 0xffffffff);
            ...
            if (class124_228_ != null) {
                if (class124_228_.aClass162Array1832 != null) {
                    for (int i_229_ = 0;
                         (class124_228_.aClass162Array1832.length
                                 > i_229_);
                         i_229_++) {
                        Class162 class162 = (class124_228_
                                .aClass162Array1832[i_229_]);
                        this.aClass162Array1832[i_218_++]
                                = class162.method1266(5, ((class162
                                .anInt2155)
                                - -(this
                                .anInt1817)));
                    }
                ...
                for (int i_230_ = 0;
					 class124_228_.anInt1817 > i_230_; i_230_++) {
                    if (bool
                            && class124_228_.aByteArray1843 != null)
                        this.aByteArray1843[(this
                                .anInt1817)]
                                = (class124_228_.aByteArray1843
                                [i_230_]);
                    if (bool_219_) {
                        if (class124_228_.aByteArray1839 != null)
                            this.aByteArray1839[(this
                                    .anInt1817)]
                                    = (class124_228_.aByteArray1839
                                    [i_230_]);
                        else
                            this.aByteArray1839[(this
                                    .anInt1817)]
                                    = class124_228_.aByte1851;
                    }
                    if (bool_220_
                            && class124_228_.aByteArray1834 != null)
                        this.aByteArray1834[(this
                                .anInt1817)]
                                = (class124_228_.aByteArray1834
                                [i_230_]);
                    if (bool_222_) {
                        if (class124_228_.aShortArray1822 == null)
                            this.aShortArray1822
                                    [this.anInt1817]
                                    = (short) -1;
                        else
                            this.aShortArray1822
                                    [this.anInt1817]
                                    = (class124_228_.aShortArray1822
                                    [i_230_]);
                    }
                    if (bool_223_) {
                        if (class124_228_.anIntArray1824 == null)
                            this.anIntArray1824[(this
                                    .anInt1817)]
                                    = -1;
                        else
                            this.anIntArray1824[(this
                                    .anInt1817)]
                                    = (class124_228_.anIntArray1824
                                    [i_230_]);
                    }
                    this.aShortArray1863[(this
                            .anInt1817)]
                            = (short) method1104(class124_228_, 0,
                            (class124_228_
                                    .aShortArray1863[i_230_]),
                            i_227_);
                    this.aShortArray1835[(this
                            .anInt1817)]
                            = (short) method1104(class124_228_, 0,
                            (class124_228_
                                    .aShortArray1835[i_230_]),
                            i_227_);
                    this.aShortArray1855[(this
                            .anInt1817)]
                            = (short) method1104(class124_228_, 0,
                            (class124_228_
                                    .aShortArray1855[i_230_]),
                            i_227_);
                    this.aShortArray1856[(this
                            .anInt1817)]
                            = i_227_;
                    this.aShortArray1862[(this
                            .anInt1817)]
                            = class124_228_.aShortArray1862[i_230_];
                    this.anInt1817++;
                }
                if (class124_228_.aClass129Array1846 != null) {
                    for (int i_231_ = 0;
                         (class124_228_.aClass129Array1846.length
                                 > i_231_);
                         i_231_++) {
                        ...
                        int i_234_ = method1104(class124_228_, 0,
                                class124_228_
										...
										[i_231_].anInt1892,
                                i_227_);
                        this.aClass129Array1846[i_216_]
                                = class124_228_.aClass129Array1846
                                [i_231_]
                    ...
                    for (int i_235_ = 0;
                        ...
                        int i_236_ = method1104(class124_228_, 0,
                                class124_228_
										...
										[i_235_].anInt4244,
                                i_227_);
                        this.aClass342Array1866[i_217_]
                                = class124_228_.aClass342Array1866
        ...
        for (int i_238_ = 0; (i_238_ ^ 0xffffffff) > (i ^ 0xffffffff);
            ...
            if (class124_240_ != null) {
                for (int i_241_ = 0;
					 class124_240_.anInt1817 > i_241_; i_241_++) {
                    if (bool_221_)
                ...
                for (int i_242_ = 0;
                    ...
                    if ((i_243_ ^ 0xffffffff) == -1) {
                        this.aShortArray1829[(this
                                ...
                                i_239_);
                        this.aShortArray1849[(this
                                .anInt1818)]
                                = (short) method1104(class124_240_, 0,
                                (class124_240_
                                        .aShortArray1849[i_242_]),
                                i_239_);
                        this.aShortArray1825[(this
                                .anInt1818)]
                                = (short) method1104(class124_240_, 0,
                                (class124_240_
                    ...
                    if ((i_243_ ^ 0xffffffff) <= -2
                        ...
                        this.aShortArray1849[(this
                                .anInt1818)]
                                = (class124_240_.aShortArray1849
                                [i_242_]);
                        this.aShortArray1825[(this
                                .anInt1818)]
                                = (class124_240_.aShortArray1825
                                [i_242_]);
                        this.anIntArray1859[(this
                                .anInt1818)]
                                = (class124_240_.anIntArray1859
                                [i_242_]);
                        this.anIntArray1816[(this
                                .anInt1818)]
                                = (class124_240_.anIntArray1816
                                [i_242_]);
                        this.anIntArray1844[(this
                                .anInt1818)]
                                = (class124_240_.anIntArray1844
                                [i_242_]);
                        this.aByteArray1833[(this
                                .anInt1818)]
                                = (class124_240_.aByteArray1833
                                [i_242_]);
                        this.aByteArray1853[(this
                                .anInt1818)]
                                = (class124_240_.aByteArray1853
                                [i_242_]);
                        this.anIntArray1867[(this
                                .anInt1818)]
                                = (class124_240_.anIntArray1867
                                [i_242_]);
                    }
                    if (i_243_ == 2) {
                        this.anIntArray1857[(this
                                .anInt1818)]
                                = (class124_240_.anIntArray1857
                                [i_242_]);
                        this.anIntArray1865[(this
                                .anInt1818)]
                                = (class124_240_.anIntArray1865
                                [i_242_]);
                    }
                    this.anInt1818++;
                }
