...
final class Class17 {
    ...
    final int method263(int i, int i_0_, int i_1_, boolean bool) {
        ...
        Class348_Sub42_Sub17 class348_sub42_sub17_5_ = this.aClass87_251.method839(i_4_ >> -1425405904, 3);
        i_4_ &= 0xffff;
        ...
        if ((this.aBoolean241 || Class28.aBoolean5002) && i != -1 && i < this.anIntArray237.length) {
            ...
            class348_sub42_sub17 = this.aClass87_251.method839(i_3_ >> -1126055824, 3);
            i_3_ &= 0xffff;
        }
        ...
        if (anIntArray260 != null && bool) {
            if (anIntArray260.length > i_1_) {
                ...
                if (i_6_ != 65535) {
                    Class348_Sub42_Sub17 class348_sub42_sub17_7_ = this.aClass87_251.method839(i_6_ >> 743125296, 3);
                    i_6_ &= 0xffff;
            ...
            if ((this.aBoolean241 || Class28.aBoolean5002) && i != -1 && anIntArray260.length > i) {
                ...
                if (i_8_ != 65535) {
                    Class348_Sub42_Sub17 class348_sub42_sub17_9_ = this.aClass87_251.method839(i_8_ >> -1324248592, 3);
                    i_8_ &= 0xffff;
        ...
        if (i_10_ == -14861) {
            if (i == 1) {
                ...
                for (int i_12_ = 0; i_12_ < i_11_; i_12_++)
                    this.anIntArray267[i_12_] = class348_sub49.method3330(842397944);
                for (int i_13_ = 0; i_13_ < i_11_; i_13_++)
                    this.anIntArray237[i_13_] = class348_sub49.method3330(842397944);
                for (int i_14_ = 0; i_14_ < i_11_; i_14_++)
                    this.anIntArray237[i_14_] = ((class348_sub49.method3330(842397944) << -1063557680) + this.anIntArray237[i_14_]);
            } else if (i != 2) {
                if (i == 3) {
                    this.aBooleanArray263 = new boolean[256];
                    int i_15_ = class348_sub49.method3387(255);//byte
                    for (int i_16_ = 0; i_16_ < i_15_; i_16_++)
                        this.aBooleanArray263[class348_sub49.method3387(255)] = true;
                } else if (i != 5) {
                    if (i != 6) {
                        if (i != 7) {
                            if (i != 8) {
                                if (i == 9) this.anInt262 = class348_sub49.method3387(i_10_ + 15116);
                                else if (i == 10) this.anInt245 = class348_sub49.method3387(i_10_ ^ ~0x3af3);
                                else if (i != 11) {
                                    if (i == 12) {
                                        int i_17_ = class348_sub49.method3387(i_10_ ^ ~0x3af3);
                                        anIntArray260 = new int[i_17_];
                                        for (int i_18_ = 0; (i_18_ < i_17_); i_18_++)
                                            anIntArray260[i_18_] = class348_sub49.method3330(842397944);
                                        for (int i_19_ = 0; (i_17_ > i_19_); i_19_++)
                                            anIntArray260[i_19_] = ((class348_sub49.method3330(842397944) << -960144720) - -anIntArray260[i_19_]);
                                    } else if (i == 13) {
                                        ...
                                        for (int i_21_ = 0; (i_21_ < i_20_); i_21_++) {
                                            ...
                                            if (i_22_ > 0) {
                                                ...
                                                for (int i_23_ = 1; (i_22_ > i_23_); i_23_++)
                                                    this.anIntArrayArray264[i_21_][i_23_] = (class348_sub49.method3330(842397944));
                                            }
                                        }
                                    } else if (i != 14) {
                                        if (i == 15) this.aBoolean241 = true;
                                            ...
                                            this.anIntArray253[class348_sub49.method3387(255)] = (class348_sub49.method3387(Class348_Sub21.method2955(i_10_, -15092)));
                                        } else if (i == 20) {
                                            ...
                                            this.anIntArray236[i_26_] = class348_sub49.method3330(842397944);
                                            this.anIntArray265[i_26_] = class348_sub49.method3330(842397944);
                                        }
                                    } else this.aBoolean242 = true;
                                } else this.anInt248 = class348_sub49.method3387(255);
                            } else this.anInt244 = class348_sub49.method3387(255);
                        } else this.anInt261 = class348_sub49.method3330(842397944);
                    } else this.anInt249 = class348_sub49.method3330(842397944);
                } else this.anInt239 = class348_sub49.method3387(i_10_ + 15116);
            } else this.anInt238 = class348_sub49.method3330(i_10_ ^ ~0x3235c2f4);
            anInt257++;
        }
    }
    ...
    final Class64 method266(Class64 class64, int i, int i_27_, byte i_28_, int i_29_, int i_30_, int i_31_, int i_32_) {
        ...
        Class348_Sub42_Sub17 class348_sub42_sub17 = this.aClass87_251.method839(i_29_ >> 663780816, 3);
        i_29_ &= 0xffff;
        ...
        if ((this.aBoolean241 || Class28.aBoolean5002) && i_27_ != -1 && this.anIntArray237.length > i_27_) {
            ...
            class348_sub42_sub17_34_ = this.aClass87_251.method839(i_27_ >> 350375504, 3);
            i_27_ &= 0xffff;
        }
    ...
    final Class64 method269(int i, Class64 class64, int i_50_, int i_51_, int i_52_, int i_53_) {
        ...
        Class348_Sub42_Sub17 class348_sub42_sub17 = this.aClass87_251.method839(i_55_ >> 730167760, 3);
        i_55_ &= 0xffff;
        ...
        if ((this.aBoolean241 || Class28.aBoolean5002) && i_50_ != -1 && this.anIntArray237.length > i_50_) {
            ...
            class348_sub42_sub17_56_ = this.aClass87_251.method839(i_50_ >> 996945008, 3);
            i_50_ &= 0xffff;
        }
        ...
        if (anIntArray260 != null) {
            if (anIntArray260.length > i_53_) {
                ...
                if (i_59_ != 65535) {
                    class348_sub42_sub17_57_ = this.aClass87_251.method839(i_59_ >> -111731472, 3);
                    i_59_ &= 0xffff;
                }
            }
            if ((this.aBoolean241 || Class28.aBoolean5002) && i_50_ != -1 && i_50_ < anIntArray260.length) {
                ...
                if (i_60_ != 65535) {
                    class348_sub42_sub17_58_ = this.aClass87_251.method839(i_60_ >> 1163760656, 3);
                    i_60_ &= 0xffff;
                }
            }
        }
