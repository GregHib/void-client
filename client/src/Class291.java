...
final class Class291 {
    ...
    private final void method2200(byte i, byte[] is) {
        ...
        for (int i_7_ = 0;
            ...
            if (i_6_ < this.anIntArray3738[i_7_])
                i_6_ = this.anIntArray3738[i_7_];
        }
        this.anInt3734 = i_6_ - -1;
        if (bool_4_)
            this.aByteArrayArray3730
                    = new byte[this.anInt3734][];
        this.anIntArray3729
                = new int[this.anInt3734];
        this.anIntArray3724
                = new int[this.anInt3734];
        this.anIntArray3725
                = new int[this.anInt3734];
        ...
        if (bool) {
            ...
            for (int i_9_ = 0;
                ...
                this.anIntArray3733[(this
                        ...
                        = class348_sub49.method3385((byte) -126);
            this.aClass316_3723
                    = new Class316(this.anIntArray3733);
        }
        if (i >= -83)
        ...
        if (bool_4_) {
            for (int i_11_ = 0; i_11_ < this.anInt3727; i_11_++) {
                ...
                this.aByteArrayArray3730[(this
                        .anIntArray3738[i_11_])]
                        = is_12_;
            }
        }
        for (int i_13_ = 0; i_13_ < this.anInt3727; i_13_++)
            this.anIntArray3722[(this.anIntArray3738
                    [i_13_])]
                    = class348_sub49.method3385((byte) -126);
        for (int i_14_ = 0; this.anInt3727 > i_14_; i_14_++)
            this.anIntArray3725[(this.anIntArray3738
                    [i_14_])]
                    = class348_sub49.method3330(842397944);
        for (int i_15_ = 0;
        ...
        if (bool) {
            ...
            for (int i_21_ = 0; i_21_ < this.anInt3727; i_21_++) {
                ...
                this.anIntArrayArray3735[i_22_]
                        = new int[this.anIntArray3724[i_22_]];
                for (int i_24_ = 0;
                     this.anIntArray3724[i_22_] > i_24_; i_24_++)
                    this.anIntArrayArray3735[i_22_][i_24_] = -1;
                for (int i_25_ = 0; i_23_ > i_25_; i_25_++) {
                    int i_26_;
                    if (this.anIntArrayArray3721[i_22_] != null)
                        i_26_ = (this.anIntArrayArray3721[i_22_]
                                [i_25_]);
                    else
                        i_26_ = i_25_;
                    this.anIntArrayArray3735[i_22_][i_26_]
                            = class348_sub49.method3385((byte) -126);
                }
                this.aClass316Array3728[i_22_]
                        = new Class316(this.anIntArrayArray3735
                        [i_22_]);
            }
        }
    }
