...
abstract class Class318_Sub1 extends Class318 {
    ...
    abstract void method2380(ha var_ha, int i, boolean bool,
    ...
    static final void method2385(Class46 class46, int i, aa var_aa, int i_4_,
                        ...
                        for (int i_9_ = 0; is.length / 2 > i_9_; i_9_++) {
                            ...
                            if ((Class348_Sub40_Sub21.anInt9282 ^ 0xffffffff)
                                ...
                                i_11_ = (i_11_ * 256
                                        ...
                                        + 256));
                                i_12_
                                        = i_12_ * 256 / (256 + (Class348_Sub49_Sub1
                                        .anInt9750));
                            }
                            is[i_9_ * 2]
