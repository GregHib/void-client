...
final class Class348_Sub42_Sub14 extends Class348_Sub42 {
    ...
    final void method3240(byte i) {
        ...
        for (Class348_Sub18 class348_sub18
             = (Class348_Sub18) this
                .aClass262_9629.method1995(i + -33);
             class348_sub18 != null;
             class348_sub18 = (Class348_Sub18) this
                     .aClass262_9629
                     .method1990((byte) 52)) {
    ...
    static final void method3241(int i, byte i_7_, ha var_ha) {
        ...
        if (!Class348_Sub40_Sub23.aBoolean9307 || !Class23.aBoolean351)
            ...
            if (Class348_Sub40_Sub26.aBoolean9352)
                Class213.aLong2789 = Class50_Sub4.aClass47_5262.method446(1);
            Class42.anInt562 = 0;
            ...
            for (int i_10_ = 0; i_10_ < Class348_Sub44.anInt7101; i_10_++)
                Class318_Sub2.method2498(Class294.aClass338Array5060[i_10_],
                        var_ha, (byte) -128, i);
            ...
            if (Class348_Sub42_Sub10.anInt9577 > 0) {
                ...
                for (int i_14_ = 0;
                    ...
                    Class348_Sub40_Sub29.method3125
                            (class338.aShortArray4194[3],
                                    class338.aShortArray4183[0],
                                    class338.aShortArray4194[1],
                                    class338.aShortArray4188[3],
                                    class338.aShortArray4188[1], (byte) -105,
                                    class338.aShortArray4183[1],
                                    class338.aShortArray4188[0],
                                    class338.aShortArray4194[0],
                                    class338.aShortArray4183[3]);
                    Class348_Sub40_Sub29.method3125
                            (class338.aShortArray4194[3],
                                    class338.aShortArray4183[1],
                                    class338.aShortArray4194[2],
                                    class338.aShortArray4188[3],
                                    class338.aShortArray4188[2], (byte) -118,
                                    class338.aShortArray4183[2],
                                    class338.aShortArray4188[1],
                                    class338.aShortArray4194[1],
                                    class338.aShortArray4183[3]);
                }
