    ...
    static final void method2177(int i, int i_22_, Class348_Sub49_Sub2 class348_sub49_sub2) {
        ...
        if (i_23_ == 0) {
            if (bool) player.aBoolean10539 = false;
                ...
                if (Class348_Sub42_Sub11.playerIndex == i_22_) throw new RuntimeException("s:lr");
            ...
            if (i_30_ == 0) {
                ...
                if (Class348_Sub42_Sub11.playerIndex == i_22_) {
                ...
                if (Class348_Sub42_Sub11.playerIndex == i_22_) Class355.anInt4372 = (player.plane);
            }
        }
    }
}
