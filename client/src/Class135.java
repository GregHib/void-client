...
abstract class Class135 {
    ...
    final void method1150(byte[] is, int i, int i_2_) {
        ...
        if (anInt1921 >= i_2_)
            ...
            ((ha_Sub2) ((Class135) this).aHa_Sub2_1927).anInt7747
                    += -anInt1921 + i_2_;
            anInt1921 = i_2_;
        }
    }
    ...
    static final Class143 method1151(int i, ha var_ha, int i_3_) {
        ...
        if (i != -25411)
            return null;
        Class352 class352
                = Class239_Sub3.method1734(i_3_, var_ha, (byte) -81, true);
        if (class352 == null)
            return null;
        return ((Class352) class352).aClass143_4333;
    }
    ...
    Class135(ha_Sub2 var_ha_Sub2, int i, byte[] is, int i_4_, boolean bool) {
        try {
            ...
            ((ha_Sub2) ((Class135) this).aHa_Sub2_1927).anInt7747 += anInt1921;
    ...
    Class135(ha_Sub2 var_ha_Sub2, int i, Buffer buffer, int i_5_,
             boolean bool) {
        try {
            anInt1930 = i;
            anInt1921 = i_5_;
