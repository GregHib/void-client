            ...
            if (this.anInt6841 != -1) {
                ...
                if (i_25_ != 0 && class12.aByte213 != 4) {
                    ...
                    if (i_25_ != 256) {
                        int i_27_ = i_25_;
                        int i_28_ = -i_25_ + 256;
                        i_24_ = ((((i_28_ * (i_24_ & 0xff00ff) + (i_26_ & 0xff00ff) * i_27_) & ~0xff00ff) - -(0xff0000 & (i_28_ * (0xff00 & i_24_) + i_27_ * (0xff00 & i_26_)))) >> -1929427256);
                    } else i_24_ = i_26_;
                }
                ...
                if (i_29_ != 0) {
                    ...
                    i_24_ = (0xff00 & i_31_) + (((~0x5ff00ff & i_30_) << -139080152) - -(i_32_ >> 58668744));
                }
            }
            anInt6838++;
