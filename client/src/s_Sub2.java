...
final class s_Sub2 extends s {
    ...
    final void YA() {
        if ((anInt8284 ^ 0xffffffff) >= -1)
            ...
            for (int i = 1;
                 (this.anInt4587 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
            ...
            for (int i_36_ = 0;
                 (i_36_ ^ 0xffffffff) > (this.anInt4587 ^ 0xffffffff);
                 i_36_++) {
                for (int i_37_ = 0;
                     ((i_37_ ^ 0xffffffff)
            ...
            for (int i_100_ = 0;
                 (i_100_ ^ 0xffffffff) > (this.anInt4587 ^ 0xffffffff);
                 i_100_++) {
    ...
    static final boolean method3999(int i, int i_147_, int i_148_) {
        if (i_148_ != 458752)
            anInt8237 = -28;
        anInt8238++;
        return (0x70000 & i_147_ ^ 0xffffffff) != -1
    ...
    final void method3987(int i, int i_152_, int i_153_, int i_154_,
        ...
        if ((anInt8284 ^ 0xffffffff) < -1) {
            ...
            if ((anInt8257 * 2 ^ 0xffffffff)
                    < (this.aHa_Sub2_8272
                            .aClass348_Sub49_Sub1_7798.aByteArray7154.length
                    ^ 0xffffffff))
                this.aHa_Sub2_8272
    ...
    final void U(int i, int i_176_, int[] is, int[] is_177_, int[] is_178_,
        ...
        try {
            ...
            for (int i_187_ = 0; i_187_ < is_180_.length; i_187_++) {
                ...
                if ((0x20 & this.anInt8235 ^ 0xffffffff) != -1
                        && i_188_ != -1
