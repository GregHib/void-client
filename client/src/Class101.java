...
abstract class Class101
{
	...
	for (int i_7_ = (i_4_ + -(Class367_Sub4.anInt7319 >> 1284666244)) / 8;
		...
		aa_Sub1.anIntArray5192[i_6_]
		    = Class367_Sub10.aClass45_7382
			  .method417("m" + i_7_ + "_" + i_8_, i + 49);
		Applet_Sub1.anIntArray38[i_6_]
		    = Class367_Sub10.aClass45_7382
			  .method417("l" + i_7_ + "_" + i_8_, 0);
		Class322.anIntArray4031[i_6_]
		    = Class367_Sub10.aClass45_7382
			  .method417("n" + i_7_ + "_" + i_8_, 0);
		Class295.anIntArray3759[i_6_]
		    = Class367_Sub10.aClass45_7382
			  .method417("um" + i_7_ + "_" + i_8_, 0);
		r.anIntArray9724[i_6_]
		    = (Class367_Sub10.aClass45_7382.method417
		       ("ul" + i_7_ + "_" + i_8_,
			Class348_Sub21.method2955(i, -49)));
	...
	try {
		...
		= new Class105[Class239_Sub1.anInt5850 + 10];
	...
	(int i, ha_Sub2 var_ha_Sub2, int i_24_, int i_25_, int i_26_) {
	try {
	    anInt1594++;
	    if (i <= 42)
		method906(123);
