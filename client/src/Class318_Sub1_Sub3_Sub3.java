...
abstract class Class318_Sub1_Sub3_Sub3 extends Class318_Sub1_Sub3 {
    ...
    final boolean method2423(int i, int i_3_, int i_4_) {
        ...
        if (i_4_ == -1) {
            if (this.anIntArray10296[i_3_] == -1)
                return true;
    ...
    final void method2424(int i, int i_14_, int i_15_, int i_16_, byte i_17_,
        ...
        if (i_32_ - -i_37_ < this.anInt10252)
    ...
    static final void method2431
            (int i, int i_56_, Class348_Sub42_Sub13 class348_sub42_sub13,
             int i_57_, int i_58_, int i_59_, int i_60_, ha var_ha, int i_61_,
        ...
        try {
            ...
            Class262.aClass324_3326.method2567(i_56_, string, (byte) 120, i, 0,
                    i_63_ - -3,
    ...
    final void method2432(ha var_ha, int i, Class101 class101, boolean bool,
                          Class64[] class64s) {
        do {
            try {
                if (i == -15074) {
    ...
    static final void method2433() {
        ...
        if (Class348_Sub31_Sub2.aClass357ArrayArrayArray9082 != null) {
            for (int i = 0;
                 i < Class348_Sub31_Sub2.aClass357ArrayArrayArray9082.length;
                 i++) {
                for (int i_82_ = 0; i_82_ < Class318_Sub7.anInt6451; i_82_++) {
                    for (int i_83_ = 0; i_83_ < Class348_Sub41.anInt7054;
                         i_83_++) {
                        if ((Class348_Sub31_Sub2.aClass357ArrayArrayArray9082
                                [i][i_82_][i_83_])
                                != null)
                            Class348_Sub31_Sub2
                                    .aClass357ArrayArrayArray9082[i][i_82_][i_83_]
                                    .method3485(true);
                        Class348_Sub31_Sub2.aClass357ArrayArrayArray9082[i]
                                [i_82_][i_83_]
                                = null;
                    }
                }
        ...
        if (Class319.aClass315Array3982 != null)
            Class319.aClass315Array3982 = null;
        Class9.aHa171 = null;
    }
    ...
    final void method2438(int i, int i_99_, int i_100_, int i_101_, int i_102_,
        ...
        if (i_105_ > 91) {
            for (int i_107_ = 0; Class132.anInt1905 > i_107_; i_107_++) {
                if (this.anIntArray10219[i_107_] > i_99_)
                    bool = false;
                else
                    bool_106_ = false;
            }
            ...
            if (!bool_106_) {
                ...
                for (int i_114_ = 1; i_114_ < Class132.anInt1905; i_114_++) {
                    if (i_109_ == 0) {
                        if (i_113_ > (this.anIntArray10219
                                [i_114_])) {
                            i_113_ = (this
