...
final class Class96 {
    static final ha method870(int i, int i_0_, d var_d, Class45 class45, Canvas canvas) {
        ...
        try {
            ...
            Method method = (var_class.getDeclaredMethod("createToolkit", Class.forName("java.awt.Canvas"), Class.forName("d"), Class.forName("Class45"), Class.forName("java.lang.Integer")));
