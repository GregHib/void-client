...
final class Class213 {
    ...
    private final void method1566(int i, int i_57_, Class348_Sub49 class348_sub49) {
        try {
            ...
            if (i_57_ != 1) {
                if (i_57_ != 2) {
                    if (i_57_ == 4) this.anInt2825 = class348_sub49.method3330(i ^ 0x3235f8fc);
                    else if (i_57_ == 5) this.anInt2787 = class348_sub49.method3330(842397944);
                    else if (i_57_ == 6) this.anInt2781 = class348_sub49.method3330(i ^ 0x3235f8fc);
                    else if (i_57_ == 7) {
                        this.anInt2779 = class348_sub49.method3330(842397944);
                        if (this.anInt2779 > 32767) this.anInt2779 -= 65536;
                    } else if (i_57_ == 8) {
                        this.anInt2826 = class348_sub49.method3330(842397944);
                        if (this.anInt2826 > 32767) this.anInt2826 -= 65536;
                    } else if (i_57_ != 11) {
                        if (i_57_ != 12) {
                            if (i_57_ == 16) this.aBoolean2783 = true;
                            else if (i_57_ == 18) this.anInt2802 = class348_sub49.method3330(i ^ 0x3235f8fc);
                            else if (i_57_ == 23) this.anInt2815 = class348_sub49.method3330(842397944);
                            else if (i_57_ == 24) anInt2804 = class348_sub49.method3330(i ^ 0x3235f8fc);
                            else if (i_57_ == 25) this.anInt2788 = class348_sub49.method3330(i + 842397940);
                            else if (i_57_ == 26) anInt2760 = class348_sub49.method3330(i + 842397940);
                            else if (i_57_ < 30 || i_57_ >= 35) {
                                if (i_57_ >= 35 && i_57_ < 40) this.aStringArray2763[-35 + i_57_] = class348_sub49.method3377((byte) 103);
                                else if (i_57_ == 40) {
                                    ...
                                    for (int i_59_ = 0; i_58_ > i_59_; i_59_++) {
                                        aShortArray2777[i_59_] = (short) (class348_sub49.method3330(842397944));
                                        aShortArray2771[i_59_] = (short) (class348_sub49.method3330(842397944));
                                    }
                                } else if (i_57_ == 41) {
                                    int i_68_ = class348_sub49.method3387(i + 251);
                                    aShortArray2801 = new short[i_68_];
                                    aShortArray2785 = new short[i_68_];
                                    for (int i_69_ = 0; i_69_ < i_68_; i_69_++) {
                                        aShortArray2785[i_69_] = (short) (class348_sub49.method3330(842397944));
                                        aShortArray2801[i_69_] = (short) (class348_sub49.method3330(842397944));
                                    }
                                } else if (i_57_ == 42) {
                                    int i_60_ = class348_sub49.method3387(i + 251);
                                    aByteArray2821 = new byte[i_60_];
                                    for (int i_61_ = 0; i_61_ < i_60_; i_61_++)
                                        aByteArray2821[i_61_] = class348_sub49.method3388(-114);
                                } else if (i_57_ == 65) this.aBoolean2755 = true;
                                else if (i_57_ == 78) anInt2805 = class348_sub49.method3330(842397944);
                                else if (i_57_ == 79) anInt2770 = (class348_sub49.method3330(i ^ 0x3235f8fc));
                                else if (i_57_ == 90) anInt2792 = class348_sub49.method3330(842397944);
                                else if (i_57_ == 91) anInt2822 = class348_sub49.method3330(842397944);
                                else if (i_57_ != 92) {
                                    if (i_57_ != 93) {
                                        if (i_57_ != 95) {
                                            if (i_57_ != 96) {
                                                if (i_57_ == 97) this.anInt2758 = (class348_sub49.method3330(842397944));
                                                else if (i_57_ == 98) this.anInt2833 = (class348_sub49.method3330(842397944));
                                                    ...
                                                    this.anIntArray2762[i_57_ - 100] = (class348_sub49.method3330(842397944));
                                                    this.anIntArray2831[i_57_ + -100] = (class348_sub49.method3330(842397944));
                                                } else if (i_57_ == 110) anInt2786 = (class348_sub49.method3330(842397944));
                                                else if (i_57_ != 111) {
                                                    if (i_57_ == 112) anInt2765 = (class348_sub49.method3330(842397944));
                                                    else if (i_57_ != 113) {
                                                        if (i_57_ == 114) anInt2824 = ((class348_sub49.method3388(-90)) * 5);
                                                        else if (i_57_ == 115) this.anInt2827 = (class348_sub49.method3387(255));
                                                        else if (i_57_ != 121) {
                                                            if (i_57_ != 122) {
                                                                if (i_57_ == 125) {
                                                                ...
                                                                } else if (i_57_ == 134) this.anInt2784 = class348_sub49.method3387(255);
                                                                else if (i_57_ == 249) {
                                                                    ...
                                                                    for (int i_66_ = 0; i_66_ < i_64_; i_66_++) {
                                                                        ...
                                                                        Class348 class348;
                                                                        if (bool) class348 = new Class348_Sub50(class348_sub49.method3377((byte) 107));
                                                                        else class348 = new Class348_Sub35(class348_sub49.method3385((byte) -126));
                                                                        this.aClass356_2757.method3483((byte) 76, i_67_, class348);
                                                                    }
                                                                }
                                                            } else this.anInt2812 = class348_sub49.method3330(i + 842397940);
                                                        } else this.anInt2778 = (class348_sub49.method3330(842397944));
                                                    } else anInt2791 = (class348_sub49.method3388(-88));
                                                } else anInt2794 = (class348_sub49.method3330(842397944));
                                            } else this.anInt2799 = (class348_sub49.method3387(255));
                                        } else this.anInt2810 = (class348_sub49.method3330(i + 842397940));
                                    } else anInt2775 = (class348_sub49.method3330(i + 842397940));
                                } else anInt2767 = class348_sub49.method3330(842397944);
                            } else this.aStringArray2811[-30 + i_57_] = class348_sub49.method3377((byte) 98);
                        } else this.anInt2819 = class348_sub49.method3385((byte) -126);
                    } else this.anInt2820 = 1;
                } else this.aString2795 = class348_sub49.method3377((byte) -42);
            } else anInt2756 = class348_sub49.method3330(i + 842397940);
            anInt2754++;
        } catch (RuntimeException runtimeexception) {
