...
final class Class318_Sub1_Sub3_Sub3_Sub2 extends Class318_Sub1_Sub3_Sub3 {
    ...
    final void method2387(ha var_ha, int i) {
        ...
        if (this.aClass154_10536 != null
            ...
            this.aClass64Array10323[0]
                    = this.aClass64Array10323[1]
                    = this.aClass64Array10323[2]
                    = null;
        }
    }
    ...
    final void method2449(int i, int i_0_, byte i_1_) {
        ...
        this.anInt6388
                = (256 * i_2_
                + 512 * this.anIntArray10317[0]);
        this.anInt6377
                = (this.anIntArray10320[0] * 512
                + i_2_ * 256);
    ...
    final void method2451(byte i, int i_3_, int i_4_, int i_5_) {
        if (i_4_ != -29034)
            this.anInt10557 = -47;
        anInt10528++;
        if (this.anInt10319 < 9)
            this.anInt10319++;
        for (int i_6_ = this.anInt10319; i_6_ > 0;
             i_6_--) {
            this.anIntArray10320[i_6_]
                    = this.anIntArray10320[-1 + i_6_];
            this.anIntArray10317[i_6_]
                    = this.anIntArray10317[i_6_ + -1];
            this.aByteArray10321[i_6_]
                    = this.aByteArray10321[-1 + i_6_];
        }
    ...
    final boolean method2391(ha var_ha, int i, int i_7_, int i_8_) {
        ...
        boolean bool = false;
        for (int i_10_ = 0;
             (this.aClass64Array10323.length > i_10_);
             i_10_++) {
            if ((this.aClass64Array10323[i_10_]
                    != null)
    ...
    final void method2452(byte i, Class348_Sub49 class348_sub49) {
        ...
        for (int i_15_ = 0; i_15_ < 12; i_15_++) {
            ...
            if (i_16_ == 0)
                ...
                if (i_18_ >= 32768) {
                    ...
                    int i_19_ = (Exception_Sub1.aClass255_112
        ...
        for (int i_21_ = 0; i_21_ < 5; i_21_++) {
            ...
            if (Class367_Sub2.aShortArrayArrayArray7290.length < 1
                    || i_22_ < 0
                    || i_22_ >= Class367_Sub2.aShortArrayArrayArray7290[0][i_21_].length)
                i_22_ = 0;
            is_20_[i_21_] = i_22_;
        }
        ...
        if (this.anInt10553 == 0)
            ...
            this.anInt10558
                    = class348_sub49.method3387(i ^ 0xab);
            if (!this.aBoolean10517 != !bool
                    || this.anInt10553 != i_23_
                    || i_24_ != this.anInt10535
                    || i_25_ != this.anInt10526
                    || (this.anInt10560 != i_26_)
                    || this.anInt10519 != i_27_
                    || i_28_ != this.anInt10558)
                Class92.method858(true, this);
        }
        if (this.aClass154_10536 == null)
            this.aClass154_10536
                    = new Class154();
        int i_29_ = (this.aClass154_10536
                .anInt2093);
        int[] is_30_ = (this.aClass154_10536
                .anIntArray2095);
        this.aClass154_10536.method1228
                (i_14_, 105, method2421((byte) 121), is,
                        aByte10538 == 1, is_20_);
        if (i_14_ != i_29_) {
            this.anInt6377
                    = (this.anIntArray10320[0]
                    << -757818679) - -(method2436((byte) 89) << -341559384);
            this.anInt6388
                    = (this.anIntArray10317[0]
                    << 1810217385) - -(method2436((byte) 98) << -592799704);
        }
        if ((Class348_Sub42_Sub11.anInt9591 == this.anInt10290)
                && is_30_ != null) {
        ...
        if (this.aClass318_Sub10_10327 != null)
            this.aClass318_Sub10_10327
                    .method2529();
        if (this.anInt10268 != -1
                && this.aBoolean10213) {
            Class225 class225 = this.method2422((byte) 72);
            if (!class225.method1623((this
                            .anInt10268),
                    -40)) {
            ...
            try {
                ...
                if (i_33_ == 0) {
                    ...
                    if (i_36_ >= 262144 && i_32_ >= i_36_) {
                        int i_37_ = 0x3fff & (int) (Math.atan2(i,
                                i_34_)
                                * 2607.5945876176133);
                        Class64 class64_38_
            ...
            try {
                ...
                if (i_44_ >= 262144
                    ...
                    int i_45_
                            ...
                            * Math.atan2(i_39_, i_43_))
                            & 0x3fff);
                    Class64 class64_46_
                            = (Canvas_Sub1.method122
                            (this.anInt10252,
                                    this.anInt10302,
                                    this.anInt10208, i_45_,
    ...
    final void method2455(int i, int i_50_, byte i_51_, int i_52_) {
        ...
        if (this.anInt10286 != -1
                && Class10.aClass87_191.method835(this.anInt10286,
                        7).anInt245 == 1) {
            this.anInt10286 = -1;
        ...
        this.anInt10524 = -1;
        if (i_52_ >= 0
                && Class367_Sub4.anInt7319 > i_52_
                && i >= 0
                && Class348_Sub40_Sub3.anInt9109 > i) {
            if (this.anIntArray10320[0] >= 0
                    && (this.anIntArray10320[0] < Class367_Sub4.anInt7319)
                    && this.anIntArray10317[0] >= 0
    ...
    final Class318_Sub4 method2386(int i, ha var_ha) {
        ...
        if (this.aClass154_10536 == null
            ...
            return null;
        Class101 class101 = var_ha.method3705();
        int i_53_ = this.aClass264_10217
                .method2019((byte) -126);
        ...
        if (class357 == null
            ...
            this.anInt10274
                    -= (float) this.anInt10274 / 10.0F;
        else {
            int i_54_ = (this.anInt10274
        ...
        if (Class316.aClass348_Sub51_3959
            ...
            if (class225.aBoolean2913
                ...
                Class64 class64
                        = (Class348.method2711
                        (this.anInt10302, i_53_,
                                this.aClass64Array10323[0],
                                this.anInt10208, false,
                                (class17_55_ == null
                                        ? this.anInt10267
                                        : this.anInt10245),
                                0, 1, this.anInt10252,
                ...
                if (class302 != null
                    ...
                    if (class302.anInt3840 == 2) {
                        int i_59_
                                ...
                                .anInt6377)
                                + 256 + class302.anInt3835);
                        int i_60_
                                = (-(Class132.aClass318_Sub1_Sub3_Sub3_Sub2_1907
                                .anInt6388)
                                + 256 + class302.anInt3832);
                        int i_61_
                                = class302.anInt3837 << 1821623465;
                        i_61_ *= i_61_;
                        if (Class305.aBoolean3870)
                    ...
                    if (class302.anInt3840 == 10
                            && class302.anInt3833 >= 0
                            && (class302.anInt3833 < (Class294
        ...
        if (class318_sub4 == null)
            class318_sub4
                    = OutputStream_Sub2.method136((this
                            .aClass64Array10323).length,
                    true, false);
        ...
        if (Class305.aBoolean3870) {
            for (int i_65_ = 0;
                 i_65_ < (this
                         .aClass64Array10323).length;
                 i_65_++) {
                if (this.aClass64Array10323[i_65_]
                        != null)
                    this.aClass64Array10323
                            [i_65_].method608
                            (class101,
            ...
            for (int i_66_ = 0;
                 i_66_ < (this
                         .aClass64Array10323).length;
                 i_66_++) {
                if (this.aClass64Array10323[i_66_]
                        != null)
                    this.aClass64Array10323
                            [i_66_].method615
                            (class101,
        ...
        for (int i_67_ = 0;
             ...
             i_67_++) {
            if (this.aClass64Array10323[i_67_]
                    != null)
                this.aBoolean10324
                        |= this.aClass64Array10323
                        [i_67_].F();
    ...
    final String method2456(boolean bool, int i) {
        ...
        if (!bool)
            string += this.aString10544;
        else
            string += this.aString10537;
    ...
    final int method2436(byte i) {
        ...
        if (this.aClass154_10536 != null
                && this
                .aClass154_10536.anInt2093 != -1)
            return (Class189.aClass278_2529.method2079
    ...
    private final boolean method2459(int i, ha var_ha, int i_69_) {
        ...
        Class17 class17_71_
                ...
                || class17 == null))
                ? Class10.aClass87_191
                .method835(this.anInt10268, 7)
                : null);
        int i_72_ = class225.anInt2932;
        int i_73_ = class225.anInt2941;
        if (i_72_ != 0 || i_73_ != 0 || class225.anInt2950 != 0
                || class225.anInt2926 != 0)
            i |= 0x7;
        int i_74_ = this.aClass264_10217
                .method2019((byte) -106);
        boolean bool
                = (this.aByte10279 != 0
                && (this.anInt10248
                <= Class367_Sub11.anInt7396)
                && (Class367_Sub11.anInt7396 < this.anInt10250));
        if (bool)
            i |= 0x80000;
        Class64 class64
                = (this.aClass64Array10323[0]
                ...
                .method1226
                        (Class318_Sub1_Sub3_Sub3.aClass170_10209, class17_71_,
                                this.aClass182Array10308, true,
                                Exception_Sub1.aClass255_112, i_74_, class17,
                                this.anInt10244, true,
                                this.anInt10312,
                                this.anIntArray10296, i,
                                Class348_Sub40_Sub25.aClass150_9342,
                                this.anInt10232, var_ha,
        ...
        if (i_72_ != 0 || i_73_ != 0) {
            this.method2424(i_74_, i_72_, class225.anInt2943,
                    i_73_, (byte) 108,
                    class225.anInt2912);
            if (this.anInt10302 != 0)
                class64.FA(this.anInt10302);
            if (this.anInt10208 != 0)
                class64.VA(this.anInt10208);
            if (this.anInt10252 != 0)
                class64.H(0, this.anInt10252, 0);
        } else
            this.method2424(i_74_, method2436((byte) 124) << 471770697, 0,
                    method2436((byte) 58) << -790952727, (byte) 65, 0);
        if (bool)
            class64.method624(this.aByte10255,
                    this.aByte10206,
                    this.aByte10270,
                    (this.aByte10279
                            & 0xff));
        if (!this.aBoolean10521
                && this.anInt10269 != -1
                && this.anInt10240 != -1) {
            Class368 class368
                    = (Class348_Sub40_Sub18.aClass319_9245.method2543
                    ((byte) 76, this.anInt10269));
            boolean bool_78_ = (class368.aByte4488 == 3
                    && (i_72_ != 0 || i_73_ != 0));
            int i_79_ = i_70_;
            if (!bool_78_) {
                if (this.anInt10237 != 0)
                    i_79_ |= 0x5;
                if (this.anInt10220 != 0)
                    i_79_ |= 0x2;
            ...
            Class64 class64_80_
                    = (this.aClass64Array10323[1]
                    = (class368.method3562
                    (this.anInt10240, var_ha,
                            this.anInt10243, i_79_,
                            this.anInt10283,
            ...
            if (class64_80_ != null) {
                if (this.anInt10278 >= 0
                    ...
                    int i_82_ = 0;
                    int i_83_ = 0;
                    if (class225.anIntArrayArray2939 != null
                            && ((class225.anIntArrayArray2939
                            [this.anInt10278])
                            != null)) {
                        i_82_ += (class225.anIntArrayArray2939
                                [this.anInt10278]
                                [1]);
                        i_83_ += (class225.anIntArrayArray2939
                                [this.anInt10278]
                                [2]);
                        i_81_ += (class225.anIntArrayArray2939
                                [this.anInt10278]
                                [0]);
                    }
                    if (class225.anIntArrayArray2910 != null
                            && ((class225.anIntArrayArray2910
                            [this.anInt10278])
                            != null)) {
                        i_82_ += (class225.anIntArrayArray2910
                                [this.anInt10278]
                                [1]);
                        i_83_ += (class225.anIntArrayArray2910
                                [this.anInt10278]
                                [2]);
                        i_81_ += (class225.anIntArrayArray2910
                                [this.anInt10278]
                                [0]);
                    }
                    if (i_83_ != 0 || i_81_ != 0) {
                        int i_84_ = i_74_;
                        if ((this.anIntArray10296
                                != null)
                                && ((this
                                .anIntArray10296
                                [this.anInt10278])
                ...
                } else if (this.anInt10237 != 0)
                    class64_80_
                            .a(2048 * this.anInt10237);
                if (this.anInt10220 != 0)
                    class64_80_.H(0,
                            (-this.anInt10220
                                    << -1384741150),
                ...
                if (bool_78_) {
                    ...
                    if (this.anInt10208 != 0)
                        class64_80_
                                .VA(this.anInt10208);
                    if (this.anInt10252 != 0)
                        class64_80_.H(0, (this
                                .anInt10252), 0);
                }
            }
        } else
            this.aClass64Array10323[1] = null;
        if (this.aBoolean10521
                || this.anInt10291 == -1
                || this.anInt10224 == -1)
            this.aClass64Array10323[2] = null;
            ...
            Class368 class368
                    = (Class348_Sub40_Sub18.aClass319_9245.method2543
                    ((byte) 76, this.anInt10291));
            boolean bool_89_ = (class368.aByte4488 == 3
                    && (i_72_ != 0
                    || i_73_ != 0));
            int i_90_ = i_70_;
            if (bool_89_)
            ...
            if (class64_91_ != null) {
                if (this.anInt10289 < 0
                    ...
                    if (class225.anIntArrayArray2939 != null
                            ...
                            [this.anInt10289])
                            != null)) {
                        i_92_ += (class225.anIntArrayArray2939
                                [this.anInt10289]
                                [0]);
                        i_93_ += (class225.anIntArrayArray2939
                                [this.anInt10289]
                                [1]);
                        i_94_ += (class225.anIntArrayArray2939
                                [this.anInt10289]
                                [2]);
                    }
                    if (class225.anIntArrayArray2910 != null
                            ...
                            [this.anInt10289])
                            != null)) {
                        i_92_ += (class225.anIntArrayArray2910
                                [this.anInt10289]
                                [0]);
                        i_93_ += (class225.anIntArrayArray2910
                                [this.anInt10289]
                                [1]);
                        i_94_ += (class225.anIntArrayArray2910
                                [this.anInt10289]
                                [2]);
                    }
                    if (i_94_ != 0 || i_92_ != 0) {
