...
final class Class318_Sub1_Sub3_Sub3_Sub2 extends Class318_Sub1_Sub3_Sub3 {
    ...
    final void method2452(byte i, Class348_Sub49 class348_sub49) {
        ...
        this.anInt6377 += -i_13_ + method2436((byte) 47) << 1271420456;
        this.anInt6388 += method2436((byte) 96) + -i_13_ << 2109816392;
        ...
        for (int i_15_ = 0; i_15_ < 12; i_15_++) {
            ...
            if (i_16_ == 0) is[i_15_] = 0;
                ...
                if (i_15_ == 0 && i_18_ == 65535) {
                    ...
                    this.anInt10542 = class348_sub49.method3387(255);
                    break;
                }
                if (i_18_ >= 32768) {
        ...
        this.anInt10516 = class348_sub49.method3387(i ^ 0xab);
        if (i != 84) anInt10520 = 87;
        if (bool_12_) {
            this.anInt10564 = class348_sub49.method3330(842397944);
            this.anInt10557 = this.anInt10516;
            if (this.anInt10564 == 65535) this.anInt10564 = -1;
            this.anInt10561 = -1;
        } else {
            this.anInt10564 = 0;
            this.anInt10557 = class348_sub49.method3387(255);
            this.anInt10561 = class348_sub49.method3387(255);
            if (this.anInt10561 == 255) this.anInt10561 = -1;
        }
        int i_23_ = this.anInt10553;
        this.anInt10553 = class348_sub49.method3387(255);
        if (this.anInt10553 == 0) Class295.method2221(this, -28482);
            ...
            this.anInt10535 = class348_sub49.method3330(842397944);
            this.anInt10526 = class348_sub49.method3330(842397944);
            this.anInt10560 = class348_sub49.method3330(842397944);
            this.anInt10519 = class348_sub49.method3330(842397944);
            this.anInt10558 = class348_sub49.method3387(i ^ 0xab);
        ...
        if (i_14_ != i_29_) {
            this.anInt6377 = (this.anIntArray10320[0] << -757818679) - -(method2436((byte) 89) << -341559384);
            this.anInt6388 = (this.anIntArray10317[0] << 1810217385) - -(method2436((byte) 98) << -592799704);
        }
            ...
            for (int i_56_ = -1 + Class348_Sub27.aClass302Array6897.length; i_56_ >= 0; i_56_--) {
                ...
                if (class302 != null && class302.anInt3834 != -1) {
                    ...
                    if (class302.anInt3840 == 2) {
                        ...
                        int i_61_ = class302.anInt3837 << 1821623465;
                        i_61_ *= i_61_;
    ...
    private final boolean method2459(int i, ha var_ha, int i_69_) {
        ...
        } else this.method2424(i_74_, method2436((byte) 124) << 471770697, 0, method2436((byte) 58) << -790952727, (byte) 65, 0);
            ...
            if (class64_80_ != null) {
                if (this.anInt10278 >= 0 && class225.anIntArrayArray2939 != null && ((class225.anIntArrayArray2939[this.anInt10278]) != null)) {
                    ...
                    if (i_83_ != 0 || i_81_ != 0) {
                        ...
                        int i_88_ = i_87_ * i_81_ + i_83_ * i_86_ >> -181246066;
                ...
                if (this.anInt10220 != 0) class64_80_.H(0, (-this.anInt10220 << -1384741150), 0);
                if (bool_78_) {
        ...
        if (this.aBoolean10521 || this.anInt10291 == -1 || this.anInt10224 == -1) this.aClass64Array10323[2] = null;
            ...
            if (class64_91_ != null) {
                ...
                if (this.anInt10260 != 0) class64_91_.H(0, (-this.anInt10260 << -1898332830), 0);
                if (bool_89_) {
