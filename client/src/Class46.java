...
final class Class46 {
    ...
    final void method431(int i, int i_29_, byte i_30_) {
        ...
        if (this.anIntArray706 == null
                || (i >= this.anIntArray706.length)) {
            int[] is = new int[1 + i];
            if (this.anIntArray706 != null) {
                for (int i_31_ = 0;
                     (i_31_ < this.anIntArray706.length);
                     i_31_++)
