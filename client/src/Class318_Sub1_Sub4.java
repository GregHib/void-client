...
abstract class Class318_Sub1_Sub4 extends Class318_Sub1 {
    ...
    static final int method2478(int i) {
        ...
        // The first call (login) consumes the force, so a later Auto-setup
        // from the in-game display settings (same entry point) runs normally.
        if (Loader.forcedGraphicsMode >= 0) {
