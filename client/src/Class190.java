...
final class Class190 {
    ...
    final boolean method1424(Class190 class190_4_, byte i) {
        ...
        if (i != 84)
            return false;
        return (this.anInt2540 == class190_4_.anInt2540)
                && (this.aFloat2547 == class190_4_.aFloat2547)
                && (class190_4_.aFloat2544 == this.aFloat2544)
                && (this.aFloat2536 == class190_4_.aFloat2536)
                && (class190_4_.aFloat2542 == this.aFloat2542)
                && (class190_4_.aFloat2545 == this.aFloat2545)
                && (class190_4_.aFloat2551 == this.aFloat2551)
                && (class190_4_.anInt2549 == this.anInt2549)
                && (class190_4_.anInt2546 == this.anInt2546)
                && (class190_4_.aClass299_2541 == this.aClass299_2541);
    }
    ...
    static final boolean method1425(byte i, Class42 class42,
        ...
        try {
            ...
            if (class42.anInt578 != -1) {
                ...
                if (class105 != null) {
                    i_11_ = (class348_sub21.anInt6853
                            + -(class105.method966() - -1 >> 1794552897));
                    i_12_ = (class348_sub21.anInt6853
                            + (1 + class105.method966() >> 970201217));
                    if (i_11_ < i_7_)
                        i_7_ = i_11_;
                    if (i_12_ > i_8_)
                        i_8_ = i_12_;
                    i_13_ = (class348_sub21.anInt6855
                            - (class105.method980() - -1 >> 1687097473));
                    if (i_13_ < i_9_)
                        i_9_ = i_13_;
                    i_14_ = (class348_sub21.anInt6855
            ...
            if (Class75.anInt1272 > i_8_
                    || i_7_ > Class75.anInt1276
                    || i_10_ < Class75.anInt1262
            ...
            if (class105 != null) {
                ...
                class105.method974((class348_sub21.anInt6853
                                + -(class105.method966() >> -474034719)),
                        (class348_sub21.anInt6855
                                + -(class105.method980() >> -1411134719)));
            }
            if (class42.aString597 != null && class323 != null)
    ...
    Class190(Class348_Sub49 class348_sub49) {
        ...
        if ((i & 0x10) == 0) {
            ...
            this.anInt2538 = class348_sub49.method3372(13638);
            this.anInt2548 = class348_sub49.method3372(13638);
        ...
        if ((0x20 & i) == 0)
            ...
            this.anInt2549
                    = class348_sub49.method3385((byte) -126);
        if ((i & 0x40) != 0)
            this.anInt2546 = class348_sub49.method3330(842397944);
        else
            this.anInt2546 = 0;
        if ((0x80 & i) != 0) {
