...
final class Class314_Sub1 extends Class314 {
    ...
    final void method2338(byte i, int i_5_) {
        ...
        if (aClass137_6365 != null) {
            for (Class348 class348 = aClass262_6369.method1995(i ^ ~0x37);
                ...
                if ((long) i_5_ == class348.aLong4291)
                    return;
            }
            Class348 class348 = new Class348();
    ...
    final int method2335(int i, int i_8_) {
        ...
        Class348_Sub42_Sub16 class348_sub42_sub16
                ...
                aClass356_6360.method3480(i, -6008));
        if (i_8_ != -22197)
            anInt6352 = 21;
        if (class348_sub42_sub16 != null)
    ...
    private final Class348_Sub42_Sub16 method2350(int i, byte i_9_,
        ...
        if (class348_sub42_sub16 != null && i_10_ == 0
                && !class348_sub42_sub16.aBoolean9663
                && class348_sub42_sub16.aBoolean9664) {
        ...
        if (class348_sub42_sub16 == null) {
            ...
            aClass356_6360.method3483((byte) 73, i,
                    class348_sub42_sub16);
        }
        ...
        if (!(class348_sub42_sub16 instanceof Class348_Sub42_Sub16_Sub2)) {
            try {
                ...
                if (class348_sub42_sub16.aBoolean9663
                    ...
                    Class348_Sub42_Sub16_Sub1 class348_sub42_sub16_sub1
                            ...
                            i, anInt6350);
                    aClass356_6360.method3483((byte) 84, i,
        ...
        try {
            ...
            int i_19_ = ((0xff00 & is[-2 + is.length] << -1875567128)
                    + (0xff & is[is.length + -1]));
            if ((aClass291_6342.anIntArray3722[i] & 0xffff)
                    != i_19_)
                throw new RuntimeException();
            if (aByteArray6351[i] != 1) {
                anInt6361++;
            ...
            if (class348_sub42_sub16.aBoolean9663
                ...
                Class348_Sub42_Sub16_Sub1 class348_sub42_sub16_sub1
                        ...
                        anInt6350);
                aClass356_6360.method3483((byte) 66, i,
                        class348_sub42_sub16_sub1);
            }
            return null;
        }
    ...
    final Class291 method2340(byte i) {
        ...
        if (aClass348_Sub42_Sub16_6355.aBoolean9664)
            return null;
