...
final class Class314_Sub1 extends Class314
{
    ...
    private byte[] aByteArray6346;
    private Class248 aClass248_6347;
    ...
    private Class112 aClass112_6354;
	...
	anInt6370++;
	if (aClass291_6342 == null)
	    return 0;
	if (!aBoolean6368)
	    return ((Class291) aClass291_6342).anInt3727;
	if (i != 24940)
	    method2345(-32);
	Class348 class348 = aClass262_6372.method1995(i ^ 0x6168);
	if (class348 == null)
	    return 0;
	return (int) ((Class348) class348).aLong4291;
    }
	...
	if (aClass262_6372 != null && method2340((byte) 56) != null) {
	    for (Class348 class348 = aClass262_6369.method1995(4);
		 class348 != null;
		 class348 = aClass262_6369.method1990((byte) 112)) {
		int i_0_ = (int) ((Class348) class348).aLong4291;
		if (i_0_ < 0
		    || ((i_0_ ^ 0xffffffff)
			<= (((Class291) aClass291_6342).anInt3734
			    ^ 0xffffffff))
		    || ((Class291) aClass291_6342).anIntArray3725[i_0_] == 0)
	...
	if (aClass262_6372 != null) {
	    ...
	    if (aBoolean6368) {
		boolean bool = true;
		for (Class348 class348 = aClass262_6372.method1995(4);
		     class348 != null;
		     class348 = aClass262_6372.method1990((byte) 106)) {
		    int i_1_ = (int) ((Class348) class348).aLong4291;
		    if (aByteArray6351[i_1_] == 0)
			method2350(i_1_, (byte) 65, 1);
		    if (aByteArray6351[i_1_] != 0)
			class348.method2715((byte) 22);
		    else
			bool = false;
		}
		while ((anInt6373 ^ 0xffffffff)
		       > (((Class291) aClass291_6342).anIntArray3725.length
			  ^ 0xffffffff)) {
		    if ((((Class291) aClass291_6342).anIntArray3725[anInt6373]
			 ^ 0xffffffff)
			== -1)
			anInt6373++;
		    else {
			if (((Class112) aClass112_6354).anInt1734 >= 250) {
			    bool = false;
			    break;
			}
			...
			if ((aByteArray6351[anInt6373] ^ 0xffffffff) == -1) {
			    ...
			    ((Class348) class348).aLong4291 = (long) anInt6373;
		...
		for (Class348 class348 = aClass262_6372.method1995(4);
		    ...
		    int i_2_ = (int) ((Class348) class348).aLong4291;
	...
	if (i == -1) {
		...
		for (Class348_Sub42_Sub16 class348_sub42_sub16
			 = (Class348_Sub42_Sub16) aClass356_6360.method3484(0);
		     class348_sub42_sub16 != null;
		     class348_sub42_sub16 = ((Class348_Sub42_Sub16)
					     aClass356_6360.method3482(0))) {
		    if (!((Class348_Sub42_Sub16) class348_sub42_sub16)
			 .aBoolean9664) {
			if (!((Class348_Sub42_Sub16) class348_sub42_sub16)
			     .aBoolean9667)
			    ((Class348_Sub42_Sub16) class348_sub42_sub16)
	...
	if (i != -52)
	    aClass291_6342 = null;
	if (aClass137_6365 != null) {
	    for (Class348 class348 = aClass262_6369.method1995(i ^ ~0x37);
		 class348 != null;
		 class348 = aClass262_6369.method1990((byte) 124)) {
		if ((long) i_5_ == ((Class348) class348).aLong4291)
		    return;
	    }
	    Class348 class348 = new Class348();
	    ((Class348) class348).aLong4291 = (long) i_5_;
	...
	if (Class5_Sub1.aBoolean8335
	    ...
	    return "";
	if (((((Class348_Sub42_Sub12) Class316.aClass348_Sub42_Sub12_3963)
	      .aString9601) == null
	...
	Class348_Sub42_Sub16 class348_sub42_sub16
	    = ((Class348_Sub42_Sub16)
	       aClass356_6360.method3480((long) i, -6008));
	if (i_8_ != -22197)
	    anInt6352 = 21;
	if (class348_sub42_sub16 != null)
	    return class348_sub42_sub16.method3257(16);
	return 0;
    }
    
    private final Class348_Sub42_Sub16 method2350(int i, byte i_9_,
						  int i_10_) {
	if (i_9_ != 65)
	    aByteArray6351 = null;
	anInt6362++;
	Class348_Sub42_Sub16 class348_sub42_sub16
	    = ((Class348_Sub42_Sub16)
	       aClass356_6360.method3480((long) i, -6008));
	if (class348_sub42_sub16 != null && i_10_ == 0
	    && !((Class348_Sub42_Sub16) class348_sub42_sub16).aBoolean9663
	    && ((Class348_Sub42_Sub16) class348_sub42_sub16).aBoolean9664) {
	...
	if (class348_sub42_sub16 == null) {
		...
		if (aClass137_6365 == null || aByteArray6351[i] == -1) {
		    if (aClass248_6347.method1900(-9))
			return null;
		    class348_sub42_sub16
			= aClass248_6347.method1906((byte) -125, (byte) 2,
						    true, i, anInt6350);
		} else
		    class348_sub42_sub16
		...
		if (aByteArray6351[i] != -1)
		    throw new RuntimeException();
		if (aClass248_6347.method1899(-120))
		    return null;
		class348_sub42_sub16
		    = aClass248_6347.method1906((byte) 97, (byte) 2, false, i,
						anInt6350);
	    }
	    aClass356_6360.method3483((byte) 73, (long) i,
				      class348_sub42_sub16);
	}
	if (((Class348_Sub42_Sub16) class348_sub42_sub16).aBoolean9664)
	    return null;
	byte[] is = class348_sub42_sub16.method3259(16);
	if (!(class348_sub42_sub16 instanceof Class348_Sub42_Sub16_Sub2)) {
		...
		if ((i_11_ ^ 0xffffffff)
		    != (((Class291) aClass291_6342).anIntArray3729[i]
			^ 0xffffffff))
		    throw new RuntimeException();
		if (((Class291) aClass291_6342).aByteArrayArray3730 != null
		    && (((Class291) aClass291_6342).aByteArrayArray3730[i]
			!= null)) {
		    byte[] is_12_
			= ((Class291) aClass291_6342).aByteArrayArray3730[i];
		    byte[] is_13_
		...
		((Class248) aClass248_6347).anInt3213 = 0;
		((Class248) aClass248_6347).anInt3214 = 0;
	    } catch (RuntimeException runtimeexception) {
		aClass248_6347.method1904(-1);
		class348_sub42_sub16.method2715((byte) 44);
		if (((Class348_Sub42_Sub16) class348_sub42_sub16).aBoolean9663
		    && !aClass248_6347.method1900(i_9_ ^ 0x1f)) {
		    Class348_Sub42_Sub16_Sub1 class348_sub42_sub16_sub1
			= aClass248_6347.method1906((byte) 111, (byte) 2, true,
						    i, anInt6350);
		    aClass356_6360.method3483((byte) 84, (long) i,
					      class348_sub42_sub16_sub1);
		}
		return null;
	    }
	    is[is.length - 2]
		= (byte) (((Class291) aClass291_6342).anIntArray3722[i]
			  >>> 1807905608);
	    is[is.length - 1]
		= (byte) ((Class291) aClass291_6342).anIntArray3722[i];
	    if (aClass137_6365 != null) {
	    ...
	    if (!((Class348_Sub42_Sub16) class348_sub42_sub16).aBoolean9663)
		class348_sub42_sub16.method2715((byte) 110);
	...
	try {
	    ...
	    if ((((Class291) aClass291_6342).anIntArray3729[i] ^ 0xffffffff)
		!= (i_15_ ^ 0xffffffff))
		throw new RuntimeException();
	    if (((Class291) aClass291_6342).aByteArrayArray3730 != null
		&& (((Class291) aClass291_6342).aByteArrayArray3730[i]
	    ...
	    int i_19_ = ((0xff00 & is[-2 + is.length] << -1875567128)
			 + (0xff & is[is.length + -1]));
	    if ((((Class291) aClass291_6342).anIntArray3722[i] & 0xffff)
		!= i_19_)
		throw new RuntimeException();
	    if (aByteArray6351[i] != 1) {
		anInt6361++;
	    ...
	    if (!((Class348_Sub42_Sub16) class348_sub42_sub16).aBoolean9663)
		class348_sub42_sub16.method2715((byte) 115);
	    return class348_sub42_sub16;
	} catch (Exception exception) {
	    aByteArray6351[i] = (byte) -1;
	    class348_sub42_sub16.method2715((byte) 121);
	    if (((Class348_Sub42_Sub16) class348_sub42_sub16).aBoolean9663
		&& !aClass248_6347.method1900(-30)) {
		Class348_Sub42_Sub16_Sub1 class348_sub42_sub16_sub1
		    = aClass248_6347.method1906((byte) 99, (byte) 2, true, i,
						anInt6350);
		aClass356_6360.method3483((byte) 66, (long) i,
					  class348_sub42_sub16_sub1);
	    }
	    return null;
	}
	...
	if (i != 56)
	    return null;
	if (aClass348_Sub42_Sub16_6355 == null) {
	    if (aClass248_6347.method1900(-14))
		return null;
	    aClass348_Sub42_Sub16_6355
		= aClass248_6347.method1906((byte) -114, (byte) 0, true,
					    anInt6350, 255);
	}
	if (((Class348_Sub42_Sub16) aClass348_Sub42_Sub16_6355).aBoolean9664)
	    return null;
	byte[] is = aClass348_Sub42_Sub16_6355.method3259(16);
	do {
	    if (aClass348_Sub42_Sub16_6355
		instanceof Class348_Sub42_Sub16_Sub2) {
		try {
		    if (is == null)
			throw new RuntimeException();
		    aClass291_6342
			= new Class291(is, anInt6344, aByteArray6346);
		    if ((((Class291) aClass291_6342).anInt3732 ^ 0xffffffff)
			!= (anInt6352 ^ 0xffffffff))
			throw new RuntimeException();
		    break;
		} catch (RuntimeException runtimeexception) {
		    aClass291_6342 = null;
		    if (aClass248_6347.method1900(i + 66))
			aClass348_Sub42_Sub16_6355 = null;
		    else
			aClass348_Sub42_Sub16_6355
			    = aClass248_6347.method1906((byte) -95, (byte) 0,
							true, anInt6350, 255);
		    return null;
		}
	    }
		...
		aClass291_6342 = null;
		if (aClass248_6347.method1900(i ^ ~0x16))
		    aClass348_Sub42_Sub16_6355 = null;
		else
		    aClass348_Sub42_Sub16_6355
			= aClass248_6347.method1906((byte) 47, (byte) 0, true,
						    anInt6350, 255);
		return null;
	    }
	    if (aClass137_6364 != null)
		aClass112_6354.method1049(is, aClass137_6364, (byte) 10,
					  anInt6350);
	} while (false);
	aClass348_Sub42_Sub16_6355 = null;
	if (aClass137_6365 != null) {
	    anInt6361 = 0;
	    aByteArray6351 = new byte[((Class291) aClass291_6342).anInt3734];
	}
	return aClass291_6342;
    }
    ...
    Class314_Sub1(int i, Class137 class137, Class137 class137_23_,
		  Class248 class248, Class112 class112, int i_24_, byte[] is,
	...
	do {
		...
		if (aClass137_6364 == null)
		    break;
		aClass348_Sub42_Sub16_6355
		    = aClass112_6354.method1055(aClass137_6364, anInt6350,
						(byte) -112);
	    } catch (RuntimeException runtimeexception) {
