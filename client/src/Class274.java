...
final class Class274
{
    ...
    static Class274 aClass274_3485
	= (new Class274
	   ("There was an error executing the command.",
	    "Es gab einen Fehler beim Ausf\u00fchren des Befehls.",
	    "Une erreur s'est produite lors de l'ex\u00e9cution de la commande.",
	    "Houve um erro quando o comando foi executado."));
    static Class274 aClass274_3486
	= new Class274("Unknown developer command: ", "Unbekannter Befehl: ",
		       "Commande inconnue : ", "Comando desconhecido: ");
    static Class274 aClass274_3487
	= new Class274("Cancel", "Abbrechen", "Annuler", "Cancelar");
	...
	Class348_Sub47 class348_sub47
	    = Class286_Sub3.method2148(Class348_Sub34.aClass351_6970,
    ...
    private Class274(String string, String string_7_, String string_8_,
		     String string_9_) {
	try {
	    aStringArray3481
	...
	aClass274_3488
	    = new Class274("Members object", "Gegenstand f\u00fcr Mitglieder",
	...
	aClass274_3489
	    = new Class274("Discard", "Ablegen", "Jeter", "Descartar");
	aClass274_3490 = new Class274("Take", "Nehmen", "Prendre", "Pegar");
	aClass274_3491
	    = new Class274("Drop", "Fallen lassen", "Poser", "Largar");
	new Class274("Ok", "Okay", "OK", "Ok");
	new Class274("Select", "Ausw\u00e4hlen", "S\u00e9lectionner",
		     "Selecionar");
	aClass274_3492
	    = new Class274("Continue", "Weiter", "Continuer", "Continuar");
	new Class274("Invalid player name.",
		     "Unzul\u00e4ssiger Charaktername!",
		     "Nom de joueur incorrect.",
		     "Nome de jogador inv\u00e1lido.");
	new Class274("You can't report yourself!",
	...
	new Class274(null, "Dieses System darf nicht missbraucht werden!",
		     null, null);
	new Class274
	...
	new Class274("Thank-you, your abuse report has been received.",
	...
	new Class274("Invalid name", "Unzul\u00e4ssiger Name!",
	...
	new Class274(null, "der Spieler ist momentan nicht verf\u00fcgbar.",
		     null, null);
	new Class274
	...
	new Class274(null, "Spieler nicht auf deiner Freunde-Liste.", null,
		     null);
	new Class274
	...
	new Class274("Chat disabled", "Deaktiviert",
		     "Messagerie d\u00e9sactiv\u00e9e",
		     "Bate-papo desativado");
	new Class274("clan_chat", "clanchat", "conversation_clan",
		     "clan_chat");
	new Class274
	...
	new Class274("Attempting to join channel...",
		     "Chatraum wird betreten...",
		     "Tentative de connexion au canal...",
		     "Tentando acessar canal...");
	new Class274("Sending request to leave channel...",
	...
	new Class274("Invalid channel name entered!",
	...
	new Class274("Now talking in clan channel ", "Chatraum: ",
	...
	new Class274("The channel you tried to join does not exist.",
	...
	new Class274("Your clan channel has now been disabled!",
	...
	new Class274("That user is not in this channel.",
	...
	new Class274("This mute will remain for a further ",
	...
	aClass274_3495
	    = new Class274("Loading - please wait.",
			   "Ladevorgang - bitte warte.",
			   "Chargement en cours. Veuillez patienter.",
			   "Carregando. Aguarde.");
	aClass274_3496 = new Class274("Profiling...", "Profiling...",
				      "Profilage...", "Profiling...");
	aClass274_3497
	    = new Class274("Connection lost.", "Verbindung abgebrochen.",
	...
	aClass274_3499
	    = new Class274("Checking for updates - ", "Suche nach Updates - ",
			   "V\u00e9rification des mises \u00e0 jour - ",
			   "Verificando atualiza\u00e7\u00f5es - ");
	aClass274_3500 = new Class274("Fetching Updates - ", "Lade Update - ",
				      "Chargement des MAJ - ",
				      "Carregando atualiza\u00e7\u00f5es - ");
	new Class274("Loading config - ", "Lade Konfiguration - ",
		     "Chargement des fichiers config - ",
		     "Carregando config - ");
	new Class274("Loaded config", "Konfig geladen.",
		     "Fichiers config charg\u00e9s", "Config carregada");
	new Class274("Loading sprites - ", "Lade Sprites - ",
		     "Chargement des sprites - ", "Carregando sprites - ");
	new Class274("Loaded sprites", "Sprites geladen.",
		     "Sprites charg\u00e9s", "Sprites carregados");
	new Class274("Loading wordpack - ", "Lade Wordpack - ",
		     "Chargement du module texte - ",
		     "Carregando pacote de palavras - ");
	new Class274("Loaded wordpack", "Wordpack geladen.",
		     "Module texte charg\u00e9",
		     "Pacote de palavras carregado");
	new Class274("Loading interfaces - ",
		     "Lade Benutzeroberfl\u00e4che - ",
		     "Chargement des interfaces - ",
		     "Carregando interfaces - ");
	new Class274("Loaded interfaces", "Benutzeroberfl\u00e4che geladen.",
		     "Interfaces charg\u00e9es", "Interfaces carregadas");
	new Class274("Loading interface scripts - ",
		     "Lade Interface-Skripte - ",
		     "Chargement des interfaces - ",
		     "Carregando interfaces - ");
	new Class274("Loaded interface scripts", "Interface-Skripte geladen",
		     "Interfaces charg\u00e9es", "Interfaces carregadas");
	new Class274("Loading additional fonts - ",
		     "Lade Zusatzschriftarten - ",
		     "Chargement de polices secondaires - ",
		     "Carregando fontes principais - ");
	new Class274("Loaded additional fonts", "Zusatzschriftarten geladen",
		     "Polices secondaires charg\u00e9es",
		     "Fontes principais carregadas");
	new Class274("Loading world map - ", "Lade Weltkarte - ",
		     "Chargement de la mappemonde - ",
		     "Carregando mapa-m\u00fandi - ");
	new Class274("Loaded world map", "Weltkarte geladen",
		     "Mappemonde charg\u00e9e", "Mapa-m\u00fandi carregado");
	new Class274("Loading world list data", "Lade Liste der Welten",
		     "Chargement de la liste des serveurs",
		     "Carregando dados da lista de mundos");
	new Class274("Loaded world list data", "Liste der Welten geladen",
		     "Liste des serveurs charg\u00e9e",
		     "Dados da lista de mundos carregados");
	new Class274("Loaded client variable data", "Client-Variablen geladen",
		     "Variables du client charg\u00e9es",
		     "As vari\u00e1veis do sistema foram carregadas");
	aClass274_3501
	    = new Class274("Loading...", "Lade...", "Chargement en cours...",
			   "Carregando...");
	new Class274
	...
	new Class274(null,
		     ...
		     null, null);
	new Class274("System update in: ", "System-Update in: ",
		     "Mise \u00e0 jour syst\u00e8me dans : ",
		     "Atualiza\u00e7\u00e3o do sistema em: ");
	aClass274_3502
	    = new Class274(" has logged in.", " loggt sich ein.",
			   " s'est connect\u00e9.", " entrou no jogo.");
	aClass274_3503
	    = new Class274(" has logged out.", " loggt sich aus.",
			   " s'est d\u00e9connect\u00e9.", " saiu do jogo.");
	aClass274_3504
	    = new Class274("Unable to find ",
			   "Spieler kann nicht gefunden werden: ",
			   "Impossible de trouver ",
			   "N\u00e3o \u00e9 poss\u00edvel encontrar ");
	new Class274("Use", "Benutzen", "Utiliser", "Usar");
	aClass274_3505
	    = new Class274("Examine", "Untersuchen", "Examiner", "Examinar");
	aClass274_3506
	    = new Class274("Attack", "Angreifen", "Attaquer", "Atacar");
	aClass274_3507
	    = new Class274("Choose Option", "W\u00e4hl eine Option",
			   "Choisir une option", "Selecionar op\u00e7\u00e3o");
	aClass274_3508
	    = new Class274(" more options", " weitere Optionen",
			   " autres options", " mais op\u00e7\u00f5es");
	aClass274_3509 = new Class274("Walk here", "Hierhin gehen",
				      "Atteindre", "Caminhar para c\u00e1");
	aClass274_3510 = new Class274("Face here", "Hierhin drehen",
				      "Regarder dans cette direction",
				      "Virar para c\u00e1");
	aClass274_3511
	    = new Class274("level: ", "Stufe: ", "niveau ", "n\u00edvel: ");
	aClass274_3512 = new Class274("skill: ", "Fertigkeit: ",
				      "comp\u00e9tence ", "habilidade: ");
	aClass274_3513
	    = new Class274("rating: ", "Kampfstufe: ", "classement ",
			   "qualifica\u00e7\u00e3o: ");
	aClass274_3514 = new Class274("Please wait...", "Bitte warte...",
	...
	aClass274_3521
	    = new Class274(" is already on your friends list.",
	...
	aClass274_3523
	    = new Class274(" is already on your ignore list.",
	...
	aClass274_3526
	    = new Class274("Please remove ", "Bitte entferne ",
			   "Veuillez commencer par supprimer ", "Remova ");
	aClass274_3527 = new Class274(" from your ignore list first.",
	...
	aClass274_3528
	    = new Class274("Please remove ", "Bitte entferne ",
			   "Veuillez commencer par supprimer ", "Remova ");
	aClass274_3529 = new Class274(" from your friends list first.",
				      " zuerst von deiner Freunde-Liste!",
				      " de votre liste d'amis.",
				      " da sua lista de amigos primeiro.");
	aClass274_3530
	    = new Class274("yellow:", "gelb:", "jaune:", "amarelo:");
	aClass274_3531 = new Class274("red:", "rot:", "rouge:", "vermelho:");
	aClass274_3532
	    = new Class274("green:", "gr\u00fcn:", "vert:", "verde:");
	aClass274_3533
	    = new Class274("cyan:", "blaugr\u00fcn:", "cyan:", "cyan:");
	aClass274_3534 = new Class274("purple:", "lila:", "violet:", "roxo:");
	aClass274_3535 = new Class274("white:", "weiss:", "blanc:", "branco:");
	aClass274_3536
	    = new Class274("flash1:", "blinken1:", "clignotant1:", "flash1:");
	aClass274_3537
	    = new Class274("flash2:", "blinken2:", "clignotant2:", "flash2:");
	aClass274_3538
	    = new Class274("flash3:", "blinken3:", "clignotant3:", "brilho3:");
	aClass274_3539
	    = new Class274("glow1:", "leuchten1:", "brillant1:", "brilho1:");
	aClass274_3540
	    = new Class274("glow2:", "leuchten2:", "brillant2:", "brilho2:");
	aClass274_3541
	    = new Class274("glow3:", "leuchten3:", "brillant3:", "brilho3:");
	aClass274_3542
	    = new Class274("wave:", "welle:", "ondulation:", "onda:");
	aClass274_3543
	    = new Class274("wave2:", "welle2:", "ondulation2:", "onda2:");
	aClass274_3544 = new Class274("shake:", "sch\u00fctteln:",
				      "tremblement:", "tremor:");
	aClass274_3545 = new Class274("scroll:", "scrollen:",
				      "d\u00e9roulement:", "rolagem:");
	aClass274_3546 = new Class274("slide:", "gleiten:", "glissement:",
				      "deslizamento:");
    }
}
