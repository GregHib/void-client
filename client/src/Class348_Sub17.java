...
final class Class348_Sub17 extends Class348
{
	...
	do {
		...
		if ((((Class318_Sub1_Sub3_Sub3) class318_sub1_sub3_sub3_sub1)
			...
			Class17 class17
				...
				7));
			int i_3_ = ((Class17) class17).anInt248;
			if (i_3_ == 1) {
			    ((Class318_Sub1_Sub3_Sub3)
		...
		for (int i_4_ = 0;
			...
			|| (((Class17) Class10.aClass87_191
					   .method835(is[i_4_], 7)).anInt239
			    >= ((Class17) (Class10.aClass87_191.method835
					   ((((Class318_Sub1_Sub3_Sub3)
					      class318_sub1_sub3_sub3_sub1)
	...
	int i;
	for (i = 0; ((((Class348_Sub49) class348_sub49).aByteArray7154
		      [i + ((Class348_Sub49) class348_sub49).anInt7197])
		     != 0); i++) {
	    /* empty */
	}
	...
	i++;
	int i_11_ = ((Class348_Sub49) class348_sub49).anInt7197;
	((Class348_Sub49) class348_sub49).anInt7197 += i;
	int i_12_;
	for (i_12_ = 0;
	     (((((Class348_Sub49) class348_sub49).aByteArray7154
		[i_12_ + ((Class348_Sub49) class348_sub49).anInt7197])
	       ^ 0xffffffff)
	      != -1);
	     i_12_++) {
	    /* empty */
	...
	i_12_++;
	((Class348_Sub49) class348_sub49).anInt7197++;
	int i_15_ = ((Class348_Sub49) class348_sub49).anInt7197;
	...
	for (int i_40_ = 0; i_40_ < 128; i_40_++) {
		...
		if (i_35_ == 0) {
		    i_39_ = -1 + (((Class348_Sub49) class348_sub49)
	...
	for (int i_42_ = 0; (i_42_ ^ 0xffffffff) > -129; i_42_++) {
		...
		if (i_35_ == 0) {
			...
			i_35_ = is_13_[i_36_++];
		    i_41_ = 16 + (((Class348_Sub49) class348_sub49)
