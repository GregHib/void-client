        ...
        do {
            try {
                ...
                if ((class318_sub1_sub3_sub3_sub1
                    ...
                    boolean bool = true;
                    for (int i_2_ = 0;
                         i_2_ < class318_sub1_sub3_sub3_sub1.anIntArray10236.length;
                         i_2_++) {
                        if ((class318_sub1_sub3_sub3_sub1
    ...
    Class348_Sub17(byte[] is) {
        ...
        for (i_12_ = 0;
             ((class348_sub49.aByteArray7154
                     [i_12_ + class348_sub49.anInt7197]) != 0);
             i_12_++) {
            /* empty */
        }
        ...
        for (int i_38_ = 0; i_38_ < 128; i_38_++) {
            if (i_35_ == 0) {
                if (i_36_ < is_30_.length)
                    i_35_ = is_30_[i_36_++];
                else
                    i_35_ = -1;
                i_37_ = class348_sub49.method3366((byte) 124);
            }
            this.aShortArray6795[i_38_]
        ...
        for (int i_40_ = 0; i_40_ < 128; i_40_++) {
            if (anIntArray6793[i_40_] != 0) {
                if (i_35_ == 0) {
                    i_39_ = -1 + (class348_sub49
                            .aByteArray7154[i_11_++]);
            ...
            if (anIntArray6793[i_42_] != 0) {
                if (i_35_ == 0) {
                    if (i_36_ >= is_13_.length)
                        ...
                        i_35_ = is_13_[i_36_++];
                    i_41_ = 16 + (class348_sub49
                            .aByteArray7154[i_15_++]) << 920444290;
                }
                i_35_--;
        ...
        for (int i_45_ = 0; i_45_ < 128; i_45_++) {
            if (i_35_ == 0) {
                if (is_30_.length > i_36_)
                    ...
                    i_35_ = -1;
                if (anIntArray6793[i_45_] > 0)
                    i_44_ = class348_sub49.method3387(255) + 1;
            }
        ...
        for (int i_46_ = 0; i_20_ > i_46_; i_46_++) {
            ...
            if (class23_47_.aByteArray348 != null) {
                for (int i_48_ = 1;
                     i_48_ < class23_47_.aByteArray348.length;
                     i_48_ += 2)
                    class23_47_.aByteArray348[i_48_]
                            = class348_sub49.method3388(-93);
            }
            if (class23_47_.aByteArray344 != null) {
                for (int i_49_ = 3;
                     -2 + class23_47_.aByteArray344.length > i_49_;
                     i_49_ += 2)
                    class23_47_.aByteArray344[i_49_]
        ...
        for (int i_52_ = 0; i_52_ < i_20_; i_52_++) {
            ...
            if (class23_53_.aByteArray344 != null) {
                i_32_ = 0;
                for (int i_54_ = 2;
                     i_54_ < class23_53_.aByteArray344.length;
                     i_54_ += 2) {
                    i_32_ = 1 + i_32_ - -class348_sub49.method3387(255);
                    class23_53_.aByteArray344[i_54_]
                            = (byte) i_32_;
                }
            }
        }
        for (int i_55_ = 0; i_20_ > i_55_;
             i_55_++) {
            Class23 class23_56_ = class23s[i_55_];
            if (class23_56_.aByteArray348 != null) {
                i_32_ = 0;
                for (int i_57_ = 2;
                     i_57_ < class23_56_.aByteArray348.length;
                     i_57_ += 2) {
                    i_32_ = 1 + (i_32_ - -class348_sub49.method3387(255));
                    class23_56_.aByteArray348[i_57_]
                            = (byte) i_32_;
                }
            }
        }
        if (is_27_ != null) {
            ...
            while (is_27_.length > i_62_) {
                ...
                for (int i_66_ = i_59_;
                    ...
                    this.aByteArray6799[i_66_]
                            = (byte) (32 + (this.aByteArray6799
                            [i_66_]) * i_67_
                            >> 1645538950);
                    i_65_ += -i_60_ + i_64_;
                }
        ...
        if (is_28_ != null) {
            ...
            for (int i_72_ = 0; i_70_ > i_72_;
                 i_72_++) {
                int i_73_
                        = ((this.aByteArray6792[i_72_] & 0xff)
                        + i_71_);
                if (i_73_ < 0)
                    i_73_ = 0;
                if (i_73_ > 128)
            ...
            for (int i_81_ = i_70_; i_81_ < 128; i_81_++) {
                int i_82_
                        = i_71_ + (this.aByteArray6792[i_81_]
                        & 0xff);
                if (i_82_ < 0)
                    i_82_ = 0;
                if (i_82_ > 128)
        ...
        for (int i_83_ = 0; i_20_ > i_83_;
             i_83_++)
            class23s[i_83_].anInt347
                    = class348_sub49.method3387(255);
        for (int i_84_ = 0; i_84_ < i_20_; i_84_++) {
            Class23 class23_85_ = class23s[i_84_];
            if (class23_85_.aByteArray348 != null)
                class23_85_.anInt345
                        = class348_sub49.method3387(255);
            if (class23_85_.aByteArray344 != null)
                class23_85_.anInt349
                        = class348_sub49.method3387(255);
            if (class23_85_.anInt347 > 0)
                class23_85_.anInt350
                        = class348_sub49.method3387(255);
        }
        for (int i_86_ = 0; i_20_ > i_86_;
             i_86_++)
            class23s[i_86_].anInt352
                    = class348_sub49.method3387(255);
        for (int i_87_ = 0; i_87_ < i_20_; i_87_++) {
            Class23 class23_88_ = class23s[i_87_];
            if (class23_88_.anInt352 > 0)
                class23_88_.anInt353
                        = class348_sub49.method3387(255);
        }
        for (int i_89_ = 0; i_20_ > i_89_;
             i_89_++) {
            Class23 class23_90_ = class23s[i_89_];
            if (class23_90_.anInt353 > 0)
                class23_90_.anInt346
                        = class348_sub49.method3387(255);
        }
    }
}
