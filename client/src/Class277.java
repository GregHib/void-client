...
final class Class277 {
    ...
    final void method2067(int i) {
        this.anInt3564 = (this.anInt3564 << -267776152 | this.anInt3573);
    ...
    private final void method2069(int i, Class348_Sub49 class348_sub49, int i_1_) {
        ...
        if (i == -1) {
            if (i_1_ != 1) {
                if (i_1_ == 2) this.anInt3575 = class348_sub49.method3387(255);
                else if (i_1_ == 3) {
                    this.anInt3575 = class348_sub49.method3330(842397944);
                    if (this.anInt3575 == 65535) this.anInt3575 = -1;
                } else if (i_1_ != 5) {
                    if (i_1_ != 7) {
                        if (i_1_ == 8) this.aClass268_3562.anInt3447 = this.anInt3573;
                        else if (i_1_ == 9) this.anInt3570 = (class348_sub49.method3330(842397944) << -345189086);
                        else if (i_1_ == 10) this.aBoolean3566 = false;
                        else if (i_1_ == 11) this.anInt3564 = class348_sub49.method3387(255);
                        else if (i_1_ != 12) {
                            if (i_1_ != 13) {
                                if (i_1_ != 14) {
                                    if (i_1_ == 16) this.anInt3574 = class348_sub49.method3387(255);
                                } else this.anInt3558 = (class348_sub49.method3387(255) << 991859202);
