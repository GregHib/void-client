...
final class Class205
{
	...
	if (i_0_ >= Class132.anInt1910 && i_0_ <= Class38.anInt513) {
	    ...
	    int i_13_ = Class85.method831(Class113.anInt1745, -i_2_ + i_5_,
					  Class369.anInt4960, -104);
	    int i_14_ = Class85.method831(Class113.anInt1745, i_5_ - -i_2_,
					  Class369.anInt4960, i_3_ + -94);
	    int i_15_ = Class85.method831(Class113.anInt1745, i_5_ - i_7_,
					  Class369.anInt4960, -82);
	    int i_16_ = Class85.method831(Class113.anInt1745, i_5_ - -i_7_,
	...
	while ((i_8_ ^ 0xffffffff) < (i_6_ ^ 0xffffffff)) {
		...
		if ((i_19_ ^ 0xffffffff) <= (Class132.anInt1910 ^ 0xffffffff)
			...
			int i_23_
			    = Class85.method831(Class113.anInt1745,
						i_6_ + i_5_,
						Class369.anInt4960, -123);
			int i_24_ = Class85.method831(Class113.anInt1745,
						      -i_6_ + i_5_,
						      Class369.anInt4960, 110);
			int i_25_ = Class85.method831(Class113.anInt1745,
						      i_22_ + i_5_,
		...
		if (Class369.anInt4960 <= i_29_
		    ...
		    i_29_ = Class85.method831(Class113.anInt1745, i_29_,
			...
			int i_33_ = Class85.method831(Class113.anInt1745,
						      -i_31_ + i_5_,
