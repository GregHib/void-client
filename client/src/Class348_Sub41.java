...
final class Class348_Sub41 extends Class348 {
            ...
            if (i_15_ > 122) {
                ...
                if ((Class312.anInt3931 ^ 0xffffffff) != -5) {
                    for (Class348_Sub37 class348_sub37
                        ...
                        int i_33_
                                = (int) (0x3fffL
                                & ((Class348) class348_sub37).aLong4291);
    ...
    static final byte[] method3158(byte[] is, int i) {
        ...
        if (i_38_ < 0
                || (Class29.anInt401 != 0
                && (Class29.anInt401 ^ 0xffffffff) > (i_38_ ^ 0xffffffff)))
            throw new RuntimeException();
        if (i_37_ != 0) {
            int i_39_ = class348_sub49.method3385((byte) -126);
            if (i_39_ < 0
                    || ((Class29.anInt401 ^ 0xffffffff) != -1
                    && (Class29.anInt401 ^ 0xffffffff) > (i_39_ ^ 0xffffffff)))
                throw new RuntimeException();
    ...
    static final void method3159(int i, int i_42_, boolean bool, int i_43_,
        ...
        if (interface10 != null) {
            ...
            if ((((Class51) class51).anInt875 ^ 0xffffffff) != 0)
                Class267.method2028(i_46_, class51, i_42_, var_ha, i_48_, 126);
            else {
                int i_50_ = i_47_;
                if ((((Class51) class51).anInt874 ^ 0xffffffff) < -1)
                    i_50_ = i;
