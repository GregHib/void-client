...
final class Class348_Sub16_Sub4 extends Class348_Sub16 {
    ...
    final synchronized void method2819(int i) {
        do {
            ...
            Class348_Sub30 class348_sub30
                    = (Class348_Sub30) aClass262_8966.method1995(4);
            synchronized (class348_sub30) {
                ...
                if (i_1_ < 0) {
                    ...
                    method2881(class348_sub30.aClass348_4294,
                            class348_sub30);
                }
            }
        } while (i != 0);
    ...
    private final void method2881(Class348 class348,
                                  Class348_Sub30 class348_sub30) {
        for (/**/;
                 (class348 != aClass262_8966.aClass348_3334
                         && (((Class348_Sub30) class348).anInt6912
                         <= class348_sub30.anInt6912));
                 class348 = class348.aClass348_4294) {
            /* empty */
        }
        Class348_Sub42_Sub16_Sub2.method3265(-106, class348_sub30, class348);
        anInt8967 = ((Class348_Sub30) aClass262_8966.aClass348_3334
                .aClass348_4294).anInt6912;
    }
    ...
    private final void method2882(Class348_Sub30 class348_sub30) {
        ...
        Class348 class348
                = (aClass262_8966.aClass348_3334
                .aClass348_4294);
        if (class348 == aClass262_8966.aClass348_3334)
            anInt8967 = -1;
        else
            anInt8967 = ((Class348_Sub30) class348).anInt6912;
    }
    ...
    private final void method2884(int i) {
        for (Class348_Sub16 class348_sub16
             = (Class348_Sub16) aClass262_8965.method1995(4);
             class348_sub16 != null;
             class348_sub16
                     = (Class348_Sub16) aClass262_8965.method1990((byte) 104))
    ...
    private final void method2885() {
        if (anInt8968 > 0) {
            for (Class348_Sub30 class348_sub30
                 ...
                 class348_sub30 != null;
                 class348_sub30
                         = (Class348_Sub30) aClass262_8966.method1990((byte) 115))
    ...
    private final void method2886(int[] is, int i, int i_2_) {
        for (Class348_Sub16 class348_sub16
             ...
             class348_sub16 != null;
             class348_sub16
                     = (Class348_Sub16) aClass262_8965.method1990((byte) 41))
