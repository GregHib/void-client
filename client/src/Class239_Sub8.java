...
final class Class239_Sub8 extends Class239 {
    ...
    static final int method1749(Class110_Sub1 class110_sub1,
                                Class110_Sub1 class110_sub1_0_, boolean bool,
                                int i, byte i_1_) {
        try {
            anInt5916++;
            if (i == 1) {
                int i_2_ = ((Class110) class110_sub1).anInt1704;
                int i_3_ = ((Class110) class110_sub1_0_).anInt1704;
                if (!bool) {
                    if (i_2_ == -1)
                        i_2_ = 2001;
                    if (i_3_ == -1)
            ...
            if ((i ^ 0xffffffff) == -3)
                return (Class239_Sub21.method1811
                        (9152,
                                (((Class283) class110_sub1_0_.method1038(false))
                                        .aString3663),
                                Class348_Sub33.anInt6967,
                                (((Class283) class110_sub1.method1038(false))
                                        .aString3663)));
            if (i == 3) {
                if (!((Class110_Sub1) class110_sub1).aString5787.equals("-")) {
                    if (((Class110_Sub1) class110_sub1_0_).aString5787
                            .equals("-")) {
                        if (!bool)
                            return -1;
                        return 1;
                ...
                return (Class239_Sub21.method1811
                        (9152, ((Class110_Sub1) class110_sub1_0_).aString5787,
                                Class348_Sub33.anInt6967,
            ...
            if ((i ^ 0xffffffff) == -9) {
                int i_4_ = ((Class110_Sub1) class110_sub1).anInt5788;
                int i_5_ = ((Class110_Sub1) class110_sub1_0_).anInt5788;
                if (!bool) {
            ...
            return (((Class110_Sub1) class110_sub1).anInt5786
                    + -((Class110_Sub1) class110_sub1_0_).anInt5786);
    ...
    static final void method1752(int i, int i_10_, int i_11_) {
        ...
        if (i == -1) {
            if (Class348_Sub49.anInt7207 == 0) {
                ...
                Class250.anInt3225
                        = (Class73.anInt4784
                        + Class107.anInt1651 / Class344.anInt4267 - -2);
                Class348_Sub16_Sub1.anInt8854
                        = Class58.anInt1067 * Class31.anInt425;
                Class239_Sub16.anInt6008
                        = Class344.anInt4267 * Class250.anInt3225;
                Class211.anInt2747
    ...
    static final String method1753(int i, Class46 class46) {
        ...
        if ((client.method105(class46).method3307(116) ^ 0xffffffff) == -1)
            return null;
        if (((Class46) class46).aString780 == null
                || ((Class46) class46).aString780.trim().length() == 0) {
        ...
        if (i != 0)
            return null;
        return ((Class46) class46).aString780;
    }
    ...
    static final int method1754(boolean bool, int i, int i_12_, int i_13_) {
        ...
        for (Class348_Sub21 class348_sub21
             = (Class348_Sub21) Class75.aClass262_1254.method1995(4);
             class348_sub21 != null;
