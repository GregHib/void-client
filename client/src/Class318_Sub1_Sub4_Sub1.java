...
final class Class318_Sub1_Sub4_Sub1 extends Class318_Sub1_Sub4
    ...
    Class318_Sub1_Sub4_Sub1(ha var_ha, Class51 class51, int i, int i_0_,
    ...
    final void method2392(boolean bool) {
        ...
        aBoolean10090 = false;
        if (this.aClass64_10071 != null)
            this.aClass64_10071.s
                    (this.aClass64_10071.ua()
                            & ~0x10000);
    }
    ...
    final void method2380(ha var_ha, int i, boolean bool,
        ...
        try {
            ...
            if (class318_sub1 instanceof Class318_Sub1_Sub4_Sub1) {
                ...
                if (this.aClass64_10071 != null
                        && (class318_sub1_sub4_sub1_14_
                        .aClass64_10071) != null)
                    this.aClass64_10071.method613
    ...
    private final Class2 method2481(boolean bool, int i, int i_15_,
        ...
        return class51.method476(var_ha, var_s, aByte10079, i,
                this.anInt6377, bool,
                var_s_16_, this.anInt6382,
                this.anInt6388, aByte10062,
                i_15_ + 132);
    }
    ...
    final Class318_Sub4 method2386(int i, ha var_ha) {
        ...
        Class318_Sub4 class318_sub4
                = OutputStream_Sub2.method136(i, aBoolean10076, false);
        if (!Class305.aBoolean3870)
            this.aClass64_10071.method615
                    (class101,
                            class318_sub4.aClass318_Sub3Array6414[0],
                            0);
        else
            this.aClass64_10071.method608
                    (class101,
                            class318_sub4.aClass318_Sub3Array6414[0],
