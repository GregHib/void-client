...
class Class348 {
    ...
    static final Class64 method2711(int i, int i_3_, Class64 class64, int i_4_,
                                    boolean bool, int i_5_, int i_6_, int i_7_,
                                    int i_8_, ha var_ha, int i_9_, int i_10_,
                                    int i_11_, Class17 class17) {
        try {
            anInt4298++;
            if (class64 == null)
                return null;
                ...
                for (int i_18_ = 0; i_18_ < i_15_; i_18_++) {
                    ...
                    for (int i_21_ = 0;
                        ...
                        int i_23_ = (Class70.anIntArray1207[i_22_] * i_19_
                                >> 428811726);
                        int i_24_ = (Class70.anIntArray1204[i_22_] * i_20_
                                >> 700180942);
                        is_17_[i_18_][i_21_]
