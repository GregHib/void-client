...
final class Class367_Sub5 extends Class367 {
    ...
    Class367_Sub5(Class378 class378, Class45 class45) {
        ...
        if (null == class45
            ...
            anIDirect3DVertexShader7332
                    = aClass378_7328.anIDirect3DDevice9810
                    .b(class45.method391("dx", "uw_ground_unlit", -29832));
            anIDirect3DVertexShader7330
                    = aClass378_7328.anIDirect3DDevice9810
                    .b(class45.method391("dx", "uw_ground_lit", -29832));
            anIDirect3DVertexShader7334
                    = aClass378_7328.anIDirect3DDevice9810
                    .b(class45.method391("dx", "uw_model_unlit", -29832));
            anIDirect3DVertexShader7335
                    = aClass378_7328.anIDirect3DDevice9810
                    .b(class45.method391("dx", "uw_model_lit", -29832));
    ...
    final void method3524(int i) {
        if (i == -14775) {
            if (null != anIDirect3DVertexShader7333) {
                IDirect3DDevice idirect3ddevice
                        = aClass378_7328.anIDirect3DDevice9810;
                idirect3ddevice.a(4, this.aHa_Sub3_4479
    ...
    final void method3527(int i, Interface18 interface18, int i_3_) {
        if (interface18 == null) {
            ...
            this.aHa_Sub3_4479.method3850((byte) -103,
                    interface18);
        ...
        if (null != anIDirect3DVertexShader7333) {
            ...
            idirect3ddevice.a
                    (11,
                            ...
                            this.aHa_Sub3_4479.aFloat8115,
                            1.0F / (-(this.aHa_Sub3_4479
                                    .aFloat8173)
                                    + (this.aHa_Sub3_4479
                                    .aFloat8115)));
            this.aHa_Sub3_4479.method3894
                    (-28186,
                            this.aHa_Sub3_4479.method3863(-103));
        }
    }
    ...
    final void method3525(int i, boolean bool) {
        ...
        if (i != 15192)
            method3520((byte) -41);
        this.aHa_Sub3_4479.method3874
                (Class328_Sub3.aClass229_6519, 105, Class248.aClass229_3196);
        this.aHa_Sub3_4479
