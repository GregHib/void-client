...
final class Class207 {
    ...
    final int method1510() {
        return (this.anInt2702 + this.anInt2703
                + this.anInt2698);
    }
    ...
    final void method1511(int i) {
        ...
        if (this.anIntArray2697.length < 255) {
            for (int i_1_ = 0; i_1_ < this.anIntArray2697.length;
                 i_1_++) {
            ...
            if (i_0_ == -1) {
                ...
                int[] is
                        = new int[this.anIntArray2697.length + 1];
                Class214.method1578(this.anIntArray2697, 0, is, 0,
                        this.anIntArray2697.length);
            ...
            int i_4_ = i >> 8 & 0xff;
            int i_5_ = i & 0xff;
            for (int i_6_ = 0; i_6_ < this.anIntArray2697.length;
                 i_6_++) {
        ...
        for (int i_15_ = this.anInt2696 - 1; i_15_ > 0; i_15_--) {
            ...
            for (int i_17_ = this.anInt2702 - 1; i_17_ > 0;
                 i_17_--) {
                if (((this.anIntArray2697
                        [this.aByteArray2699[i_17_ + i_16_] & 0xff])
                        == 0)
                        && (this.anIntArray2697
                        [((this.aByteArray2699
                        [i_17_ + i_16_ - 1 - this.anInt2702])
                        & 0xff)]) != 0)
                    this.aByteArray2699[i_17_ + i_16_]
                            = (byte) i_0_;
            }
        }
    }
    ...
    final void method1513(int i) {
        ...
        if (this.anInt2702 != i_18_
                || this.anInt2696 != i_19_) {
            int i_20_ = i;
            if (i_20_ > this.anInt2703)
                i_20_ = this.anInt2703;
            int i_21_ = i;
            if ((i_21_ + this.anInt2703
                    + this.anInt2702)
                    > i_18_)
                i_21_ = (i_18_ - this.anInt2703
                        - this.anInt2702);
            int i_22_ = i;
            if (i_22_ > this.anInt2700)
                i_22_ = this.anInt2700;
            int i_23_ = i;
            if ((i_23_ + this.anInt2700
                    + this.anInt2696)
                    > i_19_)
                i_23_ = (i_19_ - this.anInt2700
                        - this.anInt2696);
            ...
            if (this.aByteArray2695 == null) {
                for (int i_26_ = 0; i_26_ < this.anInt2696;
                     i_26_++) {
                    int i_27_ = i_26_ * this.anInt2702;
                    int i_28_ = (i_26_ + i_22_) * i_24_ + i_20_;
                    for (int i_29_ = 0; i_29_ < this.anInt2702;
                         i_29_++)
                        is[i_28_++]
                                = this.aByteArray2699[i_27_++];
                }
            } else {
                byte[] is_30_ = new byte[i_24_ * i_25_];
                for (int i_31_ = 0; i_31_ < this.anInt2696;
                     i_31_++) {
                    int i_32_ = i_31_ * this.anInt2702;
                    int i_33_ = (i_31_ + i_22_) * i_24_ + i_20_;
                    for (int i_34_ = 0; i_34_ < this.anInt2702;
                         i_34_++) {
                        is_30_[i_33_]
                                = this.aByteArray2695[i_32_];
                        is[i_33_++]
                                = this.aByteArray2699[i_32_++];
                    }
                }
    ...
    final void method1514() {
        ...
        if (this.aByteArray2695 == null) {
            for (int i = (this.anInt2696 >> 1) - 1; i >= 0; i--) {
                ...
                int i_36_ = ((this.anInt2696 - i - 1)
                        * this.anInt2702);
                for (int i_37_ = -this.anInt2702; i_37_ < 0;
                     i_37_++) {
                    byte i_38_ = is[i_35_];
                    is[i_35_] = is[i_36_];
                    is[i_36_] = i_38_;
            ...
            for (int i = (this.anInt2696 >> 1) - 1; i >= 0; i--) {
                ...
                int i_41_ = ((this.anInt2696 - i - 1)
                        * this.anInt2702);
                for (int i_42_ = -this.anInt2702; i_42_ < 0;
                     i_42_++) {
                    byte i_43_ = is[i_40_];
                    is[i_40_] = is[i_41_];
                    is[i_41_] = i_43_;
    ...
    final void method1515(int i) {
        ...
        if (this.anIntArray2697.length < 255) {
            for (int i_45_ = 0;
                 i_45_ < this.anIntArray2697.length; i_45_++) {
            ...
            int i_49_ = i & 0xff;
            for (int i_50_ = 0;
                 i_50_ < this.anIntArray2697.length; i_50_++) {
        ...
        for (int i_60_ = 0; i_60_ < this.anInt2696; i_60_++) {
            for (int i_61_ = 0; i_61_ < this.anInt2702; i_61_++) {
                ...
                if (this.anIntArray2697[i_62_] == 0) {
                    if (i_61_ > 0
                            && (this.anIntArray2697
                            [(this.aByteArray2699[i_59_ - 1]
                            & 0xff)]) != 0)
                        i_62_ = i_44_;
                    else if (i_60_ > 0
                            && (this.anIntArray2697
                            [((this.aByteArray2699
                            [i_59_ - this.anInt2702])
                            & 0xff)]) != 0)
                        i_62_ = i_44_;
                    else if (i_61_ < this.anInt2702 - 1
                            && (this.anIntArray2697
                            [(this.aByteArray2699[i_59_ + 1]
                            & 0xff)]) != 0)
                        i_62_ = i_44_;
                    else if (i_60_ < this.anInt2696 - 1
                            && (this.anIntArray2697
                            [((this.aByteArray2699
                            [i_59_ + this.anInt2702])
                            & 0xff)]) != 0)
        ...
        if (this.aByteArray2695 == null) {
            for (int i_67_ = 0; i_67_ < this.anInt2696; i_67_++) {
                ...
                int i_69_ = (this.anInt2703
                        + (i_67_ + this.anInt2700) * i);
                for (int i_70_ = 0; i_70_ < this.anInt2702;
                     i_70_++) {
                    int i_71_
                            = (this.anIntArray2697
                            [this.aByteArray2699[i_68_++] & 0xff]);
                    if (i_71_ != 0)
            ...
            if ((i_86_ & 0x2) == 0) {
                if ((i_86_ & 0x1) == 0) {
                    for (int i_87_ = 0; i_87_ < i_85_; i_87_++)
                        class207.aByteArray2699[i_87_]
                                = class348_sub49.method3388(-126);
                } else {
                    for (int i_88_ = 0;
                         i_88_ < class207.anInt2702; i_88_++) {
                        for (int i_89_ = 0;
                             i_89_ < class207.anInt2696; i_89_++)
                            class207.aByteArray2699
                                    [(i_88_
                                    + i_89_ * class207.anInt2702)]
                ...
                if ((i_86_ & 0x1) == 0) {
                    for (int i_90_ = 0; i_90_ < i_85_; i_90_++)
                        class207.aByteArray2699[i_90_]
                                = class348_sub49.method3388(-118);
                    for (int i_91_ = 0; i_91_ < i_85_; i_91_++) {
                        byte i_92_
                                = (class207.aByteArray2695[i_91_]
                                = class348_sub49.method3388(-89));
                        bool = bool | i_92_ != -1;
                    }
                } else {
                    for (int i_93_ = 0;
                         i_93_ < class207.anInt2702; i_93_++) {
                        for (int i_94_ = 0;
                             i_94_ < class207.anInt2696; i_94_++)
                            class207.aByteArray2699
                                    [(i_93_
                                    + i_94_ * class207.anInt2702)]
                                    = class348_sub49.method3388(-84);
                    }
                    for (int i_95_ = 0;
                         i_95_ < class207.anInt2702; i_95_++) {
                        for (int i_96_ = 0;
                             i_96_ < class207.anInt2696;
                             i_96_++) {
                            byte i_97_
    ...
    final void method1518() {
        ...
        if (this.aByteArray2695 == null) {
            for (int i = this.anInt2696 - 1; i >= 0; i--) {
                ...
                for (int i_99_ = (i + 1) * this.anInt2702;
                     i_98_ < i_99_; i_98_++) {
                    i_99_--;
            ...
            for (int i = this.anInt2696 - 1; i >= 0; i--) {
                ...
                for (int i_103_ = (i + 1) * this.anInt2702;
    ...
    final void method1520() {
        ...
        int i = 0;
        if (this.aByteArray2695 == null) {
            for (int i_106_ = 0; i_106_ < this.anInt2702;
                 i_106_++) {
                for (int i_107_ = this.anInt2696 - 1; i_107_ >= 0;
                     i_107_--)
                    is[i++]
                            = (this.aByteArray2699
                            [i_106_ + i_107_ * this.anInt2702]);
            }
            this.aByteArray2699 = is;
        } else {
            byte[] is_108_ = new byte[(this.anInt2702
                    * this.anInt2696)];
            for (int i_109_ = 0; i_109_ < this.anInt2702;
                 i_109_++) {
                for (int i_110_ = this.anInt2696 - 1; i_110_ >= 0;
                     i_110_--) {
                    is[i] = (this.aByteArray2699
                            [i_109_ + i_110_ * this.anInt2702]);
                    is_108_[i++]
                            = (this.aByteArray2695
                            [i_109_ + i_110_ * this.anInt2702]);
                }
    ...
    final int method1522() {
        return (this.anInt2696 + this.anInt2700
                + this.anInt2701);
    }
        ...
        if (this.anInt2702 != i
            ...
            if (this.aByteArray2695 == null) {
                ...
                for (int i_115_ = 0; i_115_ < this.anInt2696;
                    ...
                    int i_117_ = ((i_115_ + this.anInt2700) * i
                            + this.anInt2703);
                    for (int i_118_ = 0; i_118_ < this.anInt2702;
                         i_118_++) {
                        is[i_117_] = this.aByteArray2699[i_116_];
                        is_114_[i_117_++]
                                = this.aByteArray2695[i_116_++];
                    }
                }
