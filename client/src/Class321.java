        ...
        if (i != 1) {
            if (i == 2) aString4010 = class348_sub49.method3371(i_0_ ^ ~0x349a);
                ...
                for (int i_2_ = 0; i_1_ > i_2_; i_2_++) {
                    anIntArrayArray3997[i_2_][0] = class348_sub49.method3330(842397944);
                    anIntArrayArray3997[i_2_][1] = class348_sub49.method3385((byte) -126);
                    anIntArrayArray3997[i_2_][2] = class348_sub49.method3385((byte) -126);
                }
            } else if (i == 4) {
                int i_17_ = class348_sub49.method3387(255);
                anIntArrayArray3996 = new int[i_17_][3];
                for (int i_18_ = 0; i_17_ > i_18_; i_18_++) {
                    anIntArrayArray3996[i_18_][0] = class348_sub49.method3330(842397944);
                    anIntArrayArray3996[i_18_][1] = class348_sub49.method3385((byte) -126);
                    anIntArrayArray3996[i_18_][2] = class348_sub49.method3385((byte) -126);
                }
            } else if (i != 5) {
                if (i == 6) class348_sub49.method3387(255);
                else if (i == 7) class348_sub49.method3387(255);
                else if (i != 8) {
                    if (i != 9) {
                        if (i == 10) {
                            int i_3_ = class348_sub49.method3387(i_0_ + 203);
                            anIntArray4008 = new int[i_3_];
                            for (int i_4_ = 0; i_3_ > i_4_; i_4_++)
                                anIntArray4008[i_4_] = class348_sub49.method3385((byte) -126);
                        } else if (i != 12) {
                            if (i == 13) {
                                int i_15_ = class348_sub49.method3387(255);
                                anIntArray4004 = new int[i_15_];
                                for (int i_16_ = 0; i_16_ < i_15_; i_16_++)
                                    anIntArray4004[i_16_] = class348_sub49.method3330(842397944);
                            } else if (i == 14) {
                                int i_13_ = class348_sub49.method3387(i_0_ ^ 0xcb);
                                anIntArrayArray4002 = new int[i_13_][2];
                                for (int i_14_ = 0; i_14_ < i_13_; i_14_++) {
                                    anIntArrayArray4002[i_14_][0] = class348_sub49.method3387(255);
                                    anIntArrayArray4002[i_14_][1] = (class348_sub49.method3387(Class348_Sub21.method2955(i_0_, 203)));
                                }
                            } else if (i == 15) class348_sub49.method3330(842397944);
                            else if (i == 17) this.anInt4000 = class348_sub49.method3330(842397944);
                            else if (i == 18) {
                                ...
                                for (int i_6_ = 0; (i_6_ < i_5_); i_6_++) {
                                    anIntArray4014[i_6_] = (class348_sub49.method3385((byte) -126));
                                    anIntArray4001[i_6_] = (class348_sub49.method3385((byte) -126));
                                    anIntArray4007[i_6_] = (class348_sub49.method3385((byte) -126));
                                ...
                                for (int i_8_ = 0; (i_8_ < i_7_); i_8_++) {
                                    anIntArray4009[i_8_] = (class348_sub49.method3385((byte) -126));
                                    anIntArray3998[i_8_] = (class348_sub49.method3385((byte) -126));
                                    anIntArray4003[i_8_] = (class348_sub49.method3385((byte) -126));
                        ...
                        } else class348_sub49.method3385((byte) -126);
                    } else class348_sub49.method3387(255);
                }
            } else class348_sub49.method3330(842397944);
