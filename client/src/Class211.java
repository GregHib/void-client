...
final class Class211 {
    ...
    static final boolean method1538(int i, byte i_0_, Class348_Sub49_Sub2 class348_sub49_sub2) {
        ...
        if (i_1_ == 0) {
            if (class348_sub49_sub2.method3410((byte) -24, 1) != 0) method1538(i, (byte) 105, class348_sub49_sub2);
            int i_2_ = class348_sub49_sub2.method3410((byte) -24, 6);
            int i_3_ = class348_sub49_sub2.method3410((byte) -24, 6);
            boolean bool = (class348_sub49_sub2.method3410((byte) -24, 1) == 1);
            if (bool) Class18.anIntArray279[Class101_Sub3.anInt5768++] = i;
            if (Class294.aClass318_Sub1_Sub3_Sub3_Sub2Array5058[i] != null) throw new RuntimeException("hr:lr");
            Class359 class359 = Class348_Sub17.aClass359Array6802[i];
            Class318_Sub1_Sub3_Sub3_Sub2 class318_sub1_sub3_sub3_sub2 = (Class294.aClass318_Sub1_Sub3_Sub3_Sub2Array5058[i] = new Class318_Sub1_Sub3_Sub3_Sub2());
            class318_sub1_sub3_sub3_sub2.anInt10290 = i;
            if (Class154.aClass348_Sub49Array2105[i] != null) class318_sub1_sub3_sub3_sub2.method2452((byte) 84, Class154.aClass348_Sub49Array2105[i]);
            class318_sub1_sub3_sub3_sub2.method2435((byte) -108, (class359.anInt4423), true);
            class318_sub1_sub3_sub3_sub2.anInt10275 = class359.anInt4425;
        ...
        if (i_1_ == 1) {
            ...
            Class348_Sub17.aClass359Array6802[i].anInt4420 = (0xfffffff & i_11_) + (((i_11_ >> 260957884) + i_10_ & 0x3) << 1400337884);
            return false;
        }
        if (i_1_ == 2) {
            ...
            Class348_Sub17.aClass359Array6802[i].anInt4420 = i_18_ + ((i_16_ << 165004252) + (i_17_ << 706528398));
            return false;
        }
        ...
        Class348_Sub17.aClass359Array6802[i].anInt4420 = i_26_ + (i_24_ << -1791143364) - -(i_25_ << 1982417070);
        return false;
    }
                ...
                do {
                    ...
                    do {
                        ...
                        do {
                            do {
                                if (i_42_ == 1) {
                                    i_40_ = ((Class70.anIntArray1207[i_41_ << 680948963]) >> 2080897156) + 1024;
                                    break while_74_;
                                } else if (i_42_ != 3) {
                                    if (i_42_ != 4) {
                                        if (i_42_ != 2) {
                                ...
                                i_40_ = (Class291.anIntArray3726[i_41_] >> -813205215);
                                break while_74_;
                            } while (false);
                    ...
                    i_40_ = (i_41_ >= 1024 ? -i_41_ + 2048 : i_41_) << -203822847;
                    break while_74_;
                } while (false);
                i_40_ = 2048;
            }
        } while (false);
        this.aClass348_Sub1_2745.method2716(-1, ((float) ((anInt2743 * i_40_ >> -1367360181) + anInt2738) / 2048.0F));
    }
