...
final class Class60 {
    ...
    final int method575(int i) {
        ...
        for (Class348_Sub42_Sub8 class348_sub42_sub8
             = (Class348_Sub42_Sub8) aClass107_1089.method1011(-84);
             class348_sub42_sub8 != null;
             class348_sub42_sub8 = ((Class348_Sub42_Sub8)
                     aClass107_1089.method1003((byte) 79))) {
    ...
    final Object method583(long l, int i) {
        try {
            ...
            anInt1085++;
            Class348_Sub42_Sub8 class348_sub42_sub8
                    = (Class348_Sub42_Sub8) aClass356_1100.method3480(l, -6008);
    ...
    final void method587(int i) {
        anInt1096++;
        for (Class348_Sub42_Sub8 class348_sub42_sub8
             = (Class348_Sub42_Sub8) aClass107_1089.method1011(-71);
             class348_sub42_sub8 != null;
             class348_sub42_sub8 = ((Class348_Sub42_Sub8)
                     aClass107_1089.method1003((byte) 50))) {
            if (class348_sub42_sub8.method3195(-4)) {
    ...
    final Object method588(int i) {
        anInt1087++;
        Class348_Sub42_Sub8 class348_sub42_sub8
                = (Class348_Sub42_Sub8) aClass356_1100.method3484(0);
        if (i != -5052)
            method577(77);
        while (class348_sub42_sub8 != null) {
