...
final class Class154 {
    ...
    final Class64 method1226
        ...
        try {
            ...
            if (class17_0_ != null
                    && (class17_0_.anInt249 >= 0
                    || class17_0_.anInt261 >= 0)) {
                is_10_ = new int[12];
            ...
            for (int i_17_ = 0; i_16_ > i_17_; i_17_++) {
                ...
                if (class182s[i_17_] != null) {
                    Class17 class17_18_
                            = class87.method835((class182s[i_17_]
                                    .anInt2454),
                            7);
                    if (class17_18_.anIntArray237 != null) {
                        ...
                        int i_21_
                                = class17_18_.anIntArray237[i_19_];
                        ...
                        if ((class17_18_.aBoolean241
                                || Class28.aBoolean5002)
                                && i_20_ != -1
                                && (class17_18_.anIntArray237.length
                                > i_20_)) {
                            Class100.anIntArray1583[i_17_]
                                    = class17_18_.anIntArray267[i_19_];
                            Class50_Sub3.anIntArray5241[i_17_]
                                    = class182s[i_17_].anInt2456;
                            int i_22_
                                    = class17_18_.anIntArray237[i_20_];
            ...
            if (bool_15_) {
                if (class17_0_ != null) {
                    ...
                    if ((class17_0_.aBoolean241
                            || Class28.aBoolean5002)
                            && i_1_ != -1
                            && i_1_ < class17_0_.anIntArray237.length) {
                ...
                if (class17 != null) {
                    ...
                    if ((class17.aBoolean241
                            || Class28.aBoolean5002)
                            && i_3_ != -1
                            && i_3_ < class17.anIntArray237.length) {
            ...
            if (class64 == null
                ...
                if (!bool_37_) {
                    ...
                    if (class225 != null
                        ...
                        for (int i_42_ = 0; ((class225
                                .anIntArrayArray2939).length > i_42_); i_42_++) {
                    ...
                    for (int i_49_ = 0; i_49_ < 5; i_49_++) {
                        for (int i_50_ = 0;
                             (Class367_Sub2.aShortArrayArrayArray7290.length > i_50_);
                             i_50_++) {
                            if ((Class367_Sub2.aShortArrayArrayArray7290
                                    [i_50_][i_49_]).length > this.anIntArray2095[i_49_])
        ...
        try {
            ...
            if (class17 != null) {
                ...
                if ((class17.aBoolean241 || Class28.aBoolean5002)
                        && i_67_ != -1
                        && i_67_ < class17.anIntArray237.length) {
                ...
                for (int i_81_ = 0; i_81_ < 12; i_81_++) {
                    ...
                    if ((i_82_ & 0x40000000) != 0) {
                        if (!class255.method1940
                                ...
                                .method1555
                                        ((byte) 97, this.aBoolean2100))
                            bool = true;
                    } else if ((~0x7fffffff & i_82_) != 0
                            && !class150.method1203
                ...
                for (int i_86_ = 0; i_86_ < 5; i_86_++) {
                    for (int i_87_ = 0;
                         (Class367_Sub2.aShortArrayArrayArray7290.length
                                 > i_87_);
                         i_87_++) {
                        if (this.anIntArray2095[i_86_] < (Class367_Sub2.aShortArrayArrayArray7290[i_87_]
                                [i_86_]).length)
    ...
    final Class64 method1232(int i, int i_91_, int i_92_, int i_93_,
        ...
        try {
            ...
            if (class17 != null) {
                ...
                if ((class17.aBoolean241 || Class28.aBoolean5002)
                        && i != -1
                        && i < class17.anIntArray237.length) {
            ...
            if (class64 == null
                ...
                for (int i_110_ = 0; i_110_ < 5; i_110_++) {
                    for (int i_111_ = 0;
                         (i_111_ < Class367_Sub2.aShortArrayArrayArray7290.length);
                         i_111_++) {
                        if (this.anIntArray2095[i_110_] < (Class367_Sub2.aShortArrayArrayArray7290[i_111_]
                                [i_110_]).length)
