...
final class Class42 {
            ...
            for (int i_0_ = 0;
                ...
                if (this.anIntArray591[i_0_] >= this.anInt603) {
                    if (this.anIntArray591[i_0_]
                            > this.anInt595)
                        this.anInt595
                                = this.anIntArray591[i_0_];
                } else
                    this.anInt603
                            = this.anIntArray591[i_0_];
                if (this.anIntArray591[i_0_ + 1]
                        >= this.anInt607) {
                    if (this.anIntArray591[1 + i_0_]
                            > this.anInt570)
                        this.anInt570
                                = this.anIntArray591[i_0_ - -1];
                } else
                    this.anInt607
                            = this.anIntArray591[i_0_ + 1];
            }
    ...
    final Class105 method374(boolean bool, ha var_ha, byte i) {
        anInt579++;
        int i_3_
                = bool ? this.anInt605 : this.anInt578;
        if (i != 127)
            return null;
        int i_4_ = i_3_ | var_ha.anInt4567 << -1894827875;
        Class105 class105
                = (Class105) this.aClass153_593
                .aClass60_2089.method583(i_4_, 64);
        if (class105 != null)
            return class105;
        if (!this.aClass153_593.aClass45_2087
                .method421(false, i_3_))
            return null;
        Class207 class207
                = Class207.method1521((this.aClass153_593
                        .aClass45_2087),
                i_3_, 0);
        if (class207 != null) {
            class105 = var_ha.method3691(class207, true);
            this.aClass153_593.aClass60_2089
                    .method582(class105, i_4_, (byte) -111);
        }
        return class105;
    }
    ...
    final Class105 method375(ha var_ha, boolean bool) {
        ...
        Class105 class105
                ...
                .aClass60_2089.method583
                        (anInt598 | 0x20000
                                        | var_ha.anInt4567 << -507895171,
                                -75));
        if (class105 != null)
            return class105;
        this.aClass153_593.aClass45_2087
        ...
        if (class207 != null) {
            class105 = var_ha.method3691(class207, true);
            this.aClass153_593.aClass60_2089.method582
                    (class105, var_ha.anInt4567 << -286491427
    ...
    final String method376(String string, int i, byte i_5_) {
        ...
        Class348_Sub50 class348_sub50
                = (Class348_Sub50) aClass356_588.method3480(i, -6008);
    ...
    private final void method377(int i, Class348_Sub49 class348_sub49,
        ...
        if (i != 1) {
            ...
            this.anInt578 = class348_sub49.method3330(842397944);
        if (i_7_ > -113)
            method375(null, true);
    }
    ...
    final int method378(int i, int i_18_, boolean bool) {
        ...
        Class348_Sub35 class348_sub35
                = (Class348_Sub35) aClass356_588.method3480(i_18_, -6008);
