...
final class Class255 {
    ...
    static final Class74[] method1929(byte i) {
        ...
        return (new Class74[]
                {Class348_Sub42_Sub8_Sub2.aClass74_10437,
                        ...
                        Class162.aClass74_2157, Class59_Sub1_Sub2.aClass74_8662,
    ...
    final Class105 method1932(ha var_ha, int i, int i_0_, Class324 class324,
                              Class154 class154, int i_1_, boolean bool,
                              byte i_2_, ha var_ha_3_, int i_4_,
                              boolean bool_5_, int i_6_) {
        try {
            anInt3266++;
            Class105 class105 = method1941(i_6_, (byte) -74, i_4_, i_0_, i,
    ...
    static final void method1933(Class45 class45, ha var_ha, boolean bool) {
        try {
            anInt3279++;
            Class207[] class207s
                    = Class207.method1519(class45, Class348_Sub22.anInt6862, 0);
            ...
            for (int i = 0; class207s.length > i;
                ...
                Class348_Sub45.aClass105Array7107[i]
                        = var_ha.method3691(class207s[i], true);
            class207s
                    = Class207.method1519(class45, Class373_Sub2.anInt7429, 0);
            ...
            for (int i = 0; i < class207s.length; i++)
                Class240.aClass105Array4679[i]
                        = var_ha.method3691(class207s[i], true);
            class207s = Class207.method1519(class45,
                    Class348_Sub40_Sub38.anInt9473, 0);
            Class113.aClass105Array1744 = new Class105[class207s.length];
            for (int i = 0; class207s.length > i; i++)
                Class113.aClass105Array1744[i]
                        = var_ha.method3691(class207s[i], true);
            Class79.aClass105_1365
                    = var_ha.method3691(Class207.method1521(class45,
                    Class52.anInt4895, 0),
                    bool);
    ...
    static final void method1935(int i, int i_10_, Class30 class30,
                                 Class64 class64, boolean bool, int i_11_) {
        try {
            anInt3270++;
            if (class64 != null) {
                if (bool != false)
    ...
    final Class213 method1940(int i, int i_13_) {
        ...
        synchronized (aClass45_3267) {
            is = aClass45_3267.method410(-1860, Class54.method500(7, i_13_),
    ...
    final Class105 method1941(int i, byte i_15_, int i_16_, int i_17_,
    ...
    Class255(Class230 class230, int i, boolean bool, Class326 class326,
             Class45 class45, Class45 class45_22_) {
        try {
            aBoolean3269 = bool;
