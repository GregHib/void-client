...
final class Class225 {
    ...
    final Class101[] method1618(ha var_ha, int i) {
        ...
        if (aClass101Array2925 != null
                && (anInt2942 ^ 0xffffffff) == (var_ha.anInt4567
                ^ 0xffffffff))
        ...
        for (int i_0_ = i;
             ((i_0_ ^ 0xffffffff)
                     > (this.anIntArrayArray2939.length ^ 0xffffffff));
             i_0_++) {
            int i_1_ = 0;
            int i_2_ = 0;
            int i_3_ = 0;
    ...
    private final void method1622(Class348_Sub49 class348_sub49, int i,
        ...
        if (i_12_ != 1) {
            ...
            if (this.anInt2951 == 65535)
                this.anInt2951 = -1;
            if ((this.anInt2918 ^ 0xffffffff) == -65536)
                this.anInt2918 = -1;
        }
        if (i != 48)
            this.anInt2928 = -71;
    ...
    final boolean method1623(int i, int i_22_) {
        ...
        if ((i ^ 0xffffffff) == 0)
            return false;
        if ((i ^ 0xffffffff) == (this.anInt2918 ^ 0xffffffff))
            return true;
        if (this.anIntArray2915 != null) {
            for (int i_23_ = 0;
                 this.anIntArray2915.length > i_23_; i_23_++) {
                if ((i ^ 0xffffffff)
                        == (this.anIntArray2915[i_23_] ^ 0xffffffff))
                    return true;
            }
        }
        return false;
