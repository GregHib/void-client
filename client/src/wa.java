...
final class wa implements Interface4 {
    ...
    public final void method14(int i, int i_0_, int i_1_, int i_2_, int i_3_,
        ...
        Z(aLong4734, this.aJ4732.nativeid,
                this.aXa4733.nativeid, i, i_0_, i_1_, i_2_, i_3_, i_4_,
                bool, bool_5_);
    }
    ...
    public final void method15(int i, int i_22_, int i_23_, int i_24_,
                               ...
                               boolean bool_27_) {
        X(aLong4734, this.aJ4732.nativeid,
                this.aXa4733.nativeid, i, i_22_, i_23_, i_24_, i_25_,
                i_26_, bool, bool_27_);
    }
