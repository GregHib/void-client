...
final class Class348_Sub42_Sub5 extends Class348_Sub42 {
    ...
    final boolean method3184(d var_d, Class45 class45, int i) {
        try {
            ...
            if (Class101_Sub2.anInt5713 < 0) {
                for (int i_17_ = 0;
                     (anIntArray9524.length > i_17_);
                     i_17_++) {
                    if (!class45.method421(false, anIntArray9524[i_17_]))
                        return false;
                }
            } else {
                for (int i_18_ = 0; (i_18_ < anIntArray9524.length); i_18_++) {
                    if (!class45.method420(-10499, Class101_Sub2.anInt5713,
    ...
    final int[] method3185(int i, d var_d, int i_21_, boolean bool, double d,
                           boolean bool_22_, Class45 class45, int i_23_) {
        try {
            Class286_Sub5.aD6247 = var_d;
            Class348.aClass45_4286 = class45;
            anInt9526++;
            ...
            for (int i_40_ = i_21_;
                 (aClass348_Sub40Array9520.length > i_40_);
                 i_40_++)
    ...
    final float[] method3186(int i, d var_d, boolean bool, int i_41_,
        ...
        try {
            ...
            for (int i_54_ = 0;
                 (aClass348_Sub40Array9520.length > i_54_);
                 i_54_++)
    ...
    Class348_Sub42_Sub5(Class348_Sub49 class348_sub49) {
        ...
        for (int i_58_ = 0; i_58_ < i; i_58_++) {
            ...
            if (class348_sub40.method3037(-121) >= 0)
                i_56_++;
        ...
        aClass348_Sub40_9521
                = aClass348_Sub40Array9520[class348_sub49.method3387(255)];
        aClass348_Sub40_9527
                = aClass348_Sub40Array9520[class348_sub49.method3387(255)];
        aClass348_Sub40_9528
                = aClass348_Sub40Array9520[class348_sub49.method3387(255)];
