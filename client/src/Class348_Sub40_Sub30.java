...
final class Class348_Sub40_Sub30 extends Class348_Sub40
{
	...
	if (i != 98)
	    anInt9388 = 46;
	Class60.aHa1098.method3700(Class239_Sub10.aFloat5945,
	...
	Class348_Sub42_Sub15 class348_sub42_sub15
	    = ((Class348_Sub42_Sub15)
	       Class367_Sub4.aClass107_7325.method1011(-47));
	...
	do {
		...
		if (string != null) {
			...
			if (string_1_ != null) {
				...
				String string_6_
				    = (Class285_Sub1.method2127
				       (2, Class51.aStringArray932[i_5_]));
				if (string_6_ != null
				    && string_6_.equals(string_1_)) {
				    Class59.method544
					(((Class274.aClass274_3526.method2063
					   (Class348_Sub33.anInt6967, 544))
					  + string
					  + (Class274.aClass274_3527.method2063
					     (Class348_Sub33.anInt6967, 544))),
					 false, 4);
				    return;
				}
	...
	do {
		...
		if (i_39_ == 31015) {
		    ...
		    anInt9398 = (class348_sub49.method3388(i_39_ + -31101)
				 << 1792937036) / 100;
		    break;
		}
		break;
