...
final class Class318_Sub1_Sub2_Sub1 extends Class318_Sub1_Sub2 {
    ...
    final int method2393(int i) {
        ...
        if ((this.anInt10180 ^ 0xffffffff) != 0) {
            Class213 class213_2_
                    = (Exception_Sub1.aClass255_112.method1940
                    (-88, this.anInt10180));
            if (i_0_ < class213_2_.anInt2784)
                i_0_ = class213_2_.anInt2784;
        }
        return i_0_;
    }
    ...
    final Class318_Sub4 method2386(int i, ha var_ha) {
        ...
        if (class148 != null
            ...
            int i_11_ = class148.aClass318_Sub1_Sub3_2040
                    .method2394(true);
        ...
        if (class148 == null
            ...
            int i_17_ = -i_15_ / 2;
            int i_18_
                    = var_s.method3986(this.anInt6377 + i_16_,
                    this.anInt6388 + i_17_,
                    (byte) -102);
            int i_19_ = i_14_ / 2;
            int i_20_ = -i_15_ / 2;
            int i_21_
                    = var_s.method3986(i_19_ + this.anInt6377,
                    this.anInt6388 - -i_20_,
                    (byte) 94);
            int i_22_ = -i_14_ / 2;
            int i_23_ = i_15_ / 2;
            int i_24_
                    = var_s.method3986(this.anInt6377 + i_22_,
                    i_23_ + this.anInt6388,
                    (byte) -102);
            int i_25_ = i_14_ / 2;
            int i_26_ = i_15_ / 2;
            int i_27_
