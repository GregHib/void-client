...
final class Class318_Sub1_Sub2_Sub1 extends Class318_Sub1_Sub2 {
    ...
    final boolean method2391(ha var_ha, int i, int i_7_, int i_8_) {
        ...
        class101.method894(this.anInt6377, -10 + this.anInt6382, this.anInt6388);
    ...
    final Class318_Sub4 method2386(int i, ha var_ha) {
        ...
        if (class148 == null || !(class148.aClass318_Sub1_Sub3_2040.aBoolean8741)) {
            ...
            int i_16_ = -i_14_ / 2;
            int i_17_ = -i_15_ / 2;
            int i_18_ = var_s.method3986(this.anInt6377 + i_16_, this.anInt6388 + i_17_, (byte) -102);
            int i_19_ = i_14_ / 2;
            int i_20_ = -i_15_ / 2;
            int i_21_ = var_s.method3986(i_19_ + this.anInt6377, this.anInt6388 - -i_20_, (byte) 94);
            int i_22_ = -i_14_ / 2;
            int i_23_ = i_15_ / 2;
            int i_24_ = var_s.method3986(this.anInt6377 + i_22_, i_23_ + this.anInt6388, (byte) -102);
            int i_25_ = i_14_ / 2;
            int i_26_ = i_15_ / 2;
            int i_27_ = var_s.method3986(this.anInt6377 + i_25_, this.anInt6388 + i_26_, (byte) 5);
