...
final class Class318_Sub7 extends Class318 {
    ...
    final void method2507(boolean bool) {
        ...
        if (bool == true) {
            ...
            if ((this.aClass284_6444.anInt3675
                    ...
                    .anInt3668))
                    && ((this.aClass284_6444
                    .anInt3670) == (this.aClass284_6444
                    .anInt3678))
                    && ((this.aClass284_6444
                    .anInt3669) == (this.aClass284_6444
                    .anInt3670))
                    && ((this.aClass284_6444
                    .anInt3679)
                    == (this.aClass284_6444
    ...
    static final void method2509(int i, int i_0_, ha var_ha, int i_1_,
    ...
    static final boolean method2510(Class45 class45,
                                    Class348_Sub16_Sub3 class348_sub16_sub3,
                                    Class45 class45_5_, boolean bool,
                                    Class279 class279, Class45 class45_6_) {
        try {
        ...
        try {
            ...
            if (Class75.aClass348_Sub42_Sub14_1243 != null) {
                ...
                if (Class348.anInt4290 == 10) {
                    ...
                    if (Class88.aBoolean1500 || i_7_ < 0
                            || Class75.anInt1259 <= i_7_ || i_8_ < 0
                            || Class75.anInt1267 <= i_8_) {
                        if (Class239_Sub7.anInt5909 == -1
            ...
            try {
                ...
                if (bool) {
                    ...
                    int i_13_
                            ...
                            / 3);
                    if (i_11_ != (this.aClass284_6444
                            .anInt3673)
                            || i_12_ != this
                            .aClass284_6444.anInt3667
                            || i_13_ != (this.aClass284_6444
                            .anInt3671)) {
                        this.aClass284_6444
                                .anInt3667
                                = i_12_;
