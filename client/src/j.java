...
final class j extends Class105 implements Interface19 {
    ...
    j(oa var_oa, int[] is, int i, int i_66_, int i_67_, int i_68_,
      boolean bool) {
    ...
    j(oa var_oa, int[] is, byte[] is_76_, byte[] is_77_, int i, int i_78_,
      int i_79_, int i_80_) {
    ...
    private final native void ua(oa var_oa, int[] is, int i, int i_91_,
