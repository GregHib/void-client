...
final class Class324_Sub2 extends Class324
{
	...
	if (bool) {
		...
		int i_7_ = ((Class207) class207).anInt2696;
		int i_8_ = ((Class207) class207).anInt2702;
		int i_9_ = i_6_ % 16 * i;
		int i_10_ = i_6_ / 16 * i;
		int i_11_ = i_10_ * i_5_ + i_9_;
		int i_12_ = 0;
		if (((Class207) class207).aByteArray2695 == null) {
		    byte[] is_13_ = ((Class207) class207).aByteArray2699;
		    ...
		    byte[] is_16_ = ((Class207) class207).aByteArray2695;
		...
		int[] is_22_ = ((Class207) class207).anIntArray2697;
		byte[] is_23_ = ((Class207) class207).aByteArray2695;
		byte[] is_24_ = ((Class207) class207).aByteArray2699;
		int i_25_ = ((Class207) class207).anInt2696;
		int i_26_ = ((Class207) class207).anInt2702;
	...
	for (int i_36_ = 0; i_36_ < 4; i_36_++) {
		...
		for (int i_38_ = 0; i_38_ < 256; i_38_++) {
		    ...
		    int i_39_ = ((Class207) class207).anInt2696;
		    int i_40_ = ((Class207) class207).anInt2702;
		    int i_41_ = ((Class207) class207).anInt2700;
		    int i_42_ = ((Class207) class207).anInt2703;
	...
	aHa_Sub3_6494.method3862(0, ((ha_Sub3) aHa_Sub3_6494).aClass130_8204);
