...
final class Class4 {
	...
	Class4(byte[] is, Class348_Sub33 class348_sub33) {
		...
		try {
			...
			((Class348_Sub49) class348_sub49).anInt7197 += 2;
			int i = class348_sub49.method3387(255);//byte
			int i_1_ = 0;
			int i_2_ = -1;
			int i_3_ = -1;
			((Class348_Sub49) class348_sub49_0_).anInt7197 = ((Class348_Sub49) class348_sub49).anInt7197
					+ i;
			...
			if (((Class348_Sub49) class348_sub49_0_).anInt7197 != is.length)
