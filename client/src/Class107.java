...
final class Class107 {
    ...
    final int method1002(int i) {
        ...
        for (Class348_Sub42 class348_sub42
             = (this.aClass348_Sub42_1647
                .aClass348_Sub42_7063);
             this.aClass348_Sub42_1647 != class348_sub42;
             class348_sub42
    ...
    static final void method1007(Class46 class46, ha var_ha, int i, int i_1_,
                                 int i_2_) {
        try {
            anInt1648++;
            ...
            if (var_aa != null) {
                if (i_2_ != 22960)
                    anIntArray1650 = null;
                var_ha.KA(i, i_1_, i + class46.anInt709,
                        class46.anInt789 + i_1_);
                if (Class259.anInt3306 != 2
                        && Class259.anInt3306 != 5
                    ...
                    if (Class348_Sub40_Sub21.anInt9282 == 4) {
                        ...
                        i_3_ = (Class132.aClass318_Sub1_Sub3_Sub3_Sub2_1907
                                .anInt6388);
                        i_6_ = ((int) -Class314.aFloat3938 - -r_Sub2.anInt10483
                                & 0x3fff);
                    ...
                    for (int i_14_ = 0;
                         (Class348_Sub40_Sub38.anInt9479 > i_14_);
                         i_14_++) {
                        ...
                        Class51 class51
                                ...
                                (0, Class263.anIntArray3347[i_14_]));
                    ...
                    for (Class348_Sub37 class348_sub37
                        ...
                        int i_17_ = (int) (0x3L & (class348_sub37
                                .aLong4291) >> 1012614876);
                                ...
                                if (class79 != null
                                    ...
                                    class79 = (class79.method794
                                            ((Class318_Sub1_Sub3_Sub3
                                                    ...
                                                    -1));
                                if (class79 != null
                                        && class79.aBoolean1397
                                        && class79.aBoolean1396) {
                                    int i_23_
                                            = (-(i_4_ / 128)
                                            + (class318_sub1_sub3_sub3_sub1
                                            .anInt6377) / 128);
                    ...
                    for (int i_26_ = 0;
                        ...
                        if (class318_sub1_sub3_sub3_sub2 != null
                                ...
                                != class318_sub1_sub3_sub3_sub2)
                                && (class318_sub1_sub3_sub3_sub2.aByte6381 == (Class132.aClass318_Sub1_Sub3_Sub3_Sub2_1907
								.aByte6381))) {
                            int i_27_ = (-(i_4_ / 128)
                                    + (class318_sub1_sub3_sub3_sub2
                                    .anInt6377) / 128);
                            ...
                            boolean bool = false;
                            for (int i_29_ = 0;
                                 (Class348_Sub40_Sub30.anInt9383 > i_29_);
                                 i_29_++) {
                                if ((class318_sub1_sub3_sub3_sub2
                                        .aString10544.equals
                                                (Class83.aStringArray1441[i_29_]))
                                        && (ha.anIntArray4578[i_29_] != 0)) {
                                    bool = true;
                                    break;
                                }
                            }
                        ...
                        if (class302 != null
                            ...
                            if (class302.anInt3840 == 1) {
                                ...
                                if (class348_sub22 != null) {
                                    ...
                                    int i_35_
                                            ...
                                            + (class318_sub1_sub3_sub3_sub1
                                            .anInt6388) / 128);
                                    Class287.method2181(360000L, i_1_, -125,
                                            i_35_, i, class46,
                                            i_34_,
                                            (class302
                                                    .anInt3831),
                            ...
                            if (class302.anInt3840 == 2) {
                                ...
                                long l
                                        ...
                                        << -660810585;
                                l *= l;
                                Class287.method2181(l, i_1_, -112, i_37_, i,
                                        class46, i_36_,
                                        (class302
                                                .anInt3831),
                                        var_aa);
                            ...
                            if ((class302.anInt3840 == 10)
                                ...
                                if (class318_sub1_sub3_sub3_sub2 != null) {
                                    ...
                                    int i_39_
                                            ...
                                            + (class318_sub1_sub3_sub3_sub2
                                            .anInt6388) / 128);
                                    Class287.method2181(360000L, i_1_, -121,
                                            i_39_, i, class46,
                                            i_38_,
                                            (class302
                                                    .anInt3831),
                    ...
                    if (Class348_Sub40_Sub21.anInt9282 != 4) {
                        if (Class248.anInt3203 != 0) {
                            int i_40_
                                    = (-(i_4_ / 128) + (Class248.anInt3203 * 4 + 2)
                                    - (-(2
                                    * Class132
                                    .aClass318_Sub1_Sub3_Sub3_Sub2_1907
                                    .method2436((byte) 77))
        ...
        if (i == 2110355138) {
            for (; ; ) {
                Class348_Sub42 class348_sub42
                        = (this.aClass348_Sub42_1647
                        .aClass348_Sub42_7063);
                if (this.aClass348_Sub42_1647 == class348_sub42)
                    break;
                class348_sub42.method3162(true);
            }
            aClass348_Sub42_1652 = null;
