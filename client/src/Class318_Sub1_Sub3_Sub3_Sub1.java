...
final class Class318_Sub1_Sub3_Sub3_Sub1 extends Class318_Sub1_Sub3_Sub3 {
    ...
    final boolean method2391(ha var_ha, int i, int i_9_, int i_10_) {
        ...
        for (int i_12_ = i_10_;
             ((i_12_ ^ 0xffffffff)
                     ...
                     ^ 0xffffffff));
             i_12_++) {
            if (this.aClass64Array10323[i_12_]
                    != null) {
                boolean bool_13_
                        = (this
    ...
    final void method2443(int i, int i_15_, int i_16_) {
        ...
        for (int i_19_ = this.anInt10319;
             i_19_ > 0; i_19_--) {
            this.anIntArray10320[i_19_]
                    = this.anIntArray10320[-1 + i_19_];
            this.anIntArray10317[i_19_]
                    = this.anIntArray10317[-1 + i_19_];
            this.aByteArray10321[i_19_]
                    = this.aByteArray10321[i_19_ + -1];
        }
    ...
    final Class318_Sub4 method2386(int i, ha var_ha) {
        ...
        if (this.aClass79_10505 == null
            ...
            return null;
        Class101 class101 = var_ha.method3705();
        int i_20_ = this.aClass264_10217
                .method2019((byte) -69);
        ...
        if (class357 != null
            ...
            int i_21_
                    = (-class357.aClass318_Sub1_Sub1_4402.aShort8727
                    + this.anInt10274);
            this.anInt10274
                    -= (float) i_21_ / 10.0F;
        } else
        ...
        if (Class316.aClass348_Sub51_3959
                ...
                && class79.aBoolean1369
                && class225.aBoolean2913) {
            Class17 class17
                    = ((this.anInt10286 == -1
                    || this.anInt10218 != 0)
                    ? null
            ...
            Class17 class17_22_
                    ...
                    && class17 != null))
                    ? null
                    : Class10.aClass87_191.method835(this.anInt10268,
                    7));
            Class64 class64
                    = (Class348.method2711
                    (this.anInt10302, i_20_,
                            this.aClass64Array10323[0],
        ...
        if (!Class305.aBoolean3870) {
            ...
            for (int i_24_ = 0;
                 (this.aClass64Array10323.length
                         > i_24_);
                 i_24_++) {
                if (this.aClass64Array10323[i_24_]
                        != null)
                    this.aClass64Array10323
                            [i_24_].method608
                            (class101,
        ...
        for (int i_25_ = 0;
             ((i_25_ ^ 0xffffffff)
                     ...
                     ^ 0xffffffff));
             i_25_++) {
            if (this.aClass64Array10323[i_25_]
                    != null)
                this.aBoolean10324
                        |= this.aClass64Array10323
                        [i_25_].F();
    ...
    final int method2421(byte i) {
        anInt10495++;
        if ((this.aClass79_10505
                .anIntArray1377)
                != null) {
            Class79 class79
                    = this.aClass79_10505
                    .method794(Class318_Sub1_Sub3_Sub3.aClass170_10209, -1);
            if (class79 != null && class79.anInt1366 != -1)
                return class79.anInt1366;
        }
        if (i < 113)
            method2448(null, 88);
        return (this.aClass79_10505
    ...
    final void method2444(int i, boolean bool, int i_26_, int i_27_, int i_28_,
        ...
        if (!bool) {
            int i_30_
                    = i_26_ - this.anIntArray10320[0];
            int i_31_
                    = i + -this.anIntArray10317[0];
            if (i_30_ >= -8 && i_30_ <= 8 && (i_31_ ^ 0xffffffff) <= 7
                    && i_31_ <= 8) {
                if ((this.anInt10319 ^ 0xffffffff)
                        > -10)
                    this.anInt10319++;
                for (int i_32_ = this.anInt10319;
                     i_32_ > 0; i_32_--) {
                    this.anIntArray10320[i_32_]
                            = (this.anIntArray10320
                            [i_32_ - 1]);
                    this.anIntArray10317[i_32_]
                            = (this.anIntArray10317
                            [i_32_ + -1]);
                    this.aByteArray10321[i_32_]
                            = (this.aByteArray10321
                            [i_32_ + -1]);
                }
    ...
    final int method2425(int i) {
        ...
        if ((this.aClass79_10505
            ...
            Class79 class79
                    ...
                    .method794(Class318_Sub1_Sub3_Sub3.aClass170_10209, -1);
            if (class79 != null
                    && (class79.anInt1336 ^ 0xffffffff) != 0)
                return class79.anInt1336;
        }
        if (i != -1)
            this.anInt10499 = -69;
        return (this.aClass79_10505
    ...
    final int method2426(int i) {
        ...
        if ((this.aClass79_10505
            ...
            Class79 class79
                    = this.aClass79_10505
                    .method794(Class318_Sub1_Sub3_Sub3.aClass170_10209, -1);
            if (class79 != null && class79.anInt1390 != -1)
                return class79.anInt1390;
        }
        if ((this.aClass79_10505
                .anInt1390)
                == -1)
    ...
    private final boolean method2447(int i, int i_34_, ha var_ha) {
        ...
        if (i_37_ != 0 || i_38_ != 0
                || (class225.anInt2950 ^ 0xffffffff) != -1
                || (class225.anInt2926 ^ 0xffffffff) != -1)
            i_34_ |= 0x7;
        boolean bool = (this.aByte10279 != 0
        ...
        if (bool)
            i_34_ |= 0x80000;
        int i_39_ = this.aClass264_10217
                .method2019((byte) -25);
        Class64 class64
                = (this.aClass64Array10323[0]
                = (this.aClass79_10505
                .method800
                        (i_39_, this.aClass182Array10308,
                                Class10.aClass87_191, false, class17_36_,
                                this.anInt10203,
                                Class64_Sub3.aClass261_5558,
                                this.anInt10267, class17,
                                Class318_Sub1_Sub3_Sub3.aClass170_10209, var_ha,
                                this.anInt10312,
                                this.anIntArray10296,
                                this.anInt10244,
                                this.anInt10245, i_34_,
                                this.anInt10232)));
        if (class64 == null)
            return false;
        ...
        if (i_37_ != 0 || i_38_ != 0) {
            this.method2424(i_39_, i_37_, class225.anInt2943,
                    i_38_, (byte) 78, class225.anInt2912);
            if (this.anInt10302 != 0)
                this.aClass64Array10323[0]
                        .FA(this.anInt10302);
            if ((this.anInt10208 ^ 0xffffffff)
                    != -1)
                this.aClass64Array10323[0]
                        .VA(this.anInt10208);
            if (this.anInt10252 != 0)
                this.aClass64Array10323[0]
                        .H(0, this.anInt10252, 0);
        } else
        ...
        if (this.anInt10269 == -1
            ...
            Class368 class368
                    = (Class348_Sub40_Sub18.aClass319_9245.method2543
                    ((byte) 56, this.anInt10269));
            boolean bool_40_
                    = ((class368.aByte4488 ^ 0xffffffff) == -4
                    && (i_37_ != 0 || i_38_ != 0));
            int i_41_ = i_35_;
            if (!bool_40_) {
                if ((this.anInt10237 ^ 0xffffffff)
                        != -1)
                    i_41_ |= 0x5;
            ...
            if (class64_42_ != null) {
                if ((this.anInt10278 ^ 0xffffffff)
                    ...
                    if (class225.anIntArrayArray2939 != null
                            ...
                            [this.anInt10278])
                            != null)) {
                        i_45_ += (class225.anIntArrayArray2939
                                [this.anInt10278]
                                [2]);
                        i_43_ += (class225.anIntArrayArray2939
                                [this.anInt10278]
                                [0]);
                        i_44_ += (class225.anIntArrayArray2939
                                [this.anInt10278]
                                [1]);
                    }
                    if (class225.anIntArrayArray2910 != null
                            ...
                            [this.anInt10278])
                            != null)) {
                        i_44_ += (class225.anIntArrayArray2910
                                [this.anInt10278]
                                [1]);
                        i_43_ += (class225.anIntArrayArray2910
                                [this.anInt10278]
                                [0]);
                        i_45_ += (class225.anIntArrayArray2910
                                [this.anInt10278]
                                [2]);
                    }
                ...
                if (bool_40_) {
                    ...
                    if ((this.anInt10252
                            ^ 0xffffffff)
                            != -1)
                        class64_42_.H(0, (this
                                .anInt10252), 0);
                }
            }
        }
        if ((this.anInt10291 ^ 0xffffffff) == 0
                || (this.anInt10224 ^ 0xffffffff) == 0)
            this.aClass64Array10323[2] = null;
        else {
            Class368 class368
                    = (Class348_Sub40_Sub18.aClass319_9245.method2543
                    ((byte) 98, this.anInt10291));
            boolean bool_51_
                    = ((class368.aByte4488 ^ 0xffffffff) == -4
                    && (i_37_ != 0 || i_38_ != 0));
            int i_52_ = i_35_;
            ...
            if (class64_53_ != null) {
                if (this.anInt10289 >= 0
                    ...
                    if (class225.anIntArrayArray2939 != null
                            ...
                            [this.anInt10289])
                            != null)) {
                        i_55_ += (class225.anIntArrayArray2939
                                [this.anInt10289]
                                [1]);
                        i_54_ += (class225.anIntArrayArray2939
                                [this.anInt10289]
                                [0]);
                        i_56_ += (class225.anIntArrayArray2939
                                [this.anInt10289]
                                [2]);
                    }
                    if (class225.anIntArrayArray2910 != null
                            ...
                            [this.anInt10289])
                            != null)) {
                        i_55_ += (class225.anIntArrayArray2910
                                [this.anInt10289]
                                [1]);
                        i_54_ += (class225.anIntArrayArray2910
                                [this.anInt10289]
                                [0]);
                        i_56_ += (class225.anIntArrayArray2910
                                [this.anInt10289]
                                [2]);
                    }
                ...
                } else if (this.anInt10202 != 0)
                    class64_53_
                            .a(2048 * this.anInt10202);
