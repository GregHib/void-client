...
final class Class318_Sub1_Sub3_Sub3_Sub1 extends Class318_Sub1_Sub3_Sub3 {
    ...
    static final void method2441(int i, int i_0_, int i_1_, int i_2_, int i_3_,
        ...
        if (i_2_ != -22728)
            anInt10503 = 121;
        if (i_5_ - i_0_ >= Class369.anInt4960
                && Class113.anInt1745 >= i_0_ + i_5_
                && -i_0_ + i_3_ >= Class132.anInt1910
    ...
    final boolean method2391(ha var_ha, int i, int i_9_, int i_10_) {
        ...
        boolean bool = false;
        for (int i_12_ = i_10_;
             (this.aClass64Array10323.length > i_12_);
             i_12_++) {
    ...
    final Class318_Sub4 method2386(int i, ha var_ha) {
        ...
        for (int i_25_ = 0;
             (this.aClass64Array10323.length > i_25_);
             i_25_++) {
