...
final class Class318_Sub1_Sub3_Sub2 extends Class318_Sub1_Sub3
    ...
    Class318_Sub1_Sub3_Sub2(ha var_ha, Class51 class51, int i, int i_0_,
    ...
    public final void method43(ha var_ha, int i) {
        ...
        if (i != -14218)
            aClass30_10051 = null;
        this.aClass235_10045.method1674(-1,
                var_ha);
    }

    final Class318_Sub4 method2386(int i, ha var_ha) {
        anInt10057++;
        Class64 class64 = this.aClass235_10045
        ...
        Class318_Sub4 class318_sub4
                = OutputStream_Sub2.method136(i, aBoolean10056, false);
        this.aClass235_10045.method1670
                (this.aShort8751, class101,
                        this.aShort8747, var_ha,
                        this.aShort8743, class64, true, (byte) -73,
                        this.aShort8750);
        if (!Class305.aBoolean3870)
    ...
    public final void method44(int i, ha var_ha) {
        if (i != 836)
            method44(-65, null);
        anInt10059++;
        this.aClass235_10045.method1667((byte) 116,
                var_ha);
    }
    ...
    final void method2387(ha var_ha, int i) {
        ...
        if (class64 != null) {
            ...
            this.aClass235_10045.method1670
                    (this.aShort8751, class101,
                            this.aShort8747, var_ha,
                            this.aShort8743, class64, false,
                            (byte) -73, this.aShort8750);
        }
        if (i >= -125)
