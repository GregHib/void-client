 ...
 */ {
    ...
    static final boolean method2015(int i, int i_0_, int i_1_) {
        ...
        return ((InterfaceRenderer.method2217(i_0_, i, i_1_ ^ 0x7) | ParametricDefinition.method3056(115, i, i_0_) | DefinitionSub9.method3073(i_0_, i, (byte) 50)) & DisplayModeManagerContainer254.method1258(i, -9301, i_0_));
    }
    ...
    static final void method2017(int i, DisplayModeManagerContainer167 class17, int i_3_) {
        anInt3367++;
        if (Component335.anInt2021 < 50 && (class17 != null && class17.anIntArrayArray264 != null && (class17.anIntArrayArray264.length > i) && class17.anIntArrayArray264[i] != null)) {
            ...
            if (i_3_ > 8) {
                int i_8_ = 256;
                if (class17.anIntArray236 != null && class17.anIntArray265 != null) i_8_ = Component40.method2257((class17.anIntArray265[i]), (class17.anIntArray236[i]), (byte) -125);
                if (class17.aBoolean268) AudioLine.method2090(i_7_, i_8_, false, (byte) -35, 255, 0, i_5_);
                else NodeSub20.method2947(true, 255, i_5_, i_7_, 0, i_8_);
            }
        }
    }
