...
class AnimatedModelRenderer : AbstractModelRenderer {
    ...
    override fun method962(f: Float, f_12_: Float, f_13_: Float, f_14_: Float, f_15_: Float, f_16_: Float, i: Int, i_17_: Int, i_18_: Int, i_19_: Int) {
        ...
        anInterface18_Impl3_8403!!.method64((if (aBoolean8410 || aBoolean8408 || ((0x1 and i_19_) == 0)) FrameBufferObject.aClass209_4874 else PlayerSequenceSelector.aClass209_1212), -22095)
    ...
    override fun method983(f: Float, f_66_: Float, f_67_: Float, f_68_: Float, f_69_: Float, f_70_: Float, i: Int, var_sprite: Sprite?, i_71_: Int, i_72_: Int) {
        ...
        anInterface18_Impl3_8403!!.method64((if (aBoolean8410 || aBoolean8408 || (0x1 and i) == 0) FrameBufferObject.aClass209_4874 else PlayerSequenceSelector.aClass209_1212), -22095)
        ...
        aHa_Sub3_8407.method3879(-8629)
        aHa_Sub3_8407.method3849(47.toByte(), 0, LoadingBarRenderer.aTrigLookupTables_4247)
    ...
    override fun method982(i: Int, i_94_: Int, i_95_: Int, i_96_: Int, i_97_: Int, i_98_: Int, i_99_: Int, i_100_: Int) {
        ...
        anInterface18_Impl3_8403!!.method64((if (aBoolean8410 || aBoolean8408 || ((i_100_ and 0x1) == 0)) FrameBufferObject.aClass209_4874 else PlayerSequenceSelector.aClass209_1212), -22095)
    ...
    internal constructor(var_ha_Sub3: NativeRenderer, i: Int, i_118_: Int, bool: Boolean) {
        ...
        anInterface18_Impl3_8403 = var_ha_Sub3.method3861(i_118_, ((-84).toByte()).toByte(), i, MovementDirection.aMovementDirection_1183, (if (bool) GroundItemRenderState.aTextureFormatInfo_1662 else TimedRecordAccessorStatics.aTextureFormatInfo_7103))
    ...
    companion object {
        ...
        fun method989(i: Int, i_92_: Int, i_93_: Int): Boolean {
            anInt8401++
            if (LinkedListIteratorStatics.method1241(i_93_, i, i_92_ xor 0x1fe) or ((0x10000 and i) != 0) || OutgoingPacketNode.method3325(i, i_93_, true)) return true
