...
import AnimatedModelRendererStatics.anInt8390
import AnimatedModelRendererStatics.anInt8392
import AnimatedModelRendererStatics.anInt8393
import AnimatedModelRendererStatics.anInt8394
import AnimatedModelRendererStatics.anInt8395
import AnimatedModelRendererStatics.anInt8399
import AnimatedModelRendererStatics.anInt8402
import AnimatedModelRendererStatics.anInt8404
import AnimatedModelRendererStatics.anInt8406
import AnimatedModelRendererStatics.anInt8409
import AnimatedModelRendererStatics.anInt8413
import AnimatedModelRendererStatics.anInt8414
import AnimatedModelRendererStatics.anInt8420
import AnimatedModelRendererStatics.anInt8421
import AnimatedModelRendererStatics.anInt8423
...
class AnimatedModelRenderer : AbstractModelRenderer {
    ...
    override fun method962(f: Float, f_12_: Float, f_13_: Float, f_14_: Float, f_15_: Float, f_16_: Float, i: Int, i_17_: Int, i_18_: Int, i_19_: Int) {
        ...
        anInterface18_Impl3_8403!!.method64((if (aBoolean8410 || aBoolean8408 || ((0x1 and i_19_) == 0)) FrameBufferObjectStatics.aClass209_4874 else PlayerSequenceSelector.aClass209_1212), -22095)
        ...
        aHa_Sub3_8407.method3849(47.toByte(), 1, RenderListTextureNodeStatics.aTrigLookupTables_9485)
        aHa_Sub3_8407.method3885(1, true, RenderListTextureNodeStatics.aTrigLookupTables_9485)
        ...
        aHa_Sub3_8407.method3853(-32, LightDetailOptionStateStatics.aConfigFlagUtil_6030)
        aHa_Sub3_8407.method3915(0)
        aHa_Sub3_8407.method3933(-44)
        aHa_Sub3_8407.method3879(-8629)
        aHa_Sub3_8407.method3849(47.toByte(), 1, SceneObjectEntityStatics.aTrigLookupTables_8737)
        aHa_Sub3_8407.method3885(1, true, SceneObjectEntityStatics.aTrigLookupTables_8737)
    }
    ...
    override fun method965(i: Int, i_35_: Int, i_36_: Int, i_37_: Int, i_38_: Int, i_39_: Int, i_40_: Int) {
        ...
        anInterface18_Impl3_8403!!.method64(FrameBufferObjectStatics.aClass209_4874, -22095)
    ...
    override fun method983(f: Float, f_66_: Float, f_67_: Float, f_68_: Float, f_69_: Float, f_70_: Float, i: Int, var_sprite: Sprite?, i_71_: Int, i_72_: Int) {
        ...
        anInterface18_Impl3_8403!!.method64((if (aBoolean8410 || aBoolean8408 || (0x1 and i) == 0) FrameBufferObjectStatics.aClass209_4874 else PlayerSequenceSelector.aClass209_1212), -22095)
        ...
        aHa_Sub3_8407.method3874(ParticleSystemStateStatics.aRenderConfigFactory_2207, 127, RenderQueueState.aRenderConfigFactory_6519)
        aHa_Sub3_8407.method3849(47.toByte(), 0, SceneObjectEntityStatics.aTrigLookupTables_8737)
        ...
        aHa_Sub3_8407.method3879(-8629)
        aHa_Sub3_8407.method3849(47.toByte(), 0, WidgetRedrawRegionStatics.aTrigLookupTables_4247)
        aHa_Sub3_8407.method3874(ParticleSystemStateStatics.aRenderConfigFactory_2207, 118, ParticleSystemStateStatics.aRenderConfigFactory_2207)
    ...
    override fun method968(i: Int, i_77_: Int, i_78_: Int) {
        ...
        if (i_78_ == 0) {
            ...
            while (anInt8417 > i_80_) {
                ...
                for (i_82_ in 0..<anInt8411) is_79_[i_81_ + i_82_] = (BoundsConstraintEntryStatics.method2057((NpcSummaryDefinitionStatics.method1166(1828651008, `is`!![i_81_ - -i_82_]) shl 8), NpcSummaryDefinitionStatics.method1166(is_79_[i_81_ - -i_82_], 16777215)))
                i_80_++
            }
        } else if (i_78_ == 1) {
            var i_83_ = 0
            while (anInt8417 > i_83_) {
                ...
                while (anInt8411 > i_85_) {
                    is_79_[i_85_ + i_84_] = (BoundsConstraintEntryStatics.method2057(NpcSummaryDefinitionStatics.method1166(is_79_[i_85_ + i_84_], 16777215), (NpcSummaryDefinitionStatics.method1166(`is`!![i_84_ - -i_85_], 743571200) shl 16)))
                    i_85_++
                }
                i_83_++
            }
            ...
            while (anInt8417 > i_89_) {
                ...
                for (i_91_ in 0..<anInt8411) is_79_[i_90_ + i_91_] = (BoundsConstraintEntryStatics.method2057(NpcSummaryDefinitionStatics.method1166(is_79_[i_90_ + i_91_], 16777215), NpcSummaryDefinitionStatics.method1166(-3725444, (`is`!![i_91_ + i_90_] shl 24))))
                i_89_++
            }
        } else if (i_78_ == 3) {
            var i_86_ = 0
            while (anInt8417 > i_86_) {
                ...
                for (i_88_ in 0..<anInt8411) is_79_[i_88_ + i_87_] = (BoundsConstraintEntryStatics.method2057(if (`is`!![i_88_ + i_87_] != 0) -16777216 else 0, NpcSummaryDefinitionStatics.method1166(16777215, is_79_[i_88_ + i_87_])))
                i_86_++
            }
        }
    ...
    override fun method982(i: Int, i_94_: Int, i_95_: Int, i_96_: Int, i_97_: Int, i_98_: Int, i_99_: Int, i_100_: Int) {
        ...
        anInterface18_Impl3_8403!!.method64((if (aBoolean8410 || aBoolean8408 || ((i_100_ and 0x1) == 0)) FrameBufferObjectStatics.aClass209_4874 else PlayerSequenceSelector.aClass209_1212), -22095)
    ...
    override fun method979(i: Int, i_107_: Int, i_108_: Int, i_109_: Int, i_110_: Int, i_111_: Int) {
        ...
        if (`is` != null) {
            for (i_112_ in `is`.indices) `is`[i_112_] = BoundsConstraintEntryStatics.method2057(`is`[i_112_], -16777216)
    ...
    override fun method963(i: Int, i_113_: Int, var_sprite: Sprite?, i_114_: Int, i_115_: Int) {
        ...
        aHa_Sub3_8407.method3874(ParticleSystemStateStatics.aRenderConfigFactory_2207, 110, RenderQueueState.aRenderConfigFactory_6519)
        aHa_Sub3_8407.method3849(47.toByte(), 0, SceneObjectEntityStatics.aTrigLookupTables_8737)
        ...
        aHa_Sub3_8407.method3879(-8629)
        aHa_Sub3_8407.method3849(47.toByte(), 0, WidgetRedrawRegionStatics.aTrigLookupTables_4247)
        aHa_Sub3_8407.method3874(ParticleSystemStateStatics.aRenderConfigFactory_2207, 127, ParticleSystemStateStatics.aRenderConfigFactory_2207)
    ...
    internal constructor(var_ha_Sub3: NativeRenderer, i: Int, i_118_: Int, bool: Boolean) {
        ...
        anInterface18_Impl3_8403 = var_ha_Sub3.method3861(i_118_, ((-84).toByte()).toByte(), i, MovementDirectionStatics.aMovementDirection_1183, (if (bool) GroundItemRenderState.aTextureFormatInfo_1662 else TimedRecordAccessorStatics.aTextureFormatInfo_7103))
    ...
    internal constructor(var_ha_Sub3: NativeRenderer?, i: Int, i_119_: Int, `is`: IntArray?, i_120_: Int, i_121_: Int) {
        ...
        try {
            ...
            throw SoundBankPatchStatics.method2929(runtimeexception, ("jd.<init>(" + (if (var_ha_Sub3 != null) "{...}" else "null") + ',' + i + ',' + i_119_ + ',' + (if (`is` != null) "{...}" else "null") + ',' + i_120_ + ',' + i_121_ + ')'))
        }
    }
}
