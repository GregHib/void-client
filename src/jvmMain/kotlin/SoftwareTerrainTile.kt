...
class SoftwareTerrainTile(private val aHa_Sub1_8217: SoftwareRenderer, i: Int, private val anInt8223: Int, i_486_: Int, i_487_: Int, `is`: Array<IntArray?>, is_488_: Array<IntArray?>, i_489_: Int) : TerrainTile(i_486_, i_487_, i_489_, `is`) {
    ...
    override fun method3978(i: Int, i_60_: Int, `is`: IntArray, is_61_: IntArray, is_62_: IntArray, is_63_: IntArray, is_64_: IntArray, is_65_: IntArray, is_66_: IntArray, is_67_: IntArray, is_68_: IntArray, is_69_: IntArray, is_70_: IntArray, i_71_: Int, i_72_: Int, i_73_: Int, bool: Boolean) {
        ...
        if (!bool_74_) {
            ...
            val i_93_ = is_69_[0]
            if (is_68_ != null) {
                vertexNormal.anInt1600 = SoftwareTerrainTile.method2198(0, (aByteArrayArray8220!![i]!![i_60_] - aByteArrayArray8232!![i]!![i_60_]), SpriteStore.method303(is_68_[0], 30).toInt())
