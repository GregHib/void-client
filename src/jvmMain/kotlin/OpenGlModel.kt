...
class OpenGlModel : AbstractModel {
    ...
    private fun method680(i: Int, i_29_: Int, i_30_: Byte, i_31_: Short, i_32_: Int): Int {
        ...
        anInt5582++
        var i_33_ = (SoundEnvelope.anIntArray179!![ScanlineRasterFiller.method1384(i_32_, i xor 0x54b313bc, i_29_)])
        if (i_31_.toInt() != -1) {
    ...
    private fun method684(bool: Boolean, i: Int, i_108_: Int, i_109_: Int, i_110_: Int, i_111_: Int, abstractCameraTransform: AbstractCameraTransform?): Boolean {
        try {
            ...
            aFloat3943 = ((class101_sub3.aFloat5756 * class101_sub3_112_.aFloat5762) + ((class101_sub3.aFloat5761 * class101_sub3_112_.aFloat5769) + (class101_sub3_112_.aFloat5761 * class101_sub3.aFloat5770)))
            ...
            for (i_134_ in 0..7) {
                ...
                var f_138_ = (CubeMapMaterialPass.aFloat6304 * f_135_ + (f_137_ * NamedTimedNode.aFloat8784 + TextureLoaderUtil.aFloat3994 * f_136_) + f_114_)
                val f_139_ = f_113_ + (aFloat3943 * f_137_ + SmoothingBuffer.aFloat3242 * f_136_ + GameDisplayManager.aFloat2836 * f_135_)
            ...
            if (bool_115_ && i_111_.toFloat() > f_116_ && i_111_.toFloat() < f_117_ && i_109_.toFloat() > f_118_ && i_109_.toFloat() < f_119_) {
                ...
                for (i_144_ in 0..<anInt5557) {
                    ...
                    var f_148_ = f_114_ + (f_146_ * CubeMapMaterialPass.aFloat6304 + (NamedTimedNode.aFloat8784 * f_145_ + f_147_ * TextureLoaderUtil.aFloat3994))
                    ...
                    val f_150_ = f_113_ + (SmoothingBuffer.aFloat3242 * f_147_ + f_145_ * aFloat3943 + f_146_ * GameDisplayManager.aFloat2836)
    ...
    public override fun method624(i: Int, i_195_: Int, i_196_: Int, i_197_: Int) {
        ...
        if (aMapSceneTileDefinitionArray5621 != null) {
            for (i_203_ in 0..<anInt5536) {
                ...
                class48.anInt858 = ((0xffffff and (SoundEnvelope.anIntArray179!![0xffff and (aShortArray5580!![class118.anInt1783]).toInt()])) or (class48.anInt858 and 0xffffff.inv()))
            }
        }
    ...
    public override fun method608(abstractCameraTransform: AbstractCameraTransform?, class318_sub3: SceneOcculder?, i: Int, i_235_: Int) {
        try {
            ...
            if (anInt5529 != 0) {
                ...
                SpriteRenderable.aFloat4720 = ((class101_sub3_236_.aFloat5751 * class101_sub3.aFloat5784) + ((class101_sub3.aFloat5756 * class101_sub3_236_.aFloat5747) + (class101_sub3_236_.aFloat5772 * class101_sub3.aFloat5754)) + class101_sub3.aFloat5751)
                val f = (SpriteRenderable.aFloat4720 + TextureLoaderUtil.aFloat3994 * aShort5591.toFloat())
                val f_237_ = (TextureLoaderUtil.aFloat3994 * aShort5629.toFloat() + SpriteRenderable.aFloat4720)
                val f_238_: Float
                val f_239_: Float
                if (f > f_237_) {
                ...
                if (!(f_239_ >= aHa_Sub2_5598.aFloat7875) && !(aHa_Sub2_5598.anInt7826.toFloat() >= f_238_)) {
                    CubemapTexture2dSource.aFloat8696 = ((class101_sub3.aFloat5781 * class101_sub3_236_.aFloat5754) + ((class101_sub3_236_.aFloat5769 * class101_sub3.aFloat5750) + ((class101_sub3_236_.aFloat5750) * (class101_sub3.aFloat5770))))
                    ModelLightingConfig.aFloat2555 = ((class101_sub3.aFloat5781 * class101_sub3_236_.aFloat5751) + ((class101_sub3_236_.aFloat5772 * class101_sub3.aFloat5750) + (class101_sub3.aFloat5770 * (class101_sub3_236_.aFloat5747))) + class101_sub3.aFloat5747)
                    val f_240_ = (ModelLightingConfig.aFloat2555 + (aShort5591.toFloat() * CubemapTexture2dSource.aFloat8696))
                    val f_241_ = (ModelLightingConfig.aFloat2555 + (aShort5629.toFloat() * CubemapTexture2dSource.aFloat8696))
                    val f_242_: Float
                    val f_243_: Float
                    if (f_240_ > f_241_) {
                    ...
                    if (!(aHa_Sub2_5598.aFloat7835 <= f_243_ / i.toFloat()) && !(f_242_ / i.toFloat() <= aHa_Sub2_5598.aFloat7872)) {
                        ...
                        if (!(f_247_ / i.toFloat() >= aHa_Sub2_5598.aFloat7830) && !(aHa_Sub2_5598.aFloat7836 >= f_246_ / i.toFloat())) {
                            if (class318_sub3 != null || aMapSceneTileDefinitionArray5621 != null) {
                                aFloat3943 = (((class101_sub3_236_.aFloat5770) * (class101_sub3.aFloat5761)) + ((class101_sub3.aFloat5769) * class101_sub3_236_.aFloat5761) + ((class101_sub3_236_.aFloat5756) * (class101_sub3.aFloat5762)))
                            ...
                            if (class318_sub3 != null) {
                                ...
                                val i_255_ = ((i_249_.toFloat() * CubeMapMaterialPass.aFloat6304) + ((TextureLoaderUtil.aFloat3994 * aShort5629.toFloat()) + (((NamedTimedNode.aFloat8784) * i_248_.toFloat()) + SpriteRenderable.aFloat4720))).toInt()
    ...
    public override fun ia(i: Short, i_381_: Short) {
        ...
        if (aMapSceneTileDefinitionArray5621 != null) {
            for (i_383_ in 0..<anInt5536) {
                ...
                class48.anInt858 = ((SoundEnvelope.anIntArray179!![(aShortArray5580!![class118.anInt1783].toInt() and 0xffff)]) and 0xffffff or (0xffffff.inv() and class48.anInt858))
            }
        }
        if (aHoverActionEntry_5610 != null) aHoverActionEntry_5610!!.anByteBufferReader_1811 = null
    }
                ...
                if (anIntArrayArray5553 != null) {
                    ...
                    if (aMapSceneTileDefinitionArray5621 != null) {
                        ...
                        while (anInt5536 > i_466_) {
                            ...
                            class48.anInt858 = (0xffffff and (SoundEnvelope.anIntArray179!![(aShortArray5580!![(class118.anInt1783)]).toInt() and 0xffff]) or (0xffffff.inv() and class48.anInt858))
                            i_466_++
                        }
                    }
                }
        ...
        if (i == 0) {
            ...
            if (aMapSceneTileDefinitionArray5621 != null) {
                for (i_504_ in 0..<anInt5536) {
                    ...
                    class48.anInt858 = (((SoundEnvelope.anIntArray179!![0xffff and (aShortArray5580!![class118.anInt1783]).toInt()]) and 0xffffff) or (class48.anInt858 and 0xffffff.inv()))
                }
            }
        } else if (i == 8) {
                ...
                if (anIntArrayArray5553 != null) {
                    ...
                    if (aMapSceneTileDefinitionArray5621 != null) {
                        ...
                        while (anInt5536 > i_669_) {
                            ...
                            class48.anInt858 = (0xffffff and (SoundEnvelope.anIntArray179!![(aShortArray5580!![(class118.anInt1783)]).toInt() and 0xffff]) or (class48.anInt858 and 0xffffff.inv()))
                            i_669_++
                        }
                    }
                }
            ...
            try {
                ...
                if (modelDefinition.aRectangleBoundsArray1832 != null) {
                    ...
                    while (anInt5536 > i_711_) {
                        ...
                        var i_714_ = ((SoundEnvelope.anIntArray179!![0xffff and (modelDefinition.aShortArray1862[class162.anInt2155]).toInt()]) and 0xffffff)
