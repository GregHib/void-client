...
class HudTabPanel internal constructor(string: String?, @JvmField var anInt2995: Int) {
    ...
    companion object {
        ...
        fun method1642(i: Byte, var_renderer: Renderer?) {
            ...
            if (i > 98) {
                NodeDequeStatics.aFont_3326!!.method2576(LocalizedText.aLocalizedText_3507!!.method2063(ChatCommandProcessor.anInt6967, 544), i_5_, i_4_ + (ProceduralTextureGraph.anInt9532 - -14), i_3_ + (GlArrayBufferObject.anInt4717 + 3), -1, -125)
