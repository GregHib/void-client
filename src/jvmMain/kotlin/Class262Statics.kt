...
/**
 * JVM-only statics split out of [Class262]'s companion so the bare [Class262]
 * linked-list implementation could move to commonMain.
 *
 * [method1991], [method1992], [method1994], [method2000] all depend on JVM game globals
 * (ha_Sub2, Canvas, Class190, Class318_Sub1, Class45, Class324). They stay on JVM.
 * [aClass190ArrayArray3335] and [aClass324_3326] are side-channels touched by
 * commonMain instance methods — kept here and accessed via qualified name.
 */
object Class262Statics {
