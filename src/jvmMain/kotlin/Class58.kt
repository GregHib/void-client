...
class Class58 {
    ...
    companion object {
        ...
        fun method535(i: Int, i_7_: Int, i_8_: Int, i_9_: Int, i_10_: Int, i_11_: Int, i_12_: Byte) {
            ...
            var i_19_ = i_13_
            while (i_17_ > i_19_) {
                Class135_Sub2Statics.method1156(-27, i_16_, Class17.anIntArrayArray255!![i_19_]!!, i_15_, i_10_)
                i_19_++
            }
            var i_20_ = i_14_
            while (i_18_ < i_20_) {
                Class135_Sub2Statics.method1156(-27, i_16_, Class17.anIntArrayArray255!![i_20_]!!, i_15_, i_10_)
                i_20_--
            }
            ...
            for (i_23_ in i_17_..i_18_) {
                ...
                Class135_Sub2Statics.method1156(-27, i_21_, `is`, i_15_, i_10_)
                Class135_Sub2Statics.method1156(-27, i_16_, `is`, i_22_, i_10_)
            }
        }
