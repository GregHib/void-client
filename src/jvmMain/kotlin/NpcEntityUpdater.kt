...
object NpcEntityUpdater {
    ...
    fun method2109(i: Int) {
        anInt3653++
        var class348_sub42_sub18 = (SpriteTextureNodeStatics.aNodeDeque_9240!!.method1995(4) as ParticleEmitterListNode?)
        ...
        while ( /**/class348_sub42_sub18 != null) {
            ...
            if (GlGroundShaderPassStatics.anInt7396 > class318_sub1_sub3_sub5.anInt10392) {
                class348_sub42_sub18.method2715(101.toByte())
                class318_sub1_sub3_sub5.method2472(-2159)
            } else if ((class318_sub1_sub3_sub5.anInt10411) <= GlGroundShaderPassStatics.anInt7396) {
                ...
                if ((class318_sub1_sub3_sub5.anInt10412) > 0) {
                    ...
                    if (class348_sub22 != null) {
                        ...
                        if ((npc.x) >= 0 && (GlCubemapLightPassStatics.anInt7319 * 512 > npc.x) && (npc.y) >= 0 && (512 * RangeThresholdTextureNodeStatics.anInt9109 > npc.y)) class318_sub1_sub3_sub5.method2471((-103).toByte(), ((method2064(npc.x, (class318_sub1_sub3_sub5.plane).toInt(), 11219, npc.y)) + -class318_sub1_sub3_sub5.anInt10366), npc.y, GlGroundShaderPassStatics.anInt7396, npc.x)
                    }
                }
                if ((class318_sub1_sub3_sub5.anInt10412) < 0) {
                    ...
                    else player = (LoadingBarRendererStatics.aPlayerArray5058!![i_0_])
                    if (player != null && (player.x) >= 0 && ((player.x) < 512 * GlCubemapLightPassStatics.anInt7319) && (player.y) >= 0 && (player.y) < 512 * RangeThresholdTextureNodeStatics.anInt9109) class318_sub1_sub3_sub5.method2471((-103).toByte(), ((method2064((player.x), (class318_sub1_sub3_sub5.plane).toInt(), 11219, (player.y))) - class318_sub1_sub3_sub5.anInt10366), (player.y), GlGroundShaderPassStatics.anInt7396, (player.x))
                }
                class318_sub1_sub3_sub5.method2475(75.toByte(), DisplaySettingsConfigStatics.anInt7267)
                method850(class318_sub1_sub3_sub5, true)
            }
            class348_sub42_sub18 = SpriteTextureNodeStatics.aNodeDeque_9240!!.method1990(56.toByte()) as ParticleEmitterListNode?
        }
    }
