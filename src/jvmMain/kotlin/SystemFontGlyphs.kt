...
import SystemFontGlyphsStatics.anInt4038
import SystemFontGlyphsStatics.anIntArray4043
...
class SystemFontGlyphs internal constructor(var_renderer: Renderer, i: Int, bool: Boolean, component: Component) {
    ...
    private fun method2559(var_renderer: Renderer, font: Font?, fontmetrics: FontMetrics, c: Char, i: Int, bool: Boolean) {
        ...
        val image = ParticleSystemRendererStatics.aCanvas3869!!.createImage(i_0_, i_3_)
