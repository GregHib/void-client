...
class GlArrayBufferObject : GlVertexBufferBase, ByteBufferReader {
    ...
    companion object {
        ...
        fun method1153(var_renderer: Renderer, i: Int) {
            ...
            val i_11_ = i_4_ + RectangleRegion.aInputTracker_8552!!.method3597(true)
            if (i != 16) method1154(9.toByte())
            val i_12_ = i_5_ + RectangleRegion.aInputTracker_8552!!.method3594(95.toByte())
            if (ChatScriptListNode.aBoolean9535) {
                ...
                while (class348_sub42_sub12 != null) {
                    ...
                    if (i_11_ > anInt4717 - -i_4_ && anInt4717 + i_4_ - -SceneTileBounds.anInt1117 > i_11_ && i_12_ > i_14_ - 13 && 4 + i_14_ > i_12_ && (class348_sub42_sub12.aBoolean9610)) var_renderer.aa(i_4_ + anInt4717, -12 + i_14_, SceneTileBounds.anInt1117, 16, (255 + -ShortMatrixNodeStatics.anInt9511 shl 24) or CompassSmootherStatics.anInt3374, 1)
                    i_13_++
            ...
            if (ChatScriptListNode.aBoolean9535) {
                ...
                while (class348_sub42_sub13 != null) {
                    ...
                    i_20_++
                    if (class348_sub42_sub13.anInt9615 == 1) SceneModelBuilderStatics.method2494(ProceduralTextureGraph.anInt9532 - -i_5_, 0xffffff.inv() or SolidFillComponent.anInt8363, i_21_, var_renderer, (class348_sub42_sub13.aLinkedNodeListIterator_9621.aClass348_Sub42_1647.aClass348_Sub42_7063 as ContactEntry?), SceneTileBounds.anInt1117, i_12_, CharCodeMap.anInt9586 or 0xffffff.inv(), 125.toByte(), WorldMapSceneSoftware.anInt5819, anInt4717 - -i_4_, i_11_)
