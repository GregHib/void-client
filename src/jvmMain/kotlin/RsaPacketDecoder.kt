...
class RsaPacketDecoder internal constructor(mediaStreamClient: MediaStreamClient?, scriptCompilerThread: ScriptCompilerThread?, biginteger: BigInt?, biginteger_14_: BigInt?) {
    ...
    companion object {
        ...
        var anInt4221: Int = 0
        var anInt4222: Int = 0
        var aOutgoingPacketHeader_4223: OutgoingPacketHeader? = OutgoingPacketHeader(4, 0)
        var anInt4224: Int = 0
        var aOutgoingPacketHeader_4225: OutgoingPacketHeader? = OutgoingPacketHeader(43, -1)

        @JvmStatic
        fun method2671(i: Int) {
            aOutgoingPacketHeader_4225 = null
            aOutgoingPacketHeader_4223 = null
