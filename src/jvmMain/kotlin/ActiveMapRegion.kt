...
object ActiveMapRegion : MapRegionLoader() {
    ...
    fun method769(i: Int, i_0_: Byte) {
        anInt5653++
        if (i_0_ > 109 && TextureLoaderUtil.method2547(i, 84.toByte())) ShortMatrixNodeStatics.method3180(-1, (WarpTextureNodeStatics.aWidgetComponentArrayArray9427!![i]!!), 24235)
    }
        ...
        if (class357 != null) {
            ...
            if (class318_sub1_sub1.method2376(-93)) {
                if (class318_sub1_sub1.method2377(122.toByte())) {
                    class318_sub1_sub1.aClass318_Sub1_6379 = BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_3_]
                    BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_3_] = class318_sub1_sub1
                } else {
