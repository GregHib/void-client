...
class Class348_Sub18 internal constructor(private val anInt6815: Int, private val anInt6820: Int, private var anInt6811: Int, private val anInt6806: Int, private var anInt6810: Int, var anInt6809: Int, var anInt6812: Int, var anInt6819: Int, var anInt6813: Int) : Class348() {
    ...
    companion object {
        ...
        fun method2938(i: Byte) {
            ...
            Class348_Sub1Statics.aClass185_6559!!.method1393((-13).toByte())
            ...
            if (i > 53) {
                ...
                Class367Sub10Statics.aClass45_7382!!.method412((-110).toByte())
                Class59_Sub2_Sub1.aClass45_8667!!.method412(64.toByte())
                aa_Sub3Statics.aClass45_5207!!.method412(120.toByte())
                ...
                Class216Statics.aClass45_4975!!.method412(28.toByte())
                ...
                Class348_Sub11Statics.aClass45_4770!!.method412(78.toByte())
                Class239.aClass45_3146!!.method412(88.toByte())
                Class367_Sub8.aClass45_7362!!.method412((-109).toByte())
                Class262Statics.aClass45_3323!!.method412(112.toByte())
