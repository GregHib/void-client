...
/**
 * JVM-only statics split out of [Class341].
 *
 * Holds the members that couple to JVM-only collaborator types so that the bare
 * [Class341] (a ctor-param type stored in the Class369 hierarchy) can live in
 * commonMain:
 *  - JVM-typed companion handles: [aClass348_Sub24_4226], [aClass124Array4236].
 *  - [method2679], whose body compares the receiver against JVM-only singleton
 *    handles ([Class348_Sub42_Sub8_Sub2], [Class186_Sub1], [Class237_Sub1],
 *    [Class27]) to compute a layout-anchor offset; takes the [Class341] instance
 *    as its first parameter.
 *  - [method2681] (teardown of the [ha]/[Npc]/[Player]/[Class294] graph) and the
 *    other statics ([method2676]/[method2677]/[method2678]/[method2680]) that
 *    reach into JVM-coupled state.
 *
 * The neutral primitive counters, [Class341.anIntArrayArray4233] and
 * [Class341.aClass105Array4234] stay on the commonMain [Class341] companion.
 */
object Class341Statics {
    ...
    fun method2679(class341: Class341, i: Int, i_7_: Int, i_8_: Int): Int {
        ...
        if (Class186_Sub1.aClass341_5808 == class341) return 0
        if (class341 == Class237_Sub1.aClass341_5821) return i_9_ - i_7_
        if (Class27.aClass341_399 == class341) return (i_9_ - i_7_) / 2
        return 0
    }
