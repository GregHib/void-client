...
class FontDefinition internal constructor(`is`: ByteArray?) {
        ...
        try {
            ...
            while (i_4_ > i_6_) {
                ...
                if (c.code == 60) i_1_ = i_6_
                    ...
                    if (i_1_ == -1) {
                        i_3_ += 0xff and (aByteArray1986[Js5Archive.method3464(c, false).toInt() and 0xff]).toInt()
        ...
        try {
            ...
            for (i_19_ in 0..<i_18_) {
                ...
                if (c.code == 60) i = i_19_
                    ...
                    if (i == -1) {
                        i_17_ += 0xff and (aByteArray1986[Js5Archive.method3464(c, false).toInt() and 0xff]).toInt()
    ...
    fun method1188(string: String?, `is`: IntArray?, strings: Array<String?>?, i: Byte, abstractModelRenderers: Array<AbstractModelRenderer?>?): Int {
        try {
            ...
            var i_35_ = 0
            while (i_34_ > i_35_) {
                var i_36_ = Js5Archive.method3464(string.get(i_35_), false).toInt() and 0xff
                var i_37_ = 0
