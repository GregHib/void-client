...
class ShadowProjector internal constructor(private val aHa_Sub1_1666: SoftwareRenderer, private val aParticleSystemState_1670: ParticleSystemState) {
        ...
        if (i_63_ < i_64_) {
            ...
            if (aParticleSystemState_1670.aBoolean2202) {
                do {
                    if (this.aBoolean1669) {
                        ...
                        if (this.anInt1674 == 0) {
                            if (i_62_ > 0) {
                                do {
                                    i_61_ = Crc64HashableStatics.anIntArray4983!![f.toInt()]
                                    f += f_65_
                                    if (f_66_ < fs[++i]) {
                                        `is`[i] = i_61_
                                        fs[i] = f_66_
                    ...
                    if (this.anInt1674 == 0) {
                        do {
                            if (f_66_ < fs[++i]) {
                                `is`[i] = Crc64HashableStatics.anIntArray4983!![f.toInt()]
                                fs[i] = f_66_
                            }
                            f_66_ += f_67_
                            f += f_65_
                ...
                do {
                    ...
                    if (this.anInt1674 == 0) {
                        do {
                            if (f_66_ < fs[++i]) `is`[i] = Crc64HashableStatics.anIntArray4983!![f.toInt()]
                            f_66_ += f_67_
                            f += f_65_
                        } while (--i_62_ > 0)
                        break
    ...
    fun method1022(f: Float, f_314_: Float, f_315_: Float, f_316_: Float, f_317_: Float, f_318_: Float, f_319_: Float, f_320_: Float, f_321_: Float, f_322_: Float, f_323_: Float, f_324_: Float) {
        ...
        var f_324_ = f_324_
        if (aBoolean1675) {
            aHa_Sub1_1666.method3645(f.toInt(), f_316_.toInt(), f_317_.toInt(), -8003, Crc64HashableStatics.anIntArray4983!![f_322_.toInt()], f_314_.toInt())
            aHa_Sub1_1666.method3645(f_314_.toInt(), f_317_.toInt(), f_318_.toInt(), -8003, Crc64HashableStatics.anIntArray4983!![f_322_.toInt()], f_315_.toInt())
            aHa_Sub1_1666.method3645(f_315_.toInt(), f_318_.toInt(), f_316_.toInt(), -8003, Crc64HashableStatics.anIntArray4983!![f_322_.toInt()], f.toInt())
        } else {
