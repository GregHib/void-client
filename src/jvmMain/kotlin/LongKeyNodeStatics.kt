    ...
    var anInt6760: Int = 0
            ...
            fun method2804(i: Byte): Boolean {
                ...
                try {
                    ...
                    val `is` = gzipDecompressor.method1214(9, InterfaceComponentGroupStatics.aByteArray9622!!)
                    val i_0_ = 19 % ((19 - i) / 43)
                    method1969(`is`, -5901)
                    return true
            ...
            fun method2807(i: Int, i_2_: Int, i_3_: Byte, i_4_: Int): OutgoingPacketNode? {
                ...
                if (i_4_ == 0) {
                    class348_sub47 = method2148(TextureGeneratorStatics.aFontMetaRef_2495, TheoraVideoStreamStatics.aIsaacCipher_9029, -100)
                    StringValueNodeStatics.anInt7112++
                }
                if (i_4_ == 1) {
                    class348_sub47 = method2148(HeightMapNoise.aFontMetaRef_3825, TheoraVideoStreamStatics.aIsaacCipher_9029, -93)
                    ClickFeedbackTaskStatics.anInt4665++
                }
                ...
                class348_sub47.aClass348_Sub49_Sub2_7116!!.writeShortAdd(-124, ArbVertexProgramStatics.regionTileX + i_2_)
                MediaStreamClientStatics.anInt3203 = i_2_
                if (i_3_ >= -88) aFontMetaRef_6764 = null
                TerrainChunkBuilderStatics.anInt1548 = i
            ...
            fun method2808(i: Int, var_renderer: Renderer?, bool: Boolean): Boolean {
                try {
                    anInt6763++
                    val i_5_ = (-104 + GlCubemapLightPassStatics.anInt7319) / 2
                    val i_6_ = (RangeThresholdTextureNodeStatics.anInt9109 - 104) / 2
                    var bool_7_ = bool
                    ...
                    TextureCacheStatics.method3466(-86)
                    ClampTextureNodeStatics.anInt9479 = 0
                    ModelWallEntityStatics.aNodeDeque_10125!!.method1996(116)
                    if (!PlayerAppearanceUpdateDecoder.aBoolean4542) {
                        var i_37_ = i_5_
                                ...
                                while (i_39_ <= 1 + i && i_39_ <= 3) {
                                    if (method536(i_38_, !bool, i_37_, i, i_39_)) {
                                        ...
                                        if (renderTarget != null) {
                                            val class51 = (GradientLookupEffectStatics.aSeqDefinitionCache_9195!!.method2005(0, renderTarget.method42(-99)))
                                            if (!class51.aBoolean942 || ModelBatchBaseStatics.aBoolean1900) {
                                                ...
                                                if (class51.anIntArray945 != null) {
                                                    ...
                                                    while (((class51.anIntArray945!!).size > i_41_)) {
                                                        if ((class51.anIntArray945!![i_41_]) != -1) {
                                                            val class51_42_ = (GradientLookupEffectStatics.aSeqDefinitionCache_9195!!.method2005(0, (class51.anIntArray945!![i_41_])))
                                                ...
                                                if (i_40_ >= 0) {
                                                    var bool_43_ = false
                                                    if (i_40_ >= 0) {
                                                        val class42 = (TheoraVideoStreamStatics.aConfigDefinitionLoader_9031!!.method1225(i_40_, 126.toByte()))
                                                    ...
                                                    SeqDefinitionCacheStatics.anIntArray3347!![(ClampTextureNodeStatics.anInt9479)] = class51.anInt941
                                                    MenuActionNodeStatics.anIntArray6770!![(ClampTextureNodeStatics.anInt9479)] = i_44_
                                                    BoxBlurTextureNodeStatics.anIntArray9458!![(ClampTextureNodeStatics.anInt9479)] = i_45_
                                                    ClampTextureNodeStatics.anInt9479++
                                                }
                                            }
                                        }
                                    }
                        ...
                        if (OpenGlRenderNodeStatics.aSmoothingBuffer_10488 != null) {
                            ...
                            TheoraVideoStreamStatics.aConfigDefinitionLoader_9031!!.method1220(116.toByte(), 64, 1024)
                            for (i_51_ in 0..<OpenGlRenderNodeStatics.aSmoothingBuffer_10488!!.anInt3241) {
                                val i_52_ = (OpenGlRenderNodeStatics.aSmoothingBuffer_10488!!.anIntArray3238!![i_51_])
                                if ((LocalPlayerState.aPlayer_1907!!.plane).toInt() == i_52_ shr 28) {
                                    val i_53_ = ((i_52_ shr 14 and 0x3fff) - ArbVertexProgramStatics.regionTileX)
                                    val i_54_ = (i_52_ and 0x3fff) + -RegionMapDecoder.regionTileY
                                    if (i_53_ >= 0 && i_53_ < GlCubemapLightPassStatics.anInt7319 && i_54_ >= 0 && (RangeThresholdTextureNodeStatics.anInt9109 > i_54_)) ModelWallEntityStatics.aNodeDeque_10125!!.method1999(IntKeyNode(i_51_), -20180)
                                    else {
                                        val class42 = (TheoraVideoStreamStatics.aConfigDefinitionLoader_9031!!.method1225((OpenGlRenderNodeStatics.aSmoothingBuffer_10488!!.anIntArray3239!![i_51_]), 120.toByte()))
                                        if (class42!!.anIntArray591 != null && (i_53_ + class42.anInt595 >= 0) && (GlCubemapLightPassStatics.anInt7319 > class42.anInt603 + i_53_) && i_54_ + class42.anInt570 >= 0 && (RangeThresholdTextureNodeStatics.anInt9109 > (i_54_ - -class42.anInt607))) ModelWallEntityStatics.aNodeDeque_10125!!.method1999(IntKeyNode(i_51_), -20180)
                                    }
                                }
                            }
                            TheoraVideoStreamStatics.aConfigDefinitionLoader_9031!!.method1220(13.toByte(), 64, 128)
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("ij.E(" + i + ',' + (if (var_renderer != null) "{...}" else "null") + ',' + bool + ')'))
                }
            }
}
