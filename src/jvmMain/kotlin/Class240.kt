...
class Class240 internal constructor(class339: Class339?, class125: Class125?) : Interface1 {
    ...
    override fun method9(i: Byte, bool: Boolean) {
        ...
        if (class295 != null) {
            ...
            i_8_ = ++i_8_ + method1855(5, class295.aString3754, true, Class262Statics.aClass324_3326, i_7_, i_8_) * 12
            i_8_ += 5
            i_8_ += method1855(5, class295.aString3758, true, Class262Statics.aClass324_3326, i_7_, i_8_) * 12
        }
