...
class CellNoiseTextureNode : AbstractProceduralTextureNode(0, true) {
    ...
    companion object {
        ...
        var aOutgoingPacketHeader_9304: OutgoingPacketHeader? = OutgoingPacketHeader(20, -1)
        @JvmStatic
        fun method3110(i: Int) {
            aOutgoingPacketHeader_9304 = null
            aTextureFormatInfo_9303 = null
            if (i != -1633784916) aTextureFormatInfo_9303 = null
            InboundPacketHeader.aInboundPacketHeader_9285 = null
        }
        ...
        fun method3111(i: Int, i_23_: Int) {
            ...
            if (i_23_ != MenuActionNode.anInt6769) {
                ...
                RangeThresholdTextureNode.Companion.anInt9109 = FileExistsConditionStatics.anIntArray4780!![i_23_]
                ...
                for (i_24_ in 0..3) TimedRecordAccessorStatics.aCollisionMapArray7108s!![i_24_] = AnimatedModelRenderer.method988(RangeThresholdTextureNode.Companion.anInt9109, 1, GlCubemapLightPass.anInt7319)
