...
object CollisionFlagQueryStatics {
    @JvmField
            var anInt1191: Int = 0
            @JvmField
            var anInt1192: Int = 0
            ...
            fun method721(class348_sub42: HashLinkedListNode?, class348_sub42_1_: HashLinkedListNode?, i: Int) {
                do {
                    try {
                        ...
                        throw SoundBankPatchStatics.method2929(runtimeexception, ("kea.B(" + (if (class348_sub42 != null) "{...}" else "null") + ',' + (if (class348_sub42_1_ != null) "{...}" else "null") + ',' + i + ')'))
                    }
                    break
                } while (false)
            }
