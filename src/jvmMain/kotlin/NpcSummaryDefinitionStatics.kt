object NpcSummaryDefinitionStatics {
    ...
    fun method1165(i: Int) {
        CircleRasterizerObject.aClass348_Sub49_Sub2_3813!!.startBitAccess(i xor 0x79.inv())
        anInt1950++
        val i_0_ = CircleRasterizerObject.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 8)
        if (i == 1) {
            ...
            for (i_2_ in 0..<i_0_) {
                ...
                val i_4_ = CircleRasterizerObject.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 1)
                if (i_4_ == 0) {
                    Client.anIntArray1233!![ModelDefinitionLoader.anInt2057++] = i_3_
                    npc.anInt10306 = NullOggStream.anInt9041
                } else {
                    val i_5_ = CircleRasterizerObject.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 2)
                    if (i_5_ == 0) {
                        Client.anIntArray1233!![ModelDefinitionLoader.anInt2057++] = i_3_
                        npc.anInt10306 = NullOggStream.anInt9041
                        ...
                        Client.anIntArray1233!![ModelDefinitionLoader.anInt2057++] = i_3_
                        npc.anInt10306 = NullOggStream.anInt9041
                        val i_6_ = CircleRasterizerObject.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 3)
                        npc.method2443(i_6_, 1, -10)
                        val i_7_ = CircleRasterizerObject.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 1)
                        if (i_7_ == 1) MinimapRectClipper.anIntArray224!![AbstractCameraTransformStatics.anInt1597++] = i_3_
                    } else if (i_5_ == 2) {
                        Client.anIntArray1233!![ModelDefinitionLoader.anInt2057++] = i_3_
                        npc.anInt10306 = NullOggStream.anInt9041
                        if (CircleRasterizerObject.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 1) == 1) {
                            val i_9_ = CircleRasterizerObject.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 3)
                            npc.method2443(i_9_, 2, -10)
                            val i_10_ = CircleRasterizerObject.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 3)
                            npc.method2443(i_10_, 2, -10)
                        } else {
                            val i_8_ = CircleRasterizerObject.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 3)
