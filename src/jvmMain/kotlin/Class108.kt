...
object Class108 {
    ...
    fun method1012(f: Float, f_0_: Float, f_1_: Float, f_2_: Float, i: Int, f_3_: Float, i_4_: Byte, f_5_: Float): Float {
        ...
        while (f_6_ < 1.1f) {
            ...
            if (i_16_ > 0 && i_17_ > 0 && Class367Sub4Statics.anInt7319 > i_16_ && (i_17_ < Class348_Sub40_Sub3.anInt9109)) {
    ...
    fun method1015(i: Int, i_20_: Int, bool: Boolean) {
        anInt1658++
        val class190 = Class262Statics.aClass190ArrayArray3335!![i]!![i_20_]
        if (class190 != null) {
