...
class AwtKeyboardListener internal constructor(component: Component?) : KeyboardInputSource(), KeyListener, FocusListener {
    ...
    companion object {
        ...
        fun method2703(i: Int, i_6_: Int, i_7_: Int, i_8_: Byte) {
            ...
            if (i_8_.toInt() == -13) ServerConnectionInfo.method1260(false, i, (if (class190 == null) LocalizedTextStatics.aModelLightingConfig_3547 else class190))
        }

        @JvmStatic
        fun method2705(i: Int) {
            InboundPacketHeader.aInboundPacketHeader_6528 = null
