    ...
    companion object {
        ...
        fun method1797(i: Int, i_11_: Int, widgetComponent: WidgetComponent, i_12_: Byte) {
            if (RenderNodeStatics.aBoolean9722) {
                ...
                if (Client.method105(widgetComponent)!!.method3303(1) && (WidgetTextConfigStatics.anInt500 and 0x20) != 0 && (class254 == null || (widgetComponent.method428(class254.anInt3256, ParticleEmitterFactoryStatics.anInt3176, -128) != class254.anInt3256))) {
