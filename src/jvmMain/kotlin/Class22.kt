            ...
            if (Class5_Sub1_Sub1.aClass262_9931!!.method1998(i) != 0) {
                if (Class316.aClass348_Sub51_3959!!.aClass239_Sub25_7271!!.method1829(-32350) == 0) {
                    ...
                    while (class348_sub7 != null) {
                        Exception_Sub1Statics.aClass255_112!!.method1932(var_ha, class348_sub7.anInt6647, class348_sub7.anInt6648, Class240.aClass324_4684, (if (!class348_sub7.aBoolean6650) null else (Class132.aPlayer_1907!!.aClass154_10536)), class348_sub7.anInt6642, false, 83.toByte(), var_ha, class348_sub7.anInt6649, false, class348_sub7.anInt6645)
                    ...
                    if (Class348_Sub34.aHa6968 == null) {
                        // Use the existing display target from the main canvas instead of
                        // constructing a bare Canvas; the secondary renderer only needs the
                        // AWT graphics context, which the main canvas provides.
                        val target = Class305.aDisplayTarget3869 ?: AwtDisplayTarget(Class305Statics.aCanvas3869!!)
                        Class348_Sub34.aHa6968 = Class104.method958(true, 0, Class348_Sub40_Sub4.aD9113, 0, target, 36, 32, Class136.aClass45_4796)
