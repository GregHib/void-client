        ...
        try {
            ...
            if (i == 65536) {
                for (i_14_ in 0..<i_13_) {
                    val is_15_ = `is`!![i_14_]
                    if (is_15_ != null) {
                        val i_16_ = (64 * (Class348_Sub23_Sub3Statics.anIntArray9042!![i_14_] shr 8) + -za_Sub2Statics.regionTileX)
                        val i_17_ = ((Class348_Sub23_Sub3Statics.anIntArray9042!![i_14_] and 0xff) * 64 - Class90.regionTileY)
                        method3570(false)
