import Gl3dTextureStatics.method249
    ...
    var anInt3958: Int = 0
            ...
            fun method2363(i: Int) {
                if (i <= -39) {
                    ...
                    if (method2066(106.toByte())) {
                        if (ArbFogMaterialPassStatics.aStringArray6200 == null) method249(2)
                        HeapDiagnosticsHolder.anInt2254 = 0
                        FontMetaRefStatics.aBoolean4328 = true
                    }
                }
            }
                ...
                if (i_7_ == 3) {
                    if (i_3_ != i_1_ || i_2_ != i_6_ || i_5_ != i_0_ || i_8_ != i_4_) {
                        ...
                        while (i_23_ <= 4096) {
                            ...
                            MapRegionLoaderThreadStatics.method2665(i_9_, 109.toByte(), i, i_10_, i_33_, i_32_)
                            i_9_ = i_32_
                            i_10_ = i_33_
                            i_23_ += 128
                        }
                    } else MapRegionLoaderThreadStatics.method2665(i_1_, 73.toByte(), i, i_6_, i_8_, i_5_)
                    anInt3964++
                }
            }
            ...
            fun method2367(i: Byte, class348_sub42_sub12: ContactEntry): String? {
                ...
                if (class348_sub42_sub12.aString9595 == null || class348_sub42_sub12.aString9595!!.length == 0) {
                    ...
                    return (class348_sub42_sub12.aString9593 + LocalizedTextStatics.aLocalizedText_3515!!.method2063(AnimationFrameDefinitionStatics.anInt6967, 544) + (class348_sub42_sub12.aString9601))
                }
                if (class348_sub42_sub12.aString9601 == null || class348_sub42_sub12.aString9601!!.length <= 0) return (class348_sub42_sub12.aString9593 + LocalizedTextStatics.aLocalizedText_3515!!.method2063(AnimationFrameDefinitionStatics.anInt6967, 544) + (class348_sub42_sub12.aString9595))
                return (class348_sub42_sub12.aString9593 + LocalizedTextStatics.aLocalizedText_3515!!.method2063(AnimationFrameDefinitionStatics.anInt6967, 544) + class348_sub42_sub12.aString9601 + LocalizedTextStatics.aLocalizedText_3515!!.method2063(AnimationFrameDefinitionStatics.anInt6967, 544) + class348_sub42_sub12.aString9595)
            }
