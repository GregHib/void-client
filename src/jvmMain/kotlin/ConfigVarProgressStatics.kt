...
object ConfigVarProgressStatics {
    var anIntArray4806: IntArray?
            ...
            fun method2307(i: Int, l: Long, i_0_: Int, i_1_: Int) {
                try {
                    anInt4823++
                    if (i_1_ <= 3) method2308((-121).toByte(), 59)
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("cf.B(" + i + ',' + l + ',' + i_0_ + ',' + i_1_ + ')'))
                }
            }
            ...
            fun method2311(i: Byte, i_12_: Int) {
                anInt4820++
                val class348_sub42_sub15 = NamedTimedNodeStatics.method2516(i_12_, 105.toByte(), 16)
            ...
            fun method2312(i: Int, i_14_: Int, nodeDeque: NodeDeque?, i_15_: Int, var_renderer: Renderer?) {
                do {
                    try {
                        ...
                        if (!TerrainTileShapeStatics.aBoolean8805) {
                            ...
                            while (class348_sub21 != null) {
                                ...
                                if (method589(class42, -4)) {
                                    val bool = ModelLightingConfigStatics.method1425((-31).toByte(), class42, class348_sub21, i_14_, var_renderer, i_15_)
                                    if (bool) NoiseTextureGeneratorStatics.method549((-43).toByte(), class348_sub21, var_renderer!!, class42)
                                }
                        ...
                        throw SoundBankPatchStatics.method2929(runtimeexception, ("cf.G(" + i + ',' + i_14_ + ',' + (if (nodeDeque != null) "{...}" else "null") + ',' + i_15_ + ',' + (if (var_renderer != null) "{...}" else "null") + ')'))
                    }
                    break
                } while (false)
            }
