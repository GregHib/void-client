...
object SocketGameConnectionStatics {
    @JvmField
            var anInt5828: Int = 0
            @JvmField
            var anInt5829: Int = 0
            ...
            fun method1707(i: Int) {
                ImageFrameCacheStatics.aCacheLruCache_4036!!.method2303(true)
                anInt5829++
            }
                ...
                if (class348_sub9.anInt6685 != -1 || class348_sub9.anIntArray6697 != null) {
                    ...
                    if (class348_sub9.anInt6694 == 0 || (-256 + i_7_ > class348_sub9.anInt6694) || IntHashSetStatics.aClass348_Sub51_3959!!.aClass239_Sub26_7234!!.method1838(-32350) == 0 || class348_sub9.anInt6693 != i_4_) {
                        ...
                        if (i_6_.toInt() == -78) {
                            ...
                            if (i_11_ != 0 || i_12_ != 0) {
                                var i_13_ = ((-WorldMapElementStatics.anInt4638 + -(atan2(i_11_.toDouble(), i_12_.toDouble()) * 2607.5945876176133).toInt() + -4096) and 0x3fff)
                            ...
                            if ((class348_sub9.aClass348_Sub16_Sub5_6676) != null) {
                                ...
                                val i_15_ = (if (class348_sub9.anInt6681 == 256 && (class348_sub9.anInt6696 == 256)) 256 else (Texture2DProviderStatics.method2257(class348_sub9.anInt6681, class348_sub9.anInt6696, (-120).toByte())))
                                if (class348_sub9.aBoolean6674) {
                                    if ((class348_sub9.aClass348_Sub10_6688) == null) class348_sub9.aClass348_Sub10_6688 = (VorbisAudioDecoderStatics.method2793(LightingOptionStateStatics.aJs5Archive_5878!!, (class348_sub9.anInt6685)))
                                    if ((class348_sub9.aClass348_Sub10_6688) != null) {
                                        ...
                                        if ((class348_sub9.aClass348_Sub19_Sub1_6686) != null) {
                                            val class348_sub16_sub5 = (SampledVoiceStatics.method2911((class348_sub9.aClass348_Sub19_Sub1_6686!!), i_15_, i_9_ shl 6, i_10_))
                                    ...
                                    val audioClipDefinition = AudioClipDefinitionStatics.method2372(ModelFacePriorityNodeStatics.aJs5Archive_1878!!, (class348_sub9.anInt6685), 0)
                                    if (audioClipDefinition != null) {
                                        val class348_sub19_sub1 = audioClipDefinition.method2369().method2944(MapSceneTileStatics.aAudioResampler_1050!!)
                                        val class348_sub16_sub5 = (SampledVoiceStatics.method2911(class348_sub19_sub1, i_15_, i_9_ shl 6, i_10_))
                                        class348_sub16_sub5!!.method2917(-1)
                                        SpriteDefinitionStatics.aClass348_Sub16_Sub4_7065!!.method2883(class348_sub16_sub5)
                                        class348_sub9.aClass348_Sub16_Sub5_6676 = class348_sub16_sub5
                                    }
                                    ...
                                    if ((class348_sub9.anIntArray6697 != null) && (i.let { class348_sub9.anInt6670 -= it; class348_sub9.anInt6670 }) <= 0) {
                                        ...
                                        if (class348_sub9.aBoolean6699) {
                                            if ((class348_sub9.aClass348_Sub10_6683) == null) {
                                                ...
                                                class348_sub9.aClass348_Sub10_6683 = (VorbisAudioDecoderStatics.method2793(LightingOptionStateStatics.aJs5Archive_5878!!, (class348_sub9.anIntArray6697!![i_17_])))
                                            }
                                            if ((class348_sub9.aClass348_Sub10_6683) != null) {
                                                ...
                                                if ((class348_sub9.aClass348_Sub19_Sub1_6692) != null) {
                                                    val class348_sub16_sub5 = (SampledVoiceStatics.method2911((class348_sub9.aClass348_Sub19_Sub1_6692!!), i_16_, i_9_ shl 6, i_10_))
                                            ...
                                            val audioClipDefinition = AudioClipDefinitionStatics.method2372((ModelFacePriorityNodeStatics.aJs5Archive_1878!!), (class348_sub9.anIntArray6697!![i_18_]), 0)
                                            if (audioClipDefinition == null) break
                                            val class348_sub19_sub1 = (audioClipDefinition.method2369().method2944(MapSceneTileStatics.aAudioResampler_1050!!))
                                            val class348_sub16_sub5 = (SampledVoiceStatics.method2911(class348_sub19_sub1, i_16_, i_9_ shl 6, i_10_))
                                            class348_sub16_sub5!!.method2917(0)
                                            SpriteDefinitionStatics.aClass348_Sub16_Sub4_7065!!.method2883(class348_sub16_sub5)
