    ...
    fun method729(i: Int, i_0_: Int, i_1_: Byte, class318_sub1_sub3_sub3: ProjectedGroundDecor, i_2_: Int) {
        ...
        if (i != -1) {
            if ((class318_sub1_sub3_sub3.anInt10275 == -1) || (i_3_ < 10240 && i_3_ > 2048)) {
                ...
                val i_4_ = 0x3fff and (ParticleEmitterNodeStatics.anIntArray187!![i_2_] - class318_sub1_sub3_sub3.aCompassSmoother_10217.anInt3370)
                if (i != 2 || class225.anInt2919 == -1) {
                    if (i == 0 && (class225.anInt2940 != -1)) {
            ...
            class318_sub1_sub3_sub3.anInt10268 = class225.method1621(37.toByte())
