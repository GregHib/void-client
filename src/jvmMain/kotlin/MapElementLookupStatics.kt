object MapElementLookupStatics {
    @JvmField
            ...
            fun method2643(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int) {
                if (WidgetRedrawRegionStatics.anIntArrayArray4253 != null) WidgetRedrawRegionStatics.anIntArrayArray4253!![i]!![i_0_] = 0xffffff.inv() or i_1_
                if (BooleanGraphicsOptionStateStatics.aShortArrayArray5847 != null) BooleanGraphicsOptionStateStatics.aShortArrayArray5847!![i]!![i_0_] = i_2_.toShort()
