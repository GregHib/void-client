...
class ProjectileNode internal constructor(var aClass318_Sub7_10419: SpotAnimEntity, i: Int, i_65_: Int, i_66_: Int, i_67_: Int, i_68_: Int, i_69_: Int, i_70_: Int, i_71_: Int, i_72_: Int, i_73_: Int, i_74_: Int, bool: Boolean, bool_75_: Boolean) : PositionedSceneNode() {
    ...
    fun method2522(var_renderer: Renderer?, l: Long) {
        val i = this.anInt8791 shr 12 + MapTileShape.anInt4459
        val i_0_ = this.anInt8789 shr 12 + MapTileShape.anInt4459
        ...
        if (i_1_ > 0 || i_1_ < -262144 || i < 0 || i >= ActorEntity.anInt6451 || i_0_ < 0 || i_0_ >= ActorEntity.anInt7054) method2520()
            ...
            else i_4_ = i_3_ - (8 shl MapTileShape.anInt4459)
            ...
            if (class181.aBoolean2376 && i_5_ == 0 && i_1_ > var_ses[0]!!.method3982((-86).toByte(), i_0_, i)) method2520()
            else if (i_5_ == MapAreaDefinitionStatics.anInt2524 - 1 && (var_ses[i_5_]!!.method3982((-86).toByte(), i_0_, i) - i_1_ > 8 shl MapTileShape.anInt4459)) method2520()
            else {
                ...
                class318_sub10.aNodeDequeHolder_6481.aSceneNodeDeque_1569.method844(this, true)
            }
        }
    }
