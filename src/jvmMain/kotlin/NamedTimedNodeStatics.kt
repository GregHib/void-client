    ...
    var anInt8782: Int = 0
            ...
            fun method2515(i: Int): Array<MapSceneTile?>? {
                ...
                if (NativeLibraryUnloader.aMapSceneTileArray2974 == null) {
                    val mapSceneTiles: Array<MapSceneTile?> = WorldListEntryStatics.method286((-107).toByte(), VorbisOggDecoderStatics.aPrivilegedOperationWorker_8992!!)
                    ...
                    GlShaderObjectHandleStatics.method366(NativeLibraryUnloader.aMapSceneTileArray2974 as Array<Any?>, (-123).toByte(), `is`)
                }
            ...
            fun method2516(i: Int, i_7_: Byte, i_8_: Int): TimedTileQueueEntry {
                anInt8788++
                var class348_sub42_sub15 = (MinimapRendererStatics.aHashtable_1585!!.method3480((i_8_.toLong() shl 32 or i.toLong()), i_7_.toInt() xor 0x171e.inv()) as TimedTileQueueEntry?)
                if (i_7_.toInt() != 105) aFloat8784 = 0.99212307f
                if (class348_sub42_sub15 == null) {
                    class348_sub42_sub15 = TimedTileQueueEntry(i_8_, i)
                    MinimapRendererStatics.aHashtable_1585!!.method3483(91.toByte(), (class348_sub42_sub15.aLong4291), class348_sub42_sub15)
                }
