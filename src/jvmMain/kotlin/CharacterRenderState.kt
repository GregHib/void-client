        ...
        fun method2778(class318_sub1: SceneEntity, bool: Boolean, `is`: Array<Array<ByteArray?>?>?, i: Int, i_0_: Byte): Boolean {
            ...
            for (i_5_ in i_1_..i_2_) {
                for (i_6_ in i_3_..i_4_) {
                    if ((class318_sub1.aByte6376 < MapAreaDefinitionStatics.anInt2524) && i_5_ >= ByteArrayPool.anInt492 && i_5_ < ProjectileConfigUtil.anInt387 && i_6_ >= IntPairStatics.anInt6974 && i_6_ < GrayscaleNoiseTexture.anInt5293) {
                        if ((`is` != null && class318_sub1.plane >= i && (`is`[class318_sub1.plane.toInt()]!![i_5_]!![i_6_]) == i_0_) || !class318_sub1.method2378(0) || class318_sub1.method2382((-79).toByte())) {
                            if (!bool && i_5_ >= ActorEntity.anInt6111 - 16 && i_5_ <= ActorEntity.anInt6111 + 16 && i_6_ >= ActorEntity.anInt8502 - 16 && i_6_ <= ActorEntity.anInt8502 + 16) {
                                if (VoronoiNoiseTextureNode.aBoolean9121) {
                                    MapElementDefinitionCache.aCacheIndexManagerArray3982!![NpcSummaryDefinitionStatics.anInt1949++]!!.method2361(-15481, class318_sub1)
                    ...
                    if (class46 != null) {
                        ...
                        if (WorldMapRenderer.anInt4674 == 10 && Client.method105(class46)!!.method3301(-1 + i_8_, false)) {
                            if (i_8_ == 1) {
                                ...
                                val class348_sub47 = method2148((ProjectileConfigUtil.aOutgoingPacketHeader_398), (TheoraVideoStream.aIsaacCipher_9029), -93)
                            ...
                            if (i_8_ == 2) {
                                ...
                                val class348_sub47 = method2148((ScriptResources.aOutgoingPacketHeader_2638), (TheoraVideoStream.aIsaacCipher_9029), -98)
                                method3614(i_9_, i, class46.anInt812, class348_sub47, -19692)
                                InterfaceComponentGroup.method3243(126, class348_sub47)
                            }
                            if (i_8_ == 3) {
                                RegionSceneLoader.anInt3703++
                                val class348_sub47 = method2148((GlslMaterialPass.aOutgoingPacketHeader_6244), (TheoraVideoStream.aIsaacCipher_9029), -93)
                                method3614(i_9_, i, class46.anInt812, class348_sub47, -19692)
                                InterfaceComponentGroup.method3243(-80, class348_sub47)
                            }
                            if (i_8_ == 4) {
                                RegionMapDecoder.anInt1514++
                                val class348_sub47 = method2148((RasterSpriteStatics.aOutgoingPacketHeader_5204), (TheoraVideoStream.aIsaacCipher_9029), -82)
                                method3614(i_9_, i, class46.anInt812, class348_sub47, -19692)
                            ...
                            if (i_8_ == 5) {
                                ...
                                val class348_sub47 = method2148((MinimapSquareDrawer.aOutgoingPacketHeader_5217), (TheoraVideoStream.aIsaacCipher_9029), -94)
                                method3614(i_9_, i, class46.anInt812, class348_sub47, -19692)
                            ...
                            if (i_8_ == 9) {
                                ...
                                val class348_sub47 = method2148((ResourceLoaderThread.aOutgoingPacketHeader_3898), (TheoraVideoStream.aIsaacCipher_9029), -107)
                                method3614(i_9_, i, class46.anInt812, class348_sub47, -19692)
                                InterfaceComponentGroup.method3243(119, class348_sub47)
                            }
                            if (i_8_ != 10) break
                            CacheLruCache.anInt3886++
                            val class348_sub47 = method2148(ClanChatRequestSender.aOutgoingPacketHeader_3644, (TheoraVideoStream.aIsaacCipher_9029), -120)
                            method3614(i_9_, i, class46.anInt812, class348_sub47, -19692)
