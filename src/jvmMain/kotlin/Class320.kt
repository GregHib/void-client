...
object Class320 {
    ...
    fun method2547(i: Int, i_0_: Byte): Boolean {
        ...
        if (!Class229.class45!!.method408((-124).toByte(), i)) return false
        val i_1_ = Class229.class45!!.method407(0, i)
        if (i_1_ == 0) {
        ...
        while (i_1_ > i_2_) {
            if (Class348_Sub40_Sub33.aClass46ArrayArray9427!![i]!![i_2_] == null) {
                val `is` = Class229.class45!!.method410(i_0_.toInt() xor 0x717.inv(), i, i_2_)
                if (`is` != null) {
