...
object SceneEntityModelStatics {
    var anInt6407: Int = 0
            var anInt6408: Int = 0
            @JvmField
            var anInt6411: Int = 0
            ...
            fun method2501(i: Int, var_ha_Sub3: NativeRenderer?, `is`: IntArray?, i_0_: Byte, is_1_: IntArray?, i_2_: Int): IndexedSprite {
                try {
                    ...
                    anInt6412++
                    if (var_ha_Sub3!!.method3880(MovementDirectionStatics.aMovementDirection_1183, ClampTextureNodeStatics.aTextureFormatInfo_9471, 125.toByte())) {
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("jda.A(" + i + ',' + (if (var_ha_Sub3 != null) "{...}" else "null") + ',' + (if (`is` != null) "{...}" else "null") + ',' + i_0_ + ',' + (if (is_1_ != null) "{...}" else "null") + ',' + i_2_ + ')'))
                }
            }
