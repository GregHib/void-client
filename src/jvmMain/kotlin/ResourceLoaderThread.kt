...
import GlGroundShaderPassStatics.method3556
import GameClock.method599
import java.awt.Container
import kotlin.concurrent.Volatile
import ResourceLoaderThreadStatics.anInt3897
import ResourceLoaderThreadStatics.anInt3899
import ResourceLoaderThreadStatics.anInt3900
import ResourceLoaderThreadStatics.anInt3901
import ResourceLoaderThreadStatics.anInt3902
import ResourceLoaderThreadStatics.anInt3903
import ResourceLoaderThreadStatics.anInt3904
import ResourceLoaderThreadStatics.anInt3905
import ResourceLoaderThreadStatics.anInt3906
import ResourceLoaderThreadStatics.anInt3909
import ResourceLoaderThreadStatics.anInt3911
import ResourceLoaderThreadStatics.anInt3912
import ResourceLoaderThreadStatics.aWidgetComponent_3913
...
class ResourceLoaderThread : Runnable {
    ...
    fun method2316(connectionStateType: ConnectionStateType?, string: String?, i: Int, l: Long, bool: Boolean) {
        try {
            ...
            throw SoundBankPatchStatics.method2929(runtimeexception, ("ae.J(" + (if (connectionStateType != null) "{...}" else "null") + ',' + (if (string != null) "{...}" else "null") + ',' + i + ',' + l + ',' + bool + ')'))
        }
    }
    ...
    override fun run() {
        ...
        while (!aBoolean3910) {
            ...
            if (i > 0) TexGenMaterialPassStatics.method2161((-3).toByte(), i.toLong())
        }
    }
            ...
            try {
                ...
                if (anCursorController_3907 is LoadingBarRenderer) anCursorController_3907.method58(aBoolean3908, -104)
                    ...
                    if (FacingDirectionNodeStatics.aRenderer6654 != null && anCursorController_3919 != null && anCursorController_3919!!.method55((-58).toByte()) != 0 && (aLong3914 >= l_1_ - anCursorController_3919!!.method55((-58).toByte()).toLong())) {
                        ...
                        val class105 = (FacingDirectionNodeStatics.aRenderer6654!!.method3629(LocTypeDefinitionStatics.anInt4017, HardCacheEntryReferenceStatics.anInt10432, true))
                    ...
                    try {
                        ...
                        method1242((clientException_.message + " (Recovered) " + NpcTypeStatics.aClient1367!!.method81(80.toByte())), clientException_, 15004)
                ...
                else container = EdgeDetectTextureNodeStatics.anGameApplet_Frame_9169
                container!!.getSize()
                container.getSize()
                if (RsaVarbitHandlerStatics.aFrame4904 === container) RsaVarbitHandlerStatics.aFrame4904!!.getInsets()
                aBoolean3908 = false
