...
class CompositeRgbNoiseTexture : RgbNoiseTexture(12, 5, 16, 2, 2, 0.45f) {
    ...
    companion object {
        ...
        fun method569(i: Byte, class348_sub49: ByteBuffer) {
            ...
            var i_1_ = 0
            while (i_0_ > i_1_) {
                MouseInputTracker.aDataHolderArray7446!![i_1_] = DataHolder()
                MouseInputTracker.aDataHolderArray7446!![i_1_]!!.anInt3657 = class348_sub49.readSmart(-124)
                MouseInputTracker.aDataHolderArray7446!![i_1_]!!.aString3663 = class348_sub49.method3371(-13487)
                i_1_++
            }
        ...
        fun method570(i: Int) {
            ...
            InboundPacketHeader.aInboundPacketHeader_8683 = null
        ...
        fun method574(i: Int, i_16_: Int, i_17_: Int, `is`: IntArray?, bool: Boolean, i_18_: Byte, i_19_: Int, i_20_: Int, i_21_: Int, is_22_: IntArray?, i_23_: Int, collisionMap: CollisionMap?, i_24_: Int, i_25_: Int, i_26_: Int): Int {
            try {
                ...
                var i_44_ = 0
                if (i_18_.toInt() != 120) InboundPacketHeader.aInboundPacketHeader_8683 = null
