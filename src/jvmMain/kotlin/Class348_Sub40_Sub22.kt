...
class Class348_Sub40_Sub22 : Class348_Sub40(0, true) {
    ...
    private fun method3109(i: Byte) {
        ...
        for (i_2_ in 0..<anInt9301) {
            if (i_2_ > 0) {
                var i_3_ = anInt9300
                val i_4_ = ((Class124Statics.method1097(90.toByte(), 4096, random) - 2048) * anInt9305 shr 12)
            ...
            while (anInt9299 > i_5_) {
                if (i_5_ > 0) {
                    var i_6_ = anInt9291
                    val i_7_ = ((Class124Statics.method1097(117.toByte(), 4096, random) - 2048) * anInt9302 shr 12)
                    i_6_ += i_0_ * i_7_ shr 12
                    anIntArrayArray9287[i_2_]!![i_5_] = anIntArrayArray9287[i_2_]!![i_5_ + -1] + i_6_
                }
                anIntArrayArray9286[i_2_]!![i_5_] = (if (anInt9284 <= 0) 4096 else (-Class124Statics.method1097(124.toByte(), anInt9284, random) + 4096))
                i_5_++
            }
    ...
    companion object {
        ...
        fun method3111(i: Int, i_23_: Int) {
            ...
            if (i_23_ != Class348_Sub15.anInt6769) {
                ...
                Class367Sub4Statics.anInt7319 = Class348_Sub40_Sub3.Companion.anInt9109
                Class290.method2196((-9).toByte())
                Class62.anIntArrayArrayArray1116 = (Array<Array<IntArray?>?>(4) { Array<IntArray?>(Class367Sub4Statics.anInt7319 shr 3) { IntArray(Class348_Sub40_Sub3.Companion.anInt9109 shr 3) } })
                Class239_Sub8.anIntArrayArray5921 = (Array<IntArray?>(Class367Sub4Statics.anInt7319) { IntArray(Class348_Sub40_Sub3.Companion.anInt9109) })
                Class348_Sub42_Sub17.anIntArrayArray9678 = (Array<IntArray?>(Class367Sub4Statics.anInt7319) { IntArray(Class348_Sub40_Sub3.Companion.anInt9109) })
                for (i_24_ in 0..3) Class348_Sub45Statics.aClass361Array7108!![i_24_] = Class105_Sub1.method988(Class348_Sub40_Sub3.Companion.anInt9109, 1, Class367Sub4Statics.anInt7319)
                Class289.aByteArrayArrayArray3700 = (Array<Array<ByteArray?>?>(4) { Array<ByteArray?>(Class367Sub4Statics.anInt7319) { ByteArray(Class348_Sub40_Sub3.Companion.anInt9109) } })
                method1717(19278, Class348_Sub40_Sub3.Companion.anInt9109, Class367Sub4Statics.anInt7319, 4)
                Class97.method873(Class367Sub4Statics.anInt7319 shr 3, 21719, Class348_Sub8.aHa6654, Class348_Sub40_Sub3.Companion.anInt9109 shr 3)
