            ...
            do {
                try {
                    ...
                    if (!method1197(-12081, class348_sub42_sub12!!.anInt9608)) {
                        ...
                        } else `is` = Exception_Sub1Statics.aClass255_112!!.method1940(113, (class348_sub42_sub12.anInt9599)).anIntArray2772
                    } else `is` = (Exception_Sub1Statics.aClass255_112!!.method1940(-67, (class348_sub42_sub12.aLong9605).toInt()).anIntArray2772)
                    var string = Class316.method2367(125.toByte(), class348_sub42_sub12)
                    if (`is` != null) string += method1273(`is`, true)
                    Class262Statics.aClass324_3326!!.method2567(i_1_, string, 116.toByte(), i_4_, 0, i_7_ - -3, Class341.aClass105Array4234, Class175.anIntArray2330)
