            ...
            if (Class367_Sub11.anInt7396 > class318_sub1_sub3_sub5.anInt10392) {
                ...
                if ((class318_sub1_sub3_sub5.anInt10412) > 0) {
                    ...
                    if (class348_sub22 != null) {
                        ...
                        if ((npc.x) >= 0 && (Class367Sub4Statics.anInt7319 * 512 > npc.x) && (npc.y) >= 0 && (512 * Class348_Sub40_Sub3.anInt9109 > npc.y)) class318_sub1_sub3_sub5.method2471((-103).toByte(), ((method2064(npc.x, (class318_sub1_sub3_sub5.plane).toInt(), 11219, npc.y)) + -class318_sub1_sub3_sub5.anInt10366), npc.y, Class367_Sub11.anInt7396, npc.x)
                    }
                }
                if ((class318_sub1_sub3_sub5.anInt10412) < 0) {
                    ...
                    if (player != null && (player.x) >= 0 && ((player.x) < 512 * Class367Sub4Statics.anInt7319) && (player.y) >= 0 && (player.y) < 512 * Class348_Sub40_Sub3.anInt9109) class318_sub1_sub3_sub5.method2471((-103).toByte(), ((method2064((player.x), (class318_sub1_sub3_sub5.plane).toInt(), 11219, (player.y))) - class318_sub1_sub3_sub5.anInt10366), (player.y), Class367_Sub11.anInt7396, (player.x))
                }
