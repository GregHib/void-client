...
object DragDropControllerStatics {
    ...
    fun method2708(i: Int) {
        ...
        if (!MinimapSquareDrawer.aBoolean5221 || !ScrollingWidgetComponentNode.aBoolean8386) {
            if (anInt6392 > 1) RegionSceneLoader.aWidgetComponent_3701 = null
        } else {
            var i_0_ = 0
            var i_1_ = 0
            ...
            if (i == -30206) {
                ...
                if (i_3_ < anInt558) i_3_ = anInt558
                ...
                if (RectangleRegion.aInputTracker_8552!!.method3593(94)) {
                    ...
                    } else if ((WallEntity.anInt8770 == 1 || method2485(-113)) && FileExistsConditionStatics.anInt4776 > 2) method191(true, (NativeRenderer.anInt8001 + SceneEntityModel.anInt6411), (ModelDefinitionCache.anInt2872 - -(GrayscaleEffect.anInt9203)))
