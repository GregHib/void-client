...
object ConfigFlagUtilStatics {
    var anInt3229: Int = 0
            ...
            fun method1913(bool: Boolean, i: Int, widgetComponent: WidgetComponent) {
                ...
                NullRenderPassStatics.method3534(false, widgetComponent.anInt830, i_1_, bool, i_2_, (WarpTextureNodeStatics.aWidgetComponentArrayArray9427!![(widgetComponent.anInt830 shr 16)]!!))
                if (widgetComponent.aWidgetComponentArray798 != null) NullRenderPassStatics.method3534(false, widgetComponent.anInt830, i_1_, bool, i_2_, widgetComponent.aWidgetComponentArray798!!)
                val class348_sub41 = (MinimapSpriteRendererStatics.aHashtable_4915!!.method3480(widgetComponent.anInt830.toLong(), -6008) as RegionSceneShifter?)
            ...
            fun method1916(i: Int, widgetComponent: WidgetComponent) {
                anInt3229++
                if (widgetComponent.anInt794 == DirectionPathStatics.anInt1064) GzipDecompressorStatics.aBooleanArray2076!![widgetComponent.anInt760] = true
