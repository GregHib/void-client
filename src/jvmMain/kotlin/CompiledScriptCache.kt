...
class CompiledScriptCache internal constructor(i: Int, js5Archive: Js5Archive?, js5Archive_1_: Js5Archive?, textFormatter: TextFormatter?) {
    ...
    fun method3472(l: Long, `is`: IntArray?, i: Int, rectangleRegion: RectangleRegion?): String {
        try {
            ...
            anInt4370++
            if (anTextFormatter_4373 != null) {
                val string = anTextFormatter_4373!!.method54(1, l, rectangleRegion, `is`)
    ...
    init {
        ...
        anTextFormatter_4373 = null
        do {
            try {
                anTextFormatter_4373 = textFormatter
