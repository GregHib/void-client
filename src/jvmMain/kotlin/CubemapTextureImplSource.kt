        ...
        fun method2270(i: Int, i_4_: Int, var_renderer: Renderer?, string: String?, bool: Boolean, i_5_: Int, i_6_: Int, i_7_: Int) {
            try {
                if (ChatMessageStream.aAbstractModelRenderer_106 == null || MinimapFlagRenderer.aAbstractModelRenderer_1800 == null) {
                    ...
                    } else var_renderer!!.aa(i_4_, i_5_, i, i_7_, (255 + -NpcConfig.anInt948 shl 24 or CompassSmootherStatics.anInt3376), 1)
                }
                anInt8709++
                if (ChatMessageStream.aAbstractModelRenderer_106 != null && MinimapFlagRenderer.aAbstractModelRenderer_1800 != null) {
                ...
                if (bool == false) {
                    ...
                    var_renderer!!.aa(i_4_, i_7_ + i_5_, i, i_6_ + -i_7_, (CompassSmootherStatics.anInt3376 or (255 + -NpcConfig.anInt948 shl 24)), 1)
                }
