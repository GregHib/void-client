...
object HslColorTableNodeStatics {
    @JvmField
            ...
            fun method2769(var_class: Class<*>?, i: Byte, string: String?): Boolean {
                try {
                    anInt6639++
                    val var_class_0_ = (PlayerStatics.aHashtable10565!!.get(string) as? Class<*>?)
                    ...
                    if (file != null) {
                        try {
                            ...
                            PlayerStatics.aHashtable10565!![string] = aClass6640
                            return true
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("gba.C(" + (if (var_class != null) "{...}" else "null") + ',' + i + ',' + (if (string != null) "{...}" else "null") + ')'))
                }
            }
            ...
            fun method2770(i: Int) {
                anInt6638++
                if (ParticleEmitterNodeStatics.anIntArray179 == null) ParticleEmitterNodeStatics.anIntArray179 = IntArray(65536)
                else return
                ...
                for (i_5_ in 0..65535) {
                    ...
                    ParticleEmitterNodeStatics.anIntArray179!![i_5_] = i_20_
                }
                if (i != 2) anInt6634 = 92
            }
