class WaterDetailOptionState : GraphicsOptionState {
    ...
    companion object {
        ...
        fun method1780(i: Int) {
            InboundPacketHeader.aInboundPacketHeader_5992 = null
        ...
        fun method1781(i: Int, i_1_: Int, i_2_: Int): Int {
            ...
            try {
                ...
                val class124 = ParticleConfigParser.method2277(0, RasterSpriteStatics.aJs5Archive_5207!!, AbstractFrameBufferSurface.anInt6923, -1)
