...
object WidgetTextConfigStatics {
    ...
    fun method363(i: Int) {
        ...
        anInt512++
        if (MinimapFlagRenderer.anInt1794 != -1 && (CubemapTexture2dSource.aLong8694 < CommonClock.method599(-127))) {
            for (i_4_ in MinimapFlagRenderer.anInt1794..<MinimapSquareDrawer.aStringArray5223!!.size) {
                if (MinimapSquareDrawer.aStringArray5223!![i_4_]!!.startsWith("pause")) {
                    ...
                    CubemapTexture2dSource.aLong8694 = (1000 * i_5_).toLong() + CommonClock.method599(-97)
                    return
                } else {
        ...
        if (NodeDequeHolder.anInt1565 != 0) {
            ViewportTransformStatics.anInt3676 -= NodeDequeHolder.anInt1565 * 5
            if (ViewportTransformStatics.anInt3676 >= WorldMapTextLabel.anInt8587) ViewportTransformStatics.anInt3676 = -1 + WorldMapTextLabel.anInt8587
                            ...
                            if (i_7_ == 101 && (TerrainShadowBuilderGl3.anInt7006 < MapElementManager.aString4461!!.length)) {
                                ...
                                if (i_7_ == 97 && (MapElementManager.aString4461!!.length > TerrainShadowBuilderGl3.anInt7006)) {
                                    ...
                                    if (i_7_ == 105 && WalkingTypeUtil.anInt3312 > 0) {
                                        ...
                                        MapElementManager.aString4461 = ((MapElementManager.aString4461!!.substring(0, TerrainShadowBuilderGl3.anInt7006)) + RectangleRegion.anCharStreamReaderArray9534s!![i_6_]!!.method28(23.toByte()) + (MapElementManager.aString4461!!.substring(TerrainShadowBuilderGl3.anInt7006)))
                                        TerrainShadowBuilderGl3.anInt7006++
                                    }
                                } else {
                                    WalkingTypeUtil.anInt3312++
    ...
    fun method365(class318_sub1: SceneEntity, class348_sub1s: Array<AbstractTileShape?>?) {
        ...
        if (ActorEntity.aTerrainTileArray4142 == ActorEntity.aTerrainTileArray5191) {
            val bool = false
            val bool_11_ = false
            val i: Int
            val i_12_: Int
