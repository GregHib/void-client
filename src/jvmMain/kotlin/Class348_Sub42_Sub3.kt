...
class Class348_Sub42_Sub3 internal constructor(var aByteArray9499: ByteArray?) : Class348_Sub42() {
    companion object {
        ...
        fun method3174(i: Int, i_0_: Int, i_1_: Int, bool: Boolean, i_2_: Byte, i_3_: Int) {
            ...
            Class234Statics.anInt3047 = i_0_
        ...
        fun method3175(i: Byte) {
            if (!method3196(Class240.anInt4674, -114) && !method2672(Class240.anInt4674, -103)) {
                ...
                if (i_12_ < 0 || Class367Sub4Statics.anInt7319 shr 3 <= i_12_ || i_13_ < 0 || (Class348_Sub40_Sub3.anInt9109 shr 3 <= i_13_)) Class346_Sub1.method2703(0, Class367Sub4Statics.anInt7319 shr 4, (Class348_Sub40_Sub3.anInt9109 shr 4), (-13).toByte())
                else Class346_Sub1.method2703(5000, i_12_, i_13_, (-13).toByte())
            } else Class346_Sub1.method2703(5000, Class286_Sub4Statics.anInt6246 shr 12, Class59_Sub2_Sub2.anInt8685 shr 12, (-13).toByte())
            anInt9509++
            method3134(-1)
            method2988(true)
            val i_14_ = -8 % ((-30 - i) / 38)
        ...
        fun method3179(i: Int) {
            ...
            if (Class316.aClass348_Sub51_3959!!.aClass239_Sub3_7222!!.method1735(false)) sStatics.method3980(i + 93, Class305Statics.aCanvas3869!!)
