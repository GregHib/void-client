import ParticleSystemStateStatics.anInt2193
import ParticleSystemStateStatics.anInt2194
...
class ParticleSystemState internal constructor(var_ha_Sub1: SoftwareRenderer) {
    ...
    init {
        ...
        this.anIntArray2213 = IntArray(SoftwareModelStatics.anInt5350)
        this.anIntArray2214 = IntArray(SoftwareModelStatics.anInt5350)
        this.anIntArray2212 = IntArray(64)
        this.aFloatArray2226 = FloatArray(2)
        this.anIntArray2216 = IntArray(10000)
        this.anIntArray2222 = IntArray(SoftwareModelStatics.anInt5350)
        this.anIntArray2232 = IntArray(64)
        this.anIntArray2218 = IntArray(8)
        this.anIntArray2237 = IntArray(SoftwareModelStatics.anInt5350)
        this.anIntArray2236 = IntArray(10000)
        this.anIntArray2230 = IntArray(SoftwareModelStatics.anInt5350)
        ...
        this.anIntArray2244 = IntArray(SoftwareModelStatics.anInt5350)
        this.anIntArray2247 = IntArray(10)
        this.anIntArray2234 = IntArray(SoftwareModelStatics.anInt5350)
        ...
        this.anIntArray2242 = IntArray(SoftwareModelStatics.anInt5346)
        var i = 0
        while (SoftwareModelStatics.anInt5346 > i) {
