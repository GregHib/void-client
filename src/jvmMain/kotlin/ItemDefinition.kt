...
class ItemDefinition {
    ...
    fun method1562(i: Int, bool: Boolean, i_37_: Int, var_renderer: Renderer?, var_renderer_38_: Renderer?, RSFont: RSFont?, compositeNpcModelBuilder: CompositeNpcModelBuilder?, i_39_: Int, i_40_: Byte, i_41_: Int): IntArray? {
        try {
            ...
            var_renderer_38_.DA(16, 16, 512, 512)
            val class101 = var_renderer_38_.method3654()
            class101.method910()
            var_renderer_38_.method3638(class101)
            var_renderer_38_.xa(1.0f)
            var_renderer_38_.ZA(16777215, 1.0f, 1.0f, -50.0f, -10.0f, -50.0f)
            ...
            var_renderer_38_.f(50, 2147483647)
            var_renderer_38_.ya()
            var_renderer_38_.la()
            var_renderer_38_.aa(0, 0, 36, 32, 0, 0)
            class64.method615(class101_49_, null, 1)
            var_renderer_38_.f(i_50_, i_51_)
            var `is` = var_renderer_38_.na(0, 0, 36, 32)
            ...
            if (i_39_ == 1 || (i_39_ == 2 && (this.anInt2820 == 1 || i != 1) && i != -1)) RSFont!!.method2576(method1557(i, i_40_ + -11517), -256, 9, 0, -16777215, i_40_ + -15)
            ...
            throw TextureLoadException.method2929(runtimeexception, ("rq.O(" + i + ',' + bool + ',' + i_37_ + ',' + (if (var_renderer != null) "{...}" else "null") + ',' + (if (var_renderer_38_ != null) "{...}" else "null") + ',' + (if (RSFont != null) "{...}" else "null") + ',' + (if (compositeNpcModelBuilder != null) "{...}" else "null") + ',' + i_39_ + ',' + i_40_ + ',' + i_41_ + ')'))
        }
    }
