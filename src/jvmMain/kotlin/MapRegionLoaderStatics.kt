...
import CachedRgbNoiseTextureStatics.method566

object MapRegionLoaderStatics {
    @JvmField
            ...
            fun method752(js5Archive: Js5Archive?, locDefinitionCache: LocDefinitionCache?, particleDefLoader: ParticleDefLoader?, seqDefinitionCache: SeqDefinitionCache?, configDefinitionLoader: ConfigDefinitionLoader?, textureDefinitionLoader: TextureDefinitionLoader?, varResolver: VarResolver?) {
                ...
                if (`is` != null) {
                    for (i_47_ in `is`.indices) {
                        val class348_sub42_sub14 = ModelDefinitionLoaderStatics.method1205(`is`[i_47_], true, aJs5Archive_1237!!, i)
            ...
            private fun method759(var_renderConfig: RenderConfig, i: Int, i_105_: Int, i_106_: Int): Int {
                ...
                if (locTypeConfig.anInt3569 >= 0) {
                    ...
                    i_108_ = 0xffffff.inv() or (Crc64HashableStatics.anIntArray4983!![method303(method353(96, -119, i_111_), 30).toInt() and 0xffff])
                } else if (i_107_ >= 0) i_108_ = (0xffffff.inv() or (Crc64HashableStatics.anIntArray4983!![(method303(method353(96, -85, (var_renderConfig.method3(i_107_, -6662)!!.aShort208).toInt()), 30)).toInt() and 0xffff]))
                    ...
                    i_108_ = 0xffffff.inv() or (Crc64HashableStatics.anIntArray4983!![method303(method353(96, -80, i_114_), 30).toInt() and 0xffff])
                }
                return i_108_
            }
                                ...
                                if (i_149_ > 0) {
                                    ...
                                    if (i_152_ == 0 && i_153_ == 0 && i_154_ == 0) {
                                        ...
                                        if (i_154_ == 65535) {
                                            ...
                                            method755(var_renderer, i_137_, i_147_, i_139_, i_149_, i_152_, i_153_, aByteArray1275!![i_151_].toInt(), aShortArray1252, aByteArray1248!!, true)
                                        }
                                    } else method755(var_renderer, i_137_, i_147_, i_139_, i_149_, i_152_, i_153_, aByteArray1275!![i_151_].toInt(), null, null, true)
                                }
                            }
                        } else {
                                    ...
                                    if (i_164_ >= 0 && i_164_ < anInt1267) {
                                        ...
                                        if (i_165_ > 0) {
                                            if (i_165_ == 65535) {
                                                ...
                                                method763(var_renderer, i_156_, i_161_, i_158_, i_163_, aShortArray1252, aByteArray1248!!)
                                            }
                                        } else method763(var_renderer, i_156_, i_161_, i_158_, i_163_, null, null)
                                    }
                                }
                            }
                        }
                        ...
                        for (i_212_ in -5..<anInt1267) {
                            ...
                            if (i_212_ >= 0 && i_211_ > 0) {
                                if ((`is`[i_201_ + i_212_ * anInt1259].toInt() and 0xff) == 0) {
                                    ...
                                    val i_220_ = (Crc64HashableStatics.anIntArray4983!![(method303(FloatBufferStatics.method3401(i_218_, 96, 76.toByte()), 30)).toInt() and 0xffff])
