            ...
            fun method1439(i: Int, privilegedOperationWorker: PrivilegedOperationWorker?, component: Component?, i_0_: Int, i_1_: Int): SoundChannelMixer {
                ...
                try {
                    ...
                    try {
                        ...
                        if (CameraConfigDefinitionStatics.anInt3248 > 0 && ParticleDefLoaderStatics.aBackgroundWorkerThread_2462 == null) {
                            ParticleDefLoaderStatics.aBackgroundWorkerThread_2462 = BackgroundWorkerThread()
                            ParticleDefLoaderStatics.aBackgroundWorkerThread_2462!!.aPrivilegedOperationWorker_3228 = privilegedOperationWorker
                            privilegedOperationWorker!!.method2236(ParticleDefLoaderStatics.aBackgroundWorkerThread_2462, -10240, CameraConfigDefinitionStatics.anInt3248)
                        }
                        if (ParticleDefLoaderStatics.aBackgroundWorkerThread_2462 != null) {
                            require((ParticleDefLoaderStatics.aBackgroundWorkerThread_2462!!.aSoundChannelMixerArray3218s[i_0_]) == null)
                            ParticleDefLoaderStatics.aBackgroundWorkerThread_2462!!.aSoundChannelMixerArray3218s[i_0_] = soundChannelMixer
                        }
                        ...
                        try {
                            ...
                            if (ParticleDefLoaderStatics.aBackgroundWorkerThread_2462 != null) {
                                require((ParticleDefLoaderStatics.aBackgroundWorkerThread_2462!!.aSoundChannelMixerArray3218s[i_0_]) == null)
                                ParticleDefLoaderStatics.aBackgroundWorkerThread_2462!!.aSoundChannelMixerArray3218s[i_0_] = class279_sub2
                            }
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("qr.A(" + i + ',' + (if (privilegedOperationWorker != null) "{...}" else "null") + ',' + (if (component != null) "{...}" else "null") + ',' + i_0_ + ',' + i_1_ + ')'))
                }
            }
