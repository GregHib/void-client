...
object Class301 {
    ...
    fun method2280(i: Byte, i_20_: Int) {
        anInt3826++
        if (Class289.aByteArrayArrayArray3700 == null) Class289.aByteArrayArrayArray3700 = (Array<Array<ByteArray?>?>(4) { Array<ByteArray?>(Class367Sub4Statics.anInt7319) { ByteArray(Class348_Sub40_Sub3.anInt9109) } })
        if (i_20_ != 28587) method2278(35, -47, 56.toByte(), -93)
        for (i_21_ in 0..3) {
            var i_22_ = 0
            while (Class367Sub4Statics.anInt7319 > i_22_) {
                var i_23_ = 0
