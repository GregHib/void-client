...
class TextureQualityOptionState : GraphicsOptionState {
    ...
    companion object {
        ...
        fun method1782(i: Int, i_0_: Int): SystemFontGlyphs? {
            ...
            anInt6004++
            if (i == 0) {
                if (MapRegionLoaderStatics.aFloat1247.toDouble() == 3.0) return MinimapSpriteRenderer.aSystemFontGlyphs_4921
                if (MapRegionLoaderStatics.aFloat1247.toDouble() == 4.0) return GlRectangleTexture.aSystemFontGlyphs_8644
                if (MapRegionLoaderStatics.aFloat1247.toDouble() == 6.0) return GlShaderObjectHandle.aSystemFontGlyphs_521
                if (MapRegionLoaderStatics.aFloat1247.toDouble() >= 8.0) return HeapDiagnosticsHolder.aSystemFontGlyphs_2252
            } else if (i == 1) {
                if (MapRegionLoaderStatics.aFloat1247.toDouble() == 3.0) return GlShaderObjectHandle.aSystemFontGlyphs_521
                ...
                if (MapRegionLoaderStatics.aFloat1247.toDouble() >= 8.0) return GlBufferObject.aSystemFontGlyphs_4754
            } else if (i == 2) {
                if (MapRegionLoaderStatics.aFloat1247.toDouble() == 3.0) return PingHostListHolder.aSystemFontGlyphs_2333
                if (MapRegionLoaderStatics.aFloat1247.toDouble() == 4.0) return GlBufferObject.aSystemFontGlyphs_4754
                if (MapRegionLoaderStatics.aFloat1247.toDouble() == 6.0) return ModelVertexColorBuffer.aSystemFontGlyphs_6581
                if (MapRegionLoaderStatics.aFloat1247.toDouble() >= 8.0) return WorldMapRenderer.aSystemFontGlyphs_4672
            }
            return null
        }
