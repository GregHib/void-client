...
object HashTableContainerStatics {
    var anInt6996: Int = 0
            @JvmField
            ...
            fun method3030(i: Int, var_ha_Sub2: OpenGlRenderer) {
                anInt6999++
                if (GlShaderProgramHandleStatics.anObject4177 == null) {
                    val class59_sub1_sub2 = StaticNoiseTexture()
                    val `is` = class59_sub1_sub2.method562(128, 128, 121.toByte(), 16)
                    GlShaderProgramHandleStatics.anObject4177 = method1357(`is`, false, 81.toByte())
                }
                if (MapElementDefinitionCacheStatics.anObject3985 == null) {
                    val class59_sub2_sub1 = CachedRgbNoiseTexture()
                    val `is` = class59_sub2_sub1.method567(128, 111.toByte(), 16, 128)
                    MapElementDefinitionCacheStatics.anObject3985 = method1357(`is`, false, 103.toByte())
                }
                val class188 = var_ha_Sub2.aGlowPostProcessor_7736
                if (class188!!.method1414(35632) && WorldMapTextLabelStatics.anObject8592 == null) {
                    val `is` = method194(128, -1922, 8, 0.6f, 128, 4.0f, 4.0f, 0.5f, 16.0f, PerlinTextureProvider(419684), 16)
                    WorldMapTextLabelStatics.anObject8592 = method1357(`is`, false, 78.toByte())
                }
            }
            ...
            fun method3031(i: Int, class348_sub49: ByteBuffer): AbstractProceduralTextureNode? {
                ...
                val class348_sub40 = ScrollingNoiseTextureStatics.method557(i_0_, (-84).toByte())
