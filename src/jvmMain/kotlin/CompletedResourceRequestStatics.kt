object CompletedResourceRequestStatics {
    @JvmField
            ...
            fun method3263(bool: Boolean): Boolean {
                ...
                anInt10459++
                return FontMetaRefStatics.aBoolean4328
            }
            ...
            fun method3265(i: Int, linkedListNode: LinkedListNode?, linkedListNode_0_: LinkedListNode?) {
                try {
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("qh.K(" + i + ',' + (if (linkedListNode != null) "{...}" else "null") + ',' + (if (linkedListNode_0_ != null) "{...}" else "null") + ')'))
                }
            }
}
