...
class GlFontTextured internal constructor(private val aHa_Sub3_6494: NativeRenderer, fontDefinition: FontDefinition?, spriteImages: Array<SpriteImage>, bool: Boolean) : Font(aHa_Sub3_6494, fontDefinition) {
    ...
    init {
        ...
        if (bool) {
            ...
            if (!aHa_Sub3_6494.method3880(MovementDirectionStatics.aMovementDirection_1183, ClampTextureNodeStatics.aTextureFormatInfo_9471, 126.toByte())) {
            ...
            } else anInterface18_Impl3_6492 = aHa_Sub3_6494.method3944(`is`, i_5_, (ClampTextureNodeStatics.aTextureFormatInfo_9471), 2, false, i_5_)
            aBoolean6493 = true
        } else {
        ...
        anInterface18_Impl3_6492!!.method64(FrameBufferObjectStatics.aClass209_4874, -22095)
    ...
    override fun fa(c: Char, i: Int, i_49_: Int, i_50_: Int, bool: Boolean) {
        ...
        if (aBoolean6493 || bool) {
            aHa_Sub3_6494.method3874(ParticleSystemStateStatics.aRenderConfigFactory_2207, 112, RenderQueueState.aRenderConfigFactory_6519)
            aHa_Sub3_6494.method3849(47.toByte(), 0, RenderListTextureNodeStatics.aTrigLookupTables_9485)
        ...
        aHa_Sub3_6494.method3899(2, c.code * '\u0004'.code, AsyncResourceRequestStatics.aCameraRotationStub_9661, true)
        if (aBoolean6493 || bool) aHa_Sub3_6494.method3849(47.toByte(), 0, WidgetRedrawRegionStatics.aTrigLookupTables_4247)
    }
}
