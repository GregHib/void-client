...
object TypedRecordTableStatics {
    var anInt3685: Int = 0
            var anInt3686: Int = 0
            var anInt3689: Int = 0
            ...
            fun method2178(class318_sub1: SceneEntity?, i: Int, widgetDefinition: WidgetDefinition?, i_0_: Int) {
                try {
                    anInt3694++
                    if (HintArrowOrMessageStatics.anInt2021 < 50 && (widgetDefinition != null && widgetDefinition.anIntArrayArray264 != null && (widgetDefinition.anIntArrayArray264!!.size > i) && widgetDefinition.anIntArrayArray264!![i] != null)) {
                        ...
                        if (i_5_ == 0) {
                            if (LocalPlayerState.aPlayer_1907 == class318_sub1) {
                                if (!widgetDefinition.aBoolean268) TextureTileRendererStatics.method2947(true, i_7_, i_2_, i_3_, 0, i_6_)
                                else SoundChannelMixerStatics.method2090(i_3_, i_6_, false, (-35).toByte(), i_7_, 0, i_2_)
                            }
                            ...
                            GlTextureCubeMapStatics.aParticleEmitterNodeArray8531s!![HintArrowOrMessageStatics.anInt2021++] = ParticleEmitterNode((if (widgetDefinition.aBoolean268) 2.toByte() else 1.toByte()), i_2_, i_3_, 0, i_7_, i_10_, i_6_, class318_sub1)
                        }
                    }
                } catch (runtimeexception: RuntimeException) {
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("vp.A(" + (if (class318_sub1 != null) "{...}" else "null") + ',' + i + ',' + (if (widgetDefinition != null) "{...}" else "null") + ',' + i_0_ + ')'))
                }
            }
                ...
                try {
                    ...
                    if (l >= i_18_.toLong()) {
                        ...
                        if (i_18_ > i_19_ * i_19_) {
                            i_19_ -= 10
                            val i_20_: Int
                            if (WeaveTextureNodeStatics.anInt9282 == 4) i_20_ = ResourceProviderStatics.aFloat3938.toInt() and 0x3fff
                            else i_20_ = 0x3fff and (ResourceProviderStatics.aFloat3938.toInt() + OpenGlRenderNodeStatics.anInt10483)
                            var i_21_ = TrigLookupTablesStatics.anIntArray1207!![i_20_]
                            var i_22_ = TrigLookupTablesStatics.anIntArray1204!![i_20_]
                            if (WeaveTextureNodeStatics.anInt9282 != 4) {
                                i_22_ = i_22_ * 256 / (FloatBufferStatics.anInt9750 - -256)
                                i_21_ = 256 * i_21_ / (FloatBufferStatics.anInt9750 - -256)
                            }
                        ...
                        } else method1211(i, GrayscaleNoiseTextureStatics.aAbstractModelRendererArray5294!![i_17_], i_15_, widgetComponent, var_sprite, i_14_, 2, i_16_)
                    }
                } catch (runtimeexception: RuntimeException) {
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("vp.D(" + l + ',' + i + ',' + i_13_ + ',' + i_14_ + ',' + i_15_ + ',' + (if (widgetComponent != null) "{...}" else "null") + ',' + i_16_ + ',' + i_17_ + ',' + (if (var_sprite != null) "{...}" else "null") + ')'))
                }
            }
