import SpotAnimEntityStatics.method2510

object ParticleEmitterListNodeStatics {
    var anInt9681: Int = 0
            var anInt9683: Int = 0
            ...
            fun method3273(bool: Boolean, i: Int, class348_sub16_sub3: MidiSequencePlayer?) {
                ...
                AbstractProceduralTextureNodeStatics.aSoundChannelMixer_7042!!.method2088(false, class348_sub16_sub3)
                anInt9681++
                if (bool) method2510(ModelFacePriorityNodeStatics.aJs5Archive_1878, class348_sub16_sub3, LightingOptionStateStatics.aJs5Archive_5878, false, AbstractProceduralTextureNodeStatics.aSoundChannelMixer_7042, HoverActionEntryStatics.aJs5Archive_1815)
            }
            ...
            fun method3275(i: Int, i_0_: Int, i_1_: Int) {
                ...
                if (HardCacheEntryReferenceStatics.aSceneProjector_10434 != GlRectangleTextureStatics.aSceneProjector_8638) {
