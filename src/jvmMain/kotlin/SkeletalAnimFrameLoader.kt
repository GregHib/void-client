...
class SkeletalAnimFrameLoader {
    ...
    companion object {
        ...
        fun method345(i: Int, i_17_: Byte) {
            anInt469++
            if (SpriteDefinition.anInt7068 == 0) NodeDequeHolder.aClass348_Sub16_Sub3_1564!!.method2861(0, i)
        ...
        fun method349(i: Int) {
            ...
            for (i_33_ in 0..<i_32_) {
                ...
                if (player != null) Client.method2556(false, player.method2436(60.toByte()), player)
            }
        ...
        fun method350(i: Int, i_34_: Int, i_35_: Int, i_36_: Int, i_37_: Int) {
            anInt466++
            val class348_sub42_sub15 = ConfigValueProvider.method2516(i_36_, 105.toByte(), 10)
