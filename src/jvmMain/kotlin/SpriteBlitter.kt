...
object SpriteBlitter {
    ...
    fun method880(i: Int, `is`: ByteArray?, is_0_: ByteArray?, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int) {
        ...
        try {
            ...
            throw SoundBankPatchStatics.method2929(runtimeexception, ("me.D(" + i + ',' + (if (`is` != null) "{...}" else "null") + ',' + (if (is_0_ != null) "{...}" else "null") + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ')'))
        }
    }
    ...
    fun method881(class348_sub42_sub13: ContactList, i: Int, bool: Boolean, i_11_: Int) {
        ...
        if (ScrollbarComponentStatics.aBoolean8335) {
            ...
            i_12_ += 8
            if (bool == true) {
                ClickFeedbackTaskStatics.anInt4669 = 16 * (class348_sub42_sub13.anInt9615) + (if (!PlayerSequenceSelector.aBoolean1211) 22 else 26)
                val i_14_ = 21 + (class348_sub42_sub13.anInt9615) * 16
                var i_15_ = SceneTileBoundsStatics.anInt1117 + GlArrayBufferObjectStatics.anInt4717
                if (i_12_ + i_15_ > LocTypeDefinitionStatics.anInt4017) i_15_ = -i_12_ + GlArrayBufferObjectStatics.anInt4717
                if (i_15_ < 0) i_15_ = 0
                val i_16_ = if (!PlayerSequenceSelector.aBoolean1211) 31 else 33
                var i_17_ = 13 + i_11_ + -i_16_
                if (i_17_ + i_14_ > HardCacheEntryReferenceStatics.anInt10432) i_17_ = HardCacheEntryReferenceStatics.anInt10432 - i_14_
                MinimapPolygonDrawerStatics.anInt5252 = i_15_
                if (i_17_ < 0) i_17_ = 0
                ManagedGlResourceStatics.aClass348_Sub42_Sub13_3152 = class348_sub42_sub13
                TerrainTileShapeStatics.anInt8806 = i_12_
                InputTrackerStatics.anInt4534 = i_17_
            }
        }
    }
    ...
    fun method882(i: Byte) {
        ...
        WarpTextureNodeStatics.aWidgetComponentArrayArray9427 = arrayOfNulls(RenderConfigFactoryStatics.aJs5Archive_2978!!.method414(-1))
        anInt1573++
        WorldMapTextLabelStatics.aWidgetComponentArrayArray8584 = arrayOfNulls(RenderConfigFactoryStatics.aJs5Archive_2978!!.method414(-1))
