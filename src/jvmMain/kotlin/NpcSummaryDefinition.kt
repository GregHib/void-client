            ...
            if (i == 1) {
                if (i_0_ < ModelDefinitionLoader.anInt2057) {
                    ...
                    while (ModelDefinitionLoader.anInt2057 > i_1_) {
                        ProportionalScrollbarComponent.anIntArray9932!![ParticleGeometry.anInt4411++] = RgbColorPalette.anIntArray1233!![i_1_]
                        i_1_++
                    }
                }
                ...
                for (i_2_ in 0..<i_0_) {
                    val i_3_ = RgbColorPalette.anIntArray1233!![i_2_]
