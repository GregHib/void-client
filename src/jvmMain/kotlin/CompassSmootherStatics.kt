...
object CompassSmootherStatics {
    var anInt3364: Int = 0
            ...
            fun method2015(i: Int, i_0_: Int, i_1_: Int): Boolean {
                ...
                return ((LoadingBarRendererStatics.method2217(i_0_, i, i_1_ xor 0x7) or method3056(115, i, i_0_) or method3073(i_0_, i, 50.toByte())) and method1258(i, -9301, i_0_))
            }
            ...
            fun method2017(i: Int, widgetDefinition: WidgetDefinition?, i_3_: Int) {
                ...
                if (HintArrowOrMessageStatics.anInt2021 < 50 && (widgetDefinition != null && widgetDefinition.anIntArrayArray264 != null && (widgetDefinition.anIntArrayArray264!!.size > i) && widgetDefinition.anIntArrayArray264!![i] != null)) {
                    ...
                    if (i_3_ > 8) {
                        var i_8_ = 256
                        if (widgetDefinition.anIntArray236 != null && widgetDefinition.anIntArray265 != null) i_8_ = Texture2DProviderStatics.method2257((widgetDefinition.anIntArray265!![i]), (widgetDefinition.anIntArray236!![i]), (-125).toByte())
                        if (widgetDefinition.aBoolean268) SoundChannelMixerStatics.method2090(i_7_, i_8_, false, (-35).toByte(), 255, 0, i_5_)
                        else TextureTileRendererStatics.method2947(true, 255, i_5_, i_7_, 0, i_8_)
                    }
                }
            }
