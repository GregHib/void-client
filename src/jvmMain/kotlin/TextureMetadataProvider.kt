import TextureMetadataProviderStatics.anInt4612
import TextureMetadataProviderStatics.anInt4614
import TextureMetadataProviderStatics.aLong4615
import TextureMetadataProviderStatics.anInt4616
import TextureMetadataProviderStatics.anInt4617
import TextureMetadataProviderStatics.anInt4618
import TextureMetadataProviderStatics.anInt4620
import TextureMetadataProviderStatics.anInt4621
...
class TextureMetadataProvider internal constructor(js5Archive: Js5Archive?, js5Archive_12_: Js5Archive?, js5Archive_13_: Js5Archive?) : RenderConfig {
    ...
    init {
        try {
            ...
            throw SoundBankPatchStatics.method2929(runtimeexception, ("tda.<init>(" + (if (js5Archive != null) "{...}" else "null") + ',' + (if (js5Archive_12_ != null) "{...}" else "null") + ',' + (if (js5Archive_13_ != null) "{...}" else "null") + ')'))
        }
    }
}
