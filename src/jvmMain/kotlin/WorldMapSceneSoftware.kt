...
class WorldMapSceneSoftware internal constructor(i: Int, i_114_: Int, i_115_: Int, bool: Boolean) : WorldMapScene(i, i_114_, i_115_, bool, RenderConfigFactoryStatics.aLocDefinitionCache_2979, Tooltip.aParticleDefLoader_4460) {
        ...
        try {
            ...
            if (IntHashSetStatics.aClass348_Sub51_3959!!.aClass239_Sub27_7261!!.method1840(i_3_ xor 0x7e6f.inv()) != 0 || method536(i_5_, false, i, ParticleSystemState.anInt2204, i_2_)) {
                ...
                if (IntHashSetStatics.aClass348_Sub51_3959!!.aClass239_Sub24_7235!!.method1820(i_3_ + -32400) != 0 || !class51.aBoolean931) {
                    ...
                    val var_s = ActorEntity.aTerrainTileArray5191!![i_2_]
                    ...
                    if (class51.method474(82.toByte())) IdentKitRecolorStatics.method1614(979190089, null, i_0_, i_5_, i, null, class51, i_7_)
            ...
            throw TextureLoadException.method2929(runtimeexception, ("vaa.W(" + i + ',' + i_0_ + ',' + i_1_ + ',' + (if (var_renderer != null) "{...}" else "null") + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + (if (collisionMap != null) "{...}" else "null") + ')'))
        }
    }
    ...
    fun method1691(i: Int, var_renderer: Renderer?, class348_sub49: ByteBuffer?, `is`: IntArray?, i_39_: Int, i_40_: Byte) {
        do {
            try {
                ...
                throw TextureLoadException.method2929(runtimeexception, ("vaa.AA(" + i + ',' + (if (var_renderer != null) "{...}" else "null") + ',' + (if (class348_sub49 != null) "{...}" else "null") + ',' + (if (`is` != null) "{...}" else "null") + ',' + i_39_ + ',' + i_40_ + ')'))
            }
            break
        } while (false)
    }
    ...
    fun method1692(i: Int, i_73_: Int, `is`: ByteArray?, i_74_: Int, i_75_: Int, var_renderer: Renderer?, i_76_: Int, i_77_: Int, i_78_: Int, collisionMaps: Array<CollisionMap?>?, i_79_: Int) {
        try {
            ...
            throw TextureLoadException.method2929(runtimeexception, ("vaa.S(" + i + ',' + i_73_ + ',' + (if (`is` != null) "{...}" else "null") + ',' + i_74_ + ',' + i_75_ + ',' + (if (var_renderer != null) "{...}" else "null") + ',' + i_76_ + ',' + i_77_ + ',' + i_78_ + ',' + (if (collisionMaps != null) "{...}" else "null") + ',' + i_79_ + ')'))
        }
    }
        ...
        while_77_@ do {
            do {
                try {
                    ...
                    throw TextureLoadException.method2929(runtimeexception, ("vaa.U(" + (if (collisionMap != null) "{...}" else "null") + ',' + i + ',' + i_93_ + ',' + (if (var_renderer != null) "{...}" else "null") + ',' + i_94_ + ',' + i_95_ + ',' + i_96_ + ')'))
                }
            } while (false)
            break
        } while (false)
    ...
    fun method1695(`is`: ByteArray?, collisionMaps: Array<CollisionMap?>?, i: Int, var_renderer: Renderer?, i_99_: Int, i_100_: Int) {
        try {
            ...
            throw TextureLoadException.method2929(runtimeexception, ("vaa.R(" + (if (`is` != null) "{...}" else "null") + ',' + (if (collisionMaps != null) "{...}" else "null") + ',' + i + ',' + (if (var_renderer != null) "{...}" else "null") + ',' + i_99_ + ',' + i_100_ + ')'))
        }
    }
    ...
    fun method1696(class348_sub49: ByteBuffer?, bool: Boolean, i: Int, i_116_: Int, i_117_: Int, i_118_: Int, i_119_: Int, i_120_: Int, var_renderer: Renderer?, `is`: IntArray?, i_121_: Int) {
        do {
            try {
                ...
                throw TextureLoadException.method2929(runtimeexception, ("vaa.O(" + (if (class348_sub49 != null) "{...}" else "null") + ',' + bool + ',' + i + ',' + i_116_ + ',' + i_117_ + ',' + i_118_ + ',' + i_119_ + ',' + i_120_ + ',' + (if (var_renderer != null) "{...}" else "null") + ',' + (if (`is` != null) "{...}" else "null") + ',' + i_121_ + ')'))
            }
            break
        } while (false)
    }
    ...
    fun method1697(bool: Boolean, var_renderer: Renderer?, i: Int) {
        try {
            ...
            throw TextureLoadException.method2929(runtimeexception, ("vaa.T(" + bool + ',' + (if (var_renderer != null) "{...}" else "null") + ',' + i + ')'))
        }
    }
