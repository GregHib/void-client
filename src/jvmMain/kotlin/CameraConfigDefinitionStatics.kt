    ...
    @JvmField
            ...
            fun method1919(i: Int, f: Float, `is`: ByteArray?, f_0_: Float, i_1_: Int, f_2_: Float, textureGenerator: TextureGenerator?, f_3_: Float, i_4_: Int, i_5_: Byte, i_6_: Int, f_7_: Float, i_8_: Int) {
                ...
                try {
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("u.B(" + i + ',' + f + ',' + (if (`is` != null) "{...}" else "null") + ',' + f_0_ + ',' + i_1_ + ',' + f_2_ + ',' + (if (textureGenerator != null) "{...}" else "null") + ',' + f_3_ + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + f_7_ + ',' + i_8_ + ')'))
                }
            }
            ...
            fun method1922(string: String?, i: Int, string_12_: String?, bool: Boolean) {
                try {
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("u.E(" + (if (string != null) "{...}" else "null") + ',' + i + ',' + (if (string_12_ != null) "{...}" else "null") + ',' + bool + ')'))
                }
            }
}
