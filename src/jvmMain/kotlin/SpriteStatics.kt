    ...
    @JvmField
            ...
            fun method159(i: Int) {
                if (WalkingTypeUtil.anInt3312 > 0) {
                    var i_1_ = 0
                    var i_2_ = 0
                    while (ArbFogMaterialPassStatics.aStringArray6200!!.size > i_2_) {
                        if (ArbFogMaterialPassStatics.aStringArray6200!![i_2_]!!.indexOf("--> ") != -1 && ++i_1_ == WalkingTypeUtil.anInt3312) {
                            MapElementManager.aString4461 = (ArbFogMaterialPassStatics.aStringArray6200!![i_2_]!!.substring(2 + ArbFogMaterialPassStatics.aStringArray6200!![i_2_]!!.indexOf(">")))
                            break
                        }
                        i_2_++
                    }
