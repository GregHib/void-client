        ...
        fun method1823(var_renderer: Renderer, i: Int, i_4_: Int, i_5_: Byte) {
            ...
            if (i >= 0 && i_4_ >= 0 && GlFramebufferBlitter.anInt282 != 0 && ParticleSystemRenderer.anInt3861 != 0) {
                ...
                if (GrayscaleNoiseTexture.aBoolean5300) {
                    ...
                    abstractCameraTransform.method903(GlRectangleTexture.anInt8633, CachedRgbNoiseTexture.anInt8668, MinimapTileEntryStatics.anInt620, PackedFlagsAccessor.anInt7092, ClanChatRequestSender.anInt3650, DisplaySettingsConfig.anInt7244)
