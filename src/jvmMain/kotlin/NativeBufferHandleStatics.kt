...
object NativeBufferHandleStatics {
    @JvmField
            ...
            fun method849(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int) {
                ...
                val i_6_ = i_0_ + i
                val i_7_ = -i + i_3_
                for (i_8_ in i_0_..<i_6_) GlElementArrayBufferStatics.method1156(-27, i_2_, WidgetDefinitionStatics.anIntArrayArray255!![i_8_]!!, i_1_, i_5_)
                val i_9_ = -i + i_2_
                for (i_10_ in i_3_ downTo i_7_ + 1) GlElementArrayBufferStatics.method1156(-27, i_2_, WidgetDefinitionStatics.anIntArrayArray255!![i_10_]!!, i_1_, i_5_)
                val i_11_ = i + i_1_
                var i_12_ = i_6_
                while (i_7_ >= i_12_) {
                    val `is`: IntArray = WidgetDefinitionStatics.anIntArrayArray255!![i_12_]!!
                    GlElementArrayBufferStatics.method1156(-27, i_11_, `is`, i_1_, i_5_)
                    GlElementArrayBufferStatics.method1156(-27, i_2_, `is`, i_9_, i_5_)
                    i_12_++
                }
            }
            ...
            fun method850(class318_sub1_sub3: GroundDecorEntity, bool: Boolean): Boolean {
                val bool_13_ = NativeSpriteStatics.aTerrainTileArray5191 == SoundCacheState.aTerrainTileArray4142
                var i = 0
                var i_14_: Short = 0
                var i_15_: Byte = 0
                class318_sub1_sub3.method2409((-116).toByte())
                if (class318_sub1_sub3.aShort8743 < 0 || class318_sub1_sub3.aShort8750 < 0 || (class318_sub1_sub3.aShort8751 >= SpotAnimEntityStatics.anInt6451) || (class318_sub1_sub3.aShort8747 >= RegionSceneShifterStatics.anInt7054)) return false
                var i_16_: Short = 0
                for (i_17_ in class318_sub1_sub3.aShort8743..class318_sub1_sub3.aShort8751) {
                    for (i_18_ in class318_sub1_sub3.aShort8750..class318_sub1_sub3.aShort8747) {
                        ...
                        if (class357 != null) {
                            ...
                            if (bool_13_ && (WidgetRedrawRegionStatics.anIntArrayArray4253!![i_17_]!![i_18_] and 0xffffff.inv()) != 0) {
                                i = WidgetRedrawRegionStatics.anIntArrayArray4253!![i_17_]!![i_18_]
                                i_14_ = BooleanGraphicsOptionStateStatics.aShortArrayArray5847!![i_17_]!![i_18_]
                ...
                if (bool_13_ && (i and 0xffffff.inv()) != 0) {
                    for (i_20_ in class318_sub1_sub3.aShort8743..class318_sub1_sub3.aShort8751) {
                        ...
                        while ((i_21_ <= class318_sub1_sub3.aShort8747)) {
                            if ((WidgetRedrawRegionStatics.anIntArrayArray4253!![i_20_]!![i_21_] and 0xffffff.inv()) == 0) {
                                WidgetRedrawRegionStatics.anIntArrayArray4253!![i_20_]!![i_21_] = i
                                BooleanGraphicsOptionStateStatics.aShortArrayArray5847!![i_20_]!![i_21_] = i_14_
                ...
                if (bool) ModelDataCache.aClass318_Sub1_Sub3Array357!![DrawListState.anInt1477++] = class318_sub1_sub3
                    ...
                    val i_22_ = if (NativeSpriteStatics.aTerrainTileArray5191 == SoundCacheState.aTerrainTileArray4142) 1 else 0
                    if (class318_sub1_sub3.method2376(-118)) {
                        if (class318_sub1_sub3.method2377(122.toByte())) {
                            class318_sub1_sub3.aClass318_Sub1_6379 = BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_22_]
                            BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_22_] = class318_sub1_sub3
                        } else {
