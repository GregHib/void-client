...
class CubemapTextureGlSource internal constructor(var_ha_Sub2: OpenGlRenderer, i: Int) : Texture2DProvider() {
    ...
    companion object {
        ...
        var aOutgoingPacketHeader_8706: OutgoingPacketHeader? = OutgoingPacketHeader(79, 3)
        @JvmStatic
        fun method2263(var_renderer: Renderer?, i: Int, i_4_: Int): AbstractModelRenderer? {
            ...
            if (i != 0) aOutgoingPacketHeader_8706 = null
            return null
        }
        ...
        fun method2264(bool: Boolean) {
            ...
            anInt8704++
            val class348_sub42_sub15 = ConfigValueProvider.method2516(0, 105.toByte(), 15)
        ...
        fun method2265(i: Int) {
            ...
            if (i != -10794) aOutgoingPacketHeader_8706 = null
            aOutgoingPacketHeader_8706 = null
        }
