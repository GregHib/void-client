object ParticleConfigParserStatics {
    var anInt3815: Int = 0
            ...
            fun method2273(i: Byte): OutgoingPacketNode? {
                ...
                if (GroundDecorOptionStateStatics.anInt5980 == 0) return OutgoingPacketNode()
                return PingHostListHolder.aClass348_Sub47Array2334!![--GroundDecorOptionStateStatics.anInt5980]
            }
            ...
            fun method2274(string: String?, i: Int): Int {
                ...
                if (i >= -41) return 97
                var i_0_ = 0
                while ((i_0_ < HslAdjustTextureNodeStatics.anInt9383)) {
                    if (string.equals(WaterTextureSetStatics.aStringArray1441!![i_0_], ignoreCase = true)) return i_0_
                    i_0_++
                }
                return -1
            }
