...
class MapSceneCache internal constructor(sceneProjector: SceneProjector?, i: Int, js5Archive: Js5Archive?) {
    ...
    companion object {
        ...
        fun method826(i: Int, i_24_: Int, i_25_: Int, i_26_: Int, i_27_: Int, i_28_: Int, var_renderer: Renderer) {
            ...
            anInt1454++
            if (MapSceneCache.aAbstractModelRenderer_2309 != null && TimedTileQueueEntryStatics.aAbstractModelRenderer_9658 != null && TimedTileQueueEntryStatics.aAbstractModelRenderer_9659 != null) {
                val i_30_ = (-(TimedTileQueueEntryStatics.aAbstractModelRenderer_9659!!.method971() * 2) + i_25_) / MapSceneCache.aAbstractModelRenderer_2309!!.method971()
                for (i_31_ in 0..<i_30_) MapSceneCache.aAbstractModelRenderer_2309!!.method974(i_24_ + (TimedTileQueueEntryStatics.aAbstractModelRenderer_9659!!.method971() - -(i_31_ * MapSceneCache.aAbstractModelRenderer_2309!!.method971())), -MapSceneCache.aAbstractModelRenderer_2309!!.method969() + (i_28_ + i_26_))
                ...
                for (i_33_ in 0..<i_32_) {
                    ...
                    ConfigVarProgress.aAbstractModelRenderer_4808!!.method974(-ConfigVarProgress.aAbstractModelRenderer_4808!!.method971() + i_25_ + i_24_, (TimedTileQueueEntryStatics.aAbstractModelRenderer_9658!!.method969() * i_33_ + i + i_28_))
                }
