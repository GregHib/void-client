            ...
            fun method1034(i: Int, class348_sub49: ByteBuffer?, privilegedOperationWorker: PrivilegedOperationWorker?, i_5_: Int) {
                try {
                    ...
                    if (i_5_ > 90) {
                            ...
                            try {
                                ...
                                if (i_7_ != 0 && i_7_ != 1 && i_7_ != 2) {
                                    if (i_7_ == 3 || i_7_ == 4) {
                                        ...
                                        var i_13_ = 0
                                        while ((i_13_ < i_9_)) {
                                            var_classes[i_13_] = (ColorThresholdEffectStatics.method3052(11012, strings[i_13_]))
                                            i_13_++
                                        }
                                        class348_sub48.aLinkedQueueNodeArray7127!![i_6_] = (privilegedOperationWorker!!.method2230(var_classes, 76, ColorThresholdEffectStatics.method3052(11012, string), string_8_))
                                    ...
                                    class348_sub48.aLinkedQueueNodeArray7135!![i_6_] = (privilegedOperationWorker!!.method2243(0, string_14_, ColorThresholdEffectStatics.method3052(11012, string)))
                                }
                        ...
                        IntKeyNodeStatics.aNodeDeque_6978!!.method1999(class348_sub48, -20180)
                    }
                } catch (runtimeexception: RuntimeException) {
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("mr.E(" + i + ',' + (if (class348_sub49 != null) "{...}" else "null") + ',' + (if (privilegedOperationWorker != null) "{...}" else "null") + ',' + i_5_ + ')'))
                }
            }
