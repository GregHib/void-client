...
class MouseInputTracker(component: Component?, bool: Boolean) : InputTracker(), MouseListener, MouseMotionListener {
    ...
    private fun method3606(i: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int) {
        ...
        class348_sub45_sub2.aLong9734 = CommonClock.method599(-110)
    ...
    companion object {
        ...
        fun method3607(i: Int, class348_sub49: ByteBuffer?, i_10_: Int): String {
            ...
            try {
                ...
                class348_sub49.anInt7197 += (NativeRenderer.aHuffmanCodec_1131!!.method2226(`is`, class348_sub49.anInt7197, class348_sub49.aByteArray7154, i_12_, -1, 0))
