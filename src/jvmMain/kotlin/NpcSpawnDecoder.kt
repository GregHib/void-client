...
object NpcSpawnDecoder {
    ...
    fun method858(bool: Boolean, player: Player) {
        ...
        if (bool == true) {
            if (class348_sub9 == null) IdentKitRecolorStatics.method1614(979190089, null, player.plane.toInt(), (player.anIntArray10317!![0]), (player.anIntArray10320!![0]), player, null, 0)
