...
object NpcSpawnDecoder {
    ...
    fun method858(bool: Boolean, player: Player) {
        anInt1526++
        val class348_sub9 = ((CompletedResourceRequestStatics.aHashtable_10465!!.method3480(player.anInt10290.toLong(), -6008)) as CharacterRenderState)
        if (bool == true) {
            if (class348_sub9 == null) ProjectileFactoryStatics.method1614(979190089, null, player.plane.toInt(), (player.anIntArray10317!![0]), (player.anIntArray10320!![0]), player, null, 0)
            ...
            while (i_0_ > i_1_) {
                if (StringCacheNodeStatics.aByteArrayArray7212!![i_1_] != null) {
                    ...
                    for (i_3_ in 0..<ProjectileConfigUtil.anInt388) {
                        if (WidgetRedrawRegionStatics.anIntArray4250!![i_3_] == NullOggStreamStatics.anIntArray9042!![i_1_]) {
                            i_2_ = i_3_
                            break
                        }
                    }
                    if (i_2_ == -1) {
                        WidgetRedrawRegionStatics.anIntArray4250!![ProjectileConfigUtil.anInt388] = NullOggStreamStatics.anIntArray9042!![i_1_]
                    ...
                    while (class348_sub49.anInt7197 < StringCacheNodeStatics.aByteArrayArray7212!![i_1_]!!.size) {
                        if (i_4_ >= 511 || ModelDefinitionLoaderStatics.anInt2057 >= 1023) break
                        ...
                        val i_10_ = (i_8_ + (-ArbVertexProgramStatics.regionTileX + (NullOggStreamStatics.anIntArray9042!![i_1_] shr 8) * 64))
                        val i_11_ = (-RegionMapDecoder.regionTileY + (64 * (0xff and (NullOggStreamStatics.anIntArray9042!![i_1_])) - -i_9_))
                        ...
                        if (class348_sub22 == null && (class79.aByte1325.toInt() and 0x1) > 0 && i_7_ == ParticleSystemStateStatics.anInt2204 && i_10_ >= 0 && (GlCubemapLightPassStatics.anInt7319 > i_10_ - -class79.anInt1399) && i_11_ >= 0 && (RangeThresholdTextureNodeStatics.anInt9109 > i_11_ + class79.anInt1399)) {
                            val npc = Npc()
                            npc.anInt10290 = i_5_
                            ...
                            TurbulenceTextureNodeStatics.aClass348_Sub22Array9319!![TerrainShadowBuilderGl2Statics.anInt6930++] = class348_sub22_12_
                            RgbColorPaletteStatics.anIntArray1233!![ModelDefinitionLoaderStatics.anInt2057++] = i_5_
                            npc.anInt10306 = GlGroundShaderPassStatics.anInt7396
