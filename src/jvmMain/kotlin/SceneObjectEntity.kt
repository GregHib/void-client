...
abstract class SceneObjectEntity internal constructor(i: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int) : SceneEntity() {
    ...
    override fun method2380(var_renderer: Renderer?, i: Int, bool: Boolean, class318_sub1: SceneEntity?, i_3_: Int, i_4_: Byte, i_5_: Int) {
        try {
            ...
            throw TextureLoadException.method2929(runtimeexception, ("fha.N(" + (if (var_renderer != null) "{...}" else "null") + ',' + i + ',' + bool + ',' + (if (class318_sub1 != null) "{...}" else "null") + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ')'))
        }
    }
    ...
    companion object {
        ...
        fun method2405(i: Int) {
            ...
            SkeletalAnimFrameLoader.aLong482 = CommonClock.method599(-117)
