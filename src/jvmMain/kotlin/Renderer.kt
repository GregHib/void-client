...
import java.util.*
import RendererStatics.anInt4561
import RendererStatics.anInt4563
import RendererStatics.anInt4565
import RendererStatics.anInt4566
import RendererStatics.anInt4568
import RendererStatics.anInt4569
import RendererStatics.anInt4570
import RendererStatics.anInt4572
import RendererStatics.anInt4573
import RendererStatics.anInt4574
import RendererStatics.anInt4577
import RendererStatics.anInt4580
import RendererStatics.aFloat4582
...
abstract class Renderer internal constructor(@JvmField var aRenderConfig4579: RenderConfig?) {
    ...
    fun method3635(i: Byte) {
        val i_15_ = -90 % ((i - 8) / 33)
        anInt4573++
        ColourKeyTextureNodeStatics.aBooleanArray9351!![this.anInt4567] = false
        method3652()
    }
    ...
    abstract fun method3686(fontDefinition: FontDefinition?, spriteImages: Array<SpriteImage>?, bool: Boolean): Font?
    ...
    init {
        var i = -1
        for (i_215_ in 0..7) {
            if (!ColourKeyTextureNodeStatics.aBooleanArray9351!![i_215_]) {
                ColourKeyTextureNodeStatics.aBooleanArray9351!![i_215_] = true
                i = i_215_
                break
            }
        }
