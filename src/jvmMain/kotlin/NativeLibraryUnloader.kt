...
object NativeLibraryUnloader {
    ...
    fun method1629(bool: Boolean): Boolean {
        ...
        var enumeration: Enumeration<*> = PlayerStatics.aHashtable10565!!.keys()
        while (enumeration.hasMoreElements()) {
            val `object`: Any? = enumeration.nextElement()
            hashtable.put(`object`, PlayerStatics.aHashtable10565!!.get(`object`))
        }
        try {
            ...
            try {
                enumeration = PlayerStatics.aHashtable10565!!.keys()
                while (enumeration.hasMoreElements()) {
                    val string = enumeration.nextElement() as String?
                    try {
                        val file = CollisionMapAccessor.aHashtable3548!!.get(string) as File
                        val var_class_1_ = PlayerStatics.aHashtable10565!!.get(string) as Class<*>?
        ...
        PlayerStatics.aHashtable10565 = hashtable
        return PlayerStatics.aHashtable10565!!.isEmpty()
    }
    ...
    fun method1630(i: Int, i_6_: Int, i_7_: Int) {
        ...
        anInt2971++
        if (i != (TextureMetadataProviderStatics.anInt4609.inv()) && ColourAdjustmentStatics.anInt859 != -1) {
            var i_8_ = TextureMetadataProviderStatics.anInt4609 - WidgetActionEntryStatics.anInt6992
            if (i_8_ < 2 || i_8_ > 2) i_8_ /= 8
            var i_9_ = -DebugOverlayRenderer.anInt3170 + ColourAdjustmentStatics.anInt859
            WidgetActionEntryStatics.anInt6992 = i_8_ + WidgetActionEntryStatics.anInt6992
        ...
        if (GlEnvMappedWaterPassStatics.anInt7379 > 0) {
            ClientLoadStateMachine.anInt2173--
            if (ClientLoadStateMachine.anInt2173 == 0) {
                GlEnvMappedWaterPassStatics.anInt7379--
                ClientLoadStateMachine.anInt2173 = 100
            }
        } else {
            SkeletalAnimFrameLoaderStatics.anInt481 = -1
            ...
            while (class348_sub12 != null) {
                ...
                if (class348_sub12.method2799(i_6_, i_7_, 95)) {
                    if (class42!!.aStringArray577 != null) {
                        if (class42.aStringArray577[4] != null) MinimapPolygonDrawerStatics.method466(false, class42.aString565, 0, (-100).toByte(), false, class42.anInt596, -1, true, 1006, class348_sub12.aClass348_Sub21_6751!!.anInt6847.toLong(), class42.aStringArray577[4], class348_sub12.aClass348_Sub21_6751!!.anInt6847.toLong(), -1)
                        if (class42.aStringArray577[3] != null) MinimapPolygonDrawerStatics.method466(false, class42.aString565, 0, (-127).toByte(), false, class42.anInt596, -1, true, 1003, class348_sub12.aClass348_Sub21_6751!!.anInt6847.toLong(), class42.aStringArray577[3], class348_sub12.aClass348_Sub21_6751!!.anInt6847.toLong(), -1)
                        if (class42.aStringArray577[2] != null) MinimapPolygonDrawerStatics.method466(false, class42.aString565, 0, (-108).toByte(), false, class42.anInt596, -1, true, 1002, class348_sub12.aClass348_Sub21_6751!!.anInt6847.toLong(), class42.aStringArray577[2], class348_sub12.aClass348_Sub21_6751!!.anInt6847.toLong(), -1)
                        if (class42.aStringArray577[1] != null) MinimapPolygonDrawerStatics.method466(false, class42.aString565, 0, (-69).toByte(), false, class42.anInt596, -1, true, 1012, class348_sub12.aClass348_Sub21_6751!!.anInt6847.toLong(), class42.aStringArray577[1], class348_sub12.aClass348_Sub21_6751!!.anInt6847.toLong(), -1)
                        if (class42.aStringArray577[0] != null) MinimapPolygonDrawerStatics.method466(false, class42.aString565, 0, (-92).toByte(), false, class42.anInt596, -1, true, 1009, class348_sub12.aClass348_Sub21_6751!!.anInt6847.toLong(), class42.aStringArray577[0], class348_sub12.aClass348_Sub21_6751!!.anInt6847.toLong(), -1)
                    }
                    ...
                    if (class348_sub12.aClass348_Sub21_6751!!.aBoolean6848) ChatCommandProcessor.method701(StaticNoiseTextureStatics.aBoundsConstraintEntry_8664!!, class348_sub12.aClass348_Sub21_6751!!.anInt6847, class42.anInt596)
                } else if (class348_sub12.aClass348_Sub21_6751!!.aBoolean6848) {
                    class348_sub12.aClass348_Sub21_6751!!.aBoolean6848 = false
                    ChatCommandProcessor.method701(IsaacCipherStatics.aBoundsConstraintEntry_1298!!, class348_sub12.aClass348_Sub21_6751!!.anInt6847, class42!!.anInt596)
                }
