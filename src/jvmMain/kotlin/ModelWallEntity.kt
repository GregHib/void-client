...
class ModelWallEntity internal constructor(var_renderer: Renderer?, npcConfig: NpcConfig?, i: Int, i_7_: Int, i_8_: Int, i_9_: Int, i_10_: Int, bool: Boolean, i_11_: Int, i_12_: Int, i_13_: Int, i_14_: Int) : WallEntity(i_8_, i_9_, i_10_, i, i_7_, i_11_, i_12_), RenderTarget {
    ...
    public override fun method2391(var_renderer: Renderer?, i: Int, i_2_: Int, i_3_: Int): Boolean {
        ...
        if (class64 != null) {
            ...
            if (ParticleSystemRenderer.aBoolean3870) return class64.method623(i_2_, i, class101, false, 0, LocalPlayerState.anInt1906)
    ...
    companion object {
        ...
        var aOutgoingPacketHeader_10134: OutgoingPacketHeader? = OutgoingPacketHeader(62, 3)
        ...
        fun method2489(i: Byte): Int {
            ...
            if (IntHashSetStatics.aClass348_Sub42_Sub12_3963 == null) return 0
            if (i >= -11) return -42
            val i_1_ = (IntHashSetStatics.aClass348_Sub42_Sub12_3963!!.anInt9608)
        ...
        fun method2490(i: Int) {
            aOutgoingPacketHeader_10134 = null
