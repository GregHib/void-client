...
object AsyncResourceRequestStatics {
    @JvmField
            ...
            fun method3253(i: Int, i_0_: Int, i_1_: Int, var_class: Class<*>) {
                val class357 = HintArrowOrMessageStatics.aSceneCollisionEntryArrayArrayArray2029!![i]!![i_0_]!![i_1_]
                if (class357 != null) {
            ...
            fun method3254(i: Int, i_2_: Int, i_3_: Int, class318_sub1_sub4: ActorEntity, class318_sub1_sub4_4_: ActorEntity?) {
                ...
                if (class357 != null) {
                    ...
                    val i_5_ = if (NativeSpriteStatics.aTerrainTileArray5191 == SoundCacheState.aTerrainTileArray4142) 1 else 0
                    if (class318_sub1_sub4.method2376(-109)) {
                        if (class318_sub1_sub4.method2377(122.toByte())) {
                            class318_sub1_sub4.aClass318_Sub1_6379 = BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_5_]
                            BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_5_] = class318_sub1_sub4
                        } else {
                    ...
                    if (class318_sub1_sub4_4_ != null) {
                        if (class318_sub1_sub4_4_.method2376(-118)) {
                            if (class318_sub1_sub4_4_.method2377(122.toByte())) {
                                class318_sub1_sub4_4_.aClass318_Sub1_6379 = BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_5_]
                                BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_5_] = class318_sub1_sub4_4_
                            } else {
            ...
            fun method3255(i: Int, `is`: ByteArray?, i_6_: Int, bool: Boolean, string: String?, i_7_: Int): Int {
                try {
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("ffa.E(" + i + ',' + (if (`is` != null) "{...}" else "null") + ',' + i_6_ + ',' + bool + ',' + (if (string != null) "{...}" else "null") + ',' + i_7_ + ')'))
                }
            }
