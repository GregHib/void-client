...
class Class287 {
    ...
    private fun method2182(bool: Boolean, class223: Class223?, class348_sub49: Class348_Sub49?): Interface12? {
        try {
            ...
            if (Class101_Sub1Statics.aClass223_5689 == class223) return Class303.method2287(class348_sub49!!, (-112).toByte())
            ...
            try {
                ...
                if (l >= i_18_.toLong()) {
                    ...
                    if (i_18_ > i_19_ * i_19_) {
                        ...
                        else i_20_ = 0x3fff and (Class314.aFloat3938.toInt() + r_Sub2Statics.anInt10483)
