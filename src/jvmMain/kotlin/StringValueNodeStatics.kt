...
object StringValueNodeStatics {
    var anInt7109: Int = 0
            ...
            fun method3319(var_renderer: Renderer?, i: Byte) {
                ...
                anInt7114++
                if (((LocalPlayerState.aPlayer_1907!!.plane).toInt() != CameraOrModelTransformStatics.anInt4155) && HintArrowOrMessageStatics.aSceneCollisionEntryArrayArrayArray2029 != null) {
            ...
            fun method3320(class318_sub1_sub3: GroundDecorEntity, bool: Boolean) {
                for (i in class318_sub1_sub3.aShort8743..class318_sub1_sub3.aShort8751) {
                    for (i_0_ in class318_sub1_sub3.aShort8750..class318_sub1_sub3.aShort8747) {
                        val class357 = (HintArrowOrMessageStatics.aSceneCollisionEntryArrayArrayArray2029!![class318_sub1_sub3.plane.toInt()]!![i]!![i_0_])
                        if (class357 != null) {
            ...
            fun method3321(i: Int, i_2_: Int, i_3_: Int): SceneCollisionEntry? {
                if (HintArrowOrMessageStatics.aSceneCollisionEntryArrayArrayArray2029!![i]!![i_2_]!![i_3_] == null) {
                    val bool = (HintArrowOrMessageStatics.aSceneCollisionEntryArrayArrayArray2029!![0]!![i_2_]!![i_3_] != null && HintArrowOrMessageStatics.aSceneCollisionEntryArrayArrayArray2029!![0]!![i_2_]!![i_3_]!!.aSceneCollisionEntry_4400 != null)
                    if (bool && i >= MapAreaDefinitionStatics.anInt2524 - 1) return null
                    method1394(i, i_2_, i_3_)
                }
                return HintArrowOrMessageStatics.aSceneCollisionEntryArrayArrayArray2029!![i]!![i_2_]!![i_3_]
            }
    
            fun method3322(i: Int, class348_sub49: ByteBuffer): WorldMapIconLabel {
                anInt7109++
                val class369 = PcmStreamBufferStatics.method2834((-125).toByte(), class348_sub49)
