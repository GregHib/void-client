...
class Class170 : Interface17 {
    ...
    override fun method62(i: Int, i_3_: Int): Int {
        anInt5068++
        val class146 = Class229.class194!!.method1446(i, -1)
    ...
    fun method1316(i: Byte, i_30_: Int, i_31_: Int) {
        var i_31_ = i_31_
        anInt5069++
        val class146 = Class229.class194!!.method1446(i_30_, -1)
    ...
    companion object {
        ...
        fun method1311(i: Int, var_ha: ha) {
            ...
            while ((i_21_ < Class348_Sub1Statics.anIntArray6547!!.size)) {
                ...
                val class143 = Class239_Sub10.method1766((-86).toByte(), i_22_, s.aClass45_4585 as Class45)
