...
object GameDisplayManager {
    ...
    fun method1580(i: Byte, bool: Boolean, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int) {
        if (SkeletalAnimFrameLoader.aFrame476 != null && (i_2_ != 3 || i_0_ != KeyboardInputSourceStatics.anInt4276 || i_3_ != FlickeringEffectsOptionState.anInt5911)) {
        ...
        if (i_2_ == 3 && SkeletalAnimFrameLoader.aFrame476 == null) GameDisplayManager.method1580((-126).toByte(), true, -1, i_1_, IntHashSetStatics.aClass348_Sub51_3959!!.aClass239_Sub8_7227!!.method1751(-32350), -1)
            ...
            if (bool) OutgoingPacketNode.method3327(1406)
                ...
                if (!GrayscaleNoiseTexture.aBoolean5300) FacingDirectionNodeStatics.aRenderer6654!!.method3669(ParticleSystemRenderer.aCanvas3869, LocTypeDefinition.anInt4017, (GameDisplayManager.anInt10432))
            ...
            if (Client.aAbstractGameSocket_9165 != null && CameraOrModelTransformStatics.method2653(true, WorldMapRenderer.anInt4674)) method2145(-24498)
