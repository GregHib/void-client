...
//        super.finalize()
    ...
    internal constructor(var_ha_Sub2: OpenGlRenderer?, i: Int, `is`: ByteArray?, i_4_: Int, bool: Boolean) {
        try {
            ...
            throw TextureLoadException.method2929(runtimeexception, ("bi.<init>(" + (if (var_ha_Sub2 != null) "{...}" else "null") + ',' + i + ',' + (if (`is` != null) "{...}" else "null") + ',' + i_4_ + ',' + bool + ')'))
        }
    }
    ...
    internal constructor(var_ha_Sub2: OpenGlRenderer?, i: Int, buffer: Buffer?, i_5_: Int, bool: Boolean) {
        try {
            ...
            throw TextureLoadException.method2929(runtimeexception, ("bi.<init>(" + (if (var_ha_Sub2 != null) "{...}" else "null") + ',' + i + ',' + (if (buffer != null) "{...}" else "null") + ',' + i_5_ + ',' + bool + ')'))
        }
    }
    ...
    companion object {
        ...
        fun method1148(i: Int, i_0_: Int) {
            anInt1925++
            val class348_sub42_sub15 = ConfigValueProvider.method2516(i, 105.toByte(), i_0_) //6
