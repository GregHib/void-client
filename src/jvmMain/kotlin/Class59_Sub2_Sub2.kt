...
class Class59_Sub2_Sub2 : Class59_Sub2(12, 5, 16, 2, 2, 0.45f) {
    ...
    companion object {
        ...
        fun method569(i: Byte, class348_sub49: Class348_Sub49) {
            ...
            OutputStream_Sub1Statics.aClass110_Sub1Array97 = arrayOfNulls<Class110_Sub1>(1 + (Class239_Sub29.anInt6151 + -Class318_Sub1_Sub2.anInt8731))
            var i_2_ = 0
            while (Class225.anInt2956 > i_2_) {
                val i_3_ = class348_sub49.readSmart(-126)
                val class110_sub1 = (Class110_Sub1().also { OutputStream_Sub1Statics.aClass110_Sub1Array97!![i_3_] = it })
