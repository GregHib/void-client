...
import RgbNoiseTextureStatics.anInt5301
import RgbNoiseTextureStatics.anInt5304
import RgbNoiseTextureStatics.anInt5307
import RgbNoiseTextureStatics.anInt5310
...
open class RgbNoiseTexture(i: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int, f: Float) : NoiseTextureGenerator(i, i_2_, i_3_, i_4_, i_5_) {
    ...
    open fun method563(i: Byte, i_7_: Int, i_8_: Byte) {
        aByteArray5309[anInt5308++] = (NpcSummaryDefinitionStatics.method1166(127, i_8_.toInt() shr 1) + 127).toByte()
