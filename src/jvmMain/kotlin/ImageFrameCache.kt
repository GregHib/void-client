...
import ImageFrameCacheStatics.anInt4018
import ImageFrameCacheStatics.anInt4019
import ImageFrameCacheStatics.anInt4034
import ImageFrameCacheStatics.method2554
...
class ImageFrameCache internal constructor(i: Int, i_9_: Int, i_10_: Int) {
    ...
    fun method2553(i: Int): Array<Array<IntArray?>?>? {
        ...
        for (i_2_ in i..<anInt4020) aClass348_Sub24Array4033!![i_2_] = TileRenderStateStatics.aClass348_Sub24_4226
        return anIntArrayArrayArray4029
    }

    fun method2557(i: Int, i_6_: Int): Array<IntArray?>? {
        anInt4034++
        if (i >= -75) method2554((-61).toByte())
        ...
        aClass348_Sub24Array4033!![i_6_] = TileRenderStateStatics.aClass348_Sub24_4226
