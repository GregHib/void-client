...
import BoxBlurTextureNodeStatics.method3148
import BoxBlurTextureNodeStatics.anInt9457
import BoxBlurTextureNodeStatics.anInt9460
import BoxBlurTextureNodeStatics.anInt9462
    ...
    override fun method3042(i: Int, i_13_: Int): IntArray {
        ...
        if (this.aSpriteSheetCache_7032!!.aBoolean2570) {
            ...
            while (i - -anInt9463 >= i_19_) {
                val is_20_ = this.method3048(TextureCubeProviderStatics.anInt6325 and i_19_, 633706337, 0)!!
                val is_21_ = IntArray(DisplaceTextureNodeStatics.anInt9139)
                var i_22_ = 0
                var i_23_ = -anInt9466
                while (anInt9466 >= i_23_) {
                    i_22_ += is_20_[i_23_ and SimpleBinaryOptionStateStatics.anInt6076]
                    i_23_++
                }
                var i_24_ = 0
                while (i_24_ < DisplaceTextureNodeStatics.anInt9139) {
                    is_21_[i_24_] = i_17_ * i_22_ shr 16
                    i_22_ -= (is_20_[-anInt9466 + i_24_ and SimpleBinaryOptionStateStatics.anInt6076])
                    i_24_++
                    i_22_ += (is_20_[i_24_ + anInt9466 and SimpleBinaryOptionStateStatics.anInt6076])
                }
                is_18_[-i + (i_19_ + anInt9463)] = is_21_
                i_19_++
            }
            var i_25_ = 0
            while (DisplaceTextureNodeStatics.anInt9139 > i_25_) {
                var i_26_ = 0
                var i_27_ = 0
                while (i_14_ > i_27_) {
    ...
    override fun method3047(i: Int, i_28_: Int): Array<IntArray?>? {
        ...
        if (this.aImageFrameCache_7033!!.aBoolean4035) {
            ...
            for (i_34_ in i + -anInt9463..anInt9463 + i) {
                val is_35_ = this.method3039(55.toByte(), TextureCubeProviderStatics.anInt6325 and i_34_, 0)!!
                val is_36_: Array<IntArray> = Array<IntArray>(3) { IntArray(DisplaceTextureNodeStatics.anInt9139) }
                var i_37_ = 0
                var i_38_ = 0
                var i_39_ = 0
                val is_40_ = is_35_[0]!!
                ...
                for (i_43_ in -anInt9466..anInt9466) {
                    val i_44_ = SimpleBinaryOptionStateStatics.anInt6076 and i_43_
                    i_39_ += is_42_[i_44_]
                    i_37_ += is_40_[i_44_]
                    i_38_ += is_41_[i_44_]
                }
                ...
                val is_47_ = is_36_[2]
                var i_48_ = 0
                while (DisplaceTextureNodeStatics.anInt9139 > i_48_) {
                    is_45_[i_48_] = i_37_ * i_32_ shr 16
                    is_46_[i_48_] = i_38_ * i_32_ shr 16
                    is_47_[i_48_] = i_39_ * i_32_ shr 16
                    var i_49_ = SimpleBinaryOptionStateStatics.anInt6076 and -anInt9466 + i_48_
                    i_37_ -= is_40_[i_49_]
                    i_48_++
                    i_38_ -= is_41_[i_49_]
                    i_39_ -= is_42_[i_49_]
                    i_49_ = i_48_ - -anInt9466 and SimpleBinaryOptionStateStatics.anInt6076
                    i_39_ += is_42_[i_49_]
                    i_38_ += is_41_[i_49_]
                    i_37_ += is_40_[i_49_]
                }
            ...
            val is_52_ = `is`[2]!!
            var i_53_ = 0
            while (DisplaceTextureNodeStatics.anInt9139 > i_53_) {
                var i_54_ = 0
                var i_55_ = 0
                var i_56_ = 0
