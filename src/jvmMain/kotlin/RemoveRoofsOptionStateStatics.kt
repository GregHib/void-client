...
object RemoveRoofsOptionStateStatics {
    @JvmField
            var anInt6057: Int = 0
            @JvmField
            ...
            fun method1810(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int) {
                if (i_5_ != 8 && i_5_ != 16) {
                    var class357 = HintArrowOrMessageStatics.aSceneCollisionEntryArrayArrayArray2029!![i_4_]!![i]!![i_2_]
                    if (class357 == null) class357 = SceneCollisionEntry(i_4_)
                    if (i_5_ == 1) {
                    ...
                    if (MinimapSquareDrawerStatics.aBoolean5226) WaterMaterialPassStatics.method2152(false)
                } else if (i_5_ == 8) {
                    val i_12_ = i shl Tooltip.anInt4459
                    val i_13_ = ArchiveFileConditionWrapperStatics.anInt3465 + i_12_
                    val i_14_ = i_2_ shl Tooltip.anInt4459
                    val i_15_ = ArchiveFileConditionWrapperStatics.anInt3465 + i_14_
                    ...
                    LoadingBarRendererStatics.aMapTileShapeArray5060!![PackedFlagsAccessorStatics.anInt7101++] = MapTileShape(i_5_, i_4_, i_12_, i_13_, i_13_, i_12_, i_16_, i_17_, -i_1_ + i_17_, -i_1_ + i_16_, i_14_, i_15_, i_15_, i_14_)
                } else {
                    val i_6_ = ArchiveFileConditionWrapperStatics.anInt3465 + (i shl Tooltip.anInt4459)
                    val i_7_ = -ArchiveFileConditionWrapperStatics.anInt3465 + i_6_
                    val i_8_ = i_2_ shl Tooltip.anInt4459
                    val i_9_ = i_8_ + ArchiveFileConditionWrapperStatics.anInt3465
                    ...
                    LoadingBarRendererStatics.aMapTileShapeArray5060!![PackedFlagsAccessorStatics.anInt7101++] = MapTileShape(i_5_, i_4_, i_6_, i_7_, i_7_, i_6_, i_10_, i_11_, -i_1_ + i_11_, i_10_ - i_1_, i_8_, i_9_, i_9_, i_8_)
                }
                ...
                try {
                    ...
                    while_81_@ do {
                        ...
                        while (true) {
                            ...
                            c = GlSpriteRendererStatics.method990(c_25_, (-39).toByte())
                            c_24_ = GlSpriteRendererStatics.method990(c_26_, (-127).toByte())
                        ...
                        return (CameraNodeListStatics.method1056(i_18_, 30316, c_25_) + -CameraNodeListStatics.method1056(i_18_, i xor 0x55ac, c_26_))
                    } while (false)
                    ...
                    while (i_27_ > i_28_) {
                        ...
                        if (c_29_ != c_30_ && (c_29_.uppercaseChar() != c_30_.uppercaseChar())) {
                            ...
                            if (c_30_ != c_29_) return (CameraNodeListStatics.method1056(i_18_, 30316, c_29_) + -CameraNodeListStatics.method1056(i_18_, 30316, c_30_))
                        }
                        i_28_++
                    }
                    ...
                    while (i_27_ > i_32_) {
                        ...
                        if (c_34_ != c_33_) return (CameraNodeListStatics.method1056(i_18_, 30316, c_33_) - CameraNodeListStatics.method1056(i_18_, 30316, c_34_))
                        i_32_++
                    }
                    return 0
                } catch (runtimeexception: RuntimeException) {
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("vu.F(" + i + ',' + (if (string != null) "{...}" else "null") + ',' + i_18_ + ',' + (if (string_19_ != null) "{...}" else "null") + ')'))
                }
            }
