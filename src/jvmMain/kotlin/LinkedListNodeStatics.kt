            ...
            fun method2711(i: Int, i_3_: Int, abstractModel: AbstractModel?, i_4_: Int, bool: Boolean, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int, var_renderer: Renderer?, i_9_: Int, i_10_: Int, i_11_: Int, widgetDefinition: WidgetDefinition?): AbstractModel? {
                ...
                try {
                    ...
                    synchronized(WidgetRedrawRegionStatics.aLruByteCache_4254!!) {
                        abstractModel_13_ = WidgetRedrawRegionStatics.aLruByteCache_4254!!.method583(l, -64) as AbstractModel?
                    }
                    if (abstractModel_13_ == null || (var_renderer!!.method3667(abstractModel_13_.ua(), i_12_) != 0)) {
                        ...
                        for (i_18_ in 0..<i_15_) {
                            ...
                            while (i_14_ > i_21_) {
                                ...
                                val i_23_ = (TrigLookupTablesStatics.anIntArray1207!![i_22_] * i_19_ shr 14)
                                val i_24_ = (TrigLookupTablesStatics.anIntArray1204!![i_22_] * i_20_ shr 14)
                        ...
                        abstractModel_13_ = var_renderer!!.method3625(modelDefinition, i_12_, MapSceneDefLoaderStatics.anInt2482, 64, 768)
                        synchronized(WidgetRedrawRegionStatics.aLruByteCache_4254!!) {
                            WidgetRedrawRegionStatics.aLruByteCache_4254!!.method582(abstractModel_13_, l, (-103).toByte())
                        }
                    }
                    ...
                    if (widgetDefinition != null) {
                        ...
                        class348_sub42_sub17 = ParticleEmitterNodeStatics.aWidgetCache_191!!.method839(i_5_ shr 16, 3)
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("eh.PC(" + i + ',' + i_3_ + ',' + (if (abstractModel != null) "{...}" else "null") + ',' + i_4_ + ',' + bool + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + (if (var_renderer != null) "{...}" else "null") + ',' + i_9_ + ',' + i_10_ + ',' + i_11_ + ',' + (if (widgetDefinition != null) "{...}" else "null") + ')'))
                }
            }
