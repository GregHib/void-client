...
class WaterTextureSet internal constructor(var_ha_Sub2: OpenGlRenderer) {
    ...
    init {
        ...
        HashTableContainerStatics.method3030(8, var_ha_Sub2)
        if (this.aBoolean1442) {
            var `is` = method461(false, GlShaderProgramHandleStatics.anObject4177, 53146732)
            this.aClass258_Sub1_1440 = GlTexture3D(var_ha_Sub2, 6410, 128, 128, 16, `is`, 6410)
            `is` = method461(false, MapElementDefinitionCacheStatics.anObject3985, 53146732)
            ...
            if (class188!!.method1414(35632)) {
                `is` = method461(false, WorldMapTextLabelStatics.anObject8592, 53146732)
            ...
            for (i in 0..15) {
                val `is` = ObjectByteSerializerHolderStatics.method1331(97.toByte(), GlShaderProgramHandleStatics.anObject4177, 2 * (128 * i) * 128, 32768)
            ...
            for (i in 0..15) {
                val `is` = ObjectByteSerializerHolderStatics.method1331(110.toByte(), MapElementDefinitionCacheStatics.anObject3985, 2 * i * 16384, 32768)
