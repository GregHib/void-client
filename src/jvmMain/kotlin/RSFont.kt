...
abstract class RSFont internal constructor(var_renderer: Renderer?, fontDefinition: FontDefinition?) {
    ...
    private fun method2566(abstractModelRenderers: Array<AbstractModelRenderer?>?, `is`: IntArray?, i: Int, is_0_: IntArray?, is_1_: IntArray?, i_2_: Int, string: String?, i_3_: Int) {
        ...
        try {
            ...
            if (i_3_ == 174) {
                ...
                var i_8_ = 0
                while ( /**/i_7_ > i_8_) {
                    var c = (Js5Archive.method3464(string.get(i_8_), false).toInt() and 0xff).toChar()
    ...
    private fun method2573(i: Byte, string: String) {
        ...
        try {
            if (i <= -78) {
                if (string.startsWith("col=")) ParamMap.anInt9492 = (ParamMap.anInt9492 and 0xffffff.inv() or (ColourAdjustmentStatics.method450(-20188, string.substring(4), 16) and 0xffffff))
                ...
                if (string.startsWith("argb=")) ParamMap.anInt9492 = ColourAdjustmentStatics.method450(-20188, string.substring(5), 16)
                else if (string != "/argb") {
                    if (!string.startsWith("str=")) {
                        if (string == "str") Player.anInt10567 = (ParamMap.anInt9492 and 0xffffff.inv() or 0x800000)
                                ...
                                if (string != "u") {
                                    if (string != "/u") {
                                        if (!string.equals("shad=-1", ignoreCase = true)) {
                                            if (string.startsWith("shad=")) ConnectionStateRefs.anInt320 = ((0xffffff.inv() and (ParamMap.anInt9492)) or (ColourAdjustmentStatics.method450(-20188, string.substring(5), 16)))
                            ...
                            } else DirectionalStripeTextureNode.anInt9101 = ((ParamMap.anInt9492 and 0xffffff.inv()) or ColourAdjustmentStatics.method450(-20188, string.substring(2), 16))
                        } else Player.anInt10567 = -1
                    } else Player.anInt10567 = (ParamMap.anInt9492 and 0xffffff.inv() or ColourAdjustmentStatics.method450(-20188, string.substring(4), 16))
    ...
    private fun method2583(i: Int, i_103_: Int, i_104_: Int, abstractModelRenderers: Array<AbstractModelRenderer?>?, var_sprite: Sprite?, string: String?, `is`: IntArray?, i_105_: Int, i_106_: Int) {
        ...
        try {
            ...
            if (i_105_ == 25625) {
                var i_110_ = 0
                while ( /**/i_110_ < i_109_) {
                    var c = (Js5Archive.method3464(string.get(i_110_), false).toInt() and 0xff).toChar()
