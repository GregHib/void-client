            ...
            fun method449(string: String?, string_1_: String?, bool: Boolean, i: Int, bool_2_: Boolean) {
                do {
                    try {
                        ...
                        val `is`: IntArray = MinimapSquareDrawerStatics.method463(class348_sub47, false)
                        ...
                        class348_sub47.aClass348_Sub49_Sub2_7116!!.writeShort(107.toByte(), SocketStreamWorkerStatics.anInt2670)
                        class348_sub47.aClass348_Sub49_Sub2_7116!!.writeString((-5).toByte(), string!!)
                        class348_sub47.aClass348_Sub49_Sub2_7116!!.writeLong(TextureMetadataProviderStatics.aLong4615, 104.toByte())
                        class348_sub47.aClass348_Sub49_Sub2_7116!!.writeByte(bool, AnimationFrameDefinitionStatics.anInt6967)
                        class348_sub47.aClass348_Sub49_Sub2_7116!!.writeByte(bool, (HardCacheEntryReferenceStatics.aSceneProjector_10434!!.anInt2987))
                        method4002((class348_sub47.aClass348_Sub49_Sub2_7116!!), 55.toByte())
                        val string_5_ = Gl2dTextureStatics.aString8605
                        ...
                        throw SoundBankPatchStatics.method2929(runtimeexception, ("iq.D(" + (if (string != null) "{...}" else "null") + ',' + (if (string_1_ != null) "{...}" else "null") + ',' + bool + ',' + i + ',' + bool_2_ + ')'))
                    }
                    break
                } while (false)
            }
