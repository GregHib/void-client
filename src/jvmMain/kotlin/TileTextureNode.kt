...
*/
class TileTextureNode : AbstractProceduralTextureNode(1, false) {
    ...
    override fun method3047(i: Int, i_0_: Int): Array<IntArray?>? {
        ...
        if (this.aImageFrameCache_7033!!.aBoolean4035) {
            val i_1_: Int = PerlinNoiseTextureNode.Companion.anInt9139 / anInt9405
            ...
            while ((i_11_ < PerlinNoiseTextureNode.Companion.anInt9139)) {
                ...
                if (i_1_ <= 0) i_12_ = 0
                    ...
                    i_12_ = PerlinNoiseTextureNode.Companion.anInt9139 * i_13_ / i_1_
                }
    ...
    override fun method3042(i: Int, i_16_: Int): IntArray? {
        ...
        if (this.aSpriteSheetCache_7032!!.aBoolean2570) {
            val i_17_: Int = PerlinNoiseTextureNode.Companion.anInt9139 / anInt9405
            ...
            var i_21_ = 0
            while (PerlinNoiseTextureNode.Companion.anInt9139 > i_21_) {
                if (i_17_ <= 0) `is`[i_21_] = is_19_[0]
                else {
                    val i_22_ = i_21_ % i_17_
                    `is`[i_21_] = is_19_[(PerlinNoiseTextureNode.Companion.anInt9139 * i_22_ / i_17_)]
                }
                i_21_++
            }
        }
