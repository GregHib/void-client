...
import BackgroundWorkerThreadStatics.method1911
...
object RegionSceneShifterStatics {
    var anInt7046: Int = 0
            var anInt7047: Int = 0
                    ...
                    while (true) {
                        if (bool_7_) {
                            ...
                            if (i_13_ > 0 && i_14_ > 0 && i_13_ < -1 + i && -1 + i_1_ > i_14_) {
                                val class51 = GradientLookupEffectStatics.aSeqDefinitionCache_9195!!.method2005(0, i_4_)
                                if (i_12_ != 22 || IntHashSetStatics.aClass348_Sub51_3959!!.aClass239_Sub4_7220!!.method1737(-32350) != 0 || class51.anInt874 != 0 || (class51.anInt920 == 1) || class51.aBoolean947) {
                                    ...
                                    if (!class51.method485(9773)) {
                                        CompositeNpcModelBuilderStatics.anInt2101++
                                        bool = false
                                    }
                                }
                            }
            ...
            fun method3157(i: Int, i_15_: Byte, i_16_: Int, i_17_: Int, bool: Boolean) {
                anInt7049++
                if (bool || i_16_ != RendererStatics.anInt4581 || FileIoUtil.anInt4095 != i || (CompiledScriptCacheStatics.anInt4372 != ParticleSystemStateStatics.anInt2204 && IntHashSetStatics.aClass348_Sub51_3959!!.aClass239_Sub27_7261!!.method1840(-32350) != 1)) {
                    RendererStatics.anInt4581 = i_16_
                    FileIoUtil.anInt4095 = i
                    ParticleSystemStateStatics.anInt2204 = CompiledScriptCacheStatics.anInt4372
                    if (IntHashSetStatics.aClass348_Sub51_3959!!.aClass239_Sub27_7261!!.method1840(-32350) == 1) ParticleSystemStateStatics.anInt2204 = 0
                    ByteBufferStatics.method3379(2, i_17_)
                    Tooltip.method3511(true, GameAppletFrameStatics.aFont_20, ParticleEmitterFactoryStatics.aFontDefinition_3179, LocalizedTextStatics.aLocalizedText_3495!!.method2063(AnimationFrameDefinitionStatics.anInt6967, 544), 2, FacingDirectionNodeStatics.aRenderer6654)
                    val i_18_ = ArbVertexProgramStatics.regionTileX
                    val i_19_ = RegionMapDecoder.regionTileY
                    ArbVertexProgramStatics.regionTileX = (-(GlCubemapLightPassStatics.anInt7319 shr 4) + RendererStatics.anInt4581) * 8
                    RegionMapDecoder.regionTileY = 8 * (FileIoUtil.anInt4095 - (RangeThresholdTextureNodeStatics.anInt9109 shr 4))
                    NamedIdEntryStatics.aClass348_Sub42_Sub14_6885 = method766(RendererStatics.anInt4581 * 8, FileIoUtil.anInt4095 * 8)
                    OpenGlRenderNodeStatics.aSmoothingBuffer_10488 = null
                    val i_20_ = ArbVertexProgramStatics.regionTileX - i_18_
                    val i_21_ = -i_19_ + RegionMapDecoder.regionTileY
                    if (i_17_ == 11) {
                        var i_22_ = 0
                        while (TerrainShadowBuilderGl2Statics.anInt6930 > i_22_) {
                            val class348_sub22 = TurbulenceTextureNodeStatics.aClass348_Sub22Array9319!![i_22_]
                        ...
                        var bool_24_ = false
                        val i_25_ = GlCubemapLightPassStatics.anInt7319 * 512 - 512
                        val i_26_ = 512 * (-1 + RangeThresholdTextureNodeStatics.anInt9109)
                        var i_27_ = 0
                        while ((TerrainShadowBuilderGl2Statics.anInt6930 > i_27_)) {
                            val class348_sub22 = TurbulenceTextureNodeStatics.aClass348_Sub22Array9319!![i_27_]
                            if (class348_sub22 != null) {
                                val npc = (class348_sub22.aNpc_6859)!!
                                npc.y -= 512 * i_21_
                                npc.x -= 512 * i_20_
                                if ((npc.x) < 0 || i_25_ < (npc.x) || (npc.y) < 0 || i_26_ < (npc.y)) {
                                    ...
                                    for (i_29_ in 0..9) {
                                        ...
                                        if ((npc.anIntArray10320!![i_29_]) < 0 || ((npc.anIntArray10320!![i_29_]) >= GlCubemapLightPassStatics.anInt7319) || (npc.anIntArray10317!![i_29_]) < 0 || (RangeThresholdTextureNodeStatics.anInt9109 <= (npc.anIntArray10317!![i_29_]))) bool_28_ = false
                                    }
                                    if (!bool_28_) {
                                        npc.method2448(null, -2)
                                        bool_24_ = true
                                        class348_sub22.method2715(113.toByte())
                                    } else RgbColorPaletteStatics.anIntArray1233!![ModelDefinitionLoaderStatics.anInt2057++] = (npc.anInt10290)
                                }
                            }
                            i_27_++
                        }
                    ...
                    if (i_15_ > 122) {
                        for (i_30_ in 0..2047) {
                            val player = (LoadingBarRendererStatics.aPlayerArray5058!![i_30_])
                            if (player != null) {
                                for (i_31_ in 0..9) {
                        ...
                        while (class348_sub27 != null) {
                            ...
                            if (WidgetRedrawTrackerStatics.anInt3931 != 4 && (class348_sub27.anInt6905 < 0 || class348_sub27.anInt6896 < 0 || (class348_sub27.anInt6905 >= GlCubemapLightPassStatics.anInt7319) || (RangeThresholdTextureNodeStatics.anInt9109 <= (class348_sub27.anInt6896)))) class348_sub27.method2715(101.toByte())
                            class348_sub27 = SpriteRenderEntryStatics.aNodeDeque_9711!!.method1990(68.toByte()) as? MultiFieldRecord?
                        }
                        if (WidgetRedrawTrackerStatics.anInt3931 != 4) {
                            ...
                            while (class348_sub37 != null) {
                                ...
                                val i_34_ = -ArbVertexProgramStatics.regionTileX + i_33_
                                val i_35_ = (0x3fffL and (class348_sub37.aLong4291 shr 14)).toInt()
                                val i_36_ = i_35_ + -RegionMapDecoder.regionTileY
                                if (i_34_ < 0 || i_36_ < 0 || (i_34_ >= GlCubemapLightPassStatics.anInt7319) || i_36_ >= RangeThresholdTextureNodeStatics.anInt9109) class348_sub37.method2715(37.toByte())
                        ...
                        if (MediaStreamClientStatics.anInt3203 != 0) {
                            MediaStreamClientStatics.anInt3203 -= i_20_
                            TerrainChunkBuilderStatics.anInt1548 -= i_21_
                        }
                        SoundBankPatchStatics.method2928(true)
                        if (i_17_ != 11) {
                            CollisionMapAccessor.anInt3550 -= i_21_
                            GlslMaterialPassStatics.anInt6246 -= 512 * i_20_
                            RenderableEntryStatics.anInt4336 -= i_20_
                            ClanChatRequestSender.anInt3647 -= i_21_
                            IntKeyNodeStatics.anInt6981 -= i_20_
                            CompositeRgbNoiseTextureStatics.anInt8685 -= 512 * i_21_
                            if ((GlCubemapLightPassStatics.anInt7319 < abs(i_20_)) || abs(i_21_) > RangeThresholdTextureNodeStatics.anInt9109) method773(true)
                        } else if (WeaveTextureNodeStatics.anInt9282 == 4) {
                            RegionTileNodeStatics.anInt6652 -= i_21_ * 512
                            FrameStatsResetStatics.anInt5799 -= i_20_ * 512
                            AsyncTaskHandleStatics.anInt2578 -= 512 * i_21_
                            HslColorTableNodeStatics.anInt6633 -= i_20_ * 512
                        } else {
                        ...
                        method3153(0)
                        method464(-1)
                        OpenGlRenderNodeStatics.aNodeDeque_10492!!.method1996(107)
                        SpriteTextureNodeStatics.aNodeDeque_9240!!.method1996(103)
            ...
            fun method3158(`is`: ByteArray?, i: Int): ByteArray {
                ...
                if (i_38_ < 0 || (ConfigIdPairStatics.anInt401 != 0 && i_38_ > ConfigIdPairStatics.anInt401)) {
                    throw RuntimeException()
                }
                if (i_37_ != 0) {
                    val i_39_ = class348_sub49.readInt((-126).toByte())
                    if (i_39_ < 0 || (ConfigIdPairStatics.anInt401 != 0 && i_39_ > ConfigIdPairStatics.anInt401) || i_39_ > 10000000) {
                        return ByteArray(4)
                    }
                    val is_40_ = ByteArray(i_39_)
                    if (i_37_ == 1) method1547(is_40_, i_39_, `is`, i_38_, 9)
                    else {
                        synchronized(AnimationFrameDefinitionStatics.aGzipDecompressor_6955!!) {
                            AnimationFrameDefinitionStatics.aGzipDecompressor_6955!!.method1218(is_40_, 29123, class348_sub49)
                        }
                    }
                    return is_40_
                }
            ...
            fun method3159(i: Int, i_42_: Int, bool: Boolean, i_43_: Int, i_44_: Int, i_45_: Int, var_renderer: Renderer, i_46_: Int, i_47_: Int) {
                ...
                if (renderTarget != null) {
                    val class51 = GradientLookupEffectStatics.aSeqDefinitionCache_9195!!.method2005(0, renderTarget.method42(-124))
                ...
                if (renderTarget != null) {
                    val class51 = GradientLookupEffectStatics.aSeqDefinitionCache_9195!!.method2005(0, renderTarget.method42(-88))
                ...
                if (renderTarget != null) {
                    val class51 = GradientLookupEffectStatics.aSeqDefinitionCache_9195!!.method2005(0, renderTarget.method42(-118))
