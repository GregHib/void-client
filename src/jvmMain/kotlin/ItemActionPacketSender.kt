...
object ItemActionPacketSender {
    ...
    fun method1237(i: Byte, widgetComponent: WidgetComponent) {
        ...
        if (RenderNodeStatics.aBoolean9722) {
            HuffmanCodecStatics.anInt3775++
            if (widgetComponent.anObjectArray679 != null) {
                val class46_0_ = NpcReferenceStatics.method2957(NativeLibraryState.anInt169, (-54).toByte(), OrientationRotator.anInt2046)
                if (class46_0_ != null) {
            ...
            val class348_sub47 = method2148(ByteStoreStatics.aFontMetaRef_4266, TheoraVideoStreamStatics.aIsaacCipher_9029, -120)
            ...
            InterfaceComponentGroupStatics.method3243(-89, class348_sub47)
        }
    }
}
