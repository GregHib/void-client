...
object ChatScriptListNodeStatics {
    var aBoolean9535: Boolean = false
            ...
            fun method3188(i: Byte, class348_sub49: ByteBuffer) {
                anInt9539++
                for (i_0_ in 0..<NpcDefinitionStatics.anInt2956) {
                    val i_1_ = class348_sub49.readSmart(-127)
                    var i_2_ = class348_sub49.readUnsignedShort(842397944)
                    if (i_2_ == 65535) i_2_ = -1
                    if (FireParticleStreamStatics.aClass110_Sub1Array97!![i_1_] != null) FireParticleStreamStatics.aClass110_Sub1Array97!![i_1_]!!.anInt1704 = i_2_
                }
                val i_3_ = -75 / ((53 - i) / 48)
            }
                    ...
                    if (strings.size > 1) {
                        for (i_4_ in strings.indices) {
                            if (strings[i_4_]!!.startsWith("pause")) {
                                ...
                                MinimapSquareDrawerStatics.aStringArray5223 = strings
                                MinimapFlagRenderer.anInt1794 = i_4_ - -1
                                CubemapTexture2dSourceStatics.aLong8694 = (i_5_ * 1000).toLong() + method599(-104)
                                break
                            }
                        ...
                        TerrainShadowBuilderGl3Statics.anInt7006 += strings[0]!!.length
                    }
                }
            }
