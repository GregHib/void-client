object ModelBatchBaseStatics {
    @JvmField
            ...
            fun method1128(i: Int, movementDirection: MovementDirection?): Int {
                anInt1896++
                if (MovementDirectionStatics.aMovementDirection_1179 != movementDirection) {
                    if (movementDirection != MovementDirectionStatics.aMovementDirection_1181) {
                        if (movementDirection == MovementDirectionStatics.aMovementDirection_1182) return 5124
                        if (MovementDirectionStatics.aMovementDirection_1183 != movementDirection) {
                            if (movementDirection != MovementDirectionStatics.aMovementDirection_1184) {
                                if (movementDirection == MovementDirectionStatics.aMovementDirection_1185) return 5125
                                if (MovementDirectionStatics.aMovementDirection_1186 != movementDirection) {
                                    if (MovementDirectionStatics.aMovementDirection_1187 == movementDirection) return 5126
                                } else return 5131
                            } else return 5123
                        } else return 5121
                    } else return 5122
            ...
            fun method1129(i: Int, i_0_: Int) {
                ...
                HslAdjustTextureNodeStatics.anInt9399 = i
                anInt1898++
            }
