...
object ClientLoadStateMachine {
    ...
    fun method1278(i: Int): Int {
        ...
        anInt2174++
        if (TimedTileQueueEntryStatics.aConnectionStateType_9660 == ConnectionStateType.aConnectionStateType_1018) {
        ...
        if (ConnectionStateType.aConnectionStateType_1023 == TimedTileQueueEntryStatics.aConnectionStateType_9660) {
            if (SizeBoundedSoftCache.aRsaPacketDecoder_2327 == null) SizeBoundedSoftCache.aRsaPacketDecoder_2327 = RsaPacketDecoder(ClientMachineInfo.aMediaStreamClient_6601, GlShaderObjectHandle.aScriptCompilerThread_520, RsaVarbitHandler.aBigInteger4896, TimedTileQueueEntryStatics.aBigInteger9657)
        ...
        if (ConnectionStateType.aConnectionStateType_1024 == TimedTileQueueEntryStatics.aConnectionStateType_9660) {
        ...
        if (TimedTileQueueEntryStatics.aConnectionStateType_9660 == ConnectionStateType.aConnectionStateType_1026) LoadingScreenImageNodeStatics.method3178(SoftwareSpriteRaster.aJs5Archive_1627, -81, method184(1084489728), ScrollTexMaterialPass.aJs5Archive_6277)
        if (ConnectionStateType.aConnectionStateType_1027 == TimedTileQueueEntryStatics.aConnectionStateType_9660) {
            val i_5_ = StringCacheNodeStatics.method3420(0)
            val i_6_ = method3256(2)
            if (i_6_ > i_5_) return 100 * i_5_ / i_6_
        }
        if (TimedTileQueueEntryStatics.aConnectionStateType_9660 == ConnectionStateType.aConnectionStateType_1028) {
        ...
        if (TimedTileQueueEntryStatics.aConnectionStateType_9660 == ConnectionStateType.aConnectionStateType_1029) {
        ...
        if (TimedTileQueueEntryStatics.aConnectionStateType_9660 == ConnectionStateType.aConnectionStateType_1030) {
            ...
            RasterSpriteStatics.aJs5Archive_5207 = WorldMapTextLabel.method3571(false, 7, (-23).toByte(), 1)
            ...
            HoverActionEntryStatics.aJs5Archive_1815 = WorldMapTextLabel.method3571(false, 15, (-23).toByte(), 1)
        ...
        if (ConnectionStateType.aConnectionStateType_1031 == TimedTileQueueEntryStatics.aConnectionStateType_9660) {
            var i_8_ = 0
            for (i_9_ in 0..36) {
        ...
        if (ConnectionStateType.aConnectionStateType_1032 == TimedTileQueueEntryStatics.aConnectionStateType_9660) {
        ...
        if (ConnectionStateType.aConnectionStateType_1033 == TimedTileQueueEntryStatics.aConnectionStateType_9660) OSInfo.method323(Crc64Hashable.aJs5Archive_4984, VorbisOggDecoder.aPrivilegedOperationWorker_8992, 95.toByte())
        if (ConnectionStateType.aConnectionStateType_1034 == TimedTileQueueEntryStatics.aConnectionStateType_9660) {
        ...
        if (i != -28660) return 2
        if (TimedTileQueueEntryStatics.aConnectionStateType_9660 == ConnectionStateType.aConnectionStateType_1035) {
            ...
            FileExistsConditionStatics.aModelDefinitionCache_4782 = ModelDefinitionCache(Client.aSceneProjector_10434, ChatCommandProcessor.anInt6967, DirectionUtil.aJs5Archive_1541, CameraRotationStubStatics.aJs5Archive_322)
            RadialTextureNode.aModelDefinitionLoader_9342 = ModelDefinitionLoader(Client.aSceneProjector_10434, ChatCommandProcessor.anInt6967, DirectionUtil.aJs5Archive_1541, RasterSpriteStatics.aJs5Archive_5207)
            ...
            GradientLookupEffect.aSeqDefinitionCache_9195 = SeqDefinitionCache(Client.aSceneProjector_10434, ChatCommandProcessor.anInt6967, true, AnimationFrameState.aJs5Archive_1538, RasterSpriteStatics.aJs5Archive_5207)
            ...
            MapAreaDefinitionStatics.aBufferedMessageQueue_2529 = BufferedMessageQueue(Client.aSceneProjector_10434, ChatCommandProcessor.anInt6967, true, FloatGridStatics.aJs5Archive_4975, RasterSpriteStatics.aJs5Archive_5207)
            ...
            WorldMapImageBuilder.method699(SoftwareSpriteRaster.aJs5Archive_1627, (-100).toByte(), ClientLoadStateMachine.aJs5Archive_6980, CameraRotationStubStatics.aJs5Archive_322, RasterSpriteStatics.aJs5Archive_5207)
            method85(0, NodeDequeStatics.aJs5Archive_3323)
            ScriptResources.aTextureDefinitionCache_2639 = TextureDefinitionCache(ChatCommandProcessor.anInt6967, ModelBatchBaseStatics.aJs5Archive_1897, ConfigArchiveLoaderStatics.aJs5Archive_1434)
            BrightnessOptionState.aCompiledScriptCache_5900 = CompiledScriptCache(ChatCommandProcessor.anInt6967, ModelBatchBaseStatics.aJs5Archive_1897, ConfigArchiveLoaderStatics.aJs5Archive_1434, ItemNameResolver())
            method1202(0)
            ...
            ShortKeyNodeStatics.method3004(RasterSpriteStatics.aJs5Archive_5207, false, SourceRowTextureNode.aRenderConfig9113)
        ...
        if (TimedTileQueueEntryStatics.aConnectionStateType_9660 == ConnectionStateType.aConnectionStateType_1037) {
        ...
        if (TimedTileQueueEntryStatics.aConnectionStateType_9660 == ConnectionStateType.aConnectionStateType_1040) {
        ...
        if (ConnectionStateType.aConnectionStateType_1041 == TimedTileQueueEntryStatics.aConnectionStateType_9660) ByteBufferStatics.method3198(true, (-45).toByte())
        if (TimedTileQueueEntryStatics.aConnectionStateType_9660 == ConnectionStateType.aConnectionStateType_1042) {
