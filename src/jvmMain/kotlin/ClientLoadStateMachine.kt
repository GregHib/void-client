...
object ClientLoadStateMachine {
    ...
    fun method1278(i: Int): Int {
        ...
        if (TimedTileQueueEntry.aConnectionStateType_9660 == ConnectionStateType.aConnectionStateType_1035) {
            ...
            AbstractTileShapeStatics.aMapSceneDefLoader_6559 = MapSceneDefLoader(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, DirectionUtil.aJs5Archive_1541)
