    ...
    companion object {
        ...
        fun method1839(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int) {
            ...
            if (Class132.anInt1910 <= i_1_ && Class38.anInt513 >= i_1_) {
                ...
                Class135_Sub2Statics.method1156(-27, i_19_, Class17.anIntArrayArray255!![i_1_]!!, i_20_, i_3_)
            }
            ...
            while (i_6_ > 0) {
                ...
                if (i_23_ >= Class132.anInt1910 && i_22_ <= Class38.anInt513) {
                    ...
                    if (Class132.anInt1910 <= i_22_) Class135_Sub2Statics.method1156(i_2_ + -26, i_24_, Class17.anIntArrayArray255!![i_22_]!!, i_25_, i_3_)
                    if (Class38.anInt513 >= i_23_) Class135_Sub2Statics.method1156(-27, i_24_, Class17.anIntArrayArray255!![i_23_]!!, i_25_, i_3_)
                }
            }
        }
