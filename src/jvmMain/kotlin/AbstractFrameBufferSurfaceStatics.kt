...
object AbstractFrameBufferSurfaceStatics {
    @JvmField
            var anInt6913: Int = 0
            @JvmField
            var anInt6914: Int = 0
            ...
            fun method3007(i: Int, i_0_: Int) {
                NpcActorEntityStatics.anInt10074 = -1
                ...
                SceneLinkedListNodeStatics.anInt3971 = -1
                WaterDetailOptionStateStatics.anInt5994 = i
                SpriteDefinitionStatics.anInt7068 = 1
                DirectionPathStatics.anInt1059 = 0
            }
            ...
            fun method3012(i: Int, i_44_: Int, i_45_: Int, i_46_: Int, i_47_: Int, i_48_: Byte, i_49_: Int, i_50_: Int) {
                ...
                val `is` = WidgetDefinitionStatics.anIntArrayArray255!![i_49_]!!
                GlElementArrayBufferStatics.method1156(-27, i_47_ - i_54_, `is`, -i_45_ + i_47_, i_46_)
                GlElementArrayBufferStatics.method1156(-27, i_47_ + i_54_, `is`, -i_54_ + i_47_, i_44_)
                GlElementArrayBufferStatics.method1156(-27, i_45_ + i_47_, `is`, i_47_ + i_54_, i_46_)
                while (i_52_ > 0) {
                    ...
                    if (bool) {
                        ...
                        GlElementArrayBufferStatics.method1156(-27, i_88_, WidgetDefinitionStatics.anIntArrayArray255!![i_83_]!!, i_86_, i_46_)
                        GlElementArrayBufferStatics.method1156(-27, i_87_, WidgetDefinitionStatics.anIntArrayArray255!![i_83_]!!, i_88_, i_44_)
                        GlElementArrayBufferStatics.method1156(-27, i_85_, WidgetDefinitionStatics.anIntArrayArray255!![i_83_]!!, i_87_, i_46_)
                        GlElementArrayBufferStatics.method1156(-27, i_88_, WidgetDefinitionStatics.anIntArrayArray255!![i_84_]!!, i_86_, i_46_)
                        GlElementArrayBufferStatics.method1156(-27, i_87_, WidgetDefinitionStatics.anIntArrayArray255!![i_84_]!!, i_88_, i_44_)
                        GlElementArrayBufferStatics.method1156(-27, i_85_, WidgetDefinitionStatics.anIntArrayArray255!![i_84_]!!, i_87_, i_46_)
                    } else {
                        GlElementArrayBufferStatics.method1156(-27, i_85_, WidgetDefinitionStatics.anIntArrayArray255!![i_83_]!!, i_86_, i_46_)
                        GlElementArrayBufferStatics.method1156(-27, i_85_, WidgetDefinitionStatics.anIntArrayArray255!![i_84_]!!, i_86_, i_46_)
                    }
                }
            }
            ...
            fun method3014(class348_sub49: ByteBuffer, i: Byte) {
                ...
                if ((class348_sub49.aByteArray7154!!.size - class348_sub49.anInt7197) >= 1) {
                    ...
                    if (i_89_ >= 0 && i_89_ <= 1 && (class348_sub49.aByteArray7154!!.size - class348_sub49.anInt7197) >= 2) {
                        if (i.toInt() != -40) method3012(13, -47, -27, 107, -90, (-19).toByte(), -61, 36)
                        ...
                        if (i_90_ * 6 <= (-class348_sub49.anInt7197 + (class348_sub49.aByteArray7154)!!.size)) {
                            for (i_91_ in 0..<i_90_) {
                                ...
                                if ((IsaacCipherStatics.anIntArray1303!!.size > i_92_) && GlslEnvMaterialPassStatics.aBooleanArray6270!![i_92_] && ((WaterDetailOptionStateStatics.aKeyboardLayoutCache_5995!!.method1976(i_92_, -107).aChar2132) != '1' || i_93_ >= -1 && i_93_ <= 1)) IsaacCipherStatics.anIntArray1303!![i_92_] = i_93_
                            }
                        }
                    }
                }
            ...
            init {
                aBigInteger6921 = LoaderStatics.LOGIN_SERVER_RSA_MODULUS
                aString6926 = null
