...
import HslColorTableNodeStatics.method2769

object BlankTextureNodeStatics {
    @JvmField
            var anInt9253: Int = 0
            @JvmField
                    ...
                    while (widgetComponents.size > i_1_) {
                        ...
                        if (class46 != null) {
                            if (class46.anInt774 == 0) {
                                ...
                                if (class348_sub41 != null) BloomGraphicsOptionStateStatics.method1775((-8).toByte(), (class348_sub41.anInt7050), i)
                            }
            ...
            fun method3100(i: Int, bool: Boolean, i_4_: Int): Boolean {
                ...
                return SceneProjectorStatics.method1637(i, 32768, i_4_) or ((0x800 and i_4_) != 0) || BoundsConstraintEntryStatics.method2056(i_4_, 86, i)
            }
