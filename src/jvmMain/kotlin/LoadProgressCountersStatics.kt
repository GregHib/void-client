...
object LoadProgressCountersStatics {
    @JvmField
            var anInt2446: Int = 0
            ...
            fun method1372(i: Int) {
                ...
                BloomGraphicsOptionStateStatics.anInt5969 = 1
                anInt2452++
                var l = 0L
                if (NullOggStreamStatics.aString9043 == null) {
                    GlRectangleTextureStatics.method254(35, (-101).toByte())
                    return
                } else {
                    val class348_sub49 = ByteBuffer(method878((MapLabelMenuEntryStatics.method1039((NullOggStreamStatics.aString9043!!), true)), -125))
            ...
            fun method1373(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int, i_10_: Int) {
                ...
                if (TextureLoaderUtil.method2547(i, 84.toByte()) && i_5_ == -1391) {
                    if (WorldMapTextLabelStatics.aWidgetComponentArrayArray8584!![i] == null) ClientStatics.method107((WarpTextureNodeStatics.aWidgetComponentArrayArray9427!![i]!!), -1, i_1_, i_10_, i_2_, i_7_, i_0_, i_8_, i_4_, i_3_, i_6_, i_9_)
                    else ClientStatics.method107(WorldMapTextLabelStatics.aWidgetComponentArrayArray8584!![i]!!, -1, i_1_, i_10_, i_2_, i_7_, i_0_, i_8_, i_4_, i_3_, i_6_, i_9_)
                }
            }
