...
import WorldListEntryStatics.method284
...
import RectangleRegion.Companion.method1973
...
import TextureCubeProviderStatics.method2268
...
import RectangleRegion.Companion.method2407
...
import RectangleRegion.Companion.method2572
...
import RectangleRegion.Companion.method3403
...
import RectangleRegion.Companion.method3968
...
class Client : GameAppletFrame() {
    ...
    public override fun method92(i: Int) {
        ...
        if (NpcAnimationResolverStatics.aNamedIdRecord_165 != OggCacheStream.aNamedIdRecord_5271) CacheLruCache.aByteArrayArray3882 = arrayOfNulls<ByteArray>(50)
        IntHashSetStatics.aClass348_Sub51_3959 = method247(24916)
        if (NpcAnimationResolverStatics.aNamedIdRecord_165 == OggCacheStream.aNamedIdRecord_5271) GlElementArrayBuffer.aServerConnectionInfo_4839!!.aString2147 = this.getCodeBase()!!.getHost()
        else if (method2354(NpcAnimationResolverStatics.aNamedIdRecord_165, i xor 0x7044.inv())) {
        ...
        } else if (SceneObjectSpawner.aNamedIdRecord_1279 == NpcAnimationResolverStatics.aNamedIdRecord_165) {
        ...
        RectangleRegion.aInputTracker_8552 = method2941(ParticleSystemRenderer.aCanvas3869, 0, true)
        //        try {
...
//        }
    ...
    public override fun method91(i: Byte) {
        ...
        RectangleRegion.method1659((-71).toByte())
        ...
        method177()
        RectangleRegion.method1609((-121).toByte())
        ...
        RectangleRegion.method3187((-52).toByte())
        method1064(-3)
        ...
        method1411(true)
        method1499(i + -235)
        RectangleRegion.method2258((-122).toByte())
        method681(i + -14)
        method1091(-9341)
        method3403(84)
        method1962(-1)
        ...
        method208(0.toByte())
        method3016(65280)
        HashTileShapeStatics.method2731((-23).toByte())
        method221(0)
        method1645(121)
        method953(9.toByte())
        ...
        ColourAdjustmentStatics.method448((-16).toByte())
        method3295(i + -109)
        method3441(1)
        method161(114)
        method2950(71)
        ...
        method3176(true)
        method2707(false)
        NpcAnimationResolverStatics.method213((-106).toByte())
        method2043(true)
        method570(105)
        method1438(-120)
    ...
    public override fun method80(i: Int) {
        ...
        try {
            TextureCubeProviderStatics.aBufferedRandomAccessFile_6328!!.method790((-62).toByte())
    ...
    public override fun init() {
        ...
        if (this.method89(48)) {
            ...
            NpcAnimationResolverStatics.aNamedIdRecord_165 = (FacingDirectionNodeStatics.method2776((-93).toByte(), this.getParameter("modewhere")!!.toInt()))
            if (SceneObjectSpawner.aNamedIdRecord_1279 == NpcAnimationResolverStatics.aNamedIdRecord_165) {
                NpcAnimationResolverStatics.aNamedIdRecord_165 = GroundItemRenderState.aNamedIdRecord_1657
            } else if (!method2354(NpcAnimationResolverStatics.aNamedIdRecord_165, -1) && OggCacheStream.aNamedIdRecord_5271 != NpcAnimationResolverStatics.aNamedIdRecord_165) {
                NpcAnimationResolverStatics.aNamedIdRecord_165 = OggCacheStream.aNamedIdRecord_5271
            }
    ...
    private fun method113(i: Byte) {
        ...
        while (true) {
            val class348_sub36 = (HashTileShapeStatics.aNodeDeque_8810!!.method1997(i.toInt() xor 0x78) as WidgetActionEntry?)
            if (class348_sub36 == null) break
            val class46 = class348_sub36.aWidgetComponent_6989
            if (class46!!.anInt704 >= 0) {
    ...
    private fun method114(i: Int) {
        ...
        if (WorldMapRenderer.anInt4674 != 14) {
            ...
            RectangleRegion.aInputTracker_8552!!.method3589(0)
            ...
            var class348_sub45 = RectangleRegion.aInputTracker_8552!!.method3596(0)
            while (class348_sub45 != null) {
                ...
                class348_sub45 = RectangleRegion.aInputTracker_8552!!.method3596(0)
            }
    ...
    companion object {
        ...
        fun method106() {
                ...
                if ((npc!!.aBoolean10309) && npc.method2425(-1) != -1) {
                    ...
                    if (class318_sub1_sub3_sub3 != null) {
                        ...
                        if ((class318_sub1_sub3_sub3.anInt10261) == 0 && class318_sub1_sub3_sub3.method2425(-1) != -1) {
                            RectangleRegion.anIntArray8557!![Js5Archive.anInt669] = i_23_
            ...
            method347(LocDefinitionCache.anIntArray3432, RectangleRegion.anIntArray8557, 0, -22222, Js5Archive.anInt669 - 1)
        }
        ...
        fun main(strings: Array<String>) {
            try {
                try {
                    ...
                    NpcAnimationResolverStatics.aNamedIdRecord_165 = SceneObjectSpawner.aNamedIdRecord_1279
                    ...
                    if (class46.anInt774 != 0 && !class46.aBoolean682 && method105(class46)!!.anInt7098 == 0 && class46 != CalendarUtil.aWidgetComponent_4130 && class46.anInt765 != BufferToggleState.anInt3717 && (class46.anInt765 != OutgoingPacketNode.anInt7125)) {
                        ...
                        if (class46.aBoolean676 || i_45_ < i_47_ && i_46_ < i_48_) {
                            if (class46.aBoolean776 && i_40_ >= i_45_ && i_41_ >= i_46_ && i_40_ < i_47_ && i_41_ < i_48_) {
                                var class348_sub36 = HashTileShapeStatics.aNodeDeque_8810!!.method1995(4) as WidgetActionEntry?
                                while (class348_sub36 != null) {
                                    ...
                                    class348_sub36 = (HashTileShapeStatics.aNodeDeque_8810!!.method1990(71.toByte()) as WidgetActionEntry?)
                                }
                            ...
                            var bool: Boolean
                            bool = (RectangleRegion.aInputTracker_8552!!.method3597(true) + i_51_) >= i_45_ && RectangleRegion.aInputTracker_8552!!.method3594(89.toByte()) + i_52_ >= i_46_ && (RectangleRegion.aInputTracker_8552!!.method3597(true) + i_51_) < i_47_ && RectangleRegion.aInputTracker_8552!!.method3594(74.toByte()) + i_52_ < i_48_
                            ...
                            var bool_53_ = false
                            if (RectangleRegion.aInputTracker_8552!!.method3595(-91) && bool) bool_53_ = true
                            var bool_54_ = false
                            ...
                            if (class46.aBoolean682 || class46.anInt765 != 0) {
                                ...
                                if (class46.anInt765 != 0) {
                                    ...
                                    if (class46.anInt765 == TimedRecordAccessorStatics.anInt7102) {
                                        ...
                                        if (bool_54_) {
                                            ...
                                            if (class348_sub42_sub14 != null) {
                                                ...
                                                SceneEntityModel.anInt6411 = RectangleRegion.aInputTracker_8552!!.method3597(true)
                                                ModelDefinitionCache.anInt2872 = RectangleRegion.aInputTracker_8552!!.method3594(72.toByte())
                                            }
                                        } else if (bool_53_ && (HashLinkedListNodeStatics.anInt7059 > 0)) {
                                            if (HashLinkedListNodeStatics.anInt7059 == 1 && ((SceneEntityModel.anInt6411 != RectangleRegion.aInputTracker_8552!!.method3597(true)) || (ModelDefinitionCache.anInt2872 != (RectangleRegion.aInputTracker_8552!!.method3594(117.toByte()))))) {
                                            ...
                                            if (HashLinkedListNodeStatics.anInt7059 == 2) {
                                                ...
                                                OpenGlModel.method689((-59).toByte(), (ParticleDefLoader.anInt2464 + (((SceneEntityModel.anInt6411) - (RectangleRegion.aInputTracker_8552!!.method3597(true))).toDouble() * 2.0 / (MapRegionLoaderStatics.aFloat1249).toDouble()).toInt()))
                                                method2170((OpenGlTerrainTile.anInt8237 - (((ModelDefinitionCache.anInt2872) - (RectangleRegion.aInputTracker_8552!!.method3594(83.toByte()))).toDouble() * 2.0 / (MapRegionLoaderStatics.aFloat1249).toDouble()).toInt()), 3.toByte())
                                            }
                                        } else {
                                    ...
                                    if (class46.anInt765 == MapSceneIconDef.anInt2861) {
                                        if (bool_53_) method2676(class46.anInt709, class46.anInt789, (i_51_ + RectangleRegion.aInputTracker_8552!!.method3597(true) - i_43_), 58.toByte(), (i_52_ + RectangleRegion.aInputTracker_8552!!.method3594(111.toByte()) - i_44_))
                                        continue
                                    }
                                ...
                                if (class46.aBoolean793 && bool_53_ && (class46.anObjectArray785 != null)) {
                                    ...
                                    class348_sub36.aBoolean6993 = true
                                    class348_sub36.aWidgetComponent_6989 = class46
                                    class348_sub36.anInt6984 = i_51_ + RectangleRegion.aInputTracker_8552!!.method3597(true) - i_43_
                                    class348_sub36.anInt6995 = (i_52_ + RectangleRegion.aInputTracker_8552!!.method3594(98.toByte()) - i_44_)
                                ...
                                if (class46.aBoolean793 && !bool_53_) {
                                    ...
                                    if (class46.anObjectArray742 != null) {
                                        ...
                                        class348_sub36.aWidgetComponent_6989 = class46
                                        class348_sub36.anInt6984 = (i_51_ + RectangleRegion.aInputTracker_8552!!.method3597(true) - i_43_)
                                        class348_sub36.anInt6995 = (i_52_ + RectangleRegion.aInputTracker_8552!!.method3594(75.toByte()) - i_44_)
                                ...
                                if (bool_53_ && (class46.anObjectArray805 != null)) {
                                    ...
                                    class348_sub36.aWidgetComponent_6989 = class46
                                    class348_sub36.anInt6984 = i_51_ + RectangleRegion.aInputTracker_8552!!.method3597(true) - i_43_
                                    class348_sub36.anInt6995 = (i_52_ + RectangleRegion.aInputTracker_8552!!.method3594(80.toByte()) - i_44_)
                                ...
                                if (!class46.aBoolean737 && bool) {
                                    ...
                                    if (class46.anObjectArray811 != null) {
                                        ...
                                        class348_sub36.aWidgetComponent_6989 = class46
                                        class348_sub36.anInt6984 = (i_51_ + RectangleRegion.aInputTracker_8552!!.method3597(true) - i_43_)
                                        class348_sub36.anInt6995 = (i_52_ + RectangleRegion.aInputTracker_8552!!.method3594(112.toByte()) - i_44_)
                                ...
                                if (class46.aBoolean737 && bool && (class46.anObjectArray839 != null)) {
                                    ...
                                    class348_sub36.aWidgetComponent_6989 = class46
                                    class348_sub36.anInt6984 = i_51_ + RectangleRegion.aInputTracker_8552!!.method3597(true) - i_43_
                                    class348_sub36.anInt6995 = (i_52_ + RectangleRegion.aInputTracker_8552!!.method3594(95.toByte()) - i_44_)
                                ...
                                if (class46.aBoolean737 && !bool) {
                                    ...
                                    if (class46.anObjectArray683 != null) {
                                        ...
                                        class348_sub36.aWidgetComponent_6989 = class46
                                        class348_sub36.anInt6984 = (i_51_ + RectangleRegion.aInputTracker_8552!!.method3597(true) - i_43_)
                                        class348_sub36.anInt6995 = (i_52_ + RectangleRegion.aInputTracker_8552!!.method3594(90.toByte()) - i_44_)
                                ...
                                if (class46.anObjectArray822 != null) {
                                    for (i_89_ in 0..<MinimapAreaMarkerNode.anInt9699) {
                                        ...
                                        class348_sub36.anInt6982 = RectangleRegion.anCharStreamReaderArray9534s!![i_89_]!!.method28(39.toByte()).code
                            ...
                            if (class46.anInt774 == 0) {
                                ...
                                if (class348_sub41 != null) {
                                    if ((Client.aSceneProjector_10434 == ParticleEmitterNode.aSceneProjector_186) && (class348_sub41.anInt7053) == 0 && !ScrollbarComponent.aBoolean8335 && bool && !TextureCubeProviderStatics.aBoolean6327) method661(105.toByte())
        ...
        fun method111(widgetComponent: WidgetComponent): Boolean {
            if (TextureCubeProviderStatics.aBoolean6327) {
        ...
        fun method3201(bool: Boolean): Boolean {
            ...
            if (InboundPacketHeader.aInboundPacketHeader_6584 == InboundPacketHeader.aInboundPacketHeader_2183) {
                ...
                if (i_137_ >= 1 && i_137_ <= 8) {
                    ...
                    RectangleRegion.aStringArray10195!![i_137_ + -1] = string
            ...
            if (AbstractMenuEntryStatics.aBoolean1712) {
                ...
                if (WorldMapRenderer.anInt4674 == 10) {
                    ...
                    if (!RenderNodeStatics.aBoolean9719) {
                        GameClock.anInt1110++
                        val class348_sub47 = method2148((RectangleRegion.aOutgoingPacketHeader_9743), (TheoraVideoStream.aIsaacCipher_9029), -113)
                        class348_sub47.aClass348_Sub49_Sub2_7116!!.writeByte(false, 0)
