...
class RenderableGroup internal constructor(typedRecordTable: TypedRecordTable?, dualMaterialContainer: DualMaterialContainer?) : CursorController {
    ...
    override fun method59(i: Int) {
        anInt5008++
        if (i != -9719) aOutgoingPacketHeader_5015 = null
    }
    ...
    companion object {
        ...
        var aOutgoingPacketHeader_5015: OutgoingPacketHeader?
        ...
        fun method1447(i: Int) {
            if (i == 76) {
                ...
                aOutgoingPacketHeader_5015 = null
            }
        }

        fun method1448(i: Int) {
            anInt5003++
            if (i <= -55) FlipTextureNode.aClass348_Sub42_Sub12_9144 = ContactEntry((LocalizedText.aLocalizedText_3487!!.method2063(ChatCommandProcessor.anInt6967, 544)), "", Tooltip.anInt4458, 1004, -1, 0L, 0, 0, true, false, 0L, true)
        }
        ...
        init {
            aOutgoingPacketHeader_5015 = OutgoingPacketHeader(76, 4)
            anInt5019 = 0
        }
    }
}
