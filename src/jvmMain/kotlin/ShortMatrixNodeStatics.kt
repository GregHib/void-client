            ...
            fun method3180(i: Int, widgetComponents: Array<WidgetComponent?>, i_0_: Int) {
                if (i_0_ == 24235) {
                    for (i_1_ in widgetComponents.indices) {
                        ...
                        if (class46 != null && i == class46.anInt834 && !ClientStatics.method111(class46)) {
                            if (class46.anInt774 == 0) {
                                method3180(class46.anInt830, widgetComponents, 24235)
                                if (class46.aWidgetComponentArray798 != null) method3180(class46.anInt830, class46.aWidgetComponentArray798!!, i_0_)
                            ...
                            if (class46.anInt774 == 6 && class46.anInt699 != -1) {
                                ...
                                if (class17 != null) {
                                    class46.anInt841 += DisplaySettingsConfigStatics.anInt7267
