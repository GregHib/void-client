...
class Class42 {
    ...
    fun method374(bool: Boolean, var_ha: ha, i: Byte): Class105? {
        ...
        val class207 = Class207Statics.method1521((this.aClass153_593!!.aClass45_2087!!), i_3_, 0)
        if (class207 != null) {
    ...
    fun method375(var_ha: ha, bool: Boolean): Class105? {
        ...
        val class207 = Class207Statics.method1521((this.aClass153_593!!.aClass45_2087!!), anInt598, 0)
        if (class207 != null) {
            class105 = var_ha.method3691(class207, true)
