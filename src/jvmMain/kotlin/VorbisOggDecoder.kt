    ...
    companion object {
        ...
        fun method2972(string: String?, i: Int, i_3_: Int): Boolean {
            ...
            if (aPrivilegedOperationWorker_8992!!.aBoolean3777) {
                ...
                if (i < WorldMapImageBuilder.aClass110_Sub1Array1146!!.size && WorldMapImageBuilder.aClass110_Sub1Array1146!![i] != null) ConfigFlagUtilStatics.anInt3234 = (WorldMapImageBuilder.aClass110_Sub1Array1146!![i]!!.anInt1708)
                return true
            }
            var string_4_ = ""
            if (OggCacheStream.aNamedIdRecord_5271 != NpcAnimationResolverStatics.aNamedIdRecord_165) string_4_ = ":" + (7000 + i)
            var string_5_ = ""
