...
object CameraSplineNodeStatics {
    ...
    fun method2954(i: Byte) {
        anInt6856++
        if (NativeShaderProgram.anInt9775 != -1 && MapArchiveSourceStatics.anInt4803 != -1) {
            ...
            for (i_13_ in 0..2) {
                val i_14_ = 3 * (SpriteDefinition.anIntArrayArrayArray7079!![MapArchiveSourceStatics.anInt4803]!![i_11_]!![i_13_])
                val i_15_ = 3 * (SpriteDefinition.anIntArrayArrayArray7079!![MapArchiveSourceStatics.anInt4803]!![i_11_ + 1]!![i_13_])
                val i_16_ = (((SpriteDefinition.anIntArrayArrayArray7079!![MapArchiveSourceStatics.anInt4803]!![2 + i_11_]!![i_13_]) + (-(SpriteDefinition.anIntArrayArrayArray7079!![MapArchiveSourceStatics.anInt4803]!![3 + i_11_]!![i_13_]) + (SpriteDefinition.anIntArrayArrayArray7079!![MapArchiveSourceStatics.anInt4803]!![i_11_ - -2]!![i_13_]))) * 3)
                val i_17_ = (SpriteDefinition.anIntArrayArrayArray7079!![MapArchiveSourceStatics.anInt4803]!![i_11_]!![i_13_])
                val i_18_ = -i_14_ + i_15_
                val i_19_ = -(i_15_ * 2) + i_14_ + i_16_
                val i_20_ = (-i_16_ + i_15_ + (-i_17_ + (SpriteDefinition.anIntArrayArrayArray7079!![MapArchiveSourceStatics.anInt4803]!![2 + i_11_]!![i_13_])))
