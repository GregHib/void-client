...
class Class56 private constructor(i: Int, class274: Class274?, class274_5_: Class274?, i_6_: Int, i_7_: Int, bool: Boolean, bool_8_: Boolean) {
    ...
    private constructor(i: Int, class274: Class274?, class274_1_: Class274?, i_2_: Int, i_3_: Int) : this(i, class274, class274_1_, i_2_, i_3_, true, false)
    ...
    init {
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("jj.<init>(" + i + ',' + (if (class274 != null) "{...}" else "null") + ',' + (if (class274_5_ != null) "{...}" else "null") + ',' + i_6_ + ',' + i_7_ + ',' + bool + ',' + bool_8_ + ')'))
        }
    }
