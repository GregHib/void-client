...
class ModelLightingConfig {
    ...
    companion object {
        ...
        var aOutgoingPacketHeader_2539: OutgoingPacketHeader? = OutgoingPacketHeader(26, 7)
        var anInt2543: Int = 0
        var anInt2553: Int = 0
        ...
        fun method1426(i: Int) {
            aOutgoingPacketHeader_2539 = null
        ...
        fun method1636(i: Int, i_74_: Int, i_75_: Int, i_76_: Int, i_77_: Int, i_78_: Int, i_79_: Int): CircleRasterizer? {
            ...
            var circleRasterizer = NamedIdRecord.aLruByteCache_4543!!.method583(l, 90) as CircleRasterizer?
            ...
            NamedIdRecord.aLruByteCache_4543!!.method582(circleRasterizer, l, (-106).toByte())
