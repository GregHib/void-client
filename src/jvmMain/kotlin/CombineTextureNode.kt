...
class CombineTextureNode : AbstractProceduralTextureNode(2, false) {
                                        ...
                                        while_161_@ do {
                                            while_160_@ do {
                                                while_159_@ do {
                                                    ...
                                                    i_14_ = 0
                                                    while ((i_14_ < (PerlinNoiseTextureNode.Companion.anInt9139))) {
                            ...
                            while_174_@ do {
                                while_173_@ do {
                                    while_172_@ do {
                                            ...
                                            while_170_@ do {
                                                while_169_@ do {
                                                    do {
                                                        if (i_54_ == 1) {
                                                            i_54_ = 0
                                                            while (((PerlinNoiseTextureNode.Companion.anInt9139) > i_54_)) {
                                        ...
                                        i_54_ = 0
                                        while ((i_54_ < PerlinNoiseTextureNode.Companion.anInt9139)) {
    ...
    companion object {
        ...
        fun method3088(i: Int) {
            anInt9228++
            if (SceneObjectSpawner.aNamedIdRecord_1279 != NpcAnimationResolverStatics.aNamedIdRecord_165 && i == 9) {
                try {
