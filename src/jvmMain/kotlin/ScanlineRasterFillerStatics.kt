...
object ScanlineRasterFillerStatics {
    @JvmField
            ...
            fun method1385(bool: Boolean, `is`: ByteArray, i: Byte) {
                anInt2475++
                if (CubemapTextureGlSourceStatics.aClass348_Sub49_8698 == null) CubemapTextureGlSourceStatics.aClass348_Sub49_8698 = ByteBuffer(20000)
                CubemapTextureGlSourceStatics.aClass348_Sub49_8698!!.writeBytes(`is`.size, 0, `is`, 97)
                if (bool) {
                    ParticleSystemStateStatics.method1294((-113).toByte(), (CubemapTextureGlSourceStatics.aClass348_Sub49_8698!!.aByteArray7154))
                    WorldMapImageBuilderStatics.aClass110_Sub1Array1146 = arrayOfNulls<MapLabelMenuEntry>(NpcDefinitionStatics.anInt2956)
                    var i_2_ = 0
                    var i_3_ = SceneObjectEntityStatics.anInt8731
                    while ((MultiLevelOptionStateStatics.anInt6151 >= i_3_)) {
                        val class110_sub1 = method1742(false, i_3_)
                        if (class110_sub1 != null) WorldMapImageBuilderStatics.aClass110_Sub1Array1146!![i_2_++] = class110_sub1
                        i_3_++
                    }
                    ModelBatchBaseStatics.aBoolean1899 = false
                    WorldMapRendererStatics.aLong4683 = method599(-92)
                    CubemapTextureGlSourceStatics.aClass348_Sub49_8698 = null
                }
            ...
            fun method1388(i: Int, i_4_: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int) {
                var i = i
                var i_8_ = i_8_
                method1156(-27, i_6_, WidgetDefinitionStatics.anIntArrayArray255!![i++]!!, i_7_, i_4_)
                anInt2472++
                method1156(-27, i_6_, WidgetDefinitionStatics.anIntArrayArray255!![i_8_--]!!, i_7_, i_4_)
                val i_9_ = -52 / ((i_5_ - -32) / 55)
                var i_10_ = i
                while (i_8_ >= i_10_) {
                    val `is` = WidgetDefinitionStatics.anIntArrayArray255!![i_10_]!!
                    `is`[i_6_] = i_4_
                    `is`[i_7_] = `is`[i_6_]
                    i_10_++
                }
