...
class GlTexture3D : GlTexture {
    ...
    companion object {
        ...
        fun method1960(i: Int, i_12_: Int, i_13_: Int, i_14_: Int, `is`: Array<Array<ByteArray?>?>?, is_15_: IntArray?, is_16_: IntArray?, is_17_: IntArray?, is_18_: IntArray?, is_19_: IntArray?, i_20_: Int, i_21_: Byte, i_22_: Int, i_23_: Int, bool: Boolean, bool_24_: Boolean, i_25_: Int, i_26_: Int, bool_27_: Boolean) {
            ...
            ActorEntity.anInt6111 = i_12_ shr MapTileShape.anInt4459
            ActorEntity.anInt8502 = i_14_ shr MapTileShape.anInt4459
                ...
                for (i_29_ in 0..<(ActorEntity.anInt10084 + ActorEntity.anInt10084 + 2)) {
                    ...
                    for (i_32_ in 0..<(ActorEntity.anInt10084 + ActorEntity.anInt10084 + 2)) {
                        ...
                        if (i_33_ >= 0 && i_34_ >= 0 && i_33_ < ActorEntity.anInt6451 && i_34_ < ActorEntity.anInt7054) {
                            val i_35_ = i_33_ shl MapTileShape.anInt4459
                            val i_36_ = i_34_ shl MapTileShape.anInt4459
                            val i_37_ = (TerrainTileShapeStatics.aTerrainTileArray8801!![TerrainTileShapeStatics.aTerrainTileArray8801!!.size - 1]!!.method3982((-86).toByte(), i_34_, i_33_) - (1000 shl MapTileShape.anInt4459 - 7))
            ...
            if (VoronoiNoiseTextureNode.aBoolean9121) {
                for (i_46_ in 0..<MapAreaDefinitionStatics.anInt2524) SolidFillComponent.aBooleanArrayArrayArray8361!![i_46_] = OverlayColorTable.aBooleanArrayArrayArray1751!![i_46_]
                method2131(0)
            ...
            if (VoronoiNoiseTextureNode.aBoolean9121) {
                method2290()
                for (i_48_ in 0..<MapAreaDefinitionStatics.anInt2524) OverlayColorTable.aBooleanArrayArrayArray1751!![i_48_] = SolidFillComponent.aBooleanArrayArrayArray8361!![i_48_]!!
                if (Npc.anInt10503 == 2) {
