    ...
    companion object {
        ...
        fun method4004(i: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int) {
            ...
            if (i_7_ < -33) {
                ...
                val i_18_ = WhirlpoolHash.method831(CameraNodeListStatics.anInt1745, i_8_ + i_6_, WorldMapLabel.anInt4960, 114)
                val i_19_ = WhirlpoolHash.method831(CameraNodeListStatics.anInt1745, -i_6_ + i_3_, WorldMapLabel.anInt4960, 34)
