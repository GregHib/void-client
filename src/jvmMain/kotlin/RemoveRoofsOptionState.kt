...
class RemoveRoofsOptionState : GraphicsOptionState {
    ...
    companion object {
        ...
        fun method1810(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int) {
            if (i_5_ != 8 && i_5_ != 16) {
                var class357 = HintArrowOrMessage.aSceneCollisionEntryArrayArrayArray2029!![i_4_]!![i]!![i_2_]
                ...
                val i_12_ = i shl MapTileShape.anInt4459
                val i_13_ = ActorEntity.anInt3465 + i_12_
                val i_14_ = i_2_ shl MapTileShape.anInt4459
                ...
                val i_6_ = ActorEntity.anInt3465 + (i shl MapTileShape.anInt4459)
                val i_7_ = -ActorEntity.anInt3465 + i_6_
                val i_8_ = i_2_ shl MapTileShape.anInt4459
