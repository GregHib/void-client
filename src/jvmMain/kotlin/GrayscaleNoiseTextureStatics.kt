...
object GrayscaleNoiseTextureStatics {
    @JvmField
            var anInt5277: Int = 0
            @JvmField
            var anInt5281: Int = 0
            ...
            fun method551(i: Int, i_2_: Int, i_3_: Int, fs: FloatArray, i_4_: Int, i_5_: Int, i_6_: Int) {
                ...
                var i_5_ = i_5_
                anInt5277++
                require(!(i_4_ < i && !AsyncTaskHandleStatics.method1436(i_4_ + -23, i))) { "" }
                require(!(i_5_ > 0 && !AsyncTaskHandleStatics.method1436(56, i_5_))) { "" }
                val i_7_ = ParticleDefLoaderStatics.method1382(i_2_, -6409)
                var i_8_ = 0
                var i_9_ = min(i_5_, i)
                var i_10_ = i shr 1
            ...
            fun method554(i: Int, i_42_: Int, `is`: ByteArray?): Int {
                ...
                anInt5284++
                return RefCountedHandleStatics.method1319(i_42_, true, `is`!!, 0)
            }
            ...
            fun method555(bool: Boolean, i: Int) {
                ...
                if (i != MapElementManager.aString4461!!.length) {
                    ConfigArchiveLoaderStatics.method812(MapElementManager.aString4461, false, bool, (-79).toByte())
                    if (!bool) {
