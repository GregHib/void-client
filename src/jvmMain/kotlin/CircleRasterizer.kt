...
object CircleRasterizerObject {
    ...
    fun method2255(i: Int, i_3_: Int, i_4_: Byte, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int) {
        ...
        GlElementArrayBuffer.method1156(-27, i_18_, `is`, i_17_, i_7_)
        GlElementArrayBuffer.method1156(-27, i + i_3_, `is`, i_18_, i_8_)
        while (i_11_ > i_9_) {
            i_16_ += 2
            i_15_ += 2
            i_14_ += i_16_
            i_12_ += i_15_
            if (i_14_ >= 0 && i_13_ >= 1) {
                CipheredPacketBuffer.anIntArray9757!![i_13_] = i_9_
                i_13_--
                i_14_ -= i_13_ shl 1
            }
            i_9_++
            if (i_12_ >= 0) {
                ...
                if (i_10_ <= i_11_) {
                    ...
                    GlElementArrayBuffer.method1156(-27, i_29_, is_23_, i_27_, i_8_)
                    GlElementArrayBuffer.method1156(-27, i_28_, is_23_, i_29_, i_7_)
                    GlElementArrayBuffer.method1156(-27, i_26_, is_23_, i_28_, i_8_)
                    GlElementArrayBuffer.method1156(-27, i_29_, is_24_, i_27_, i_8_)
                    GlElementArrayBuffer.method1156(-27, i_28_, is_24_, i_29_, i_7_)
            ...
            if (i_10_ > i_9_) {
                val i_34_ = (if (i_9_ <= i_13_) i_13_ else CipheredPacketBuffer.anIntArray9757!![i_9_])
                val i_35_ = i_34_ + i_3_
                val i_36_ = i_3_ + -i_34_
                GlElementArrayBuffer.method1156(-27, i_36_, is_30_, i_33_, i_8_)
                GlElementArrayBuffer.method1156(-27, i_35_, is_30_, i_36_, i_7_)
                GlElementArrayBuffer.method1156(-27, i_32_, is_30_, i_35_, i_8_)
                GlElementArrayBuffer.method1156(-27, i_36_, is_31_, i_33_, i_8_)
                GlElementArrayBuffer.method1156(-27, i_35_, is_31_, i_36_, i_7_)
                GlElementArrayBuffer.method1156(-27, i_32_, is_31_, i_35_, i_8_)
            } else {
                GlElementArrayBuffer.method1156(-27, i_32_, is_30_, i_33_, i_8_)
                GlElementArrayBuffer.method1156(-27, i_32_, is_31_, i_33_, i_8_)
            }
        }
    }
}
