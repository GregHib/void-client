...
import SpriteSheetCacheStatics.anInt2556
import SpriteSheetCacheStatics.anInt2558
import SpriteSheetCacheStatics.anInt2566
...
class SpriteSheetCache internal constructor(i: Int, i_16_: Int, i_17_: Int) {
    ...
    fun method1427(i: Byte): Array<IntArray?>? {
        ...
        while (anInt2559 > i_0_) {
            aClass348_Sub6Array2563!![i_0_] = RasterSpriteStatics.aClass348_Sub6_5206
            i_0_++
        }
    ...
    fun method1433(i: Int, i_14_: Int): IntArray? {
        ...
        if (anInt2559 == anInt2565) {
            ...
            aClass348_Sub6Array2563!![i_14_] = RasterSpriteStatics.aClass348_Sub6_5206
