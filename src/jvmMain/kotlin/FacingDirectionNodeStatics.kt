...
object FacingDirectionNodeStatics {
    @JvmField
            ...
            fun method2774(i: Byte, class318_sub1_sub3_sub3: ProjectedGroundDecor): Int {
                ...
                if (class318_sub1_sub3_sub3.anInt10275 != -1) {
                    ...
                    if (class318_sub1_sub3_sub3.anInt10275 >= 32768) {
                        if ((class318_sub1_sub3_sub3.anInt10275) >= 32768) class318_sub1_sub3_sub3_0_ = (LoadingBarRendererStatics.aPlayerArray5058!![class318_sub1_sub3_sub3.anInt10275 + -32768])
                    } else {
                ...
                if (class318_sub1_sub3_sub3 is Player) {
                    ...
                    if ((npc.anInt10499) != -1 && ((npc.anInt10319) == 0 || npc.anInt10326 > 0)) {
                        val i_3_ = (-((-ArbVertexProgramStatics.regionTileX + npc.anInt10499 - ArbVertexProgramStatics.regionTileX) * 256) + (npc.x))
            ...
            fun method2776(i: Byte, i_5_: Int): NamedIdRecord? {
                ...
                val class364s = ScatterTextureNodeStatics.method3122(91.toByte())
                var i_6_ = 0
            ...
            fun method2777(l: Long, l_7_: Long): Long {
                try {
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, "gia.C(" + l + ',' + l_7_ + ')')
                }
            }
