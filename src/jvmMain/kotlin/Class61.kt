    ...
    companion object {
        ...
        fun method592(bool: Boolean, i: Byte, bool_0_: Boolean, i_1_: Int, i_2_: Int): Int {
            ...
            while ((class348_sub13.anIntArray6757!!.size > i_4_)) {
                if (class348_sub13.anIntArray6757!![i_4_] >= 0 && (Exception_Sub1Statics.aClass255_112!!.anInt3271 > class348_sub13.anIntArray6757!![i_4_])) {
                    val class213 = (Exception_Sub1Statics.aClass255_112!!.method1940(-127, (class348_sub13.anIntArray6757!![i_4_])))
