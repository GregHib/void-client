...
import Class348Statics.method2710
                ...
                if (Class8.aClass364_165 != Class55_Sub1.aClass364_5271 || Class192.anInt2581 >= 2) {
                    ...
                    try {
                        ...
                        if (string.equals("gc", ignoreCase = true)) {
                            ...
                            val i_2_ = RuntimeInfoProvider.instance.usedMemoryKb()
                        ...
                        if (string.equals("compact", ignoreCase = true)) {
                            ...
                            var i_4_ = RuntimeInfoProvider.instance.usedMemoryKb()
                            method94(("Memory before cleanup=" + i_4_ + "k"), 115)
                            method2271(31268)
                            method427(96)
                            for (i_5_ in 0..9) System.gc()
                            i_4_ = RuntimeInfoProvider.instance.usedMemoryKb()
                        ...
                        if (string.equals("getcamerapos", ignoreCase = true)) {
                            ...
                            method94(
                                ("Look: " + (Class132.aPlayer_1907!!.plane) + "," + (Class352.anInt4336 - -za_Sub2Statics.regionTileX shr 6) + "," + (Class90.regionTileY + Class281.anInt3647 shr 6) + "," + (0x3f and Class352.anInt4336 - -za_Sub2Statics.regionTileX) + "," + (0x3f and Class281.anInt3647 - -Class90.regionTileY) + " Height: " + ((Class275.method2064(
                                    Class352.anInt4336,
                                    (Class132.aPlayer_1907!!.plane).toInt(),
                                    11219,
                                    Class281.anInt3647
