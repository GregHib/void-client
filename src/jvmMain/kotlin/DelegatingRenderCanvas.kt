    ...
    companion object {
        ...
        fun method122(i: Int, i_13_: Int, i_14_: Int, i_15_: Int, i_16_: Int, i_17_: Byte, var_renderer: Renderer): AbstractModel? {
            ...
            if (abstractModel == null) {
                val class124 = ParticleConfigParser.method2277(0, RasterSpriteStatics.aJs5Archive_5207!!, i_16_, -1)
        ...
        fun method123(i: Int) {
            ...
            while (DragDropControllerStatics.aByteArrayArray4281!!.size > i_19_) {
                if (NativeSprite.anIntArray5192!![i_19_] != -1 && DragDropControllerStatics.aByteArrayArray4281!![i_19_] == null) {
                    DragDropControllerStatics.aByteArrayArray4281!![i_19_] = AbstractCameraTransformStatics.aJs5Archive_7382!!.method410(-1860, NativeSprite.anIntArray5192!![i_19_], 0)
            ...
            if (OpenGlRenderNode.aSmoothingBuffer_10488 == null) {
                if (NamedIdEntryStatics.aClass348_Sub42_Sub14_6885 != null && (TerrainShadowBuilderGl2.aJs5Archive_6950!!.method400(-18308, (NamedIdEntryStatics.aClass348_Sub42_Sub14_6885!!.aString9625) + "_staticelements"))) {
                    if (TerrainShadowBuilderGl2.aJs5Archive_6950!!.method413(100, (NamedIdEntryStatics.aClass348_Sub42_Sub14_6885!!.aString9625) + "_staticelements")) OpenGlRenderNode.aSmoothingBuffer_10488 = SkeletonSequenceLoader.method2300(TerrainShadowBuilderGl2.aJs5Archive_6950, ((NamedIdEntryStatics.aClass348_Sub42_Sub14_6885!!.aString9625) + "_staticelements"), ModelBatchBaseStatics.aBoolean1900, (-91).toByte())
                    else {
                        bool = false
                        LocDefinitionCache.anInt3441++
                    }
            ...
            if (bool) {
                ...
                if (bool) {
                    ...
                    if (bool_25_) {
                        ...
                        VarpStore.aClass237_Sub1_5067!!.method1679(0, 0, (MapTileShapeStatics.aClass237_Sub1_4197!!.anIntArrayArrayArray3122[0]!!))
                    ...
                    if (RsaVarbitHandler.aFrame4904 != null && Client.aAbstractGameSocket_9165 != null && WorldMapRenderer.anInt4674 == 11) {
                        ...
                        val class348_sub47 = method2148(FileIoUtil.aOutgoingPacketHeader_4094, (TheoraVideoStream.aIsaacCipher_9029), i xor 0x55.inv())
                    ...
                    if (WorldMapRenderer.anInt4674 != 4) {
                        if (WorldMapRenderer.anInt4674 != 8) {
                            ...
                            if (Client.aAbstractGameSocket_9165 != null) {
                                val class348_sub47 = method2148((RsaPacketDecoder.aOutgoingPacketHeader_4223), (TheoraVideoStream.aIsaacCipher_9029), -106)
