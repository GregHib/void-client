...
public class OpenGlRenderer(canvas: Canvas?, var_renderConfig: RenderConfig?, i: Int) : Renderer(var_renderConfig) {
    ...
    override fun method3646(i: Int) {
        ...
        if (E() > 100663296 && 60000L + aLong7757 < CommonClock.method599(-96)) {
            System.gc()
            aLong7757 = CommonClock.method599(-91)
        }
        this.anInt7735 = i
    }
            ...
            while ((i_322_ < ModelDefinitionLoader.anInt2057 + i_321_)) {
                ...
                if ((class318_sub1_sub3_sub3.anInt10285 >= 0) && (((class318_sub1_sub3_sub3.anInt10301) == TextureQualityOptionState.anInt6006) || ((LocalPlayerState.aPlayer_1907!!.plane) == class318_sub1_sub3_sub3.plane))) {
                    ...
                    if (RemoveRoofsOptionState.anIntArray6062!![0] >= 0) {
                        if ((class318_sub1_sub3_sub3.aString10292) != null && (i_321_ <= i_322_ || ShaderProgramStatics.anInt7276 == 0 || ShaderProgramStatics.anInt7276 == 3 || (ShaderProgramStatics.anInt7276 == 1 && (KeyEventNodeStatics.method2797((class318_sub1_sub3_sub3 as Player).aString10544, (-63).toByte())))) && SceneNodeDeque.anInt1497 < ConfigVarProgress.anInt4814) {
