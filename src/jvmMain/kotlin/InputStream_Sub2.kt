...
class InputStream_Sub2 : InputStream(), CommonInputStream {
    override fun read(buf: ByteArray, off: Int, len: Int): Int = super.read(buf, off, len)
        ...
        fun method128(class74: Class74?, i: Byte) {
            try {
                ...
                if (class74 == Class348_Sub26.aClass74_6891) {
                    val i_0_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByteSubtract((-124).toByte())
                    val i_1_ = i_0_ shr 2
                    val i_2_ = 0x3 and i_0_
                    val i_3_ = Class36.anIntArray487!![i_1_]
                    val i_4_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(842397944)
                    ...
                    val i_11_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(842397944)
                    ...
                    val i_18_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255)
                    val i_19_ = Class278.anInt3581 - -(i_18_ shr 4 and 0x7)
                    val i_20_ = (0x7 and i_18_) + Class73.anInt4786
                    var i_21_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(842397944)
                    if (i_21_ == 65535) i_21_ = -1
                    val i_22_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(i + 247)
                    ...
                    val i_29_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(842397944)
                    ...
                    val i_31_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(i + 247)
                    val i_32_ = Class278.anInt3581 + ((i_31_ and 0x7b) shr 4)
                    val i_33_ = (i_31_ and 0x7) + Class73.anInt4786
                    var i_34_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(842397944)
                    if (i_34_ == 65535) i_34_ = -1
                    val i_35_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(i + 247)
                    ...
                    var i_42_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readShortLittle(false)
                    if (i_42_ == 65535) i_42_ = -1
                    val i_43_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByteSubtract(65.toByte())
                    val i_44_ = ((i_43_ and 0x71) shr 4) + Class278.anInt3581
                    val i_45_ = Class73.anInt4786 + (i_43_ and 0x7)
                    val i_46_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readByteInverse(21.toByte())
                    ...
                    val i_53_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255)
                    val bool = (0x1 and i_53_) != 0
                    val bool_54_ = (i_53_ and 0x2) != 0
                    val i_55_ = if (bool_54_) i_53_ shr 2 else -1
                    var i_56_ = (Class299Statics.aClass348_Sub49_Sub2_3813!!.readByte(-77) + i_51_)
                    var i_57_ = (Class299Statics.aClass348_Sub49_Sub2_3813!!.readByte(-88) + i_52_)
                    val i_58_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readShort(13638)
                    val i_59_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readShort(13638)
                    val i_60_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(i + 842397936)
                    var i_61_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255)
                    if (!bool_54_) i_61_ *= 4
                    else i_61_ = i_61_.toByte().toInt()
                    var i_62_ = (Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(i.toInt() xor 0xf7) * 4)
                    val i_63_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(i + 842397936)
                    val i_64_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(842397944)
                    ...
                    val i_69_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readShortAddLittle(-128)
                    val i_70_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByteSubtract(31.toByte())
                    ...
                    val i_76_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readShortLittle(false)
                    val i_77_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255)
                    ...
                    if (Class39.aClass74_515 == class74) {
                        val i_89_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255)
                        ...
                        val i_97_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readShortLittle(false)
                        val i_98_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255)
                        ...
                        val i_105_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(i + 247)
                        val bool = (0x80 and i_105_) != 0
                        var i_106_ = Class278.anInt3581 - -(i_105_ shr 3 and 0x7)
                        var i_107_ = (0x7 and i_105_) + Class73.anInt4786
                        var i_108_ = i_106_ - -Class299Statics.aClass348_Sub49_Sub2_3813!!.readByte(-94)
                        var i_109_ = (Class299Statics.aClass348_Sub49_Sub2_3813!!.readByte(-87) + i_107_)
                        val i_110_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readShort(13638)
                        val i_111_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(i + 842397936)
                        var i_112_ = (Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255) * 4)
                        var i_113_ = (Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255) * 4)
                        val i_114_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(i + 842397936)
                        val i_115_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(i + 842397936)
                        ...
                        Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255)
                        val i_118_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(i + 247)
                        val i_119_ = (i_118_ shr 4 and 0x7) + Class278.anInt3581
                        val i_120_ = (0x7 and i_118_) + Class73.anInt4786
                        val i_121_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(i.toInt() xor 0x3235f8f0)
                        val i_122_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255)
                        val i_123_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readMedium(-1)
