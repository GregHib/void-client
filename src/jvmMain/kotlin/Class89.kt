import Class376Statics.method3620
...
//        super.finalize()
    ...
    companion object {
        ...
        fun method849(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int) {
            ...
            val i_6_ = i_0_ + i
            val i_7_ = -i + i_3_
            for (i_8_ in i_0_..<i_6_) Class135_Sub2Statics.method1156(-27, i_2_, Class17.anIntArrayArray255!![i_8_]!!, i_1_, i_5_)
            val i_9_ = -i + i_2_
            for (i_10_ in i_3_ downTo i_7_ + 1) Class135_Sub2Statics.method1156(-27, i_2_, Class17.anIntArrayArray255!![i_10_]!!, i_1_, i_5_)
            val i_11_ = i + i_1_
            var i_12_ = i_6_
            while (i_7_ >= i_12_) {
                val `is`: IntArray = Class17.anIntArrayArray255!![i_12_]!!
                Class135_Sub2Statics.method1156(-27, i_11_, `is`, i_1_, i_5_)
                Class135_Sub2Statics.method1156(-27, i_2_, `is`, i_9_, i_5_)
                i_12_++
            }
        }
            ...
            if (bool) Class24.aClass318_Sub1_Sub3Array357!![Class86.anInt1477++] = class318_sub1_sub3
                ...
                if (class318_sub1_sub3.method2376(-118)) {
                    if (class318_sub1_sub3.method2377(122.toByte())) {
                        ...
                        class318_sub1_sub3.aClass318_Sub1_6379 = Class348Statics.aClass318_Sub1Array4293!![i_22_]
                        Class348Statics.aClass318_Sub1Array4293!![i_22_] = class318_sub1_sub3
