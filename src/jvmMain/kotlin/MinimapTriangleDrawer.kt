...
import MinimapTriangleDrawerStatics.anInt5228
import MinimapTriangleDrawerStatics.aBoolean5233
import MinimapTriangleDrawerStatics.anInt5234
import MinimapTriangleDrawerStatics.anInt5235
...
class MinimapTriangleDrawer internal constructor(private var anInt5231: Int, private val anInt5227: Int, private val anInt5232: Int, private val anInt5230: Int, i_9_: Int, i_10_: Int, i_11_: Int) : MinimapShapeDrawer(i_9_, i_10_, i_11_) {
    public override fun method455(i: Int, i_0_: Int, i_1_: Int) {
        ...
        VarpStoreStatics.method1308(this.anInt864, i_4_, i_2_, this.anInt865, (-123).toByte(), this.anInt862, i_3_, i_5_)
    }
    ...
    public override fun method457(i: Int, i_12_: Int, i_13_: Int) {
        ...
        if (i_13_ <= -29) {
            ...
            TerrainChunkBuilderStatics.method872(this.anInt865, 1, this.anInt862, i_16_, i_17_, i_15_, i_14_)
        }
    }
