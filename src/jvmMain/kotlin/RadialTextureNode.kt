...
*/
class RadialTextureNode : AbstractProceduralTextureNode(0, true) {
    ...
    override fun method3042(i: Int, i_2_: Int): IntArray? {
        ...
        if (this.aSpriteSheetCache_7032!!.aBoolean2570) {
            for (i_3_ in 0..<PerlinNoiseTextureNode.Companion.anInt9139) {
                val i_4_ = anInt9339 + (PerlinNoiseTextureNode.anIntArray6432!![i_3_] shl 12) / anInt9340
                val i_5_ = anInt9338 + (PerlinNoiseTextureNode.anIntArray6035!![i] shl 12) / anInt9340
                val i_6_ = i_4_
                val i_7_ = i_5_
                var i_8_ = i_4_
                var i_9_ = i_5_
