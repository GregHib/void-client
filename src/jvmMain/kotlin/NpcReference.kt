...
class NpcReference internal constructor(@JvmField var aNpc_6859: Npc?) : LinkedListNode() {
    companion object {
        ...
        fun method2959(i: Int) {
            ...
            anInt6860++
            RectangleRegion.aInputTracker_8552!!.method3592(0)
            ...
            RectangleRegion.aInputTracker_8552 = InterfaceBoundsStatics.method2941(ParticleSystemRenderer.aCanvas3869, 0, true)
        }
    }
}
