...
object LoadingScreenStateStatics {
    var anInt2624: Int = 0
            ...
            fun method1455(i: Int, color: Color?, string: String?, color_0_: Color?, i_1_: Byte, color_2_: Color?) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (FontMetaRefStatics.aFont4329 == null) FontMetaRefStatics.aFont4329 = Font("Helvetica", 1, 13)
                        ...
                        try {
                            ...
                            val graphics_3_ = WidgetRedrawRegionStatics.anImage4249!!.getGraphics()
                            graphics_3_.setColor(Color.black)
                            graphics_3_.fillRect(0, 0, LocTypeDefinitionStatics.anInt4017, HardCacheEntryReferenceStatics.anInt10432)
                            val i_4_ = -152 + LocTypeDefinitionStatics.anInt4017 / 2
                            val i_5_ = -18 + HardCacheEntryReferenceStatics.anInt10432 / 2
                            ...
                            graphics_3_.setFont(FontMetaRefStatics.aFont4329)
                            ...
                            if (AsyncResourceRequestStatics.aString9665 != null) {
                                graphics_3_.setFont(FontMetaRefStatics.aFont4329)
                                graphics_3_.setColor(color_2_)
                                graphics_3_.drawString(AsyncResourceRequestStatics.aString9665, (LocTypeDefinitionStatics.anInt4017 / 2 - (AsyncResourceRequestStatics.aString9665!!.length * 6 / 2)), -26 + HardCacheEntryReferenceStatics.anInt10432 / 2)
                            }
                            graphics.drawImage(WidgetRedrawRegionStatics.anImage4249, 0, 0, null)
                        } catch (exception: Exception) {
                            graphics.setColor(Color.black)
                            graphics.fillRect(0, 0, LocTypeDefinitionStatics.anInt4017, HardCacheEntryReferenceStatics.anInt10432)
                            val i_6_ = -152 + LocTypeDefinitionStatics.anInt4017 / 2
                            val i_7_ = HardCacheEntryReferenceStatics.anInt10432 / 2 + -18
                            ...
                            graphics.setFont(FontMetaRefStatics.aFont4329)
                            graphics.setColor(color_2_)
                            if (AsyncResourceRequestStatics.aString9665 != null) {
                                graphics.setFont(FontMetaRefStatics.aFont4329)
                                graphics.setColor(color_2_)
                                graphics.drawString(AsyncResourceRequestStatics.aString9665, (LocTypeDefinitionStatics.anInt4017 / 2 + -(6 * AsyncResourceRequestStatics.aString9665!!.length / 2)), HardCacheEntryReferenceStatics.anInt10432 / 2 - 26)
                            }
                            graphics.drawString(string, i_6_ - -((304 + -(string!!.length * 6)) / 2), 22 + i_7_)
                        }
                    } catch (exception: Exception) {
                        ParticleSystemRendererStatics.aCanvas3869!!.repaint()
                    }
                } catch (runtimeexception: RuntimeException) {
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("rc.A(" + i + ',' + (if (color != null) "{...}" else "null") + ',' + (if (string != null) "{...}" else "null") + ',' + (if (color_0_ != null) "{...}" else "null") + ',' + i_1_ + ',' + (if (color_2_ != null) "{...}" else "null") + ')'))
                }
            }
            ...
            fun method1459(i: Int, i_9_: Int) {
                anInt2637++
                val class348_sub42_sub15 = NamedTimedNodeStatics.method2516(i, 105.toByte(), 10)
            ...
            init {
                for (i in 0..4095) anIntArray2631!![i] = SmoothingBufferStatics.method1918(-3358, i)
