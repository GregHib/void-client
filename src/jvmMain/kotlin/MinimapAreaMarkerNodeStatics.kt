...
object MinimapAreaMarkerNodeStatics {
    var aOutgoingPacketHeader_9687: OutgoingPacketHeader? = OutgoingPacketHeader(14, -1)
    var anInt9698: Int = 0
    ...
    fun method3276(soundEnvelope: SoundEnvelope) {
        if (CalendarUtil.anInt4135 < 65535) {
            ...
            SceneEntity.aSoundEnvelopeArray5993!![CalendarUtil.anInt4135] = soundEnvelope
            ...
            for (i_1_ in i..i_0_) {
                ...
                for (i_5_ in i_3_..i_4_) {
                    ...
                    for (i_9_ in i_7_..i_8_) {
                        val l = (SceneEntity.aLongArrayArrayArray10431!![i_1_]!![i_9_]!![i_5_])
                        if ((l and 0xffffL) == 0L) SceneEntity.aLongArrayArrayArray10431!![i_1_]!![i_9_]!![i_5_] = l or CalendarUtil.anInt4135.toLong()
                        else if ((l and 0xffff0000L) == 0L) SceneEntity.aLongArrayArrayArray10431!![i_1_]!![i_9_]!![i_5_] = l or (CalendarUtil.anInt4135.toLong() shl 16)
                        else if ((l and 0xffff00000000L) == 0L) SceneEntity.aLongArrayArrayArray10431!![i_1_]!![i_9_]!![i_5_] = l or (CalendarUtil.anInt4135.toLong() shl 32)
                        else if ((l and 0xffffffffffffL.inv()) == 0L) SceneEntity.aLongArrayArrayArray10431!![i_1_]!![i_9_]!![i_5_] = l or (CalendarUtil.anInt4135.toLong() shl 48)
                    }
                }
            }
        }
    ...
    fun method3277(i: Byte) {
        ...
        if (ManagedGlResource.aClass348_Sub42_Sub13_3152 != null) {
            ...
            method226(MinimapPolygonDrawer.anInt5252, TerrainTileShapeStatics.anInt8806, InputTracker.anInt4534, 0, ClickFeedbackTask.anInt4669)
        }
    }

    @JvmStatic
    fun method3278(i: Int) {
        aOutgoingPacketHeader_9687 = null
        if (i != 1) anInt9699 = -66
