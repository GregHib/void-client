...
object SceneryDetailOptionStateStatics {
    @JvmField
            var anInt6084: Int = 0
            @JvmField
            var anInt6085: Int = 0
            ...
            fun method1823(var_renderer: Renderer, i: Int, i_4_: Int, i_5_: Byte) {
                ...
                if (i >= 0 && i_4_ >= 0 && GlFramebufferBlitterStatics.anInt282 != 0 && ParticleSystemRendererStatics.anInt3861 != 0) {
                    ...
                    if (GrayscaleNoiseTextureStatics.aBoolean5300) {
                        LinkedNodeListIteratorStatics.method1010(false, false)
                        ...
                        i_12_ = OggBitstreamDecoderStatics.method2960(false, -52) + i_4_
                    } else {
                        var_renderer.DA(HslPaletteState.anInt4171, CircleDrawer.anInt2688, GlFramebufferBlitterStatics.anInt282, ParticleSystemRendererStatics.anInt3861)
                        i_8_ = CircleDrawer.anInt2688
                        i_9_ = ParticleSystemRendererStatics.anInt3861
                        i_7_ = HslPaletteState.anInt4171
                        i_10_ = GlFramebufferBlitterStatics.anInt282
                        var_renderer.KA(ConfigValueProviderStatics.anInt4911, SocketGameConnectionStatics.anInt5832, GlFramebufferBlitterStatics.anInt282, ParticleSystemRendererStatics.anInt3861)
                        abstractCameraTransform = var_renderer.method3654()
                        abstractCameraTransform.method903(GlRectangleTextureStatics.anInt8633, CachedRgbNoiseTextureStatics.anInt8668, MinimapTileEntryStatics.anInt620, PackedFlagsAccessorStatics.anInt7092, ClanChatRequestSender.anInt3650, DisplaySettingsConfigStatics.anInt7244)
                    ...
                    if (TerrainTileShapeStatics.aTerrainTileArray8801 != null && (!RenderNodeStatics.aBoolean9722 || (0x40 and WidgetTextConfigStatics.anInt500) != 0)) {
                        ...
                        if (f > 0.0f) {
                            ...
                            if (i_26_ < 3 && ((0x2 and (AnimationFrameDefinitionStatics.aByteArrayArrayArray6962!![1]!![i_24_ shr 9]!![i_25_ shr 9]).toInt()) != 0)) i_26_++
                        }
                        if (i_13_ != -1 && i_14_ != -1) {
                            if (!RenderNodeStatics.aBoolean9722 || (0x40 and WidgetTextConfigStatics.anInt500) == 0) {
                                if (ObjectSpawnDecoder.aBoolean1801) MinimapPolygonDrawerStatics.method466(false, "", i_14_, (-109).toByte(), true, i_13_, -1, true, 12, (i_14_ or (i_13_ shl 0)).toLong(), (LocalizedTextStatics.aLocalizedText_3510!!.method2063(AnimationFrameDefinitionStatics.anInt6967, 544)), 0L, -1)
                                RenderableEntryStatics.anInt4334++
                                MinimapPolygonDrawerStatics.method466(false, "", i_14_, (-82).toByte(), true, i_13_, -1, true, 19, (i_14_ or (i_13_ shl 0)).toLong(), LightingOptionStateStatics.aString5882, 0L, MapElementLookupStatics.anInt4144)
                            } else {
                                val class46 = NpcReferenceStatics.method2957(NativeLibraryState.anInt169, (-54).toByte(), OrientationRotator.anInt2046)
                                if (class46 == null) TileRenderStateStatics.method2678(-2049)
                                else MinimapPolygonDrawerStatics.method466(false, " ->", i_14_, (-101).toByte(), true, i_13_, -1, true, 15, (i_13_ shl 0 or i_14_).toLong(), ItemNameResolverStatics.aString5001, 0L, (FloatBufferStatics.anInt9747))
                            }
                        }
                    }
                    if (GrayscaleNoiseTextureStatics.aBoolean5300) GlVertexBufferArbStatics.method2129(86.toByte())
                    var i_27_ = 0
                    while ((i_27_ < (if (!GrayscaleNoiseTextureStatics.aBoolean5300) 1 else 2))) {
                        val bool = i_27_ == 0
                        val class76 = (if (bool) PlayerSequenceSelector.aSceneObjectSpawner_1208 else HardCacheEntryReferenceStatics.aSceneObjectSpawner_10436)
                        var i_28_ = i
                        var i_29_ = i_4_
                        if (GrayscaleNoiseTextureStatics.aBoolean5300) {
                            LinkedNodeListIteratorStatics.method1010(false, bool)
                            i_28_ += MinimapFlagRenderer.method1082(-92, bool)
                            i_29_ += OggBitstreamDecoderStatics.method2960(bool, -48)
                        }
                            ...
                            if ((TextureLoadExceptionStatics.aBoolean4599 || ((LocalPlayerState.aPlayer_1907!!.plane) == class318_sub4.aClass318_Sub1_6410!!.plane)) && class318_sub4.method2504(i_29_, i_28_, var_renderer, -115)) {
                                ...
                                if (class318_sub4.aClass318_Sub1_6410 is Player) {
                                    ...
                                    if (((0x1 and i_34_) == 0 && (0x1ff and (player.x)) == 0 && (0x1ff and (player.y)) == 0) || ((i_34_ and 0x1) == 1 && ((player.x) and 0x1ff) == 256 && ((player.y) and 0x1ff) == 256)) {
                                        ...
                                        var i_37_ = 0
                                        while ((ModelDefinitionLoaderStatics.anInt2057 > i_37_)) {
                                            val class348_sub22 = ((NpcEntityUpdater.aHashtable_3654!!.method3480(RgbColorPaletteStatics.anIntArray1233!![i_37_].toLong(), -6008)) as? NpcReference?)
                                            if (class348_sub22 != null) {
                                                val npc = (class348_sub22.aNpc_6859)!!
                                                if ((GlGroundShaderPassStatics.anInt7396 != (npc.anInt10215)) && (npc.aBoolean10309)) {
                                                    ...
                                                    if (i_35_ <= i_38_ && ((-(i_38_ + -i_35_ shr 9) + (player.method2436(68.toByte()))) >= (npc.aNpcType_10505!!.anInt1399)) && i_36_ <= i_39_ && ((-(-i_36_ + i_39_ shr 9) + (player.method2436(97.toByte()))) >= (npc.aNpcType_10505!!.anInt1399))) {
                                                        WaterMaterialPassStatics.method2150(((class318_sub4.aClass318_Sub1_6410!!.plane) != (LocalPlayerState.aPlayer_1907!!.plane)), false, npc)
                                                        npc.anInt10215 = GlGroundShaderPassStatics.anInt7396
                                                    }
                                                }
                                            }
                                            i_37_++
                                        }
                                        val i_40_ = ShaderStateStatics.anInt6513
                                        val `is` = ScrollTexMaterialPassStatics.anIntArray6290!!
                                        var i_41_ = 0
                                        while ((i_40_ > i_41_)) {
                                            val player_42_ = (LoadingBarRendererStatics.aPlayerArray5058!![`is`[i_41_]])
                                            if ((player_42_ != null) && (GlGroundShaderPassStatics.anInt7396 != (player_42_.anInt10215)) && (player != player_42_) && (player_42_.aBoolean10309)) {
                                                ...
                                                if ((i_43_ >= i_35_) && ((player.method2436(70.toByte()) - (-i_35_ + i_43_ shr 9)) >= player_42_.method2436(89.toByte())) && (i_44_ >= i_36_) && ((player.method2436(42.toByte()) - (i_44_ - i_36_ shr 9)) >= player_42_.method2436(127.toByte()))) {
                                                    SpriteDefinitionStatics.method3298(114.toByte(), ((class318_sub4.aClass318_Sub1_6410!!.plane) != (LocalPlayerState.aPlayer_1907!!.plane)), player_42_)
                                                    player_42_.anInt10215 = GlGroundShaderPassStatics.anInt7396
                                                }
                                            }
                                            i_41_++
                                        }
                                    }
                                    if (GlGroundShaderPassStatics.anInt7396 == player.anInt10215) {
                                        class318_sub4 = class243.method1878((-123).toByte()) as SceneEntityModel?
                                        continue
                                    }
                                    SpriteDefinitionStatics.method3298(96.toByte(), ((LocalPlayerState.aPlayer_1907!!.plane) != class318_sub4.aClass318_Sub1_6410!!.plane), player)
                                    player.anInt10215 = GlGroundShaderPassStatics.anInt7396
                                }
                                if (class318_sub4.aClass318_Sub1_6410 is Npc) {
                                    ...
                                    if (npc.aNpcType_10505 != null) {
                                        if (((npc.aNpcType_10505!!.anInt1399 and 0x1) == 0 && (0x1ff and (npc.x)) == 0 && (0x1ff and (npc.y)) == 0) || ((0x1 and npc.aNpcType_10505!!.anInt1399) == 1 && (0x1ff and (npc.x)) == 256 && ((npc.y) and 0x1ff) == 256)) {
                                            ...
                                            for (i_47_ in 0..<ModelDefinitionLoaderStatics.anInt2057) {
                                                val class348_sub22 = ((NpcEntityUpdater.aHashtable_3654!!.method3480(RgbColorPaletteStatics.anIntArray1233!![i_47_].toLong(), -6008)) as NpcReference?)
                                                if (class348_sub22 != null) {
                                                    val npc_48_ = (class348_sub22.aNpc_6859)!!
                                                    if (((npc_48_.anInt10215) != GlGroundShaderPassStatics.anInt7396) && (npc != npc_48_) && (npc_48_.aBoolean10309)) {
                                                        ...
                                                        if (i_49_ >= i_45_ && ((npc_48_.aNpcType_10505!!.anInt1399) <= ((npc.aNpcType_10505!!.anInt1399) - (-i_45_ + i_49_ shr 9))) && (i_46_ <= i_50_) && ((npc_48_.aNpcType_10505!!.anInt1399) <= ((npc.aNpcType_10505!!.anInt1399) + -(i_50_ + -i_46_ shr 9)))) {
                                                            WaterMaterialPassStatics.method2150(((class318_sub4.aClass318_Sub1_6410!!.plane) != (LocalPlayerState.aPlayer_1907!!.plane)), false, npc_48_)
                                                            npc_48_.anInt10215 = (GlGroundShaderPassStatics.anInt7396)
                                                        }
                                                    }
                                                }
                                            }
                                            val i_51_ = ShaderStateStatics.anInt6513
                                            val `is` = ScrollTexMaterialPassStatics.anIntArray6290!!
                                            var i_52_ = 0
                                            while ((i_51_ > i_52_)) {
                                                val player = (LoadingBarRendererStatics.aPlayerArray5058!![`is`[i_52_]])
                                                if ((player != null) && (GlGroundShaderPassStatics.anInt7396 != (player.anInt10215)) && (player.aBoolean10309)) {
                                                    ...
                                                    if ((i_53_ >= i_45_) && ((-(-i_45_ + i_53_ shr 9) + (npc.aNpcType_10505!!.anInt1399)) >= player.method2436(114.toByte())) && (i_54_ >= i_46_) && (player.method2436(58.toByte()) <= ((npc.aNpcType_10505!!.anInt1399) - (i_54_ + -i_46_ shr 9)))) {
                                                        SpriteDefinitionStatics.method3298(125.toByte(), ((class318_sub4.aClass318_Sub1_6410!!.plane) != (LocalPlayerState.aPlayer_1907!!.plane)), player)
                                                        player.anInt10215 = GlGroundShaderPassStatics.anInt7396
                                                    }
                                                }
                                                i_52_++
                                        ...
                                        if (GlGroundShaderPassStatics.anInt7396 == npc.anInt10215) {
                                            class318_sub4 = class243.method1878((-123).toByte()) as SceneEntityModel?
                                            continue
                                        }
                                        WaterMaterialPassStatics.method2150((class318_sub4.aClass318_Sub1_6410!!.plane != (LocalPlayerState.aPlayer_1907!!.plane)), false, npc)
                                ...
                                if (class318_sub4.aClass318_Sub1_6410 is DynamicSceneObjectEntity) {
                                    val i_55_ = ArbVertexProgramStatics.regionTileX + i_33_
                                    val i_56_ = i_32_ - -RegionMapDecoder.regionTileY
                                    val class348_sub37 = ((ModelBatchBaseStatics.aHashtable_1895!!.method3480(((class318_sub4.aClass318_Sub1_6410!!.plane).toInt() shl 28 or (i_56_ shl 14) or i_55_).toLong(), -6008)) as HashTableContainer?)
                                        ...
                                        while (class348_sub34 != null) {
                                            ...
                                            if (RenderNodeStatics.aBoolean9722 && ((LocalPlayerState.aPlayer_1907!!.plane) == class318_sub4.aClass318_Sub1_6410!!.plane)) {
                                                ...
                                                if ((WidgetTextConfigStatics.anInt500 and 0x1) != 0 && (class254 == null || ((class254.anInt3256) != (class213.method1567((class254.anInt3256), 29, ParticleEmitterFactoryStatics.anInt3176))))) {
                                                    TerrainChunkBuilderStatics.anInt1555++
                                                    MinimapPolygonDrawerStatics.method466(false, (ItemNameResolverStatics.aString5000 + " -> <col=ff9040>" + (class213.aString2795)), i_32_, (-76).toByte(), false, i_33_, -1, true, 49, i_57_.toLong(), ItemNameResolverStatics.aString5001, class348_sub34.anInt6973.toLong(), (FloatBufferStatics.anInt9747))
                                                }
                                            }
                                            if (class318_sub4.aClass318_Sub1_6410!!.plane == (LocalPlayerState.aPlayer_1907!!.plane)) {
                                                ...
                                                for (i_58_ in 4 downTo 0) {
                                                    if (strings != null && strings[i_58_] != null) {
                                                        ...
                                                        MinimapPolygonDrawerStatics.method466(false, ("<col=ff9040>" + (class213.aString2795)), i_32_, (-119).toByte(), false, i_33_, -1, true, i_59_, i_57_.toLong(), strings[i_58_], class348_sub34.anInt6973.toLong(), i_60_)
                                                        CacheEntryReferenceStatics.anInt9548++
                                                    }
                                                }
                                            }
                                            AnimationFrameDefinitionStatics.anInt6956++
                                            MinimapPolygonDrawerStatics.method466(((LocalPlayerState.aPlayer_1907!!.plane) != class318_sub4.aClass318_Sub1_6410!!.plane), ("<col=ff9040>" + class213.aString2795) + LoaderStatics.getDebug(class213.anInt2769), i_32_, (-122).toByte(), false, i_33_, -1, true, 1010, i_57_.toLong(), (LocalizedTextStatics.aLocalizedText_3505!!.method2063(AnimationFrameDefinitionStatics.anInt6967, 544)), class348_sub34.anInt6973.toLong(), CubeMapMaterialPassStatics.anInt6299)
                                ...
                                if (class318_sub4.aClass318_Sub1_6410 is RenderTarget) {
                                    ...
                                    var npcConfig: NpcConfig? = (GradientLookupEffectStatics.aSeqDefinitionCache_9195!!.method2005(0, renderTarget.method42(-100)))
                                    ...
                                    if (npcConfig != null) {
                                        if (RenderNodeStatics.aBoolean9722 && ((LocalPlayerState.aPlayer_1907!!.plane) == (class318_sub4.aClass318_Sub1_6410!!.plane))) {
                                            ...
                                            if (((0x4 and WidgetTextConfigStatics.anInt500) != 0) && (class254 == null || ((class254.anInt3256) != (npcConfig.method487(ParticleEmitterFactoryStatics.anInt3176, (class254.anInt3256), 54))))) {
                                                ...
                                                MinimapPolygonDrawerStatics.method466(false, (ItemNameResolverStatics.aString5000 + " -> <col=00ffff>" + (npcConfig.aString884)), i_32_, (-94).toByte(), false, i_33_, -1, true, 2, renderTarget.hashCode().toLong(), ItemNameResolverStatics.aString5001, (WeaveTextureNodeStatics.method3107(95.toByte(), renderTarget, i_32_, i_33_)), FloatBufferStatics.anInt9747)
                                            }
                                        }
                                        if (class318_sub4.aClass318_Sub1_6410!!.plane == (LocalPlayerState.aPlayer_1907!!.plane)) {
                                            ...
                                            if (strings != null) {
                                                for (i_61_ in 4 downTo 0) {
                                                    if (strings[i_61_] != null) {
                                                        ...
                                                        MinimapPolygonDrawerStatics.method466(false, ("<col=00ffff>" + (npcConfig.aString884)), i_32_, (-100).toByte(), false, i_33_, -1, true, i_62_, renderTarget.hashCode().toLong(), strings[i_61_], (WeaveTextureNodeStatics.method3107((-116).toByte(), renderTarget, i_32_, i_33_)), i_63_)
                                                        WaterTextureSetStatics.anInt1445++
                                                    }
                                                }
                                            }
                                            val x = i_33_ + ArbVertexProgramStatics.regionTileX
                                            val y = i_32_ + RegionMapDecoder.regionTileY
                                            MinimapPolygonDrawerStatics.method466(
                                                ((LocalPlayerState.aPlayer_1907!!.plane) != class318_sub4.aClass318_Sub1_6410!!.plane),
                                                ("<col=00ffff>" + npcConfig.aString884 + LoaderStatics.getDebug(npcConfig.anInt941, x, y, class318_sub4.aClass318_Sub1_6410!!.plane.toInt())),
                                                i_32_,
                                                (-120).toByte(),
                                                false,
                                                i_33_,
                                                ...
                                                (LocalizedTextStatics.aLocalizedText_3505!!.method2063(AnimationFrameDefinitionStatics.anInt6967, 544)),
                                                npcConfig.anInt941.toLong(),
                                                CubeMapMaterialPassStatics.anInt6299
                                            )
                                            anInt6094++
                                        }
                                    }
