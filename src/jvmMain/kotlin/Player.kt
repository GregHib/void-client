...
class Player : ProjectedGroundDecor() {
    ...
    fun method2452(i: Byte, class348_sub49: ByteBuffer) {
        ...
        if (NpcAnimationResolverStatics.aNamedIdRecord_165 == OggCacheStream.aNamedIdRecord_5271 && AsyncTaskHandle.anInt2581 >= 2) this.aBoolean10551 = false
        this.anInt10542 = 0
        var i_14_ = -1
        val `is` = IntArray(12)
        for (i_15_ in 0..11) {
    ...
    override fun method2386(i: Int, var_renderer: Renderer?): SceneEntityModel? {
        ...
        val class357 = (HintArrowOrMessage.aSceneCollisionEntryArrayArrayArray2029!![this.plane.toInt()]!![this.x shr MapTileShape.anInt4459]!![this.y shr MapTileShape.anInt4459])
    ...
    private fun method2459(i: Int, var_renderer: Renderer?, i_69_: Int): Boolean {
        ...
        if (OggCacheStream.aNamedIdRecord_5271 != NpcAnimationResolverStatics.aNamedIdRecord_165 && i_75_ < 50) {
            val i_77_: Int
            i_77_ = -i_75_ + 50
        ...
        } else if (NpcAnimationResolverStatics.aNamedIdRecord_165 != OggCacheStream.aNamedIdRecord_5271) {
            ...
            if (class64_80_ != null) {
                if (this.anInt10278 >= 0 && class225.anIntArrayArray2939 != null && ((class225.anIntArrayArray2939!![this.anInt10278]) != null)) {
                    ...
                    if (i_83_ != 0 || i_81_ != 0) {
                        ...
                        val i_86_ = SpotAnimVector.anIntArray1207!![i_85_]
                        val i_87_ = SpotAnimVector.anIntArray1204!![i_85_]
            ...
            if (class64_91_ != null) {
                if (this.anInt10289 < 0 || class225.anIntArrayArray2939 == null || ((class225.anIntArrayArray2939!![this.anInt10289]) == null)) {
                    ...
                    if (i_94_ != 0 || i_92_ != 0) {
                        ...
                        val i_97_ = SpotAnimVector.anIntArray1207!![i_96_]
                        val i_98_ = SpotAnimVector.anIntArray1204!![i_96_]
