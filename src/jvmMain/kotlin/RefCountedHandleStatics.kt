object RefCountedHandleStatics {
    var anInt2267: Int = 0
            @JvmField
            ...
            fun method1319(i: Int, bool: Boolean, `is`: ByteArray, i_0_: Int): Int {
                ...
                var i_1_ = -1
                for (i_2_ in i_0_..<i) i_1_ = (i_1_ ushr 8 xor NativeBufferHandleStatics.anIntArray1508!![(i_1_ xor `is`[i_2_].toInt()) and 0xff])
                i_1_ = i_1_ xor -0x1
                return i_1_
            }
            ...
            fun method1320() {
                for (i in 0..<CalendarUtil.anInt4135) {
                    if (!RenderNodeStatics.aBooleanArray9718!![i]) {
                        val class211 = WaterDetailOptionStateStatics.aSoundEnvelopeArray5993!![i]
                        val class348_sub1 = class211!!.aClass348_Sub1_2745!!
                        val i_3_ = class211.anInt2731
                        val i_4_ = (class348_sub1.method2723(-1) - TheoraVideoStreamStatics.anInt9037)
                        ...
                        if (i_9_ >= RegionSceneShifterStatics.anInt7054) i_9_ = RegionSceneShifterStatics.anInt7054 - 1
                        for (i_10_ in i_8_..i_9_) {
                            ...
                            if (i_15_ >= SpotAnimEntityStatics.anInt6451) i_15_ = SpotAnimEntityStatics.anInt6451 - 1
                            for (i_16_ in i_14_..i_15_) {
                                var i_17_ = 1
                                val class318_sub1_sub3: GroundDecorEntity? = (ClickFeedbackTaskStatics.method1353(i_3_, i_16_, i_10_, (if (aClass2276 != null) aClass2276 else (GroundDecorEntity::class.java.also { aClass2276 = it }))))
                        ...
                        NativeSpriteStatics.aTerrainTileArray5191!![i_3_]!!.method3981(class348_sub1, `is`)
                    }
                }
            }
            ...
            fun method1321(i: Byte, i_32_: Int, i_33_: Int, i_34_: Int, i_35_: Int, i_36_: Int): Int {
                ...
                val i_37_ = 4 / ((-51 - i) / 63)
                anInt2273++
                if (NativeSpriteStatics.aTerrainTileArray5191 == null) return 0
                if (i_35_ < 3) {
                    val i_38_ = i_32_ shr 9
                    val i_39_ = i_33_ shr 9
                    if (i_34_ < 0 || i_36_ < 0 || -1 + GlCubemapLightPassStatics.anInt7319 < i_34_ || (i_36_ > RangeThresholdTextureNodeStatics.anInt9109 - 1)) return 0
                    if (i_38_ < 1 || i_39_ < 1 || -1 + GlCubemapLightPassStatics.anInt7319 < i_38_ || -1 + RangeThresholdTextureNodeStatics.anInt9109 < i_39_) return 0
                    var bool = ((0x2 and (AnimationFrameDefinitionStatics.aByteArrayArrayArray6962!![1]!![i_32_ shr 9]!![i_33_ shr 9]).toInt()) != 0)
                    if ((i_32_ and 0x1ff) == 0) {
                        val bool_40_ = ((0x2 and (AnimationFrameDefinitionStatics.aByteArrayArrayArray6962!![1]!![-1 + i_38_]!![i_33_ shr 9]).toInt()) != 0)
                        val bool_41_ = ((0x2 and (AnimationFrameDefinitionStatics.aByteArrayArrayArray6962!![1]!![i_38_]!![i_33_ shr 9]).toInt()) != 0)
                        if (bool_40_ == !bool_41_) bool = (0x2 and (AnimationFrameDefinitionStatics.aByteArrayArrayArray6962!![1]!![i_34_]!![i_36_]).toInt()) != 0
                    }
                    if ((i_33_ and 0x1ff) == 0) {
                        val bool_42_ = ((AnimationFrameDefinitionStatics.aByteArrayArrayArray6962!![1]!![i_32_ shr 9]!![-1 + i_39_]).toInt() and 0x2) != 0
                        val bool_43_ = ((0x2 and (AnimationFrameDefinitionStatics.aByteArrayArrayArray6962!![1]!![i_32_ shr 9]!![i_39_]).toInt()) != 0)
                        if (bool_42_ == !bool_43_) bool = (0x2 and (AnimationFrameDefinitionStatics.aByteArrayArrayArray6962!![1]!![i_34_]!![i_36_]).toInt()) != 0
                    }
                    if (bool) i_35_++
                }
                return NativeSpriteStatics.aTerrainTileArray5191!![i_35_]!!.method3986(i_32_, i_33_, 22.toByte())
            }
            ...
            fun method1323(i: Int, i_44_: Int) {
                synchronized(WidgetRedrawRegionStatics.aLruByteCache_4254!!) {
                    WidgetRedrawRegionStatics.aLruByteCache_4254!!.method578(2, i)
                }
