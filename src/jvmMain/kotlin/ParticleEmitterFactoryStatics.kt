    ...
    @JvmField
            ...
            fun method1885(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, fs: FloatArray?, i_4_: Int, f: Float, i_5_: Int, i_6_: Int, f_7_: Float, fs_8_: FloatArray?) {
                ...
                try {
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("ca.D(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + (if (fs != null) "{...}" else "null") + ',' + i_4_ + ',' + f + ',' + i_5_ + ',' + i_6_ + ',' + f_7_ + ',' + (if (fs_8_ != null) "{...}" else "null") + ')'))
                }
            }
            ...
            fun method1887(i: Int, i_16_: Int, i_17_: Int): Boolean {
                anInt3178++
                if (i != 0) return true
                return RangeThresholdTextureNodeStatics.method3056(63, i_17_, i_16_) or ((0x70000 and i_17_) != 0) || CompassSmootherStatics.method2015(i_17_, i_16_, i + 7)
            }
}
