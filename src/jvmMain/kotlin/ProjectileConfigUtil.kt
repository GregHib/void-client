...
object ProjectileConfigUtil {
    ...
    var aOutgoingPacketHeader_395: OutgoingPacketHeader? = OutgoingPacketHeader(49, 6)

    var anInt396: Int = -1

    var anInt397: Int = 0
    var aOutgoingPacketHeader_398: OutgoingPacketHeader? = OutgoingPacketHeader(23, 8)
    ...
    fun method316(i: Byte) {
        aHashtable_389 = null
        aOutgoingPacketHeader_398 = null
        aTileRenderState_399 = null
        if (i.toInt() != -94) method313(98L, -24)
        aOutgoingPacketHeader_395 = null
    }
                    ...
                    if (i >= 90) {
                        for (i_10_ in 0..<HslAdjustTextureNode.anInt9383) {
                            ...
                            if (string_11_ != null && string_11_ == string_6_) {
                                method544(((LocalizedText.aLocalizedText_3528!!.method2063(ChatCommandProcessor.anInt6967, 544)) + string + (LocalizedText.aLocalizedText_3529!!.method2063(ChatCommandProcessor.anInt6967, 544))), false, 4)
                                return
                            }
                        ...
                        if (method2127(2, (LocalPlayerState.aPlayer_1907!!.aString10544)) == string_6_) method544((LocalizedText.aLocalizedText_3525!!.method2063(ChatCommandProcessor.anInt6967, 544)), false, 4)
                        else {
                            WorldMapElement.anInt4628++
                            val class348_sub47 = (method2148(MinimapAreaMarkerNodeStatics.aOutgoingPacketHeader_9687, TheoraVideoStream.aIsaacCipher_9029, -94))
