object CompositeRgbNoiseTextureStatics {
    @JvmField
            var anInt8675: Int = 0
            @JvmField
            var anInt8676: Int = 0
            ...
            fun method569(i: Byte, class348_sub49: ByteBuffer) {
                ...
                MouseInputTrackerStatics.aDataHolderArray7446 = arrayOfNulls<DataHolder>(i_0_)
                var i_1_ = 0
                while (i_0_ > i_1_) {
                    MouseInputTrackerStatics.aDataHolderArray7446!![i_1_] = DataHolder()
                    MouseInputTrackerStatics.aDataHolderArray7446!![i_1_]!!.anInt3657 = class348_sub49.readSmart(-124)
                    MouseInputTrackerStatics.aDataHolderArray7446!![i_1_]!!.aString3663 = class348_sub49.method3371(-13487)
                    i_1_++
                }
                SceneObjectEntityStatics.anInt8731 = class348_sub49.readSmart(-127)
                MultiLevelOptionStateStatics.anInt6151 = class348_sub49.readSmart(-119)
                NpcDefinitionStatics.anInt2956 = class348_sub49.readSmart(-122)
                FireParticleStreamStatics.aClass110_Sub1Array97 = arrayOfNulls<MapLabelMenuEntry>(1 + (MultiLevelOptionStateStatics.anInt6151 + -SceneObjectEntityStatics.anInt8731))
                var i_2_ = 0
                while (NpcDefinitionStatics.anInt2956 > i_2_) {
                    val i_3_ = class348_sub49.readSmart(-126)
                    val class110_sub1 = (MapLabelMenuEntry().also { FireParticleStreamStatics.aClass110_Sub1Array97!![i_3_] = it })
                    class110_sub1.anInt1711 = class348_sub49.readUnsignedByte(255)
                    class110_sub1.anInt1708 = class348_sub49.readInt((-126).toByte())
                    class110_sub1.anInt5786 = SceneObjectEntityStatics.anInt8731 + i_3_
                    class110_sub1.aString5787 = class348_sub49.method3371(-13487)
                    class110_sub1.aString5794 = class348_sub49.method3371(-13487)
                    i_2_++
                }
                ScrollbarComponentStatics.anInt8349 = class348_sub49.readInt((-126).toByte())
                RenderableGroupStatics.aBoolean5013 = true
            }
            ...
            fun method573(class348_sub42: HashLinkedListNode?, class348_sub42_15_: HashLinkedListNode?, i: Byte) {
                try {
                    ...
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("wd.F(" + (if (class348_sub42 != null) "{...}" else "null") + ',' + (if (class348_sub42_15_ != null) "{...}" else "null") + ',' + i + ')'))
                }
            }
                ...
                try {
                    for (i_27_ in 0..127) {
                        for (i_28_ in 0..127) {
                            ...
                            ProjectileFactoryStatics.anIntArrayArray2900!![i_27_]!![i_28_] = 99999999
                        }
                    }
                    anInt8676++
                    val bool_29_: Boolean
                    if (i_16_ != 1) {
                        if (i_16_ == 2) bool_29_ = SeqDefinitionCacheStatics.method2007(i_19_, -125, i_23_, collisionMap!!, i, i_21_, i_24_, i_17_, i_25_, i_20_, i_26_)
                        else bool_29_ = MapAreaDefinitionStatics.method1420(i_24_, i_26_, -73, i_21_, i_17_, i, i_20_, i_25_, i_16_, collisionMap!!, i_19_, i_23_)
                    } else bool_29_ = ScrollbarComponentStatics.method187(i, i_23_, i_21_, i_26_, i_25_, i_24_, collisionMap!!, i_19_, i_17_, i_20_, 1109655552)
                    val i_30_ = i_20_ - 64
                    val i_31_ = i_21_ + -64
                    var i_32_ = HslAdjustTextureNodeStatics.anInt9388
                    ...
                    if (!bool_29_) {
                        ...
                        while (i - -i_36_ >= i_37_) {
                            for (i_38_ in i_23_ - i_36_..i_23_ - -i_36_) {
                                ...
                                if (i_39_ >= 0 && i_40_ >= 0 && i_39_ < 128 && i_40_ < 128 && (ProjectileFactoryStatics.anIntArrayArray2900!![i_39_]!![i_40_] < 100)) {
                                    var i_41_ = 0
                                    if (i <= i_37_) {
                                    ...
                                    if (i_43_ < i_34_ || i_34_ == i_43_ && ((ProjectileFactoryStatics.anIntArrayArray2900!![i_39_]!![i_40_]) < i_35_)) {
                                        i_34_ = i_43_
                                        i_32_ = i_37_
                                        i_35_ = (ProjectileFactoryStatics.anIntArrayArray2900!![i_39_]!![i_40_])
                                        i_33_ = i_38_
                                    }
                                }
                            }
                    ...
                    GlGroundShaderPassStatics.anIntArray7397!![i_44_] = i_32_
                    ...
                    var i_47_ = 0
                    while (i_44_-- > 0) {
                        is_22_!![i_47_] = GlGroundShaderPassStatics.anIntArray7397!![i_44_]
                        `is`!![i_47_++] = CircleDrawer.anIntArray2694!![i_44_]
                        if (is_22_.size <= i_47_) break
                    }
                    return i_47_
                } catch (runtimeexception: RuntimeException) {
                    throw SoundBankPatchStatics.method2929(runtimeexception, ("wd.B(" + i + ',' + i_16_ + ',' + i_17_ + ',' + (if (`is` != null) "{...}" else "null") + ',' + bool + ',' + i_18_ + ',' + i_19_ + ',' + i_20_ + ',' + i_21_ + ',' + (if (is_22_ != null) "{...}" else "null") + ',' + i_23_ + ',' + (if (collisionMap != null) "{...}" else "null") + ',' + i_24_ + ',' + i_25_ + ',' + i_26_ + ')'))
                }
            }
}
