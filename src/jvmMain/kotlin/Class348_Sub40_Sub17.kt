...
open class Class348_Sub40_Sub17 : Class348_Sub40(0, false) {
    ...
    fun method3090(bool: Boolean): Boolean {
        ...
        if (anInt9243 >= 0) {
            val class207 = (if (Class101_Sub2.anInt5713 >= 0) Class207Statics.method1521(Class348Statics.aClass45_4286!!, Class101_Sub2.anInt5713, anInt9243) else Class207Statics.method1512(Class348Statics.aClass45_4286!!, anInt9243))
            class207!!.method1524()
