...
class VarpStore : VarResolver {
    ...
    companion object {
        ...
        fun method1308(i: Int, i_14_: Int, i_15_: Int, i_16_: Int, i_17_: Byte, i_18_: Int, i_19_: Int, i_20_: Int) {
            anInt5072++
            if (WorldMapLabel.anInt4960 <= i_15_ && i_19_ <= CameraNodeListStatics.anInt1745 && i_14_ >= LocalPlayerState.anInt1910 && WidgetTextConfigStatics.anInt513 >= i_20_) method1730(i_16_, i_20_, i_14_, i_19_, i, i_18_, -128, i_15_)
        ...
        fun method1317(i: Int, i_36_: Byte, i_37_: Int): Boolean {
            ...
            return LoadingBarRenderer.method2217(i, i_37_, 0) or ((i_37_ and 0x70000) != 0) || CompassSmootherStatics.method2015(i_37_, i, 7)
        }
        ...
        fun method1318(i: Int) {
            ...
            for (i_38_ in 0..<AbstractCameraTransformStatics.anInt1597) {
                ...
                if ((0x2 and i_40_) != 0) {
                    ...
                    npc.method2448((MapAreaDefinitionStatics.aBufferedMessageQueue_2529!!.method2079(CircleRasterizerObject.aClass348_Sub49_Sub2_3813!!.readShortAdd(-1), -1)), -2)
                    npc.method2434(95.toByte(), npc.aNpcType_10505!!.anInt1399)
                    npc.anInt10310 = npc.aNpcType_10505!!.anInt1329 shl 3
                    if (npc.aNpcType_10505!!.method793(0)) IdentKitRecolorStatics.method1614(979190089, npc, (npc.plane).toInt(), (npc.anIntArray10317!![0]), (npc.anIntArray10320!![0]), null, null, 0)
                }
                if ((0x8 and i_40_) != 0) {
                    val `is` = IntArray(4)
                    for (i_41_ in 0..3) {
