                        ...
                        while ((Class348_Sub40_Sub3.anInt9109 shr 3 > i_54_)) {
                            ...
                            if (i_55_ != -1) {
                                ...
                                if (!class237_sub1.aBoolean3109 || i_56_ == 0) {
                                    ...
                                    for (i_61_ in Class348_Sub23_Sub3Statics.anIntArray9042!!.indices) {
                                        if (i_60_ == (Class348_Sub23_Sub3Statics.anIntArray9042!![i_61_]) && `is`!![i_61_] != null) {
                                            class237_sub1.method1692((i_58_ and 0x7) * 8, i_57_, `is`[i_61_], i_56_, (i_59_ and 0x7) * 8, Class348_Sub8.aHa6654, 8 * i_54_, 8 * i_53_, i + 8219, Class348_Sub45Statics.aClass361Array7108, i_52_)
                                            break
                                        }
                                    }
                                }
