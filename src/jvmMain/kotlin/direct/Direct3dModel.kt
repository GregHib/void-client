...
class Direct3dModel internal constructor(var_ha_Sub3: NativeRenderer?, i: Int, i_764_: Int, bool: Boolean, bool_765_: Boolean) : AbstractModel() {
        ...
        if (aTextureMipDescriptorArray5524 != null) {
            ...
            while (anInt5406 > i_0_) {
                ...
                if (!class353.aBoolean4350 || !aHa_Sub3_5419!!.method3666()) {
                    ...
                    val f_5_ = WorldMapRenderer.aFloat4673 + (TextureMipDescriptorStatics.aFloat4338 * f_1_ + f * RenderQueueState.aFloat6523 + f_2_ * Renderer.aFloat4582)
    ...
    public override fun VA(i: Int) {
        anInt5479++
        val i_18_ = SpotAnimVector.anIntArray1207!![i]
        val i_19_ = SpotAnimVector.anIntArray1204!![i]
        var i_20_ = 0
    ...
    public override fun method628(i: Int, i_22_: Int, abstractCameraTransform: AbstractCameraTransform?, bool: Boolean, i_23_: Int): Boolean {
        try {
            anInt5414++
    ...
    private fun method662(i: Int, i_30_: Int, i_31_: Int, i_32_: Int, i_33_: Int, bool: Boolean, abstractCameraTransform: AbstractCameraTransform?): Boolean {
        try {
            anInt5450++
            ...
            aFloat6430 = ((class101_sub2_34_.aFloat5722 * class101_sub2.aFloat5732) + (class101_sub2.aFloat5704 * class101_sub2_34_.aFloat5708) + (class101_sub2.aFloat5716 * class101_sub2_34_.aFloat5732))
            ...
            if (bool_37_ && f_38_ < i.toFloat() && f_39_ > i.toFloat() && f_40_ < i_33_.toFloat() && f_41_ > i_33_.toFloat()) {
                ...
                for (i_65_ in 0..<anInt5433) {
                    ...
                    var f_69_ = (Renderer.aFloat4582 * f_66_ + (f_68_ * RenderQueueState.aFloat6523 + TextureMipDescriptorStatics.aFloat4338 * f_67_) + f_36_)
    ...
    public override fun a(i: Int) {
        anInt5435++
        val i_83_ = SpotAnimVector.anIntArray1207!![i]
        val i_84_ = SpotAnimVector.anIntArray1204!![i]
        var i_85_ = 0
    ...
    public override fun FA(i: Int) {
        anInt5488++
        val i_87_ = SpotAnimVector.anIntArray1207!![i]
        val i_88_ = SpotAnimVector.anIntArray1204!![i]
    ...
    public override fun P(i: Int, i_91_: Int, i_92_: Int, i_93_: Int) {
        ...
        if (i == 0) {
            ...
            while (anInt5433 > i_97_) {
                ...
                if (i_93_ != 0) {
                    val i_98_ = SpotAnimVector.anIntArray1207!![i_93_]
                    val i_99_ = SpotAnimVector.anIntArray1204!![i_93_]
                ...
                if (i_91_ != 0) {
                    val i_101_ = SpotAnimVector.anIntArray1207!![i_91_]
                    val i_102_ = SpotAnimVector.anIntArray1204!![i_91_]
                ...
                if (i_92_ != 0) {
                    val i_104_ = SpotAnimVector.anIntArray1207!![i_92_]
                    val i_105_ = SpotAnimVector.anIntArray1204!![i_92_]
            ...
            for (i_111_ in 0..<anInt5478) {
                ...
                aShortArray5486!![i_111_] = (WhirlpoolHash.method2057(WhirlpoolHash.method2057(i_114_ shl 7, i_113_ shl 10), i_115_)).toShort()
            }
            if (aTextureMipDescriptorArray5524 != null) {
                for (i_116_ in 0..<anInt5406) {
                    ...
                    class334.anInt4156 = ((SoundEnvelope.anIntArray179!![(aShortArray5486!![class353.anInt4342].toInt() and 0xffff)]) and 0xffffff or (0xffffff.inv() and class334.anInt4156))
                }
            }
            method670(-109)
        } else if (i == 8) {
    ...
    public override fun k(i: Int) {
        anInt5490++
        val i_140_ = SpotAnimVector.anIntArray1207!![i]
        val i_141_ = SpotAnimVector.anIntArray1204!![i]
            ...
            if (aShortArray5494 != null) {
                ...
                for (i_149_ in 0..<anInt5433) {
                    if ((i and aShortArray5494!![i_149_].toInt()) != 0) {
                        if (!bool) abstractCameraTransform.method897(anIntArray5511!![i_149_], anIntArray5519!![i_149_], anIntArray5429!![i_149_], `is`)
                        else abstractCameraTransform.method892(anIntArray5511!![i_149_], anIntArray5519!![i_149_], anIntArray5429!![i_149_], `is`)
    ...
    public override fun method608(abstractCameraTransform: AbstractCameraTransform?, class318_sub3: SceneOcculder?, i: Int, i_179_: Int) {
        try {
            ...
            if (anInt5475 != 0) {
                ...
                val f = (WorldMapRenderer.aFloat4673 + anInt5461.toFloat() * TextureMipDescriptorStatics.aFloat4338)
                val f_181_ = (TextureMipDescriptorStatics.aFloat4338 * anInt5509.toFloat() + WorldMapRenderer.aFloat4673)
                val f_182_: Float
                val f_183_: Float
                if (f_181_ < f) {
                    ...
                    if (!(aHa_Sub3_5419!!.aFloat8158 <= f_187_ / i.toFloat()) && !(f_186_ / i.toFloat() <= aHa_Sub3_5419!!.aFloat8126)) {
                        ...
                        if (!(f_191_ / i.toFloat() >= aHa_Sub3_5419!!.aFloat8185) && !(f_190_ / i.toFloat() <= aHa_Sub3_5419!!.aFloat8103)) {
                            ...
                            if (class318_sub3 != null) {
                                ...
                                val i_196_ = ((anInt5461.toFloat() * TextureMipDescriptorStatics.aFloat4338) + ((RenderQueueState.aFloat6523 * i_192_.toFloat()) + WorldMapRenderer.aFloat4673) + i_193_.toFloat() * Renderer.aFloat4582).toInt()
                                ...
                                val i_199_ = (Renderer.aFloat4582 * i_193_.toFloat() + ((anInt5509.toFloat() * TextureMipDescriptorStatics.aFloat4338) + ((RenderQueueState.aFloat6523 * i_192_.toFloat()) + WorldMapRenderer.aFloat4673))).toInt()
    ...
    private fun method669(i: Int, l: Long, i_200_: Int, i_201_: Int, i_202_: Int, i_203_: Int, f: Float, i_204_: Int, f_205_: Float, modelDefinition: ModelDefinition?, i_206_: Int): Short {
        try {
                    ...
                    if (anIntArrayArray5413!!.size > i_229_) {
                        ...
                        if ((0x1 and i_215_) == 0) {
                            ...
                            while ((is_230_.size > i_231_)) {
                                ...
                                if (i_214_ != 0) {
                                    val i_233_ = SpotAnimVector.anIntArray1207!![i_214_]
                                    val i_234_ = SpotAnimVector.anIntArray1204!![i_214_]
                                ...
                                if (i_212_ != 0) {
                                    val i_236_ = SpotAnimVector.anIntArray1207!![i_212_]
                                    val i_237_ = SpotAnimVector.anIntArray1204!![i_212_]
                                ...
                                if (i_213_ != 0) {
                                    val i_239_ = SpotAnimVector.anIntArray1207!![i_213_]
                                    val i_240_ = SpotAnimVector.anIntArray1204!![i_213_]
                            ...
                            for (i_242_ in is_230_.indices) {
                                ...
                                if (i_212_ != 0) {
                                    val i_244_ = SpotAnimVector.anIntArray1207!![i_212_]
                                    val i_245_ = SpotAnimVector.anIntArray1204!![i_212_]
                                ...
                                if (i_214_ != 0) {
                                    val i_247_ = SpotAnimVector.anIntArray1207!![i_214_]
                                    val i_248_ = SpotAnimVector.anIntArray1204!![i_214_]
                                ...
                                if (i_213_ != 0) {
                                    val i_250_ = SpotAnimVector.anIntArray1207!![i_213_]
                                    val i_251_ = SpotAnimVector.anIntArray1204!![i_213_]
                        ...
                        if (i_254_ < anIntArrayArray5413!!.size) {
                            ...
                            for (i_256_ in is_255_.indices) {
                                ...
                                while ((i_259_ > i_260_)) {
                                    ...
                                    if (i_261_ == -1) break
                                    if (i_214_ != 0) {
                                        val i_262_ = SpotAnimVector.anIntArray1207!![i_214_]
                                        val i_263_ = SpotAnimVector.anIntArray1204!![i_214_]
                                    ...
                                    if (i_212_ != 0) {
                                        val i_265_ = SpotAnimVector.anIntArray1207!![i_212_]
                                        val i_266_ = SpotAnimVector.anIntArray1204!![i_212_]
                                    ...
                                    if (i_213_ != 0) {
                                        val i_268_ = SpotAnimVector.anIntArray1207!![i_213_]
                                        val i_269_ = SpotAnimVector.anIntArray1204!![i_213_]
                    ...
                    while (i_216_ > i_285_) {
                        ...
                        if (anIntArrayArray5492!!.size > i_286_) {
                            ...
                            for (i_288_ in is_287_.indices) {
                                ...
                                aShortArray5486!![i_289_] = (WhirlpoolHash.method2057(i_293_, (WhirlpoolHash.method2057(i_291_ shl 10, i_292_ shl 7)))).toShort()
                            }
                    ...
                    if (bool_284_) {
                        if (aTextureMipDescriptorArray5524 != null) {
                            ...
                            while (anInt5406 > i_294_) {
                                ...
                                class334.anInt4156 = (0xffffff and (SoundEnvelope.anIntArray179!![(aShortArray5486!![(class353.anInt4342)]).toInt() and 0xffff]) or (0xffffff.inv() and class334.anInt4156))
                                i_294_++
                            }
                        }
                        method670(-100)
    ...
    public override fun method615(abstractCameraTransform: AbstractCameraTransform?, class318_sub3: SceneOcculder?, i: Int) {
        try {
            ...
            if (anInt5475 != 0) {
                ...
                val f = (TextureMipDescriptorStatics.aFloat4338 * anInt5461.toFloat() + WorldMapRenderer.aFloat4673)
                val f_308_ = (anInt5509.toFloat() * TextureMipDescriptorStatics.aFloat4338 + WorldMapRenderer.aFloat4673)
                val f_309_: Float
                val f_310_: Float
                if (f > f_308_) {
                    ...
                    if (!(aHa_Sub3_5419!!.aFloat8158 <= f_314_ / f_309_) && !(f_313_ / f_309_ <= aHa_Sub3_5419!!.aFloat8126)) {
                        ...
                        if (!(aHa_Sub3_5419!!.aFloat8185 <= f_318_ / f_309_) && !(f_317_ / f_309_ <= aHa_Sub3_5419!!.aFloat8103)) {
                            ...
                            if (class318_sub3 != null) {
                                ...
                                val i_324_ = (WorldMapRenderer.aFloat4673 + (i_320_.toFloat() * RenderQueueState.aFloat6523) + (anInt5461.toFloat() * TextureMipDescriptorStatics.aFloat4338) + i_321_.toFloat() * Renderer.aFloat4582).toInt()
                                ...
                                val i_327_ = ((anInt5509.toFloat() * TextureMipDescriptorStatics.aFloat4338) + (WorldMapRenderer.aFloat4673 + (i_320_.toFloat() * RenderQueueState.aFloat6523)) + Renderer.aFloat4582 * i_321_.toFloat()).toInt()
    ...
    internal constructor(var_ha_Sub3: NativeRenderer?, modelDefinition: ModelDefinition?, i: Int, i_334_: Int, i_335_: Int, i_336_: Int) : this(var_ha_Sub3, i, i_336_, true, false) {
        do {
            try {
                val var_renderConfig: RenderConfig = var_ha_Sub3!!.aRenderConfig4579!!
                val `is` = IntArray(modelDefinition!!.anInt1817)
                anIntArray5455 = IntArray(1 + modelDefinition.anInt1821)
                for (i_337_ in 0..<modelDefinition.anInt1817) {
                    if (modelDefinition.aByteArray1843 == null || modelDefinition.aByteArray1843!![i_337_].toInt() != 2) {
                        if (modelDefinition.aShortArray1822 != null && (modelDefinition.aShortArray1822!![i_337_].toInt() != -1)) {
                            val class12 = var_renderConfig.method3(((modelDefinition.aShortArray1822!![i_337_]).toInt() and 0xffff), -6662)
                            if (((anInt5472 and 0x40) == 0 || !class12!!.aBoolean209) && class12!!.aBoolean204) continue
                        }
                        `is`[anInt5478++] = i_337_
                        anIntArray5455!![(modelDefinition.aShortArray1863[i_337_]).toInt()] = anIntArray5455!![(modelDefinition.aShortArray1863[i_337_]).toInt()] + 1
                        anIntArray5455!![(modelDefinition.aShortArray1835!![i_337_]).toInt()] = anIntArray5455!![(modelDefinition.aShortArray1835!![i_337_]).toInt()] + 1
                        anIntArray5455!![(modelDefinition.aShortArray1855[i_337_]).toInt()] = anIntArray5455!![(modelDefinition.aShortArray1855[i_337_]).toInt()] + 1
                    }
                }
                anInt5516 = anInt5478
                ...
                for (i_338_ in 0..<anInt5478) {
                    ...
                    if (modelDefinition.aShortArray1822 != null) {
                        i_347_ = modelDefinition.aShortArray1822!![i_339_].toInt()
                        if (i_347_ != -1) {
                    ...
                    val bool_348_ = ((modelDefinition.aByteArray1834 != null && modelDefinition.aByteArray1834!![i_339_].toInt() != 0) || (npcAppearanceFlags != null && npcAppearanceFlags.anInt200 != 0))
                    if ((bool || bool_348_) && modelDefinition.aByteArray1839 != null) i_340_ += (modelDefinition.aByteArray1839!![i_339_].toInt() shl 17)
                ...
                method2832(`is`, ls, 0)
                anInt5497 = modelDefinition.anInt1836
                anIntArray5429 = modelDefinition.anIntArray1852
                anIntArray5519 = modelDefinition.anIntArray1847
                ...
                if (modelDefinition.aRectangleBoundsArray1832 != null) {
                    ...
                    while (anInt5406 > i_350_) {
                        ...
                        var i_353_ = (0xffffff and (SoundEnvelope.anIntArray179!![((modelDefinition.aShortArray1862[class162.anInt2155]).toInt() and 0xffff)]))
                ...
                var i_355_ = 0
                var i_356_ = 0
                while ((i_356_ < modelDefinition.anInt1821)) {
                ...
                while ((modelDefinition.anInt1817 > i_358_)) {
                    ...
                    val i_360_ = modelDefinition.aShortArray1835!![i_358_]
                    val i_361_ = modelDefinition.aShortArray1855[i_358_]
                ...
                for (i_373_ in 0..<anInt5478) {
                    ...
                    val i_375_ = (0xffff and modelDefinition.aShortArray1862[i_374_].toInt())
                    var i_376_: Int
                    if (modelDefinition.aByteArray1820 != null) i_376_ = modelDefinition.aByteArray1820!![i_374_].toInt()
                    else i_376_ = -1
                    val i_377_: Int
                    if (modelDefinition.aByteArray1834 == null) i_377_ = 0
                    else i_377_ = 0xff and (modelDefinition.aByteArray1834!![i_374_]).toInt()
                    var i_378_: Short = (if (modelDefinition.aShortArray1822 != null) modelDefinition.aShortArray1822!![i_374_] else (-1).toShort())
                    ...
                    if (i_378_.toInt() != -1) {
                        if (i_376_ == -1) {
                            ...
                            val i_387_ = modelDefinition.aByteArray1823[i_376_]
                            if (i_387_.toInt() == 0) {
                                val i_415_ = (modelDefinition.aShortArray1863[i_374_])
                                val i_416_ = (modelDefinition.aShortArray1835!![i_374_])
                                val i_417_ = (modelDefinition.aShortArray1855[i_374_])
                                val i_418_ = (modelDefinition.aShortArray1829[i_376_])
                                val i_419_ = (modelDefinition.aShortArray1849[i_376_])
                                val i_420_ = (modelDefinition.aShortArray1825[i_376_])
                                val f_421_ = (modelDefinition.anIntArray1841[i_418_.toInt()]).toFloat()
                                val f_422_ = (modelDefinition.anIntArray1847[i_418_.toInt()]).toFloat()
                                val f_423_ = (modelDefinition.anIntArray1852[i_418_.toInt()]).toFloat()
                                val f_424_ = ((modelDefinition.anIntArray1841[i_419_.toInt()]).toFloat() - f_421_)
                                val f_425_ = (-f_422_ + (modelDefinition.anIntArray1847[i_419_.toInt()]).toFloat())
                                val f_426_ = (-f_423_ + (modelDefinition.anIntArray1852[i_419_.toInt()]).toFloat())
                                val f_427_ = (-f_421_ + (modelDefinition.anIntArray1841[i_420_.toInt()]).toFloat())
                                val f_428_ = ((modelDefinition.anIntArray1847[i_420_.toInt()]).toFloat() - f_422_)
                                val f_429_ = (-f_423_ + (modelDefinition.anIntArray1852[i_420_.toInt()]).toFloat())
                                val f_430_ = (-f_421_ + (modelDefinition.anIntArray1841[i_415_.toInt()]).toFloat())
                                val f_431_ = ((modelDefinition.anIntArray1847[i_415_.toInt()]).toFloat() - f_422_)
                                val f_432_ = (-f_423_ + (modelDefinition.anIntArray1852[i_415_.toInt()]).toFloat())
                                val f_433_ = (-f_421_ + (modelDefinition.anIntArray1841[i_416_.toInt()]).toFloat())
                                val f_434_ = ((modelDefinition.anIntArray1847[i_416_.toInt()]).toFloat() - f_422_)
                                val f_435_ = ((modelDefinition.anIntArray1852[i_416_.toInt()]).toFloat() - f_423_)
                                val f_436_ = (-f_421_ + (modelDefinition.anIntArray1841[i_417_.toInt()]).toFloat())
                                val f_437_ = (-f_422_ + (modelDefinition.anIntArray1847[i_417_.toInt()]).toFloat())
                                val f_438_ = ((modelDefinition.anIntArray1852[i_417_.toInt()]).toFloat() - f_423_)
                                ...
                                val i_388_ = (modelDefinition.aShortArray1863[i_374_])
                                val i_389_ = (modelDefinition.aShortArray1835!![i_374_])
                                val i_390_ = (modelDefinition.aShortArray1855[i_374_])
                                ...
                                val i_394_ = (modelDefinition.aByteArray1853[i_376_])
                                ...
                                if (i_387_.toInt() == 1) {
                                    ...
                                    val f_396_ = ((modelDefinition.anIntArray1857[i_376_]).toFloat() / 256.0f)
                                    val f_397_ = ((modelDefinition.anIntArray1865[i_376_]).toFloat() / 256.0f)
                                    val i_398_ = (-(modelDefinition.anIntArray1841[i_388_.toInt()]) + (modelDefinition.anIntArray1841[i_389_.toInt()]))
                                    val i_399_ = ((modelDefinition.anIntArray1847[i_389_.toInt()]) + -(modelDefinition.anIntArray1847[i_388_.toInt()]))
                                    val i_400_ = (-(modelDefinition.anIntArray1852[i_388_.toInt()]) + (modelDefinition.anIntArray1852[i_389_.toInt()]))
                                    val i_401_ = ((modelDefinition.anIntArray1841[i_390_.toInt()]) + -(modelDefinition.anIntArray1841[i_388_.toInt()]))
                                    val i_402_ = ((modelDefinition.anIntArray1847[i_390_.toInt()]) - (modelDefinition.anIntArray1847[i_388_.toInt()]))
                                    val i_403_ = (-(modelDefinition.anIntArray1852[i_388_.toInt()]) + (modelDefinition.anIntArray1852[i_390_.toInt()]))
                                    val i_404_ = (i_399_ * i_403_ + -(i_400_ * i_402_))
                                    val i_405_ = (i_401_ * i_400_ + -(i_398_ * i_403_))
                                    val i_406_ = (i_402_ * i_398_ + -(i_399_ * i_401_))
                                    val f_407_ = (64.0f / (modelDefinition.anIntArray1859!![i_376_]).toFloat())
                                    val f_408_ = (64.0f / (modelDefinition.anIntArray1816[i_376_]).toFloat())
                                    val f_409_ = (64.0f / (modelDefinition.anIntArray1844[i_376_]).toFloat())
                                    ...
                                    SoftwareModel.method1367(i_393_, i_394_.toInt(), f_395_, (modelDefinition.anIntArray1841[i_388_.toInt()]), DataHolderStatics.aFloatArray3658, (modelDefinition.anIntArray1852[i_388_.toInt()]), i_391_, (modelDefinition.anIntArray1847[i_388_.toInt()]), i_392_, -4, fs)
                                    f = DataHolderStatics.aFloatArray3658!![0]
                                    f_379_ = DataHolderStatics.aFloatArray3658!![1]
                                    SoftwareModel.method1367(i_393_, i_394_.toInt(), f_395_, (modelDefinition.anIntArray1841[i_389_.toInt()]), DataHolderStatics.aFloatArray3658, (modelDefinition.anIntArray1852[i_389_.toInt()]), i_391_, (modelDefinition.anIntArray1847[i_389_.toInt()]), i_392_, -4, fs)
                                    f_380_ = DataHolderStatics.aFloatArray3658!![0]
                                    f_381_ = DataHolderStatics.aFloatArray3658!![1]
                                    SoftwareModel.method1367(i_393_, i_394_.toInt(), f_395_, (modelDefinition.anIntArray1841[i_390_.toInt()]), DataHolderStatics.aFloatArray3658, (modelDefinition.anIntArray1852[i_390_.toInt()]), i_391_, (modelDefinition.anIntArray1847[i_390_.toInt()]), i_392_, -4, fs)
                                    f_382_ = DataHolderStatics.aFloatArray3658!![0]
                                    f_383_ = DataHolderStatics.aFloatArray3658!![1]
                                    if ((i_394_.toInt() and 0x1) == 0) {
                                        if (-f + f_382_ > 0.5f) {
                    ...
                    val i_446_: Byte
                    if (modelDefinition.aByteArray1843 != null) i_446_ = modelDefinition.aByteArray1843!![i_374_]
                    ...
                    if (i_446_.toInt() == 0) {
                        ...
                        aShortArray5512!![i_373_] = method669(class63.anInt1122, l + i_385_.toLong(), i_373_, 0, class63.anInt1118, -109, f_382_, (modelDefinition.aShortArray1855[i_374_]).toInt(), f_383_, modelDefinition, class63.anInt1119)
                    }
                    if (modelDefinition.aByteArray1834 != null) aByteArray5515!![i_373_] = modelDefinition.aByteArray1834!![i_374_]
                    if (modelDefinition.aShortArray1856 != null) aShortArray5432!![i_373_] = modelDefinition.aShortArray1856!![i_374_]
                    aShortArray5486!![i_373_] = modelDefinition.aShortArray1862[i_374_]
                ...
                for (i_461_ in 0..<anInt5478) {
                    val i_462_ = modelDefinition.anIntArray1824!![`is`[i_461_]]
                    if (i_462_ >= 0) {
                        is_460_[i_462_]++
                ...
                while (anInt5478 > i_464_) {
                    val i_465_ = modelDefinition.anIntArray1824!![`is`[i_464_]]
    ...
    public override fun method623(i: Int, i_478_: Int, abstractCameraTransform: AbstractCameraTransform?, bool: Boolean, i_479_: Int, i_480_: Int): Boolean {
        try {
            anInt5517++
    ...
    public override fun ia(i: Short, i_528_: Short) {
        ...
        if (aTextureMipDescriptorArray5524 != null) {
            for (i_530_ in 0..<anInt5406) {
                ...
                class334.anInt4156 = ((SoundEnvelope.anIntArray179!![0xffff and aShortArray5486!![(class353.anInt4342)].toInt()]) and 0xffffff or (class334.anInt4156 and 0xffffff.inv()))
            }
        }
        method670(-119)
    }
    ...
    public override fun method624(i: Int, i_560_: Int, i_561_: Int, i_562_: Int) {
        ...
        while (anInt5478 > i_563_) {
            ...
            aShortArray5486!![i_563_] = (WhirlpoolHash.method2057(WhirlpoolHash.method2057(i_565_ shl 10, i_566_ shl 7), i_567_)).toShort()
            i_563_++
        }
        if (aTextureMipDescriptorArray5524 != null) {
            var i_568_ = 0
            while (anInt5406 > i_568_) {
                ...
                class334.anInt4156 = (class334.anInt4156 and 0xffffff.inv() or ((SoundEnvelope.anIntArray179!![(aShortArray5486!![class353.anInt4342].toInt() and 0xffff)]) and 0xffffff))
                i_568_++
            }
        }
        method670(-107)
            ...
            if (i == 0) {
                ...
                if (is_594_ == null) {
                        ...
                        if (i_659_ < anIntArrayArray5413!!.size) {
                            ...
                            while (is_660_.size > i_661_) {
                                ...
                                if (aShortArray5494 == null || ((aShortArray5494!![i_662_].toInt() and i_593_) != 0)) {
                                    ...
                                    if (i_592_ != 0) {
                                        val i_663_ = SpotAnimVector.anIntArray1207!![i_592_]
                                        val i_664_ = SpotAnimVector.anIntArray1204!![i_592_]
                                    ...
                                    if (i_590_ != 0) {
                                        val i_666_ = SpotAnimVector.anIntArray1207!![i_590_]
                                        val i_667_ = SpotAnimVector.anIntArray1204!![i_590_]
                                    ...
                                    if (i_591_ != 0) {
                                        val i_669_ = SpotAnimVector.anIntArray1207!![i_591_]
                                        val i_670_ = SpotAnimVector.anIntArray1204!![i_591_]
                                ...
                                for (i_675_ in is_674_.indices) {
                                    ...
                                    if (aShortArray5494 == null || ((aShortArray5494!![i_676_].toInt() and i_593_) != 0)) {
                                        ...
                                        while ((i_679_ < i_678_)) {
                                            ...
                                            if (i_680_ == -1) break
                                            if (i_592_ != 0) {
                                                val i_681_ = (SpotAnimVector.anIntArray1207!![i_592_])
                                                val i_682_ = (SpotAnimVector.anIntArray1204!![i_592_])
                                            ...
                                            if (i_590_ != 0) {
                                                val i_684_ = (SpotAnimVector.anIntArray1207!![i_590_])
                                                val i_685_ = (SpotAnimVector.anIntArray1204!![i_590_])
                                            ...
                                            if (i_591_ != 0) {
                                                val i_687_ = (SpotAnimVector.anIntArray1207!![i_591_])
                                                val i_688_ = (SpotAnimVector.anIntArray1204!![i_591_])
                    ...
                    if (OpenGlModel.aBoolean5609) {
                        var i_616_ = ((is_594_[6] * KeyboardInputSourceStatics.anInt4274 + (SpriteLoadValidatorStatics.anInt4795 * is_594_[0] - -(SpriteArchiveLoader.anInt386 * is_594_[3])) + 8192) shr 14)
                        var i_617_ = ((is_594_[7] * KeyboardInputSourceStatics.anInt4274 + (is_594_[1] * SpriteLoadValidatorStatics.anInt4795 - -(is_594_[4] * SpriteArchiveLoader.anInt386) + 8192)) shr 14)
                        i_616_ += i_613_
                        var i_618_ = ((8192 + KeyboardInputSourceStatics.anInt4274 * is_594_[8] + SpriteLoadValidatorStatics.anInt4795 * is_594_[2] + SpriteArchiveLoader.anInt386 * is_594_[5]) shr 14)
                        i_617_ += i_614_
                        i_618_ += i_615_
                    ...
                    val i_620_ = SpotAnimVector.anIntArray1204!![i_590_]
                    val i_621_ = SpotAnimVector.anIntArray1207!![i_590_]
                    val i_622_ = SpotAnimVector.anIntArray1204!![i_591_]
                    val i_623_ = SpotAnimVector.anIntArray1207!![i_591_]
                    val i_624_ = SpotAnimVector.anIntArray1204!![i_592_]
                    val i_625_ = SpotAnimVector.anIntArray1207!![i_592_]
                    ...
                    val i_628_ = ((-KeyboardInputSourceStatics.anInt4274 * is_619_[2] + is_619_[1] * -SpriteArchiveLoader.anInt386 + (is_619_[0] * -SpriteLoadValidatorStatics.anInt4795 + 8192)) shr 14)
                    val i_629_ = ((8192 + -KeyboardInputSourceStatics.anInt4274 * is_619_[5] + (-SpriteLoadValidatorStatics.anInt4795 * is_619_[3] - -(is_619_[4] * -SpriteArchiveLoader.anInt386))) shr 14)
                    val i_630_ = ((8192 + -KeyboardInputSourceStatics.anInt4274 * is_619_[8] + (-SpriteLoadValidatorStatics.anInt4795 * is_619_[6] + -SpriteArchiveLoader.anInt386 * is_619_[7])) shr 14)
                ...
                if (is_594_ == null) {
                    ...
                    if (OpenGlModel.aBoolean5609) {
                        var i_701_ = ((KeyboardInputSourceStatics.anInt4274 * is_594_[6] + (SpriteLoadValidatorStatics.anInt4795 * is_594_[0] + (is_594_[3] * SpriteArchiveLoader.anInt386 + 8192))) shr 14)
                        var i_702_ = (8192 + (SpriteLoadValidatorStatics.anInt4795 * is_594_[1] + (SpriteArchiveLoader.anInt386 * is_594_[4] - -(is_594_[7] * KeyboardInputSourceStatics.anInt4274))) shr 14)
                        i_701_ += i_698_
                        i_702_ += i_699_
                        var i_703_ = ((8192 + is_594_[2] * SpriteLoadValidatorStatics.anInt4795 - -(is_594_[5] * SpriteArchiveLoader.anInt386) - -(KeyboardInputSourceStatics.anInt4274 * is_594_[8])) shr 14)
                        i_703_ += i_700_
                        ...
                        if (anIntArrayArray5492!!.size > i_743_) {
                            ...
                            while (is_744_.size > i_745_) {
                                ...
                                if (aShortArray5432 == null || ((aShortArray5432!![i_746_].toInt() and i_593_) != 0)) {
                                    ...
                                    aShortArray5486!![i_746_] = (WhirlpoolHash.method2057((WhirlpoolHash.method2057(i_749_ shl 7, i_748_ shl 10)), i_750_)).toShort()
                                }
                                i_745_++
                            }
                    ...
                    if (bool_741_) {
                        if (aTextureMipDescriptorArray5524 != null) {
                            ...
                            while (anInt5406 > i_751_) {
                                ...
                                class334.anInt4156 = ((class334.anInt4156 and 0xffffff.inv()) or (0xffffff and (SoundEnvelope.anIntArray179!![0xffff and (aShortArray5486!![(class353.anInt4342)]).toInt()])))
                                i_751_++
                            }
                        }
                        method670(-90)
