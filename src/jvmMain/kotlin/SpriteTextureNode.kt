...
open class SpriteTextureNode : AbstractProceduralTextureNode(0, false) {
    ...
    override fun method3047(i: Int, i_1_: Int): Array<IntArray?>? {
        ...
        if (this.aImageFrameCache_7033!!.aBoolean4035 && method3090(true)) {
            ...
            if (PerlinNoiseTextureNode.Companion.anInt9139 == this.anInt9237) {
                var i_6_ = 0
                ...
                while ((PerlinNoiseTextureNode.Companion.anInt9139 > i_8_)) {
                    val i_9_: Int = (this.anInt9237 * i_8_ / PerlinNoiseTextureNode.Companion.anInt9139)
    ...
    companion object {
        ...
        var aOutgoingPacketHeader_9234: OutgoingPacketHeader? = OutgoingPacketHeader(67, -1)
        ...
        fun method3091(bool: Boolean) {
            aOutgoingPacketHeader_9234 = null
