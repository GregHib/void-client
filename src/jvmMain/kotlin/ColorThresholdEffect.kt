...
*/
class ColorThresholdEffect : AbstractProceduralTextureNode(1, false) {
    ...
    override fun method3047(i: Int, i_5_: Int): Array<IntArray?>? {
        ...
        anInt9093++
        val `is` = this.aImageFrameCache_7033!!.method2557(-127, i)!!
        if (this.aImageFrameCache_7033!!.aBoolean4035) {
            ...
            val is_12_ = `is`[2]!!
            var i_13_ = 0
            while (PerlinNoiseTextureNode.Companion.anInt9139 > i_13_) {
    ...
    companion object {
        ...
        var anInt9088: Int = 0
        var aOutgoingPacketHeader_9089: OutgoingPacketHeader? = OutgoingPacketHeader(2, 6)
        ...
        fun method3050(bool: Boolean) {
            aOutgoingPacketHeader_9089 = null
        ...
        fun method3052(i: Int, string: String?): Class<*> {
            if (i != 11012) aOutgoingPacketHeader_9089 = null
            anInt9088++
