...
*/
class Class6 internal constructor(var anInt144: Int, i_46_: Int, i_47_: Int, i_48_: Int, i_49_: Int, i_50_: Int, i_51_: Int, i_52_: Int, i_53_: Int, var aBoolean145: Boolean, var anInt154: Int) {
    var aShort143: Short
    var aShort146: Short
    var aByte148: Byte
    var aShort150: Short
    ...
    companion object {
        ...
        fun method203(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int) {
            ...
            Class135_Sub2Statics.method1156(-27, i_8_, Class17.anIntArrayArray255!![i_2_]!!, i_9_, i_1_)
            while (i_5_ > i_4_) {
                i_7_ += 2
                i_6_ += i_7_
                if (i_6_ > 0) {
                    ...
                    if (i_11_ >= Class132.anInt1910 && Class38.anInt513 >= i_10_) {
                        ...
                        if (i_11_ <= Class38.anInt513) Class135_Sub2Statics.method1156(-27, i_12_, (Class17.anIntArrayArray255!![i_11_]!!), i_13_, i_1_)
                        if (Class132.anInt1910 <= i_10_) Class135_Sub2Statics.method1156(-27, i_12_, (Class17.anIntArrayArray255!![i_10_]!!), i_13_, i_1_)
                    }
                }
                val i_14_ = -++i_4_ + i_2_
                val i_15_ = i_2_ - -i_4_
                if (Class132.anInt1910 <= i_15_ && Class38.anInt513 >= i_14_) {
                    ...
                    if (i_15_ <= Class38.anInt513) Class135_Sub2Statics.method1156(-27, i_16_, Class17.anIntArrayArray255!![i_15_]!!, i_17_, i_1_)
                    if (i_14_ >= Class132.anInt1910) Class135_Sub2Statics.method1156(-27, i_16_, Class17.anIntArrayArray255!![i_14_]!!, i_17_, i_1_)
                }
            }
        }
        ...
        fun method204(i: Int) {
            ...
            while (Class299Statics.aClass348_Sub49_Sub2_3813!!.method3415(-62, Class348_Sub40_Sub25.anInt9341) >= 15) {
                val i_18_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 15)
                ...
                val i_19_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 2)
                val i_20_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 1)
                var i_21_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 5)
                if (i_21_ > 15) i_21_ -= 32
                var i_22_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 5)
                if (i_22_ > 15) i_22_ -= 32
                val i_23_ = 0x3d01 and (4 + Class299Statics.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 3) shl 11)
                val i_24_ = Class299Statics.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 1)
                if (i_24_ == 1) Class13.anIntArray224!![Class101Statics.anInt1597++] = i_18_
                npc.method2448((Class189.aClass278_2529!!.method2079(Class299Statics.aClass348_Sub49_Sub2_3813!!.readBits((-24).toByte(), 14), -1)), i xor 0x2b297815)
        ...
        fun method207(var_ha: ha?, i: Byte) {
            do {
                try {
                    ...
                    Class262Statics.aClass324_3326!!.method2576("--> " + Class250.method1909(31.toByte(), Class363.aString4461!!), -1, (i_36_ - (-350 + Class369.aClass143_4962!!.anInt1993) - 1), 10 + i_35_, -16777216, -127)
