...
object IdentKitRecolorStatics {
    ...
    fun method203(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int) {
        ...
        var i_6_ = -i_3_
        var i_7_ = -1
        val i_8_ = WhirlpoolHash.method831(CameraNodeListStatics.anInt1745, i_3_ + i_0_, WorldMapLabel.anInt4960, -108)
        val i_9_ = WhirlpoolHash.method831(CameraNodeListStatics.anInt1745, -i_3_ + i_0_, WorldMapLabel.anInt4960, 81)
