    ...
    companion object {
        ...
        fun method3225(i: Int) {
            ...
            if (Class316.aClass348_Sub51_3959!!.aClass239_Sub14_7264!!.method1778(-32350) == 2) {
                ...
                val i_6_ = Class239_Sub15.anInt6006 % Class367Sub4Statics.anInt7319
                for (i_7_ in 0..3) {
                    var i_8_ = 0
                    ...
                    if (i >= 100) {
                        if (Class348_Sub40_Sub21.anInt9282 == 1 || Class9.anInt167 != -1) {
                            ...
                            if (Class348_Sub42_Sub19.Companion.anInt9701 < 2560) {
                                ...
                                if (i_16_ == 0 && i_17_ == 0 || -Class367Sub4Statics.anInt7319 >= i_16_ || (Class367Sub4Statics.anInt7319 <= i_16_) || i_17_ <= -Class348_Sub40_Sub3.anInt9109 || Class348_Sub40_Sub3.anInt9109 <= i_17_) method1242(("RC: " + i_12_ + "," + i_13_ + " " + i_14_ + "," + i_15_ + " " + za_Sub2Statics.regionTileX + "," + Class90.regionTileY), null, 15004)
                                else if (i_16_ <= i_17_) {
