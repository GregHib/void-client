...
object ChatMessageStreamStatics {
    @JvmField
            var anInt101: Int
            @JvmField
            var anInt102: Int = 0
            ...
            fun method136(i: Int, bool: Boolean, bool_2_: Boolean): SceneEntityModel {
                ...
                synchronized(SceneLinkedListNodeStatics.aDoublyLinkedNodeListArray3974s!!) {
                    ...
                    if (SceneLinkedListNodeStatics.aDoublyLinkedNodeListArray3974s!!.size > i && !SceneLinkedListNodeStatics.aDoublyLinkedNodeListArray3974s!![i]!!.method1871(111.toByte())) {
                        class318_sub4 = SceneLinkedListNodeStatics.aDoublyLinkedNodeListArray3974s!![i]!!.method1870(-104) as SceneEntityModel
            ...
            fun method137(i: Int, i_4_: Int, i_5_: Int): Boolean {
                ...
                return ((0x70000 and i_5_) != 0) or EdgeDetectTextureNodeStatics.method3073(i, i_5_, 50.toByte()) || CompassSmootherStatics.method2015(i_5_, i, 7)
            }
            ...
            fun method138(class348_sub42_sub12: ContactEntry, bool: Boolean): Int {
                ...
                if (!WidgetNodeLinkStatics.method1197(-12081, (class348_sub42_sub12.anInt9608))) {
                    if (class348_sub42_sub12.anInt9599 == -1) {
                        if (FixedFunctionWaterPassStatics.method3549(class348_sub42_sub12.anInt9608, (-44).toByte())) {
                        ...
                        } else if (RemoveRoofsOptionStateStatics.method1813(8806, (class348_sub42_sub12.anInt9608))) {
                            val `object`: Any? = null
                            var npcConfig: NpcConfig?
                            if ((class348_sub42_sub12.anInt9608) == 1001) npcConfig = (GradientLookupEffectStatics.aSeqDefinitionCache_9195!!.method2005(0, (class348_sub42_sub12.aLong9605).toInt()))
                            else npcConfig = (GradientLookupEffectStatics.aSeqDefinitionCache_9195!!.method2005(0, (0x7fffffffL and ((class348_sub42_sub12.aLong9605) ushr 32)).toInt()))
                ...
                var i = WorldMapLabelStatics.aFontDefinition_4962!!.method1186(string, TileRenderStateStatics.aAbstractModelRendererArray4234, bool)
                if (class348_sub42_sub12.aBoolean9597) i += SceneryDetailOptionStateStatics.aAbstractModelRenderer_6097!!.method971() + 4
                return i
            }
