...
class Npc : ProjectedGroundDecor() {
    ...
    companion object {
        ...
        fun method2441(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int) {
            ...
            if (i_5_ - i_0_ >= WorldMapLabel.anInt4960 && CameraNodeListStatics.anInt1745 >= i_0_ + i_5_ && -i_0_ + i_3_ >= LocalPlayerState.anInt1910 && i_3_ + i_0_ <= WidgetTextConfig.anInt513) CircleRasterizerObject.method2255(i_0_, i_5_, (-68).toByte(), i_1_, i_3_, i_4_, i)
