...
object MapSceneRenderer {
    ...
    fun method384(i: Int, i_0_: Int, i_1_: Int): Int {
        anInt623++
        val i_2_ = (WidgetComponentNodeStatics.method1115(i - 1, i_1_ - 1, 91.toByte()) - (-WidgetComponentNodeStatics.method1115(i - -1, i_1_ + -1, (-53).toByte()) + -WidgetComponentNodeStatics.method1115(-1 + i, 1 + i_1_, (-90).toByte())) + WidgetComponentNodeStatics.method1115(i - -1, i_1_ - -1, (-82).toByte()))
        val i_3_ = (WidgetComponentNodeStatics.method1115(i + -1, i_1_, (-118).toByte()) + (WidgetComponentNodeStatics.method1115(i - i_0_, i_1_, 118.toByte()) - (-WidgetComponentNodeStatics.method1115(i, -1 + i_1_, 109.toByte()) + -WidgetComponentNodeStatics.method1115(i, 1 + i_1_, 89.toByte()))))
        val i_4_ = WidgetComponentNodeStatics.method1115(i, i_1_, (-59).toByte())
        ...
        do {
            try {
                ...
                for (i in 0..<class237_sub1!!.anInt3130) {
                    method3570(false)
                    var i_6_ = 0
                    while ((GlCubemapLightPassStatics.anInt7319 shr 3 > i_6_)) {
                        for (i_7_ in 0..<(RangeThresholdTextureNodeStatics.anInt9109 shr 3)) {
                            ...
                            if (i_8_ != -1) {
                                ...
                                if (!class237_sub1.aBoolean3109 || i_9_ == 0) {
                                    ...
                                    for (i_14_ in (NullOggStreamStatics.anIntArray9042)!!.indices) {
                                        if ((i_13_ == (NullOggStreamStatics.anIntArray9042!![i_14_])) && `is`!![i_14_] != null) {
                ...
                while (class237_sub1.anInt3130 > i) {
                    method3570(false)
                    var i_15_ = 0
                    while ((i_15_ < GlCubemapLightPassStatics.anInt7319 shr 3)) {
                        var i_16_ = 0
                        while ((i_16_ < RangeThresholdTextureNodeStatics.anInt9109 shr 3)) {
                ...
                if (is_5_[0] != -1) {
                    KeyboardLayoutCacheStatics.aParticleSystemRenderer_3304 = CircleHitboxStatics.aMapSceneCache_413!!.method823(is_5_[2], is_5_[3], is_5_[1], -109, (HoverActionEntryStatics.aSpriteStore_1813!!), is_5_[0])
                    MapSceneDefLoaderStatics.anInt2481 = is_5_[4]
                }
                if (bool == false) break
                method387(26)
            } catch (runtimeexception: RuntimeException) {
                throw SoundBankPatchStatics.method2929(runtimeexception, ("ik.D(" + bool + ',' + (if (class237_sub1 != null) "{...}" else "null") + ',' + (if (`is` != null) "{...}" else "null") + ')'))
            }
            break
        } while (false)
    }
    ...
    fun method388(i: Int, i_18_: Int, i_19_: Int, class318_sub1_sub5: WallEntity, class318_sub1_sub5_20_: WallEntity?) {
        ...
        if (class357 != null) {
            ...
            val i_21_ = if (NativeSpriteStatics.aTerrainTileArray5191 == SoundCacheState.aTerrainTileArray4142) 1 else 0
            if (class318_sub1_sub5.method2376(-62)) {
                if (class318_sub1_sub5.method2377(122.toByte())) {
                    class318_sub1_sub5.aClass318_Sub1_6379 = BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_21_]
                    BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_21_] = class318_sub1_sub5
                } else {
            ...
            if (class318_sub1_sub5_20_ != null) {
                if (class318_sub1_sub5_20_.method2376(-110)) {
                    if (class318_sub1_sub5_20_.method2377(122.toByte())) {
                        class318_sub1_sub5_20_.aClass318_Sub1_6379 = BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_21_]
                        BackgroundWorkerThreadStatics.aClass318_Sub1Array3226!![i_21_] = class318_sub1_sub5_20_
                    } else {
