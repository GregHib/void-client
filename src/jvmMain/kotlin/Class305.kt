...
class Class305 internal constructor(private val anInt3858: Int, private val aClass72Array3862: Array<Class72?>?, i_23_: Int, private val anInt3866: Int, private val anInt3854: Int, private var anInt3853: Int) {
    ...
    fun method2293(i: Int, var_ha: ha, i_6_: Byte, i_7_: Int, i_8_: Int, i_9_: Int, i_10_: Int, i_11_: Int, i_12_: Int, i_13_: Int) {
        ...
        if (anInt3858 != -1 && anInt3863 != 0) {
            val class12 = Class101_Sub1Statics.aD5684!!.method3(anInt3858, -6662)
            if (aClass105_3867 == null && Class101_Sub1Statics.aD5684!!.method4(-7953, anInt3858)) {
                val `is` = (if (class12!!.anInt200 == 2) Class101_Sub1Statics.aD5684!!.method6(-21540, anInt3863, 0.7f, anInt3858, false, anInt3863) else Class101_Sub1Statics.aD5684!!.method5(false, anInt3858, 0.7f, anInt3863, anInt3863, -119))
