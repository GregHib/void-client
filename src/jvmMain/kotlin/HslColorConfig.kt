            ...
            if (ProportionalScrollbarComponent.aNodeDeque_9931!!.method1998(i) != 0) {
                if (IntHashSetStatics.aClass348_Sub51_3959!!.aClass239_Sub25_7271!!.method1829(-32350) == 0) {
                    ...
                    if (IntPairStatics.aRenderer6968 == null) {
                        ...
                        IntPairStatics.aRenderer6968 = SoftwareSpriteRaster.method958(true, 0, SourceRowTextureNode.aRenderConfig9113, 0, canvas, SpriteLoadValidator.aJs5Archive_4796)
                        EdgeDetectTextureNode.aRSFont_9173 = (IntPairStatics.aRenderer6968!!.method3686(method1819(ConnectionStateType.anInt1044, 0, -44, SoftwareSpriteRaster.aJs5Archive_1627!!), SpriteImage.method1519(CameraRotationStubStatics.aJs5Archive_322!!, ConnectionStateType.anInt1044, 0), true))
                    }
