    ...
    companion object {
        ...
        fun method3490(bool: Boolean): Boolean {
            ...
            if (ProportionalScrollbarComponent.aSpriteImageArray9929 == null) {
                if (CameraRotationStubStatics.aJs5Archive_322!!.method421(false, ConnectionStateRefs.anInt317)) ProportionalScrollbarComponent.aSpriteImageArray9929 = SpriteImage.method1523(CameraRotationStubStatics.aJs5Archive_322!!, ConnectionStateRefs.anInt317)
                else bool_0_ = false
            }
            return bool_0_
        }
