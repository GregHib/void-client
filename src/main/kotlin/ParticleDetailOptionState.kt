    ...
    companion object {
        ...
        fun method1797(i: Int, i_11_: Int, class46: Class46, i_12_: Byte) {
            if (RenderNode.aBoolean9722) {
                ...
                if (Client.method105(class46)!!.method3303(1) && (WidgetTextConfig.anInt500 and 0x20) != 0 && (class254 == null || (class46.method428(class254.anInt3256, ParticleEmitterFactory.anInt3176, -128) != class254.anInt3256))) {
