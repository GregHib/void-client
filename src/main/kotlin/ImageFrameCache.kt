...
class ImageFrameCache internal constructor(i: Int, i_9_: Int, i_10_: Int) {
    ...
    fun method2553(i: Int): Array<Array<IntArray?>?>? {
        ...
        for (i_2_ in i..<anInt4020) aClass348_Sub24Array4033!![i_2_] = TileRenderState.aClass348_Sub24_4226
    ...
    fun method2557(i: Int, i_6_: Int): Array<IntArray?>? {
        ...
        aClass348_Sub24Array4033!![i_6_] = TileRenderState.aClass348_Sub24_4226
