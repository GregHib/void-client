        ...
        try {
            ...
            if (class64 == null || var_renderer!!.method3667(class64.ua(), i_15_) != 0) {
                ...
                for (i_31_ in `is`.indices) {
                    if (`is`[i_31_] != -1) modelDefinitions[i_31_] = Exception_Sub1.aModelHeaderCache_112!!.method1940(Class348_Sub21.Companion.method2955(i_14_, -112), `is`[i_31_]).method1558(bool, false)
                }
