...
class ArbFogMaterialPass internal constructor(var_ha_Sub2: OpenGlRenderer) : MaterialPass(var_ha_Sub2) {
    ...
    private var aRefCountedHandle_6199: RefCountedHandle? = null
    ...
    init {
        if (this.aHa_Sub2_3684.aBoolean7841) {
            aRefCountedHandle_6188 = (method459(
                34336,
                this.aHa_Sub2_3684,
