...
class Class318_Sub1_Sub4_Sub1 internal constructor(var_renderer: Renderer?, class51: Class51?, i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, bool: Boolean, i_4_: Int, i_5_: Int, bool_6_: Boolean) : Class318_Sub1_Sub4(i_1_, i_2_, i_3_, i, i_0_, Class286_Sub9.method2175(i_5_, (-34).toByte(), i_4_)), Interface10 {
    ...
    init {
        do {
            try {
                ...
                aBoolean10064 = (var_renderer!!.method3682() && class51.aBoolean894 && !aBoolean10066 && Class316.aClass348_Sub51_3959!!.aClass239_Sub7_7238!!.method1748(-32350) != 0)
                var i_7_ = 2048
    ...
    public override fun method2391(var_renderer: Renderer?, i: Int, i_9_: Int, i_10_: Int): Boolean {
        anInt10070++
        val class64 = method2482(var_renderer!!, 126.toByte(), 131072)
    ...
    private fun method2481(bool: Boolean, i: Int, i_15_: Int, var_renderer: Renderer?): Class2? {
        ...
        return class51.method476(var_renderer, var_s, aByte10079.toInt(), i, this.x, bool, var_s_16_, this.anInt6382, this.y, aByte10062.toInt(), i_15_ + 132)
    }
