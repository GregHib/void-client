            ...
            do {
                try {
                    ...
                    if (Class348.anInt4290 < 100) {
                        ...
                        Class262.aClass324_3326!!.method2575((-116).toByte(), i_16_, Class50_Sub3.aColorArray5242!![UnderlayDefinition.anInt2884]!!.getRGB(), Class274.aClass274_3501!!.method2063(Class348_Sub33.anInt6967, i + 551), -1, i_15_ + i_17_)
                    } else {
                        ...
                        GameAppletFrame.aClass324_20!!.method2569("Fps:" + (Class239_Sub5.anInt5891), i_23_, 16776960, i_22_, i + -116, -1)
                        i_23_ -= 15
                        val runtime = Runtime.getRuntime()
                        val i_24_ = ((runtime.totalMemory() + -runtime.freeMemory()) / 1024L).toInt()
                        var i_25_ = 16776960
                        if (i_24_ > 65536) i_25_ = 16711680
                        GameAppletFrame.aClass324_20!!.method2569("Mem:" + i_24_ + "k", i_23_, i_25_, i_22_, -127, -1)
                        i_23_ -= 15
                    }
                } catch (runtimeexception: RuntimeException) {
