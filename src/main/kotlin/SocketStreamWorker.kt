        ...
        fun method1469(i: Int) {
            ...
            while (BackgroundWorkerThread.anInt3225 > i_1_) {
                ...
                for (i_3_ in 0..<ItemModelDefinition.anInt425) {
                    val i_4_ = i_2_ - -i_3_
                    Class92.anInterface4Array1525!![i_4_]!!.method15(i_3_ * DirectionPath.anInt1067, i_1_ * ByteStore.anInt4267, DirectionPath.anInt1067, ByteStore.anInt4267, 0, 0, true, true)
                }
                i_1_++
            }
        }
