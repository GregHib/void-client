            ...
            if (bool || i_16_ != Renderer.anInt4581 || FileIoUtil.anInt4095 != i || (CompiledScriptCache.anInt4372 != ParticleSystemState.anInt2204 && IntHashSet.aClass348_Sub51_3959!!.aClass239_Sub27_7261!!.method1840(-32350) != 1)) {
                        ...
                        if (class348_sub22 != null) {
                            ...
                            if ((npc.x) < 0 || i_25_ < (npc.x) || (npc.y) < 0 || i_26_ < (npc.y)) {
                                ...
                                for (i_29_ in 0..9) {
                                    ...
                                    if ((npc.anIntArray10320!![i_29_]) < 0 || ((npc.anIntArray10320!![i_29_]) >= Class367_Sub4.anInt7319) || (npc.anIntArray10317!![i_29_]) < 0 || (RangeThresholdTextureNode.anInt9109 <= (npc.anIntArray10317!![i_29_]))) bool_28_ = false
                                }
                                if (!bool_28_) {
                                    npc.method2448(null, -2)
                                    bool_24_ = true
                ...
                if (i_15_ > 122) {
                    ...
                    while (class348_sub27 != null) {
                        ...
                        if (WidgetRedrawTracker.anInt3931 != 4 && (class348_sub27.anInt6905 < 0 || class348_sub27.anInt6896 < 0 || (class348_sub27.anInt6905 >= Class367_Sub4.anInt7319) || (RangeThresholdTextureNode.anInt9109 <= (class348_sub27.anInt6896)))) class348_sub27.method2715(101.toByte())
                    ...
                    if (i_17_ != 11) {
                        ...
                        if ((Class367_Sub4.anInt7319 < abs(i_20_)) || abs(i_21_) > RangeThresholdTextureNode.anInt9109) method773(true)
