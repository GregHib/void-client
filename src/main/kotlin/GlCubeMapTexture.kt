...
class GlCubeMapTexture internal constructor(glRenderDevice: GlRenderDevice?, i: Int, bool: Boolean, `is`: Array<IntArray?>?) : GlTextureBase(glRenderDevice, 34067, GroundItemRenderState.aTextureFormatInfo_1662, Class68.aClass68_1183, 6 * (i * i), bool), Interface18_Impl2 {
    init {
        try {
