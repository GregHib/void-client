                                ...
                                if (i_31_ < i_34_ && i_32_ < i_33_) {
                                    ...
                                    if (SizeBoundedSoftCache.aBooleanArray2326!![i_23_] || NativeRenderer.anInt8045 > 1) {
                                        if (class46.anInt774 == 3) {
                                            ...
                                            if (class46.anInt705 >= 0) class46.method444(bool_15_, HoverActionEntry.aSpriteStore_1813, Class30.aClass84_413)!!.method2293(0, Class348_Sub8.aRenderer6654!!, (-35).toByte(), i_24_, class46.anInt709, i_25_, (class46.anInt835 shl 3), (class46.anInt759 shl 3), 0, class46.anInt789)
                                            else {
                                                ...
                                                if (class46.anInt812 != -1) {
                                                    ...
                                                    abstractModelRenderer = (Exception_Sub1.aModelHeaderCache_112!!.method1941((class46.anInt672), (-74).toByte(), (class46.anInt812), (class46.anInt781), (0xffffff.inv() or (class46.anInt809)), (class46.anInt678), Class348_Sub8.aRenderer6654, class154))
                                            ...
                                            if (class46.anInt812 != -1) {
                                                ...
                                                if (i_61_ >= 0 && (i_61_ < 2048)) {
                                                    ...
                                                    if ((player != null) && ((i_61_ == (Class348_Sub42_Sub11.anInt9591)) || ((class46.anInt779) == (Class318_Sub1_Sub3_Sub1.method2418((player.aString10544!!), (-50).toByte()))))) class64 =
                                                        (player.aCompositeNpcModelBuilder_10536!!.method1226((Class318_Sub1_Sub3_Sub3.aVarpStore_10209), null, null, true, (Exception_Sub1.aModelHeaderCache_112), 0, class17, class46.anInt730, true, -1, null, 2048, (Class348_Sub40_Sub25.Companion.aModelDefinitionLoader_9342), class46.anInt841, (Class348_Sub8.aRenderer6654), (MapAreaDefinition.aClass278_2529), (ParticleEmitterNode.aClass87_191), 0, class46.anInt795, 0, (Class64_Sub3.aNpcDefinitionCache_5558)))
                                                }
