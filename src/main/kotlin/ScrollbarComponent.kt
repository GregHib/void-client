...
open class ScrollbarComponent(js5Archive: Js5Archive, js5Archive_0_: Js5Archive, class369_sub3: WorldMapIconLabel) : WorldMapElement(js5Archive, js5Archive_0_, class369_sub3) {
    ...
    public override fun method178(i: Int, bool: Boolean, i_27_: Byte, i_28_: Int) {
        if (bool) {
            ...
            FacingDirectionNode.aRenderer6654!!.KA(i, i_28_, i - -this.aWorldMapLabel_4635!!.anInt4971, (i_28_ + this.aWorldMapLabel_4635!!.anInt4963))
            ...
            FacingDirectionNode.aRenderer6654!!.KA(i, i_28_, (this.aWorldMapLabel_4635!!.anInt4971 + i), i_28_ - -aAbstractModelRenderer_8343!!.method980())
            ...
            FacingDirectionNode.aRenderer6654!!.KA(i, (-i_33_ + i_28_ - -this.aWorldMapLabel_4635!!.anInt4963), this.aWorldMapLabel_4635!!.anInt4971 + i, (i_28_ + this.aWorldMapLabel_4635!!.anInt4963))
    ...
    companion object {
        ...
        fun method184(i: Int): IntArray {
            ...
            return (intArrayOf(ConnectionStateType.anInt1044, WidgetDefinition.anInt235, CutsceneSequenceData.anInt3736))
        }
