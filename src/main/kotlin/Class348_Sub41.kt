    ...
    companion object {
        ...
        fun method3157(i: Int, i_15_: Byte, i_16_: Int, i_17_: Int, bool: Boolean) {
            ...
            if (bool || i_16_ != Renderer.anInt4581 || FileIoUtil.anInt4095 != i || (Class355.anInt4372 != ParticleSystemState.anInt2204 && IntHashSet.aClass348_Sub51_3959!!.aClass239_Sub27_7261!!.method1840(-32350) != 1)) {
                ...
                Class362.method3511(true, GameAppletFrame.aFont_20, ParticleEmitterFactory.aFontDefinition_3179, LocalizedText.aLocalizedText_3495!!.method2063(Class348_Sub33.Companion.anInt6967, 544), 2, Class348_Sub8.aRenderer6654)
                ...
                if (i_15_ > 122) {
                    ...
                    Class348_Sub40_Sub17.aNodeDeque_9240!!.method1996(103)
        ...
        fun method3158(`is`: ByteArray?, i: Int): ByteArray {
            ...
            if (i_37_ != 0) {
                ...
                if (i_37_ == 1) method1547(is_40_, i_39_, `is`, i_38_, 9)
                    ...
                    synchronized(Class348_Sub33.Companion.aGzipDecompressor_6955!!) {
                        Class348_Sub33.Companion.aGzipDecompressor_6955!!.method1218(is_40_, 29123, class348_sub49)
                    }
                }
                return is_40_
            }
