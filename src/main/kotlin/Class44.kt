...
object Class44 {
    ...
    fun method385(bool: Boolean, class237_sub1: WorldMapSceneSoftware?, `is`: Array<ByteArray?>?) {
        do {
            try {
                ...
                if (is_5_[0] != -1) {
                    KeyboardLayoutCache.aParticleSystemRenderer_3304 = CircleHitbox.aClass84_413!!.method823(is_5_[2], is_5_[3], is_5_[1], -109, (HoverActionEntry.aSpriteStore_1813!!), is_5_[0])
    ...
    fun method388(i: Int, i_18_: Int, i_19_: Int, class318_sub1_sub5: Class318_Sub1_Sub5, class318_sub1_sub5_20_: Class318_Sub1_Sub5?) {
        ...
        if (class357 != null) {
            ...
            val i_21_ = if (NativeSprite.aTerrainTileArray5191 == Class332.aTerrainTileArray4142) 1 else 0
