...
abstract class Class105 : Interface3 {
    ...
    abstract fun method963(i: Int, i_23_: Int, var_sprite: Sprite?, i_24_: Int, i_25_: Int)
    ...
    fun method967(f: Float, f_36_: Float, f_37_: Float, f_38_: Float, i: Int, i_39_: Int, var_sprite: Sprite?, i_40_: Int, i_41_: Int) {
        if (i != 0) {
            ...
            method975(f_44_, f_45_, f_46_, f_47_, f_48_, f_49_, var_sprite, i_40_, i_41_)
        }
    }
    ...
    private fun method975(f: Float, f_65_: Float, f_66_: Float, f_67_: Float, f_68_: Float, f_69_: Float, var_sprite: Sprite?, i: Int, i_70_: Int) {
        method983(f, f_65_, f_66_, f_67_, f_68_, f_69_, 1, var_sprite, i, i_70_)
    }

    fun method976(f: Float, f_71_: Float, i: Int, i_72_: Int, var_sprite: Sprite?, i_73_: Int, i_74_: Int) {
        method967(f, f_71_, method966().toFloat() / 2.0f, method980().toFloat() / 2.0f, i, i_72_, var_sprite, i_73_, i_74_)
    }
    ...
    abstract fun method983(f: Float, f_101_: Float, f_102_: Float, f_103_: Float, f_104_: Float, f_105_: Float, i: Int, var_sprite: Sprite?, i_106_: Int, i_107_: Int)
