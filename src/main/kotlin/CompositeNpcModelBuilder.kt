...
class CompositeNpcModelBuilder {
    ...
    fun method1226(interface17: Interface17?, widgetDefinition: WidgetDefinition?, loadProgressCounters: Array<LoadProgressCounters?>?, bool: Boolean, modelHeaderCache: ModelHeaderCache?, i: Int, widgetDefinition_0_: WidgetDefinition?, i_1_: Int, bool_2_: Boolean, i_3_: Int, `is`: IntArray?, i_4_: Int, modelDefinitionLoader: ModelDefinitionLoader?, i_5_: Int, var_renderer: Renderer?, bufferedMessageQueue: BufferedMessageQueue?, widgetCache: WidgetCache?, i_6_: Int, i_7_: Int, i_8_: Int, npcDefinitionCache: NpcDefinitionCache?): AbstractModel? {
        try {
            anInt2097++
            if (this.anInt2093 != -1) return (bufferedMessageQueue!!.method2079(this.anInt2093, -1).method800(i, loadProgressCounters, widgetCache, !bool_2_, widgetDefinition, i_8_, npcDefinitionCache, i_7_, widgetDefinition_0_, interface17, var_renderer, i_3_, `is`, i_1_, i_6_, i_4_, i_5_))
            var i_9_ = i_4_
            var l = aLong2102
            ...
            if (bool_15_) {
                if (widgetDefinition_0_ != null) {
                    ...
                    class348_sub42_sub17 = widgetCache!!.method839(i_32_, 3)
                    ...
                    if ((widgetDefinition_0_.aBoolean241 || ItemNameResolver.aBoolean5002) && i_1_ != -1 && i_1_ < widgetDefinition_0_.anIntArray237.size) {
                        ...
                        class348_sub42_sub17_26_ = (if (i_32_ == i_33_) class348_sub42_sub17 else widgetCache.method839(i_33_, 3))
                ...
                if (widgetDefinition != null) {
                    ...
                    class348_sub42_sub17_30_ = widgetCache!!.method839(i_34_, 3)
                    ...
                    if ((widgetDefinition.aBoolean241 || ItemNameResolver.aBoolean5002) && i_3_ != -1 && i_3_ < widgetDefinition.anIntArray237.size) {
                        ...
                        class348_sub42_sub17_31_ = (if (i_35_ == i_34_) class348_sub42_sub17_30_ else widgetCache.method839(i_35_, 3))
    ...
    fun method1230(modelHeaderCache: ModelHeaderCache?, i: Int, widgetCache: WidgetCache?, modelDefinitionLoader: ModelDefinitionLoader?, interface17: Interface17?, bufferedMessageQueue: BufferedMessageQueue?, i_66_: Int, i_67_: Int, i_68_: Int, widgetDefinition: WidgetDefinition?, i_69_: Int, var_renderer: Renderer?): AbstractModel? {
        try {
            anInt2107++
            if (this.anInt2093 != -1) return (bufferedMessageQueue!!.method2079(this.anInt2093, -1).method803(interface17, var_renderer, i_69_, i_67_, widgetDefinition, widgetCache, i_66_, 121, i_68_))
            var i_70_ = i_68_
            if (widgetDefinition != null) {
                var bool = false
                var bool_71_ = false
                ...
                val class348_sub42_sub17 = widgetCache!!.method839(i_77_, 3)
                if (class348_sub42_sub17 != null) {
            ...
            throw SoundBankPatch.method2929(
                runtimeexception,
                ("oo.J(" + (if (modelHeaderCache != null) "{...}" else "null") + ',' + i + ',' + (if (widgetCache != null) "{...}" else "null") + ',' + (if (modelDefinitionLoader != null) "{...}" else "null") + ',' + (if (interface17 != null) "{...}" else "null") + ',' + (if (bufferedMessageQueue != null) "{...}" else "null") + ',' + i_66_ + ',' + i_67_ + ',' + i_68_ + ',' + (if (widgetDefinition != null) "{...}" else "null") + ',' + i_69_ + ',' + (if (var_renderer != null) "{...}" else "null") + ')')
            )
        }
    }
    ...
    fun method1232(i: Int, i_91_: Int, i_92_: Int, i_93_: Int, widgetCache: WidgetCache?, modelDefinitionLoader: ModelDefinitionLoader?, i_94_: Int, i_95_: Int, i_96_: Int, var_renderer: Renderer?, i_97_: Int, widgetDefinition: WidgetDefinition?): AbstractModel? {
        try {
            anInt2106++
            var i_98_ = i_91_
            if (widgetDefinition != null) {
                ...
                val class348_sub42_sub17 = widgetCache!!.method839(i_105_, 3)
                ...
                if ((widgetDefinition.aBoolean241 || ItemNameResolver.aBoolean5002) && i != -1 && i < widgetDefinition.anIntArray237.size) {
                    ...
                    if (i_105_ != i_106_) class348_sub42_sub17_107_ = widgetCache.method839(i_103_ ushr 16, 3)
