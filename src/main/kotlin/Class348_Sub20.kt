...
class Class348_Sub20 internal constructor(private val aS_Sub2_6839: OpenGlTerrainTile, var anInt6841: Int, i_38_: Int, var anInt6825: Int, var anInt6833: Int, var anInt6826: Int) : Class348() {
    ...
    companion object {
        ...
        fun method2947(bool: Boolean, i: Int, i_4_: Int, i_5_: Int, i_6_: Int, i_7_: Int) {
            ...
            if (Class316.aClass348_Sub51_3959!!.aClass239_Sub26_7272!!.method1838(-32350) != 0 && i_5_ != 0 && Class147.anInt2021 < 50 && i_4_ != -1) Class258_Sub2.aParticleEmitterNodeArray8531s!![Class147.anInt2021++] = ParticleEmitterNode(1.toByte(), i_4_, i_5_, i_6_, i, 0, i_7_, null)
        }
