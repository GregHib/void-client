...
public open class Class369(screenAnchorAlignment: ScreenAnchorAlignment?, class341: Class341?, i: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int) : Interface12 {
    ...
    companion object {
        ...
        fun method3568(var_renderer: Renderer?, i: Int) {
            anInt4964++
            WorldMapRenderer.aClass324_4684 = GlTextureBase.method232(var_renderer, (-53).toByte(), true, Class56.anInt1044)
            ...
            NodeDeque.aClass324_3326 = GlTextureBase.method232(var_renderer, (-53).toByte(), true, CutsceneSequenceData.anInt3736)
