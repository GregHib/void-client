...
*/
class MenuActionNode internal constructor(var anInt6773: Int, var aClass55_Sub1_6768: Class55_Sub1?, var anInt6782: Int, var aBoolean6776: Boolean) : LinkedListNode() {
    ...
    companion object {
        ...
        fun method2811(bool: Boolean) {
            ...
            if (WidgetActionEntry.Companion.anInt6992 > Class75.anInt1259) {
                WidgetActionEntry.Companion.anInt6992 = Class75.anInt1259
                Class48.anInt859 = -1
                TextureMetadataProvider.anInt4609 = -1
            }
