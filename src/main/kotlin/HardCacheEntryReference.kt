...
class HardCacheEntryReference internal constructor(private val anObject10429: Any?, i: Int) : CacheEntryReference(i) {
    ...
    companion object {
        ...
        fun method3201(bool: Boolean): Boolean {
            ...
            if (Class365.aIntRange_4477 == ModelVertexColorBuffer.aIntRange_6584) {
                val i = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readIntInverseMiddle(255)
            ...
            if (Class95.aIntRange_1540 == ModelVertexColorBuffer.aIntRange_6584) {
                Class57.aBoxedIntHolder_1055 = Class38.method360((-57).toByte(), CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255))
                ModelVertexColorBuffer.aIntRange_6584 = null
                return true
            }
            ...
            if (ModelVertexColorBuffer.aIntRange_6584 == SpotAnimVector.aIntRange_2305) {
                val i = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readIntMiddleEndian(82.toByte())
