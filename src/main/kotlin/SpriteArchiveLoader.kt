...
class SpriteArchiveLoader internal constructor(class45: Class45?, class45_9_: Class45?) {
    ...
    private fun method307(i: Int, `is`: IntArray?, i_0_: Int, i_1_: Int): PcmSampleData? {
        ...
        val l = i_2_.toLong()
        var class348_sub19_sub1 = aClass356_381.method3480(l, -6008) as PcmSampleData?
    ...
    private fun method310(i: Int, i_5_: Int, i_6_: Byte, `is`: IntArray?): PcmSampleData? {
        ...
        if (class348_sub19_sub1 != null) return class348_sub19_sub1
        if (`is` != null && `is`[0] <= 0) return null
        var class348_sub10 = aClass356_374.method3480(l, -6008) as VorbisAudioDecoder?
        if (class348_sub10 == null) {
            class348_sub10 = VorbisAudioDecoder.method2795(aClass45_377!!, i_5_, i)
    ...
    init {
        try {
            ...
            throw SoundBankPatch.method2929(runtimeexception, ("hs.<init>(" + (if (class45 != null) "{...}" else "null") + ',' + (if (class45_9_ != null) "{...}" else "null") + ')'))
        }
    }
