        ...
        fun method132(i: Int, bool: Boolean, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int) {
            ...
            if (Class147.aClass357ArrayArrayArray2029 == null) Class348_Sub8.aRenderer6654!!.method3675(i_0_, (-125).toByte(), i_1_, i_3_, i_2_, -16777216)
                ...
                if (Class348_Sub40_Sub21.anInt9282 == 1) {
                    ...
                    Class17.method268(i_4_, -200 + (Class275.method2064((Class132.aPlayer_1907!!.x), Class355.anInt4372, 11219, (Class132.aPlayer_1907!!.y))), i_5_, Class192.anInt2578, i_2_, -19360, FrameStatsReset.anInt5799, (i_4_ shr 3) * 3 + 600 shl 2)
