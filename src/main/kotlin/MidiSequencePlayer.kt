...
class MidiSequencePlayer : AudioStreamNode {
    ...
    private val aClass348_Sub43ArrayArray8915: Array<Array<SpriteDefinition?>?>
    private var anIntArray8916: IntArray?
    private val anInt8921: Int
    private val anIntArray8925: IntArray
    private val aClass348_Sub43ArrayArray8928: Array<Array<SpriteDefinition?>?>
    ...
    private var aClass348_Sub16_Sub1_8958: SynthVoiceGroup?
    ...
    private fun method2845(i: Int, class348_sub43: SpriteDefinition?): Int {
        try {
            if (i != 0) anInt8956 = 53
            anInt8934++
    ...
    fun method2847(i: Int, class348_sub43: SpriteDefinition?): Boolean {
        try {
            anInt8948++
    ...
    private fun method2848(class348_sub43: SpriteDefinition?, i: Byte): Int {
        try {
    ...
    private fun method2849(i: Int, i_39_: Int, i_40_: Byte, i_41_: Int) {
        ...
        if (class348_sub43 != null) {
            ...
            if ((this.anIntArray8895[i_41_] and 0x2) != 0) {
                var class348_sub43_43_ = (aClass348_Sub16_Sub1_8958!!.aNodeDeque_8848.method1995(4) as SpriteDefinition?)
                while (class348_sub43_43_ != null) {
                    ...
                    class348_sub43_43_ = (aClass348_Sub16_Sub1_8958!!.aNodeDeque_8848.method1990(36.toByte()) as SpriteDefinition?)
                }
    ...
    private fun method2850(i: Int, i_44_: Int) {
        if ((0x4 and this.anIntArray8895[i]) != 0) {
            var class348_sub43 = (aClass348_Sub16_Sub1_8958!!.aNodeDeque_8848.method1995(4) as SpriteDefinition?)
            while (class348_sub43 != null) {
                if (i == class348_sub43.anInt7067) class348_sub43.anInt7082 = 0
                class348_sub43 = (aClass348_Sub16_Sub1_8958!!.aNodeDeque_8848.method1990(65.toByte()) as SpriteDefinition?)
            }
        }
    ...
    private fun method2853(i: Int, i_49_: Int, i_50_: Int, i_51_: Int) {
        ...
        if ((0x2 and this.anIntArray8895[i_51_]) != 0) {
            var class348_sub43 = (aClass348_Sub16_Sub1_8958!!.aNodeDeque_8848.method1993(i xor 0x51.inv()) as? SpriteDefinition?)
            while (class348_sub43 != null) {
        ...
        if (class348_sub17 != null) {
            ...
            if (class348_sub19_sub1 != null) {
                val class348_sub43 = SpriteDefinition()
    ...
    private fun method2855(i: Int, i_56_: Byte) {
        ...
        if (i_56_ < -42) {
            ...
            while (class348_sub43 != null) {
                ...
                class348_sub43 = (aClass348_Sub16_Sub1_8958!!.aNodeDeque_8848.method1990(60.toByte()) as SpriteDefinition?)
            }
        }
    }
    ...
    private fun method2858(i: Int, i_62_: Int) {
        ...
        if ((this.anIntArray8895[i_62_] and 0x2) != 0) {
            ...
            while (class348_sub43 != null) {
                ...
                class348_sub43 = (aClass348_Sub16_Sub1_8958!!.aNodeDeque_8848.method1990(41.toByte()) as SpriteDefinition?)
            }
        }
    }
    ...
    private fun method2868(class348_sub43: SpriteDefinition?, i: Int): Int {
        try {
    ...
    private fun method2872(i: Int, i_90_: Int) {
        anInt8918++
        var class348_sub43 = (aClass348_Sub16_Sub1_8958!!.aNodeDeque_8848.method1995(i + -2005674596) as SpriteDefinition?)
        while (class348_sub43 != null) {
            ...
            class348_sub43 = (aClass348_Sub16_Sub1_8958!!.aNodeDeque_8848.method1990(68.toByte()) as SpriteDefinition?)
        }
    ...
    fun method2874(i: Int, bool: Boolean, class348_sub43: SpriteDefinition?) {
        try {
            anInt8909++
    ...
    constructor() {
        ...
        aClass348_Sub43ArrayArray8915 = Array<Array<SpriteDefinition?>?>(16) { arrayOfNulls<SpriteDefinition>(128) }
        ...
        aClass348_Sub43ArrayArray8928 = Array<Array<SpriteDefinition?>?>(16) { arrayOfNulls<SpriteDefinition>(128) }
    ...
    internal constructor(class348_sub16_sub3_107_: MidiSequencePlayer?) {
        anIntArray8896 = IntArray(16)
        aClass348_Sub43ArrayArray8915 = Array<Array<SpriteDefinition?>?>(16) { arrayOfNulls<SpriteDefinition>(128) }
        anIntArray8904 = IntArray(16)
        this.anIntArray8914 = IntArray(16)
    ...
    companion object {
        ...
        fun method2839(i: Int, i_0_: Int, i_1_: Int) {
            ...
            ColourAdjustment.anInt859 = i_1_ + -Class75.anInt1263
