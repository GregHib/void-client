    ...
    companion object {
        ...
        fun method3241(i: Int, i_7_: Byte, var_renderer: Renderer) {
            ...
            if (!Class348_Sub40_Sub23.aBoolean9307 || !SkeletalAnimFrameData.aBoolean351) Class348_Sub42_Sub10.Companion.anInt9577 = 0
                ...
                if ((WorldMapToggle.anInt3872 != (Class348_Sub40_Sub34.anIntArray9436!![0].toFloat() / 3.0f).toInt()) || Class86.anInt1480 != (Class348_Sub40_Sub34.anIntArray9436!![1].toFloat() / 3.0f).toInt()) {
                    Class86.anInt1480 = (Class348_Sub40_Sub34.anIntArray9436!![1].toFloat() / 3.0f).toInt()
                    WorldMapToggle.anInt3872 = (Class348_Sub40_Sub34.anIntArray9436!![0].toFloat() / 3.0f).toInt()
                ...
                for (i_10_ in 0..<Class348_Sub44.anInt7101) Class318_Sub2.method2498(LoadingBarRenderer.aClass338Array5060!![i_10_], var_renderer, (-128).toByte(), i)
