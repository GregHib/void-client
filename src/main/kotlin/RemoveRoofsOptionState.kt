    ...
    companion object {
        ...
        fun method1810(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int) {
            if (i_5_ != 8 && i_5_ != 16) {
                ...
                LoadingBarRenderer.aClass338Array5060!![Class348_Sub44.anInt7101++] = Class338(i_5_, i_4_, i_12_, i_13_, i_13_, i_12_, i_16_, i_17_, -i_1_ + i_17_, -i_1_ + i_16_, i_14_, i_15_, i_15_, i_14_)
            } else {
                ...
                LoadingBarRenderer.aClass338Array5060!![Class348_Sub44.anInt7101++] = Class338(i_5_, i_4_, i_6_, i_7_, i_7_, i_6_, i_10_, i_11_, -i_1_ + i_11_, i_10_ - i_1_, i_8_, i_9_, i_9_, i_8_)
            }
