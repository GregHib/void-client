...
class Player : ProjectedGroundDecor() {
    ...
    fun method2452(i: Byte, class348_sub49: Buffer) {
        ...
        if (Class8.aNamedIdRecord_165 == Class55_Sub1.aNamedIdRecord_5271 && AsyncTaskHandle.anInt2581 >= 2) this.aBoolean10551 = false
        this.anInt10542 = 0
        var i_14_ = -1
        val `is` = IntArray(12)
        for (i_15_ in 0..11) {
    ...
    private fun method2459(i: Int, var_renderer: Renderer?, i_69_: Int): Boolean {
        ...
        if (Class55_Sub1.aNamedIdRecord_5271 != Class8.aNamedIdRecord_165 && i_75_ < 50) {
            val i_77_: Int
            i_77_ = -i_75_ + 50
        ...
        } else if (Class8.aNamedIdRecord_165 != Class55_Sub1.aNamedIdRecord_5271) {
