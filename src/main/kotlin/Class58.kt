...
class Class58 {
    ...
    private fun method533(spriteMaskShape: SpriteMaskShape, i: Int) {
        aLong1057 = aLong1057 or (spriteMaskShape.anInt4070 shl anInt1058++ * SpriteMaskShape.anInt4081).toLong()
        anInt1063++
        val i_5_ = 0 % ((28 - i) / 59)
    }
    ...
    private fun method534(i: Byte, i_6_: Int): Int {
        ...
        return (aLong1057 shr SpriteMaskShape.anInt4081 * i_6_).toInt() and 0xf
    }
    ...
    fun method537(i: Int, i_27_: Int): SpriteMaskShape? {
        ...
        return SpriteMaskShape.method2598(method534(0.toByte(), i), -109)
    }
    ...
    companion object {
        ...
        fun method535(i: Int, i_7_: Int, i_8_: Int, i_9_: Int, i_10_: Int, i_11_: Int, i_12_: Byte) {
            anInt1062++
            val i_13_ = Class85.method831(WidgetTextConfig.anInt513, i_11_, LocalPlayerState.anInt1910, 111)
            val i_14_ = Class85.method831(WidgetTextConfig.anInt513, i_7_, LocalPlayerState.anInt1910, -104)
            if (i_12_ >= -62) Companion.method535(80, -63, -10, 41, -65, 39, (-89).toByte())
            val i_15_ = Class85.method831(CameraNodeList.anInt1745, i, WorldMapLabel.anInt4960, -79)
            val i_16_ = Class85.method831(CameraNodeList.anInt1745, i_9_, WorldMapLabel.anInt4960, 92)
            val i_17_ = Class85.method831(WidgetTextConfig.anInt513, i_11_ + i_8_, LocalPlayerState.anInt1910, 32)
            val i_18_ = Class85.method831(WidgetTextConfig.anInt513, -i_8_ + i_7_, LocalPlayerState.anInt1910, 41)
            var i_19_ = i_13_
            while (i_17_ > i_19_) {
            ...
            val i_21_ = Class85.method831(CameraNodeList.anInt1745, i_8_ + i, WorldMapLabel.anInt4960, 121)
            val i_22_ = Class85.method831(CameraNodeList.anInt1745, -i_8_ + i_9_, WorldMapLabel.anInt4960, -101)
