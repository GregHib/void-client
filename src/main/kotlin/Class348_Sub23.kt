...
abstract class Class348_Sub23 internal constructor(var anOggStreamState6869: OggStreamState) : Class348() {
    ...
    companion object {
        ...
        fun method2965(string: String?, i: Int, bool: Boolean, i_1_: Int) {
            ...
            if (i == 0) {
                Class348_Sub8.aHa6654 = Class104.method958(true, 0, Class348_Sub40_Sub4.aRenderConfig9113, Class316.aClass348_Sub51_3959!!.aClass239_Sub20_7248!!.method1808(-32350) * 2, Class305.aCanvas3869, Class136.aClass45_4796)
                if (string != null) {
                ...
                var var_ha: ha? = null
                if (string != null) {
                    var_ha = Class104.method958(true, 0, Class348_Sub40_Sub4.aRenderConfig9113, 0, Class305.aCanvas3869, Class136.aClass45_4796)!!
                    var_ha.GA(0)
                ...
                try {
                    Class348_Sub8.aHa6654 = Class104.method958(true, i, Class348_Sub40_Sub4.aRenderConfig9113, 2 * Class316.aClass348_Sub51_3959!!.aClass239_Sub20_7248!!.method1808(i_1_ + -32350), Class305.aCanvas3869, Class136.aClass45_4796)
                    if (string != null) {
                        var_ha!!.GA(0)
