    ...
    companion object {
        ...
        fun method3276(soundEnvelope: SoundEnvelope) {
            if (CalendarUtil.anInt4135 < 65535) {
                ...
                for (i_1_ in i..i_0_) {
                    var i_2_ = 0
                    var i_3_ = ((class348_sub1!!.method2717(89.toByte()) - class348_sub1.method2723(-1) + TheoraVideoStream.anInt9037) shr Class362.anInt4459)
                    if (i_3_ < 0) {
                        i_2_ -= i_3_
                        i_3_ = 0
                    }
                    var i_4_ = ((class348_sub1.method2717(122.toByte()) + class348_sub1.method2723(-1) - TheoraVideoStream.anInt9037) shr Class362.anInt4459)
                    ...
                    for (i_5_ in i_3_..i_4_) {
                        ...
                        var i_7_ = (((class348_sub1.method2724(-1) - class348_sub1.method2723(-1) + TheoraVideoStream.anInt9037) shr Class362.anInt4459) + (i_6_ ushr 8))
