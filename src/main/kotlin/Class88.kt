    ...
    companion object {
        ...
        fun method842(bool: Boolean) {
            ...
            if (RectangleRegion.aClass46Array1942 != null) {
                method3064(i, SpriteLoadValidator.anInt4792, true, AbstractTileShape.anInt6555, i_1_, CalendarUtil.aClass46_4130!!.anInt760, i + LocTypeDefinition.anInt4017, false, RectangleRegion.aClass46Array1942, -1412584499, i_1_ - -HardCacheEntryReference.anInt10432)
                RectangleRegion.aClass46Array1942 = null
            }
        }
                ...
                try {
                    ...
                    if (NpcDefinition.anInt2955 == 3) {
                        ...
                        if (BloomGraphicsOptionState.anInt5969 == 2) {
                            ...
                            class348_sub49_sub2.writeByte(false, AnimationFrameDefinition.anInt6967)
                            method4002(class348_sub49_sub2, 55.toByte())
                            class348_sub49_sub2.writeString((-5).toByte(), BloomGraphicsOptionState.aString5966!!)
