    ...
    companion object {
        ...
        fun method2663(i: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int) {
            ...
            if (Class348_Sub49.anInt7207 == 1) {
                ...
                if (i_7_ < Class31.anInt425 && i_8_ >= 0 && BackgroundWorkerThread.anInt3225 > i_9_ && i_10_ >= 0 && i == -5590) {
                    ...
                    for (i_11_ in i_9_..i_10_) {
                        val i_12_ = (Class350.method3452(i_11_ + MaterialPass.anInt3682, (-15).toByte(), BackgroundWorkerThread.anInt3225) * Class31.anInt425)
                        var i_13_ = i_7_
                        while (i_8_ >= i_13_) {
