...
*/
class Class348_Sub42_Sub20 internal constructor(widgetRedrawRegion: WidgetRedrawRegion?, class318_sub10: SceneGraphContainer?) : Class348_Sub42() {
    ...
    fun method3279(i: Int) {
        ...
        if ((this.aWidgetRedrawRegion_9702!!.aAbstractCameraTransform_4252) != null) this.aWidgetRedrawRegion_9702!!.aAbstractCameraTransform_4252!!.method905((this.aSpotAnimVector_9704!!.anInt2291), (this.aSpotAnimVector_9704!!.anInt2290), (this.aSpotAnimVector_9704!!.anInt2294), Class348_Sub8.anIntArray6666!!)
    ...
    companion object {
        ...
        fun method3283(i: Int) {
            if (Class348_Sub23_Sub1.aPrivilegedOperationWorker_8992!!.aBoolean3777 && (IndexedSprite.aServerConnectionInfo_5199!!.anInt2143 != -1)) method2972((IndexedSprite.aServerConnectionInfo_5199!!.aString2147), (IndexedSprite.aServerConnectionInfo_5199!!.anInt2143), -54)
            anInt9713++
            val i_7_ = 9 / ((i - 60) / 50)
        }
    }
