            ...
            try {
                ...
                while (i_16_ < i_5_ - -104) {
                    ...
                    while (i_17_ < i_6_ - -104) {
                                ...
                                for (i_27_ in -4..<RuntimeException_Sub1.anInt4600) {
                                    for (i_28_ in -4..<RuntimeException_Sub1.anInt4600) {
                                        ...
                                        if (i_5_ <= i_29_ && i_6_ <= i_30_ && method536(i_30_, false, i_29_, i, i_24_)) {
                                            ...
                                            if (i_31_ >= 0) RegionSceneShifter.Companion.method3159(i_14_, ((-i_28_ + (RuntimeException_Sub1.anInt4600)) * 4 + i_19_ + -4), false, i_31_, i_30_, i_29_, var_renderer, 4 * i_27_ + i_18_, i_13_)
                                        }
                                    }
                                }
                            }
                        ...
                        if (Class375.aBoolean4542) {
                            val class361 = TimedRecordAccessor.aClass361Array7108!![i]
                                    ...
                                    if (interface10 != null) {
                                        ...
                                        if (!class51.aBoolean942 || ModelBatchBase.aBoolean1900) {
                                            ...
                                            if (i_40_ >= 0) {
                                                ...
                                                var i_45_ = i_38_
                                                if (bool_43_) {
                                                    val is_46_ = (TimedRecordAccessor.aClass361Array7108!![i_39_]!!.anIntArrayArray4438)!!
                                                    val i_47_ = (TimedRecordAccessor.aClass361Array7108!![i_39_]!!.anInt4453)
                                                    val i_48_ = (TimedRecordAccessor.aClass361Array7108!![i_39_]!!.anInt4441)
                                                    for (i_49_ in 0..9) {
