...
class VarpStore : Interface17 {
    ...
    companion object {
        ...
        fun method1308(i: Int, i_14_: Int, i_15_: Int, i_16_: Int, i_17_: Byte, i_18_: Int, i_19_: Int, i_20_: Int) {
            anInt5072++
            if (WorldMapLabel.anInt4960 <= i_15_ && i_19_ <= CameraNodeList.anInt1745 && i_14_ >= LocalPlayerState.anInt1910 && WidgetTextConfig.anInt513 >= i_20_) method1730(i_16_, i_20_, i_14_, i_19_, i, i_18_, -128, i_15_)
        ...
        fun method1309(bool: Boolean, i: Int) {
            if (NpcConfig.aResourceLoaderThread_897 == null) method726(92)
            if (i < 116) aClass237_Sub1_5067 = null
            anInt5062++
            if (bool) NpcConfig.aResourceLoaderThread_897!!.method2326(96)
        }
        ...
        fun method1318(i: Int) {
            ...
            for (i_38_ in 0..<AbstractCameraTransform.anInt1597) {
                ...
                if ((0x8 and i_40_) != 0) {
                    val `is` = IntArray(4)
                    for (i_41_ in 0..3) {
                        `is`[i_41_] = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(842397944)
                ...
                if ((i_40_ and 0x20) != 0) {
                    ...
                    val i_44_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readIntMiddleEndian(82.toByte())
                    if (i_43_ == 65535) i_43_ = -1
                    val i_45_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readUnsignedByte(255)
                ...
                if ((0x4000 and i_40_) != 0) {
                    val i_48_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readByteInverse(21.toByte())
                    val `is` = IntArray(i_48_)
                    val is_49_ = IntArray(i_48_)
                    val is_50_ = IntArray(i_48_)
                    var i_51_ = 0
                    while (i_48_ > i_51_) {
                        var i_52_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(842397944)
                        if (i_52_ == 65535) i_52_ = -1
                        `is`[i_51_] = i_52_
                        is_49_[i_51_] = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readByteInverse(21.toByte())
                        is_50_[i_51_] = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readShortAddLittle(-109)
                        i_51_++
                    }
                    method3548(-7387, npc, is_50_, `is`, is_49_)
                }
                if ((i_40_ and 0x200) != 0) {
                    val i_53_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readUnsignedByteSubtract((-121).toByte())
                    val `is` = IntArray(i_53_)
                    val is_54_ = IntArray(i_53_)
                    var i_55_ = 0
                    while (i_53_ > i_55_) {
                        val i_56_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readShortAdd(124)
                        if ((0xc000 and i_56_) == 49152) {
                            val i_57_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(i + 842463480)
                            `is`[i_55_] = BoundsConstraintEntry.method2057(i_57_, i_56_ shl 16)
                        } else `is`[i_55_] = i_56_
                        is_54_[i_55_] = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(842397944)
                        i_55_++
                    }
                    npc.method2430(is_54_, `is`, -100)
                }
                if ((0x4 and i_40_) != 0) {
                    npc.anInt10499 = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readShortAdd(124)
                    npc.anInt10512 = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readShortLittle(false)
                }
                if ((0x1000 and i_40_) != 0) {
                    npc.anInt10293 = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readByteSubtract(-27697).toInt()
                ...
                if ((i_40_ and 0x2000) != 0) {
                    npc.aByte10255 = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readByteInverse(-622951480)
                ...
                if ((i_40_ and 0x40) != 0) {
                    ...
                    if (i_58_ > 0) {
                        ...
                        while (i_58_ > i_59_) {
                            ...
                            var i_61_ = -1
                            var i_62_ = -1
                            var i_63_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readSmart(-126)
                            if (i_63_ == 32767) {
                                i_63_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readSmart(-118)
                                i_61_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readSmart(-117)
                                i_60_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readSmart(-122)
                                i_62_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readSmart(-123)
                            } else if (i_63_ != 32766) i_61_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readSmart(-123)
                            else i_63_ = -1
                ...
                if ((i_40_ and 0x80) != 0) {
                    npc.anInt10275 = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(842397944)
                    if ((npc.anInt10275) == 65535) npc.anInt10275 = -1
                }
                if ((0x1 and i_40_) != 0) {
                    npc.aString10292 = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readString(121.toByte())
                    npc.anInt10264 = 100
                }
                if ((i_40_ and 0x800) != 0) {
                    val i_66_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readUnsignedShort(842397944)
                    npc.anInt10227 = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readUnsignedByteSubtract((-84).toByte())
                ...
                if ((i_40_ and 0x400) != 0) {
                    ...
                    val i_68_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readIntLittle((-127).toByte())
                    if (i_67_ == 65535) i_67_ = -1
                    val i_69_ = CircleRasterizer.aClass348_Sub49_Sub2_3813!!.readUnsignedByteSubtract((-116).toByte())
