            ...
            while (i_0_ > i_1_) {
                if (Class348_Sub50.aByteArrayArray7212!![i_1_] != null) {
                    ...
                    for (i_3_ in 0..<ProjectileConfigUtil.anInt388) {
                        if (WidgetRedrawRegion.anIntArray4250!![i_3_] == Class348_Sub23_Sub3.anIntArray9042!![i_1_]) {
                            i_2_ = i_3_
                            break
                        }
                    }
                    if (i_2_ == -1) {
                        WidgetRedrawRegion.anIntArray4250!![ProjectileConfigUtil.anInt388] = Class348_Sub23_Sub3.anIntArray9042!![i_1_]
