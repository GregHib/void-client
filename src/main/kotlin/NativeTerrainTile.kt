...
class NativeTerrainTile(var_ha_Sub3: NativeRenderer?, i: Int, i_139_: Int, i_140_: Int, i_141_: Int, `is`: Array<IntArray?>, is_142_: Array<IntArray?>?, i_143_: Int) : TerrainTile(i_140_, i_141_, i_143_, `is`) {
    ...
    override fun YA() {
        if (anInt8329 <= 0) aVideoStreamDecoder_8307 = null
                ...
                for (i_115_ in 0..<this.anInt4590) {
                    ...
                    if (is_116_ != null) {
                        ...
                        while (is_116_.size > i_118_) {
                            ...
                            var class348_sub3_124_: ModelVertexColorBuffer? = null
            ...
            if ((0x7 and this.anInt8294) == 0) {
                if (anIntArrayArrayArray8314 == null) this.aModelBatchBase_8324 = (this.aHa_Sub3_8322!!.method3812(0, (arrayOf<Class58>(Class58(arrayOf<SpriteMaskShape?>(SpriteMaskShape.aSpriteMaskShape_4073, SpriteMaskShape.aSpriteMaskShape_4078)), Class58(SpriteMaskShape.aSpriteMaskShape_4076!!)))))
                else this.aModelBatchBase_8324 = (this.aHa_Sub3_8322!!.method3812(0, (arrayOf<Class58>(Class58(arrayOf<SpriteMaskShape?>(SpriteMaskShape.aSpriteMaskShape_4073, SpriteMaskShape.aSpriteMaskShape_4078, SpriteMaskShape.aSpriteMaskShape_4077)), Class58(SpriteMaskShape.aSpriteMaskShape_4076!!)))))
            } else if (anIntArrayArrayArray8314 != null) this.aModelBatchBase_8324 = (this.aHa_Sub3_8322!!.method3812(0, (arrayOf<Class58>(Class58(arrayOf<SpriteMaskShape?>(SpriteMaskShape.aSpriteMaskShape_4073, SpriteMaskShape.aSpriteMaskShape_4078, SpriteMaskShape.aSpriteMaskShape_4077, SpriteMaskShape.aSpriteMaskShape_4075)), Class58(SpriteMaskShape.aSpriteMaskShape_4076!!)))))
            else this.aModelBatchBase_8324 = (this.aHa_Sub3_8322!!.method3812(0, (arrayOf<Class58>(Class58(arrayOf<SpriteMaskShape?>(SpriteMaskShape.aSpriteMaskShape_4073, SpriteMaskShape.aSpriteMaskShape_4078, SpriteMaskShape.aSpriteMaskShape_4075)), Class58(SpriteMaskShape.aSpriteMaskShape_4076!!)))))
            var i_125_ = 0
            for (i_126_ in class348_sub3s.indices) {
                if (class348_sub3s[i_126_]!!.anInt6589 > 0) class348_sub3s[i_125_++] = class348_sub3s[i_126_]
            }
            aClass348_Sub3Array8328 = arrayOfNulls<ModelVertexColorBuffer>(i_125_)
    ...
    init {
        ...
        do {
            try {
                ...
                aClass348_Sub3ArrayArrayArray8312 = Array<Array<Array<ModelVertexColorBuffer?>?>?>(i_140_) { arrayOfNulls<Array<ModelVertexColorBuffer?>>(i_141_) }
        ...
        if (i_151_ == -1) {
            if (aClass348_Sub3Array8328 != null) {
                ...
                if (!aNodeDeque_8286.method2002(18.toByte())) {
                    ...
                    this.aHa_Sub3_8322!!.method3849(47.toByte(), 0, RenderListTextureNode.aClass70_9485)
    ...
    override fun U(i: Int, i_167_: Int, `is`: IntArray?, is_168_: IntArray?, is_169_: IntArray, is_170_: IntArray?, is_171_: IntArray, is_172_: IntArray?, is_173_: IntArray, is_174_: IntArray, i_175_: Int, i_176_: Int, i_177_: Int, bool: Boolean) {
        try {
            ...
            val class348_sub3s = (arrayOfNulls<ModelVertexColorBuffer>(is_171_.size).also { aClass348_Sub3ArrayArrayArray8312!![i]!![i_167_] = it })
    ...
    companion object {
        ...
        fun method4004(i: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int) {
            anInt8292++
            val i_10_ = Class85.method831(WidgetTextConfig.anInt513, i_4_, LocalPlayerState.anInt1910, -118)
            val i_11_ = Class85.method831(WidgetTextConfig.anInt513, i, LocalPlayerState.anInt1910, 72)
            val i_12_ = Class85.method831(CameraNodeList.anInt1745, i_8_, WorldMapLabel.anInt4960, -80)
            val i_13_ = Class85.method831(CameraNodeList.anInt1745, i_3_, WorldMapLabel.anInt4960, -101)
            val i_14_ = Class85.method831(WidgetTextConfig.anInt513, i_4_ + i_6_, LocalPlayerState.anInt1910, -110)
            val i_15_ = Class85.method831(WidgetTextConfig.anInt513, i + -i_6_, LocalPlayerState.anInt1910, 28)
            if (i_7_ < -33) {
                ...
                val i_18_ = Class85.method831(CameraNodeList.anInt1745, i_8_ + i_6_, WorldMapLabel.anInt4960, 114)
                val i_19_ = Class85.method831(CameraNodeList.anInt1745, -i_6_ + i_3_, WorldMapLabel.anInt4960, 34)
