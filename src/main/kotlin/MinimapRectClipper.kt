    ...
    fun method227(class318_sub1: Class318_Sub1, bool: Boolean, bool_5_: Boolean) {
        ...
        if (Class348_Sub40_Sub5.aBoolean9121) {
            if (bool) Class319.aCacheIndexManagerArray3982!![Class319.aCacheIndexManagerArray3982!!.size - 1]!!.method2353(class318_sub1, false)
                ...
                if (i_7_ == i_8_) Class319.aCacheIndexManagerArray3982!![i]!!.method2353(class318_sub1, false)
                else if (i_8_ - i_7_ == 1) Class319.aCacheIndexManagerArray3982!![Class75_Sub1.anInt5652 + i_7_]!!.method2353(class318_sub1, false)
                else Class319.aCacheIndexManagerArray3982!![Class319.aCacheIndexManagerArray3982!!.size - 1]!!.method2353(class318_sub1, false)
            }
