...
*/
abstract class AudioStreamNode : LinkedListNode() {
    @JvmField
    @Volatile
    var aBoolean6784: Boolean = true
    @JvmField
    var aClass348_Sub16_6785: AudioStreamNode? = null
    @JvmField
    var anInt6786: Int = 0
    @JvmField
    var aClass348_Sub19_6787: AbstractAudioSample? = null
    ...
    abstract fun method2816(): AudioStreamNode?

    abstract fun method2817(`is`: IntArray, i: Int, i_1_: Int)

    abstract fun method2818(): AudioStreamNode?
