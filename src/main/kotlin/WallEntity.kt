...
abstract class WallEntity internal constructor(i: Int, i_11_: Int, i_12_: Int, i_13_: Int, i_14_: Int, i_15_: Int, i_16_: Int) : SceneEntity() {
    ...
    companion object {
        ...
        fun method2486(i: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int) {
            if (i_8_ >= WorldMapLabel.anInt4960 && i_5_ <= CameraNodeList.anInt1745 && LocalPlayerState.anInt1910 <= i_9_ && Class38.anInt513 >= i_7_) MinimapSpriteRenderer.method1111(i_7_, i, i_5_, i_8_, i_9_, i_6_)
