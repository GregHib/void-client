...
class FixedFunctionMaterialPass internal constructor(var_ha_Sub2: OpenGlRenderer) : MaterialPass(var_ha_Sub2) {
    ...
    companion object {
        ...
        fun method2145(i: Int) {
            anInt6210++
            Class368.anInt4494++
            val class348_sub47: OutgoingPacketNode = WaterMaterialPass.Companion.method2148(Class59_Sub1.aClass351_5288, TheoraVideoStream.aClass77_9029, -124)
        ...
        fun method2146(i: Byte) {
            ...
            MinimapRectClipper.method226(GlArrayBufferObject.anInt4717, Class63.anInt1117, ProceduralTextureGraph.anInt9532, 0, WorldMapSceneSoftware.anInt5819)
        }
