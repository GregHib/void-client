                            ...
                            for (i_10_ in i_6_..i_7_) {
                                if (i_10_ >= 0 && i_10_ < RegionSceneShifter.anInt7054 && (!bool || i_9_ >= i_5_ || i_10_ >= i_7_ || i_10_ < i_1_ && i_9_ != i_0_)) {
                                    ...
                                    if (class357 != null) {
                                        ...
                                        if (class318_sub1_sub4 != null && class318_sub1_sub4.method2388(-127)) class318_sub1.method2380(NativeLibraryState.aRenderer171, i_11_, bool, class318_sub1_sub4, (((i_10_ - i_1_) * ArchiveFileConditionWrapper.anInt3465) + ((1 - i_3_) * (TheoraVideoStream.anInt9037))), (-112).toByte(), (((i_9_ - i_0_) * ArchiveFileConditionWrapper.anInt3465) + ((1 - i_2_) * (TheoraVideoStream.anInt9037))))
                                        if (class318_sub1_sub4_12_ != null && class318_sub1_sub4_12_.method2388(-100)) class318_sub1.method2380(NativeLibraryState.aRenderer171, i_11_, bool, class318_sub1_sub4_12_, (((i_10_ - i_1_) * ArchiveFileConditionWrapper.anInt3465) + ((1 - i_3_) * (TheoraVideoStream.anInt9037))), (-115).toByte(), (((i_9_ - i_0_) * ArchiveFileConditionWrapper.anInt3465) + ((1 - i_2_) * (TheoraVideoStream.anInt9037))))
                                        ...
                                        while (class148 != null) {
                                            ...
                                            if (class318_sub1_sub3 != null && class318_sub1_sub3.method2388(-111) && (i_9_ == (class318_sub1_sub3.aShort8743).toInt() || i_9_ == i_4_) && (i_10_ == (class318_sub1_sub3.aShort8750).toInt() || i_10_ == i_6_)) {
                                                ...
                                                class318_sub1.method2380(NativeLibraryState.aRenderer171, i_11_, bool, class318_sub1_sub3, (((class318_sub1_sub3.aShort8750) - i_1_) * ArchiveFileConditionWrapper.anInt3465 + ((i_14_ - i_3_) * (TheoraVideoStream.anInt9037))), (-115).toByte(), (((class318_sub1_sub3.aShort8743) - i_0_) * ArchiveFileConditionWrapper.anInt3465 + ((i_13_ - i_2_) * (TheoraVideoStream.anInt9037))))
                                            }
