...
class Class334 {
    ...
    companion object {
        ...
        fun method2650(fontDefinition: FontDefinition?, i: Int, var_sprite: Sprite?, i_1_: Int, i_2_: Int, string: String?, i_3_: Int, class324: Class324?, i_4_: Int, class46: Class46?, i_5_: Int, i_6_: Int) {
            try {
                anInt4153++
                val i_7_: Int
                if (Class348_Sub40_Sub21.anInt9282 == 4) i_7_ = Class314.aFloat3938.toInt() and 0x3fff
                else i_7_ = 0x3fff and OpenGlRenderNode.anInt10483 + Class314.aFloat3938.toInt()
                ...
                throw Class348_Sub17.method2929(runtimeexception, ("dk.H(" + (if (fontDefinition != null) "{...}" else "null") + ',' + i + ',' + (if (var_sprite != null) "{...}" else "null") + ',' + i_1_ + ',' + i_2_ + ',' + (if (string != null) "{...}" else "null") + ',' + i_3_ + ',' + (if (class324 != null) "{...}" else "null") + ',' + i_4_ + ',' + (if (class46 != null) "{...}" else "null") + ',' + i_5_ + ',' + i_6_ + ')'))
            }
        }
