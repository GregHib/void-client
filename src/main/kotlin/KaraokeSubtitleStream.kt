...
class KaraokeSubtitleStream internal constructor(oggstreamstate: OggStreamState) : OggBitstreamDecoder(oggstreamstate) {
    ...
    companion object {
        ...
        fun method2988(bool: Boolean) {
            ...
            anInt9049++
            Class60.aRenderer1098!!.ZA(NativeIndexBuffer.anInt4703, TextureMetadataProvider.aFloat4626, CollisionMap.aFloat4455, (CameraRotationStub.anInt325 shl 2).toFloat(), (ModelGroundDecor.anInt10023 shl 2).toFloat(), (SingletonMarker.anInt2601 shl 2).toFloat())
