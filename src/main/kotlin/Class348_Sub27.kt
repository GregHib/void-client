...
class Class348_Sub27 : Class348() {
    ...
    companion object {
        ...
        fun method3002(i: Byte): Array<RectangleRegion?> {
            ...
            anInt6901++
            return (arrayOf<RectangleRegion?>(RandomAccessFileOnDisk.aRectangleRegion_3044, Texture2DProvider.aRectangleRegion_6321, Font.aRectangleRegion_4062, UnderlayDefinition.aRectangleRegion_2885, Class348_Sub42_Sub5.aRectangleRegion_9530, Class348_Sub49_Sub1.aRectangleRegion_9748, SpriteMaskShape.aRectangleRegion_4082, GlTexture1D.aRectangleRegion_8553, ShaderProgram.aRectangleRegion_7274, Class71.aRectangleRegion_1213, Class52.aRectangleRegion_4901, DynamicSceneObjectEntity.aRectangleRegion_10194, ArbVertexProgram.aRectangleRegion_9781, Class377.aRectangleRegion_9860))
        }
    }
}
