...
class D3dIndexBuffer internal constructor(private val aD3dRenderDevice_8515: D3dRenderDevice, private var aMovementDirection_8518: MovementDirection?, private val aBoolean8519: Boolean) : IndexBufferResource {
    ...
    override fun method24(bool: Boolean, bool_3_: Boolean): Buffer? {
        ...
        if (!aBoolean8520 && a((this.anIDirect3DIndexBuffer8517!!.Lock(0, anInt8521, if (!bool) 0 else 8192, aD3dRenderDevice_8515.aGeometryBuffer9811)), false)) {
            aBoolean8520 = true
            return aD3dRenderDevice_8515.aGeometryBuffer9811
        }
        return null
    }
