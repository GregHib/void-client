...
abstract class Class318_Sub1_Sub2 internal constructor(i: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int) : Class318_Sub1() {
    override fun method2382(i: Byte): Boolean {
        ...
        anInt8733++
        val class148 = RenderableGroup.method1449(this.plane.toInt(), (this.x shr Class362.anInt4459), (this.y shr Class362.anInt4459))
    ...
    override fun method2378(i: Int): Boolean {
        ...
        anInt8734++
        return (Class99.aBooleanArrayArray1572!![(Class318_Sub1_Sub4_Sub1.anInt10084 + -DisplayModeOptionState.anInt6111 + (this.x shr Class362.anInt4459))]!![(Class318_Sub1_Sub4_Sub1.anInt10084 + (-Class285_Sub2.anInt8502 + (this.y shr Class362.anInt4459)))])
    }
