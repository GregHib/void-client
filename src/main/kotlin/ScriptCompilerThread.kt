    ...
    companion object {
        ...
        fun method1053(i: Int): Int {
            ...
            if (RegionSceneLoader.aWidgetComponent_3701 == null) {
                if (!ScrollbarComponent.aBoolean8335 && IntHashSet.aClass348_Sub42_Sub12_3963 != null) return (IntHashSet.aClass348_Sub42_Sub12_3963!!.anInt9609)
                ...
                if (ChatScriptListNode.aBoolean9535) {
                    ...
                    } else if (ManagedGlResource.aClass348_Sub42_Sub13_3152 != null && Class50_Sub3.anInt5252 < i_2_ && (TerrainTileShape.anInt8806 + Class50_Sub3.anInt5252) > i_2_) {
                        var i_4_ = -1
                        var i_5_ = 0
                    ...
                    while (Class73.anInt4776 > i_15_) {
                        if (Class71.aBoolean1211) {
                            ...
                            val i_16_ = 31 + (ProceduralTextureGraph.anInt9532 + (-i_15_ + (Class73.anInt4776 - 1)) * 16)
