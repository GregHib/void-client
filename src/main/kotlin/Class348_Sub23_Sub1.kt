...
class Class348_Sub23_Sub1 internal constructor(oggstreamstate: OggStreamState) : Class348_Sub23(oggstreamstate) {
    ...
    companion object {
        ...
        fun method2972(string: String?, i: Int, i_3_: Int): Boolean {
            ...
            val string_6_ = ("http://" + string + string_4_ + "/l=" + Class348_Sub33.anInt6967 + "/a=" + SocketStreamWorker.anInt2670 + string_5_ + "/j" + (if (!Class289.aBoolean3697) "0" else "1") + ",o" + (if (Class348_Sub37.aBoolean6997) "1" else "0") + ",a2")
            try {
