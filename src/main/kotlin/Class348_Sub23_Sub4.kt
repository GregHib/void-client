...
class Class348_Sub23_Sub4 internal constructor(oggstreamstate: OggStreamState) : Class348_Sub23(oggstreamstate) {
    ...
    companion object {
        ...
        fun method2987(i: Int, i_7_: Int, i_8_: Int, i_9_: Int, i_10_: Int) {
            ...
            if (i_7_ == 8 || i_7_ == 16) {
                ...
                while ((Class348_Sub44.anInt7101 > i_11_)) {
                    val class338 = LoadingBarRenderer.aClass338Array5060!![i_11_]!!
                    if ((class338.aByte4192.toInt() == i_7_ && i_10_ == class338.aShort4185.toInt() && i_8_ == class338.aShort4193.toInt()) || ((class338.aShort4182.toInt() == i_10_) && (class338.aShort4193.toInt() == i_8_))) {
                        if (i_11_ != Class348_Sub44.anInt7101) ArrayCopyUtil.method1575(LoadingBarRenderer.aClass338Array5060!!, 1 + i_11_, LoadingBarRenderer.aClass338Array5060!!, i_11_, (LoadingBarRenderer.aClass338Array5060!!.size + -i_11_ - 1))
        ...
        fun method2988(bool: Boolean) {
            Class60.aRenderer1098!!.xa((Class316.aClass348_Sub51_3959!!.aClass239_Sub10_7232!!.method1764(-32350).toFloat() * 0.1f + 0.7f) * KeyboardLayoutConfig.aFloat2137)
            anInt9049++
            ...
            Class60.aRenderer1098!!.method3653(HeapInfoRecord.aClass299_4938)
