                    ...
                    if (i_20_ < i_17_) {
                        ...
                        if (anInt9312 == 0) {
                            for (i_23_ in 0..<i_16_) {
                                ...
                                is_21_[(NpcSummaryDefinition.method1166(Class239_Sub22.anInt6076, i_3_ - (-i_5_ + (i_23_ - -1))))] = i_22_ * i_24_ shr 12
                                is_21_[NpcSummaryDefinition.method1166(i_23_ + i_3_, (Class239_Sub22.anInt6076))] = is_21_[(NpcSummaryDefinition.method1166(Class239_Sub22.anInt6076, i_3_ - (-i_5_ + (i_23_ - -1))))]
                            }
                        } else {
                            var i_25_ = 0
                            while (i_16_ > i_25_) {
                                val i_26_ = i_6_ * i_25_ / i_16_
                                is_21_[(NpcSummaryDefinition.method1166(i_3_ - -i_5_ + (-i_25_ - 1), Class239_Sub22.anInt6076))] = min(i_26_, i_22_)
                                is_21_[NpcSummaryDefinition.method1166((Class239_Sub22.anInt6076), i_25_ + i_3_)] = is_21_[(NpcSummaryDefinition.method1166(i_3_ - -i_5_ + (-i_25_ - 1), Class239_Sub22.anInt6076))]
                                i_25_++
                            }
                        }
                        ...
                        if (i_17_ > i_28_) {
                            ...
                            if (anInt9312 == 0) {
                                ...
                                while (i_16_ > i_30_) {
                                    ...
                                    is_21_[(NpcSummaryDefinition.method1166(Class239_Sub22.anInt6076, -1 + i_5_ + i_3_ - i_30_))] = i_31_ * i_29_ shr 12
                                    is_21_[NpcSummaryDefinition.method1166((Class239_Sub22.anInt6076), i_30_ + i_3_)] = is_21_[(NpcSummaryDefinition.method1166(Class239_Sub22.anInt6076, -1 + i_5_ + i_3_ - i_30_))]
                                    i_30_++
                                }
                            } else {
                                var i_32_ = 0
                                while ((i_16_ > i_32_)) {
                                    ...
                                    is_21_[(NpcSummaryDefinition.method1166(Class239_Sub22.anInt6076, -i_32_ + i_5_ + (i_3_ + -1)))] = min(i_29_, i_33_)
                                    is_21_[NpcSummaryDefinition.method1166((Class239_Sub22.anInt6076), i_3_ + i_32_)] = is_21_[(NpcSummaryDefinition.method1166(Class239_Sub22.anInt6076, -i_32_ + i_5_ + (i_3_ + -1)))]
                                    i_32_++
                                }
                            }
        ...
        if (this.aSpriteSheetCache_7032!!.aBoolean2570) {
            ...
            while (true) {
                ...
                if (i_60_ == Class348_Sub40_Sub6.Companion.anInt9139) {
                    ...
                    i_45_ = i_44_
                    i_50_ = 0
                    i_44_ = ModelDefinition.method1097(113.toByte(), Class348_Sub40_Sub6.Companion.anInt9139, random)
                    i_43_ = -i_45_ + i_44_
                    i_46_ = 0
                    var i_80_ = i_43_
