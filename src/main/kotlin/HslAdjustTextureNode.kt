...
*/
class HslAdjustTextureNode : AbstractProceduralTextureNode(1, false) {
    ...
    companion object {
        ...
        fun method3126(i: Byte) {
            ...
            Class60.aRenderer1098!!.method3700(RangedGraphicsOptionState.aFloat5945, ModelVertexColorBuffer.aFloat6586, NormalMapGenerator.aFloat3462)
            anInt9387++
        }
                        ...
                        if (anInt9383 >= 200 && !FrameBufferObject.aBoolean4888 || anInt9383 >= 200) {
                            ...
                            if (string_1_ != null) {
                                ...
                                if (method2127(2, (LocalPlayerState.aPlayer_1907!!.aString10544)) == string_1_) method544((LocalizedText.aLocalizedText_3524!!.method2063(AnimationFrameDefinition.anInt6967, 544)), false, 4)
                                    ...
                                    val class348_sub47 = (method2148(LoadingBarRenderer.aClass351_5057, TheoraVideoStream.aClass77_9029, -85))
