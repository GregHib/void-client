...
class AnimatedModelRenderer : AbstractModelRenderer {
    ...
    override fun method983(f: Float, f_66_: Float, f_67_: Float, f_68_: Float, f_69_: Float, f_70_: Float, i: Int, var_sprite: Sprite?, i_71_: Int, i_72_: Int) {
        ...
        aHa_Sub3_8407.method3874(ParticleSystemState.aClass229_2207, 127, Class328_Sub3.aClass229_6519)
        ...
        aHa_Sub3_8407.method3874(ParticleSystemState.aClass229_2207, 118, ParticleSystemState.aClass229_2207)
    ...
    override fun method968(i: Int, i_77_: Int, i_78_: Int) {
        ...
        if (i_78_ == 0) {
            ...
            while (anInt8417 > i_80_) {
                ...
                for (i_82_ in 0..<anInt8411) is_79_[i_81_ + i_82_] = (Class273.method2057((NpcSummaryDefinition.method1166(1828651008, `is`!![i_81_ - -i_82_]) shl 8), NpcSummaryDefinition.method1166(is_79_[i_81_ - -i_82_], 16777215)))
                i_80_++
            }
        } else if (i_78_ == 1) {
            var i_83_ = 0
            while (anInt8417 > i_83_) {
                ...
                while (anInt8411 > i_85_) {
                    is_79_[i_85_ + i_84_] = (Class273.method2057(NpcSummaryDefinition.method1166(is_79_[i_85_ + i_84_], 16777215), (NpcSummaryDefinition.method1166(`is`!![i_84_ - -i_85_], 743571200) shl 16)))
                    i_85_++
                }
                i_83_++
            }
            ...
            while (anInt8417 > i_89_) {
                ...
                for (i_91_ in 0..<anInt8411) is_79_[i_90_ + i_91_] = (Class273.method2057(NpcSummaryDefinition.method1166(is_79_[i_90_ + i_91_], 16777215), NpcSummaryDefinition.method1166(-3725444, (`is`!![i_91_ + i_90_] shl 24))))
                i_89_++
            }
        } else if (i_78_ == 3) {
            var i_86_ = 0
            while (anInt8417 > i_86_) {
                ...
                for (i_88_ in 0..<anInt8411) is_79_[i_88_ + i_87_] = (Class273.method2057(if (`is`!![i_88_ + i_87_] != 0) -16777216 else 0, NpcSummaryDefinition.method1166(16777215, is_79_[i_88_ + i_87_])))
                i_86_++
            }
        }
    ...
    override fun method963(i: Int, i_113_: Int, var_sprite: Sprite?, i_114_: Int, i_115_: Int) {
        ...
        aHa_Sub3_8407.method3874(ParticleSystemState.aClass229_2207, 110, Class328_Sub3.aClass229_6519)
        aHa_Sub3_8407.method3849(47.toByte(), 0, Class318_Sub1_Sub2.aClass70_8737)
        ...
        aHa_Sub3_8407.method3879(-8629)
        aHa_Sub3_8407.method3849(47.toByte(), 0, Class342.aClass70_4247)
        aHa_Sub3_8407.method3874(ParticleSystemState.aClass229_2207, 127, ParticleSystemState.aClass229_2207)
    ...
    companion object {
        ...
        fun method987(i: Int, class348_sub49: Class348_Sub49): Class369_Sub2 {
            ...
            return Class369_Sub2(class369.aScreenAnchorAlignment_4968, class369.aClass341_4973, class369.anInt4970, class369.anInt4959, class369.anInt4971, class369.anInt4963, class369.anInt4966, class369.anInt4965, class369.anInt4961, i_8_, i_9_)
        }
