                ...
                if (Class355.anInt4372 != 3) {
                    ...
                    if (i >= 100) {
                        if (WeaveTextureNode.anInt9282 == 1 || Class9.anInt167 != -1) {
                            ...
                            if ((0x4 and (AnimationFrameDefinition.aByteArrayArrayArray6962!![Class355.anInt4372]!![i_10_ shr 9]!![i_11_ shr 9]).toInt()) != 0) method3542(i_11_ shr 9, HintArrowOrMessage.aClass357ArrayArrayArray2029, i_10_ shr 9, 0, 0, false)
                            if (MinimapAreaMarkerNode.Companion.anInt9701 < 2560) {
                                ...
                                if (i_16_ == 0 && i_17_ == 0 || -Class367_Sub4.anInt7319 >= i_16_ || (Class367_Sub4.anInt7319 <= i_16_) || i_17_ <= -RangeThresholdTextureNode.anInt9109 || RangeThresholdTextureNode.anInt9109 <= i_17_) method1242(("RC: " + i_12_ + "," + i_13_ + " " + i_14_ + "," + i_15_ + " " + ArbVertexProgram.regionTileX + "," + Class90.regionTileY), null, 15004)
                                else if (i_16_ <= i_17_) {
                                    ...
                                    while (i_15_ != i_13_) {
                                        ...
                                        if ((0x4 and (AnimationFrameDefinition.aByteArrayArrayArray6962!![Class355.anInt4372]!![i_12_]!![i_13_]).toInt()) != 0) {
