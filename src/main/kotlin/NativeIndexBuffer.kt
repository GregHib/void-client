        ...
        fun method1077(var_renderer: Renderer?, i: Byte) {
            ...
            if ((Class73.anInt4776 >= 2 || RenderNode.aBoolean9722) && RegionSceneLoader.aClass46_3701 == null) {
                ...
                if (RenderNode.aBoolean9722 && Class73.anInt4776 < 2) string = (ItemNameResolver.aString5001 + LocalizedText.aLocalizedText_3515!!.method2063(Class348_Sub33.anInt6967, 544) + ItemNameResolver.aString5000 + " ->")
                    ...
                    string = IntHashSet.method2367((-52).toByte(), class348_sub42_sub12)
                ...
                if (Class348_Sub36.aClass46_6990 != null) {
                    ...
                    val i_1_ = (NodeDeque.aClass324_3326!!.method2571(-1, Class356.anInt4383, SizeBoundedSoftCache.anIntArray2330, string, 16777215, 0, Class341.aAbstractModelRendererArray4234, 16 + SocketGameConnection.anInt5832, 4 + ConfigValueProvider.Companion.anInt4911, OutputStream_Sub1.aRandom93))
