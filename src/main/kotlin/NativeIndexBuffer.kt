        ...
        fun method1077(var_renderer: Renderer?, i: Byte) {
            ...
            if ((Class73.anInt4776 >= 2 || RenderNode.aBoolean9722) && RegionSceneLoader.aClass46_3701 == null) {
                ...
                if (Class348_Sub36.aClass46_6990 != null) {
                    ...
                    val i_1_ = (NodeDeque.aFont_3326!!.method2571(-1, Class356.anInt4383, SizeBoundedSoftCache.anIntArray2330, string, 16777215, 0, Class341.aAbstractModelRendererArray4234, 16 + SocketGameConnection.anInt5832, 4 + ConfigValueProvider.Companion.anInt4911, OutputStream_Sub1.aRandom93))
