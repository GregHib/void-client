...
class Class318_Sub1_Sub1_Sub1 internal constructor(var_renderer: Renderer?, class51: Class51, i: Int, i_7_: Int, i_8_: Int, i_9_: Int, i_10_: Int, bool: Boolean, i_11_: Int, i_12_: Int) : Class318_Sub1_Sub1(i_8_, i_9_, i_10_, i, i_7_, class51.anInt930), Interface10 {
    ...
    public override fun method2387(var_renderer: Renderer?, i: Int) {
        anInt9962++
        val class64 = this.aClass235_9955!!.method1668(true, true, -128, 262144, var_renderer)
        if (class64 != null) {
            val i_0_ = this.x shr 9
            val i_1_ = this.y shr 9
            val class101 = var_renderer!!.method3705()
            class101.method894(this.x, this.anInt6382, this.y)
            this.aClass235_9955!!.method1670(i_0_, class101, i_1_, var_renderer, i_0_, class64, false, (-73).toByte(), i_1_)
        }
    }
    ...
    public override fun method2386(i: Int, var_renderer: Renderer?): Class318_Sub4? {
        anInt9968++
        val class64 = this.aClass235_9955!!.method1668(false, true, -128, 2048, var_renderer)
        ...
        this.aClass235_9955!!.method1670(i_2_, class101, i_3_, var_renderer, i_2_, class64, true, (-73).toByte(), i_3_)
    ...
    init {
        try {
            this.aClass235_9955 = Class235(var_renderer, class51, 22, i_11_, i, i_7_, this, bool, i_12_)
    ...
    public override fun method2391(var_renderer: Renderer?, i: Int, i_13_: Int, i_14_: Int): Boolean {
        anInt9952++
        val class64 = this.aClass235_9955!!.method1668(false, false, -128, 131072, var_renderer)
        if (class64 == null) return false
        val class101 = var_renderer!!.method3705()
        if (i_14_ != 0) return true
        class101.method894(this.x, this.anInt6382, this.y)
        if (Class305.aBoolean3870) return class64.method623(i_13_, i, class101, false, 0, LocalPlayerState.anInt1906)
    ...
    override fun method43(var_renderer: Renderer?, i: Int) {
        if (i == -14218) {
            this.aClass235_9955!!.method1674(-1, var_renderer)
            anInt9951++
        }
    }
    ...
    override fun method44(i: Int, var_renderer: Renderer?) {
        ...
        this.aClass235_9955!!.method1667(116.toByte(), var_renderer)
        anInt9961++
    }
