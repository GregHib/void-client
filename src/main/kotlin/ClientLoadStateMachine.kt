...
object ClientLoadStateMachine {
    ...
    fun method1278(i: Int): Int {
        ...
        anInt2174++
        if (TimedTileQueueEntry.aClass56_9660 == Class56.aClass56_1018) {
        ...
        if (Class56.aClass56_1023 == TimedTileQueueEntry.aClass56_9660) {
            if (SizeBoundedSoftCache.aRsaPacketDecoder_2327 == null) SizeBoundedSoftCache.aRsaPacketDecoder_2327 = RsaPacketDecoder(ClientMachineInfo.aMediaStreamClient_6601, GlShaderObjectHandle.aScriptCompilerThread_520, Class52.aBigInteger4896, TimedTileQueueEntry.aBigInteger9657)
        ...
        if (Class56.aClass56_1024 == TimedTileQueueEntry.aClass56_9660) {
            ...
            i_2_ = i_2_ + (if (!bool) SpriteRgbTextureNode.aClass45_10426!!.method398((-31).toByte()) else 100)
            if (i_2_ != 400) return i_2_ / 4
            AbstractFrameBufferSurface.anInt6924 = ScrollTexMaterialPass.aClass45_6277!!.method389(77)
            GroundItemRenderState.anInt1663 = SpriteRgbTextureNode.aClass45_10426!!.method389(i + 28561)
            ...
            PerlinTextureProvider.aCollisionMapRegion_5813 = CollisionMapRegion(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, SpriteRgbTextureNode.aClass45_10426)
        ...
        if (TimedTileQueueEntry.aClass56_9660 == Class56.aClass56_1026) LoadingScreenImageNode.method3178(SoftwareSpriteRaster.aClass45_1627, -81, method184(1084489728), ScrollTexMaterialPass.aClass45_6277)
        if (Class56.aClass56_1027 == TimedTileQueueEntry.aClass56_9660) {
            val i_5_ = StringCacheNode.method3420(0)
            val i_6_ = method3256(2)
            if (i_6_ > i_5_) return 100 * i_5_ / i_6_
        }
        if (TimedTileQueueEntry.aClass56_9660 == Class56.aClass56_1028) {
        ...
        if (Class56.aClass56_1031 == TimedTileQueueEntry.aClass56_9660) {
            ...
            LoadingScreenImageNode.method3178(SoftwareSpriteRaster.aClass45_1627, -124, method184(i xor 0x40a46ff3.inv()), CameraRotationStub.aClass45_322)
        }
        if (Class56.aClass56_1032 == TimedTileQueueEntry.aClass56_9660) {
        ...
        if (Class56.aClass56_1033 == TimedTileQueueEntry.aClass56_9660) method323(Crc64Hashable.aClass45_4984, VorbisOggDecoder.aPrivilegedOperationWorker_8992, 95.toByte())
        if (Class56.aClass56_1034 == TimedTileQueueEntry.aClass56_9660) {
        ...
        if (TimedTileQueueEntry.aClass56_9660 == Class56.aClass56_1035) {
            ...
            AbstractTileShape.aMapSceneDefLoader_6559 = MapSceneDefLoader(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aClass45_1541)
            GradientLookupEffect.aSeqDefinitionCache_9195 = SeqDefinitionCache(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, true, Class94.aClass45_1538, RasterSprite.aClass45_5207)
            TheoraVideoStream.aConfigDefinitionLoader_9031 = ConfigDefinitionLoader(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aClass45_1541, CameraRotationStub.aClass45_322)
            ModelOrSpriteHolder.aTextureDefinitionLoader_117 = TextureDefinitionLoader(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aClass45_1541, CameraRotationStub.aClass45_322)
            MapAreaDefinition.aBufferedMessageQueue_2529 = BufferedMessageQueue(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, true, FloatGrid.aClass45_4975, RasterSprite.aClass45_5207)
            Exception_Sub1.aModelHeaderCache_112 = ModelHeaderCache(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, true, ProjectionCameraTransform.aEmoteDefCache_5764, SpotAnimVector.aClass45_2306, RasterSprite.aClass45_5207)
            TheoraVideoStream.aLocTypeDefLoader_9036 = LocTypeDefLoader(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aClass45_1541)
            ParticleEmitterNode.aClass87_191 = Class87(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, OpenGlRenderNode.aClass45_10480, ShortKeyNode.aClass45_6909, TextureGenerator.aClass45_2490)
            CircleHitbox.aClass84_413 = Class84(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aClass45_1541)
            HoverActionEntry.aSpriteStore_1813 = SpriteStore(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aClass45_1541)
            ConstantColourTextureNode.aMapElementDefinitionCache_9245 = MapElementDefinitionCache(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class78.aClass45_1322, RasterSprite.aClass45_5207)
            SpriteLoadValidator.aClass65_4787 = Class65(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aClass45_1541)
            Class91.aClass82_1523 = Class82(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aClass45_1541)
            WaterDetailOptionState.aKeyboardLayoutCache_5995 = KeyboardLayoutCache(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aClass45_1541)
            RenderConfigFactory.aVarbitDefLoader_2981 = VarbitDefLoader(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, MidiSequencePlayer.aClass45_8926)
            NormalMapGenerator.aParticleAmountCache_3453 = ParticleAmountCache(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aClass45_1541)
            ...
            ShortKeyNode.method3004(RasterSprite.aClass45_5207, false, SourceRowTextureNode.aRenderConfig9113)
        ...
        if (TimedTileQueueEntry.aClass56_9660 == Class56.aClass56_1037) {
            val i_11_ = (NpcReference.method2958(22388, CameraRotationStub.aClass45_322!!) + CipheredPacketBuffer.method3405(2012104999, true))
        ...
        if (Class56.aClass56_1039 == TimedTileQueueEntry.aClass56_9660) {
            ...
            method1063(1)
            GlBufferObject.anInt4737 = IntKeyNode.aClass45_6980!!.method417("loginscreen", i xor 0x6ff3.inv())
            Class54.anInt970 = IntKeyNode.aClass45_6980!!.method417("lobbyscreen", 0)
            ...
            IntKeyNode.aClass45_6980!!.method404(0, true, true)
        ...
        if (TimedTileQueueEntry.aClass56_9660 == Class56.aClass56_1042) {
            ...
            SpriteRgbTextureNode.aClass45_10426 = null
