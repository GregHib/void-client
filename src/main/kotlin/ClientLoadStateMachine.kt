...
object ClientLoadStateMachine {
    ...
    fun method1278(i: Int): Int {
        ...
        if (TimedTileQueueEntry.aConnectionStateType_9660 == ConnectionStateType.aConnectionStateType_1035) {
            ...
            CircleHitbox.aMapSceneCache_413 = MapSceneCache(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aJs5Archive_1541)
