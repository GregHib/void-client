...
object ClientLoadStateMachine {
    ...
    fun method1278(i: Int): Int {
        ...
        if (TimedTileQueueEntry.aClass56_9660 == Class56.aClass56_1026) LoadingScreenImageNode.method3178(SoftwareSpriteRaster.aJs5Archive_1627, -81, method184(1084489728), ScrollTexMaterialPass.aJs5Archive_6277)
        ...
        if (TimedTileQueueEntry.aClass56_9660 == Class56.aClass56_1030) {
            ...
            Class95.aJs5Archive_1541 = WorldMapTextLabel.method3571(false, 2, (-23).toByte(), 1)
            ...
            Class82.aJs5Archive_1434 = WorldMapTextLabel.method3571(false, 25, (-23).toByte(), 1)
        ...
        if (Class56.aClass56_1033 == TimedTileQueueEntry.aClass56_9660) method323(Crc64Hashable.aJs5Archive_4984, VorbisOggDecoder.aPrivilegedOperationWorker_8992, 95.toByte())
        ...
        if (TimedTileQueueEntry.aClass56_9660 == Class56.aClass56_1035) {
            ...
            Exception_Sub1.aModelHeaderCache_112 = ModelHeaderCache(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, true, ProjectionCameraTransform.aEmoteDefCache_5764, SpotAnimVector.aJs5Archive_2306, RasterSprite.aJs5Archive_5207)
            TheoraVideoStream.aLocTypeDefLoader_9036 = LocTypeDefLoader(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aJs5Archive_1541)
            ...
            SpriteLoadValidator.aClass65_4787 = Class65(HardCacheEntryReference.aSceneProjector_10434, AnimationFrameDefinition.anInt6967, Class95.aJs5Archive_1541)
            ...
            Class65.method699(SoftwareSpriteRaster.aJs5Archive_1627, (-100).toByte(), IntKeyNode.aJs5Archive_6980, CameraRotationStub.aJs5Archive_322, RasterSprite.aJs5Archive_5207)
            method85(0, NodeDeque.aJs5Archive_3323)
            ScriptResources.aTextureDefinitionCache_2639 = TextureDefinitionCache(AnimationFrameDefinition.anInt6967, ModelBatchBase.aJs5Archive_1897, Class82.aJs5Archive_1434)
            BrightnessOptionState.aCompiledScriptCache_5900 = CompiledScriptCache(AnimationFrameDefinition.anInt6967, ModelBatchBase.aJs5Archive_1897, Class82.aJs5Archive_1434, ItemNameResolver())
            method1202(0)
        ...
        if (Class56.aClass56_1038 == TimedTileQueueEntry.aClass56_9660) method752(TerrainShadowBuilderGl2.aJs5Archive_6950, RenderConfigFactory.aLocDefinitionCache_2979, Tooltip.aParticleDefLoader_4460, GradientLookupEffect.aSeqDefinitionCache_9195, TheoraVideoStream.aConfigDefinitionLoader_9031, ModelOrSpriteHolder.aTextureDefinitionLoader_117, ProjectedGroundDecor.aVarpStore_10209)
        if (Class56.aClass56_1039 == TimedTileQueueEntry.aClass56_9660) {
            ...
            Class54.anInt970 = IntKeyNode.aJs5Archive_6980!!.method417("lobbyscreen", 0)
