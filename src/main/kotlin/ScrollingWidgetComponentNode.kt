...
class ScrollingWidgetComponentNode internal constructor(class45: Class45?, class288_sub1: ParticleEmitterDefExt?) : WidgetComponentNode(class45, class288_sub1) {
    ...
    override fun method9(i: Byte, bool: Boolean) {
        anInt8379++
        val i_0_ = ((this.aParticleEmitterDef_4659!!.aScreenAnchorAlignment_4955!!.method1607(Class92.anInt1524, this.aAbstractModelRenderer_4655!!.method966(), (-117).toByte())) - -this.aParticleEmitterDef_4659!!.anInt4950)
        val i_1_ = ((this.aParticleEmitterDef_4659!!.aClass341_4952!!.method2679(OpenGlRenderer.anInt7666, this.aAbstractModelRenderer_4655!!.method980(), 1595)) + this.aParticleEmitterDef_4659!!.anInt4951)
