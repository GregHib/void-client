...
class ModelDefinitionLoader internal constructor(sceneProjector: SceneProjector?, i: Int, class45: Class45?, class45_9_: Class45?) {
    ...
    companion object {
        ...
        fun method1202(i: Int) {
            anInt2052++
            val `is` = IntArray(Exception_Sub1.aModelHeaderCache_112!!.anInt3271)
            var i_0_ = i
            var i_1_ = 0
            while (Exception_Sub1.aModelHeaderCache_112!!.anInt3271 > i_1_) {
                val class213 = Exception_Sub1.aModelHeaderCache_112!!.method1940(-104, i_1_)
