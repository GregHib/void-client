...
abstract class Renderer internal constructor(@JvmField var aRenderConfig4579: RenderConfig?) {
    ...
    companion object {
        ...
        fun method3641(i: Int, i_35_: Int, i_36_: Byte, i_37_: Int, i_38_: Int, i_39_: Int) {
            ...
            else if (WorldMapLabel.anInt4960 <= i_39_ + -i_38_ && CameraNodeList.anInt1745 >= i_39_ - -i_38_ && -i_35_ + i >= LocalPlayerState.anInt1910 && Class38.anInt513 >= i + i_35_) method515(i_37_, i_39_, i, i_35_, i_38_, -122)
