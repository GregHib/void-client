...
abstract class Renderer internal constructor(@JvmField var aRenderConfig4579: RenderConfig?) {
    ...
    companion object {
        ...
        fun method3641(i: Int, i_35_: Int, i_36_: Byte, i_37_: Int, i_38_: Int, i_39_: Int) {
            ...
            else if (Class369.anInt4960 <= i_39_ + -i_38_ && CameraNodeList.anInt1745 >= i_39_ - -i_38_ && -i_35_ + i >= LocalPlayerState.anInt1910 && Class38.anInt513 >= i + i_35_) method515(i_37_, i_39_, i, i_35_, i_38_, -122)
        ...
        fun method3692(i: Int, i_168_: Int, i_169_: Int, class45: Class45?, i_170_: Int, var_renderConfig: RenderConfig?, canvas: Canvas?, i_171_: Int): Renderer? {
            try {
                ...
                if (i_171_ == 2) return Class306.method2297(-6, i_168_, var_renderConfig, canvas, i_169_)
                if (i_171_ == 1) return Class262.method2000(3, i, canvas, var_renderConfig)
