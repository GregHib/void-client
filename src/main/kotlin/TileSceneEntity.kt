...
abstract class TileSceneEntity internal constructor(i: Int, i_4_: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int) : SceneEntity() {
    ...
    override fun method2378(i: Int): Boolean {
        ...
        anInt8721++
        return (Class99.aBooleanArrayArray1572!![(NpcActorEntity.anInt10084 + -DisplayModeOptionState.anInt6111 + (this.x shr Class362.anInt4459))]!![((this.y shr Class362.anInt4459) + -GlIndexBufferArb.anInt8502 + NpcActorEntity.anInt10084)])
    }
