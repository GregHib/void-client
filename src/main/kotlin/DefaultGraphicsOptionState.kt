    ...
    companion object {
        ...
        fun method1839(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int) {
            ...
            if (LocalPlayerState.anInt1910 <= i_1_ && Class38.anInt513 >= i_1_) {
                val i_19_ = Class85.method831(CameraNodeList.anInt1745, i + i_4_, WorldMapLabel.anInt4960, -89)
                val i_20_ = Class85.method831(CameraNodeList.anInt1745, -i_4_ + i, WorldMapLabel.anInt4960, -116)
            ...
            while (i_6_ > 0) {
                ...
                if (i_23_ >= LocalPlayerState.anInt1910 && i_22_ <= Class38.anInt513) {
                    val i_24_ = Class85.method831(CameraNodeList.anInt1745, i + i_5_, WorldMapLabel.anInt4960, 86)
                    val i_25_ = Class85.method831(CameraNodeList.anInt1745, -i_5_ + i, WorldMapLabel.anInt4960, 32)
                    ...
                    if (Class38.anInt513 >= i_23_) GlElementArrayBuffer.method1156(-27, i_24_, WidgetDefinition.anIntArrayArray255!![i_23_]!!, i_25_, i_3_)
                }
            }
        }
