...
class GroundDecorRenderer internal constructor(var_ha_Sub3: NativeRenderer) {
    ...
    private fun method2102(bool: Boolean, var_ha_Sub3: NativeRenderer, i: Int) {
        ...
        if (buffer != null) {
            ...
            if (anInterface5_Impl1_3638.method18(6331)) {
                ...
                var_ha_Sub3.method3938(VideoAdChecker.aCameraRotationStub_3181, 2 * i_20_, anInterface5_Impl2_3635, 0, 0, i_20_ * 4, 118)
            }
        }
    }
    ...
    init {
        ...
        aModelBatchBase_3637 = (var_ha_Sub3.method3812(0, (arrayOf<Class58>(Class58(arrayOf<SpriteMaskShape?>(SpriteMaskShape.aSpriteMaskShape_4073, SpriteMaskShape.aSpriteMaskShape_4076, SpriteMaskShape.aSpriteMaskShape_4078)), Class58(SpriteMaskShape.aSpriteMaskShape_4075!!)))))
