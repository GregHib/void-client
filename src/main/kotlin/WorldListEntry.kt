...
class WorldListEntry {
    ...
    companion object {
        ...
        fun method283(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int) {
            var class318_sub5 = NpcDefinition.aDoublyLinkedNodeList_2957!!.method1872(8) as Class318_Sub5?
            while (class318_sub5 != null) {
                if (class318_sub5.anInt6421 <= Class367_Sub11.anInt7396) class318_sub5.method2373(false)
                    ...
                    NodeDeque.aClass324_3326!!.method2575(122.toByte(), i_3_ - -RemoveRoofsOptionState.anIntArray6062!![0], 0xffffff.inv() or class318_sub5.anInt6415, class318_sub5.aString6416, 0, i_4_ - -RemoveRoofsOptionState.anIntArray6062!![1])
                }
                class318_sub5 = (NpcDefinition.aDoublyLinkedNodeList_2957!!.method1878(0.toByte()) as Class318_Sub5?)
            }
            anInt305++
