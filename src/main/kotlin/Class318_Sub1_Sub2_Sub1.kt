...
class Class318_Sub1_Sub2_Sub1 internal constructor(i: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int) : Class318_Sub1_Sub2(i, i_3_, i_4_, i_5_, i_6_) {
    ...
    public override fun method2393(i: Int): Int {
        ...
        val class213 = (Exception_Sub1.aModelHeaderCache_112!!.method1940(-115, this.anInt10181))
        var i_0_ = class213.anInt2784
        if (this.anInt10189 != -1) {
            val class213_1_ = (Exception_Sub1.aModelHeaderCache_112!!.method1940(74, this.anInt10189))
            if (class213_1_.anInt2784 > i_0_) i_0_ = class213_1_.anInt2784
        }
        if (this.anInt10180 != -1) {
            val class213_2_ = (Exception_Sub1.aModelHeaderCache_112!!.method1940(-88, this.anInt10180))
    ...
    public override fun method2391(var_renderer: Renderer?, i: Int, i_7_: Int, i_8_: Int): Boolean {
        anInt10188++
        val class101 = var_renderer!!.method3705()
        class101.method894(this.x, -10 + this.anInt6382, this.y)
        val class213 = (Exception_Sub1.aModelHeaderCache_112!!.method1940(i_8_ xor 0x6b, this.anInt10181))
        var class64 = class213.method1559(null, null, var_renderer, 131072, 0, this.anInt10185, 0, 88.toByte(), -1)
        if (class64 != null && (if (Class305.aBoolean3870) class64.method623(i_7_, i, class101, true, class213.anInt2784, LocalPlayerState.anInt1906) else class64.method628(i_7_, i, class101, true, class213.anInt2784))) return true
        if ((this.anInt10189.inv()) != i_8_) {
            val class213_9_ = (Exception_Sub1.aModelHeaderCache_112!!.method1940(-88, this.anInt10189))
            class64 = class213_9_.method1559(null, null, var_renderer, 131072, 0, (this.anInt10190), 0, 88.toByte(), -1)
            if (class64 != null && (if (Class305.aBoolean3870) class64.method623(i_7_, i, class101, true, class213_9_.anInt2784, LocalPlayerState.anInt1906) else class64.method628(i_7_, i, class101, true, class213_9_.anInt2784))) return true
        }
        if (this.anInt10180 != -1) {
            val class213_10_ = (Exception_Sub1.aModelHeaderCache_112!!.method1940(-99, this.anInt10180))
            class64 = class213_10_.method1559(null, null, var_renderer, 131072, 0, (this.anInt10186), 0, 88.toByte(), -1)
            return class64 != null && (if (!Class305.aBoolean3870) class64.method628(i_7_, i, class101, true, class213_10_.anInt2784) else class64.method623(i_7_, i, class101, true, class213_10_.anInt2784, LocalPlayerState.anInt1906))
        }
        return false
    }
    ...
    public override fun method2386(i: Int, var_renderer: Renderer?): Class318_Sub4 {
        ...
        anInt10184 = 0
        if (this.anInt10180 != -1) {
            val class64 = (Exception_Sub1.aModelHeaderCache_112!!.method1940(i xor 0x6c, this.anInt10180).method1559(null, null, var_renderer, 2048, 0, this.anInt10186, 0, 88.toByte(), -1))
            if (class64 != null) {
                if (Class305.aBoolean3870) class64.method608(class101, (class318_sub4.aClass318_Sub3Array6414!![2]), LocalPlayerState.anInt1906, 0)
        ...
        if (this.anInt10189 != -1) {
            val class64 = (Exception_Sub1.aModelHeaderCache_112!!.method1940(i xor 0x3b.inv(), this.anInt10189).method1559(null, null, var_renderer, 2048, 0, this.anInt10190, 0, 88.toByte(), -1))
            if (class64 != null) {
        ...
        val class64 = (Exception_Sub1.aModelHeaderCache_112!!.method1940(-48, this.anInt10181).method1559(null, null, var_renderer, 2048, 0, this.anInt10185, 0, 88.toByte(), -1))
        if (class64 != null) {
