...
class Class367_Sub7 internal constructor(private var aD3dRenderDevice_7346: D3dRenderDevice, js5Archive: Js5Archive?, private val aNormalMapGenerator_7348: NormalMapGenerator) : AbstractRenderPass(aD3dRenderDevice_7346) {
    ...
    override fun method3526(i: Int, i_0_: Int, i_1_: Int) {
        ...
        if (aBoolean7344) {
            val idirect3ddevice = aD3dRenderDevice_7346!!.anIDirect3DDevice9810
    ...
    override fun method3525(i: Int, bool: Boolean) {
        if (i == 15192) {
            ...
            if (aBoolean7347 && null != interface18_impl2) {
                val idirect3ddevice = aD3dRenderDevice_7346!!.anIDirect3DDevice9810
                aD3dRenderDevice_7346!!.method3957(anIDirect3DVertexShader7345, (-89).toByte())
                aD3dRenderDevice_7346!!.method3962(22927, anIDirect3DPixelShader7343)
    ...
    override fun method3523(i: Byte) {
        if (aBoolean7344) {
            val idirect3ddevice = aD3dRenderDevice_7346!!.anIDirect3DDevice9810
            val class101_sub2 = aD3dRenderDevice_7346!!.method3948(-22036)
    ...
    override fun method3520(i: Byte) {
        if (aBoolean7344) {
            aD3dRenderDevice_7346!!.method3957(null, (-89).toByte())
            aD3dRenderDevice_7346!!.method3962(22927, null)
            this.aHa_Sub3_4479.method3897(1, -4382)
    ...
    override fun method3531(bool: Boolean) {
        if (!bool) {
            if (aBoolean7344) {
                val idirect3ddevice = aD3dRenderDevice_7346!!.anIDirect3DDevice9810
                val class101_sub2 = aD3dRenderDevice_7346!!.method3887((-123).toByte())
                val class101_sub2_7_ = aD3dRenderDevice_7346!!.method3948(-22036)
