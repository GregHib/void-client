        ...
        fun method383(i: Int) {
            ...
            while (BackgroundWorkerThread.anInt3225 > i_3_) {
                ...
                while (ItemModelDefinition.anInt425 > i_5_) {
                    ...
                    if (LocalPlayerState.anIntArray1909!![i_6_] == GroundDecorSceneEntity.anInt9997) Class92.anInterface4Array1525!![i_6_]!!.method14(0, 0, Class58.anInt1067, Class344.anInt4267, i_5_ * Class58.anInt1067, Class344.anInt4267 * i_3_, true, true)
                    i_5_++
                }
                i_3_++
            }
