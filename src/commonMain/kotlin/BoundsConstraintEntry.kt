...
*/
class BoundsConstraintEntry internal constructor(string: String?, var anInt5167: Int) : NamedConstraint {
    ...
    companion object {
        ...
        fun method2056(i: Int, i_0_: Int, i_1_: Int): Boolean {
            ...
            if (method1087(12644, i_1_, i) or ((i and 0xb000) != 0) or NpcTypeList.Companion.method2075(i, -128, i_1_)) return true
