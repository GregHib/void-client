...
*/
class ParticleSystemState internal constructor(var_ha_Sub1: SoftwareRasterHost) {
    private val aHa_Sub1_2191: SoftwareRasterHost
    var anInt2192: Int = 0
            ...
            try {
                ...
                while (is_7_!!.size > i_9_) {
                    ...
                    while (i_11_ != 0 && i_13_ < (player!!.aLoadProgressCountersArray10308)!!.size) {
                        if ((i_11_ and 0x1) != 0) {
                            if (i_10_ != -1) {
                                val class17 = ParticleEmitterNode.aAnimationTypeList_191!!.method835(i_10_, 7)
                                ...
                                if (class182 != null) {
                                    ...
                                    } else if (class17.anInt239 >= ParticleEmitterNode.aAnimationTypeList_191!!.method835((class182.anInt2454), 7).anInt239) {
                                        player.aLoadProgressCountersArray10308!![i_13_] = null
                                        class182 = player.aLoadProgressCountersArray10308!![i_13_]
                                    }
                                }
