        ...
        fun method3120(i: Int) {
            ...
            for (i_21_ in (-(GlCubemapLightPass.anInt7319 shr 4) + i_17_) / 8..(i_17_ + (GlCubemapLightPass.anInt7319 shr 4)) / 8) {
                ...
                while ((i_22_ <= ((RangeThresholdTextureNode.Companion.anInt9109 shr 4) + i_16_) / 8)) {
                    ...
                    NativeSprite.anIntArray5192!![i_18_] = AbstractCameraTransformStatics.maps!!.method417("m" + i_21_ + "_" + i_22_, 0)
                    GameAppletFrame.anIntArray38!![i_18_] = AbstractCameraTransformStatics.maps!!.method417("l" + i_21_ + "_" + i_22_, 0)
                    LocalizedTextTriple.anIntArray3759!![i_18_] = AbstractCameraTransformStatics.maps!!.method417("um" + i_21_ + "_" + i_22_, 0)
                    RenderNodeStatics.anIntArray9724!![i_18_] = AbstractCameraTransformStatics.maps!!.method417("ul" + i_21_ + "_" + i_22_, 0)
                    i_18_++
                    i_22_++
                }
            }
