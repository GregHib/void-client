            ...
            if (ProportionalScrollbarComponent.aNodeDeque_9931!!.method1998(i) != 0) {
                if (IntHashSetStatics.aClass348_Sub51_3959!!.aClass239_Sub25_7271!!.method1829(-32350) == 0) {
                    ...
                    if (IntPair.aRenderer6968 == null) {
                        ...
                        IntPair.aRenderer6968 = SoftwareSpriteRaster.method958(true, 0, SourceRowTextureNode.aRenderConfig9113, 0, canvas, SpriteLoadValidator.shaders)
                        EdgeDetectTextureNode.aRSFont_9173 = (IntPair.aRenderer6968!!.method3686(method1819(ConnectionStateType.anInt1044, 0, -44, SoftwareSpriteRaster.aJs5Archive_1627!!), SpriteImage.method1519(CameraRotationStub.Companion.sprites!!, ConnectionStateType.anInt1044, 0), true))
                    }
                    var class348_sub7 = (ProportionalScrollbarComponent.aNodeDeque_9931!!.method1995(i + 4) as RegionTileNode?)
                    while (class348_sub7 != null) {
                        ClientException.aItemTypeList_112!!.method1932(IntPair.aRenderer6968, class348_sub7.anInt6647, class348_sub7.anInt6648, EdgeDetectTextureNode.aRSFont_9173, (if (class348_sub7.aBoolean6650) (LocalPlayerState.aPlayer_1907!!.aCompositeNpcModelBuilder_10536) else null), class348_sub7.anInt6642, false, 83.toByte(), var_renderer, class348_sub7.anInt6649, false, class348_sub7.anInt6645)
