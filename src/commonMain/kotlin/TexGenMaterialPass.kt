...
class TexGenMaterialPass internal constructor(var_ha_Sub2: OpenGlRenderer, waterTextureSet: WaterTextureSet?) : MaterialPass(var_ha_Sub2) {
    ...
    companion object {
        ...
        fun method2159(i: Byte, js5Archive: Js5Archive) {
            ...
            VarcstrTypeList.anInt1435 = js5Archive.method417("headicons_prayer", 0)
            ...
            BrightnessGraphicsOptionState.anInt5948 = js5Archive.method417("cross", 0)
            ...
            QuestTypeList.anInt2510 = js5Archive.method417("floorshadows", 0)
