...
*/
class DisplaceTextureNode : AbstractProceduralTextureNode(3, false) {
    ...
    override fun method3042(i: Int, i_0_: Int): IntArray {
        ...
        if (this.aSpriteSheetCache_7032!!.aBoolean2570) {
            ...
            for (i_3_ in 0..<PerlinNoiseTextureNode.anInt9139) {
                ...
                val i_8_ = i_3_ - -(i_6_ shr 12) and CustomCursorOptionState.anInt6076
    ...
    override fun method3047(i: Int, i_13_: Int): Array<IntArray?>? {
        ...
        if (this.aImageFrameCache_7033!!.aBoolean4035) {
            ...
            val is_18_ = `is`[2]!!
            var i_19_ = 0
            while (PerlinNoiseTextureNode.anInt9139 > i_19_) {
                ...
                val i_24_ = i_19_ + (i_22_ shr 12) and CustomCursorOptionState.anInt6076
