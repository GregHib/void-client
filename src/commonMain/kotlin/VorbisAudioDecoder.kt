...
*/
class VorbisAudioDecoder private constructor(`is`: ByteArray?) : LinkedListNode() {
    ...
    private fun method2794(i: Int): FloatArray? {
        ...
        if (bool_51_) {
            ...
            val fs_62_: FloatArray = (if (bool) VorbisAudioDecoder.Companion.aFloatArray6712 else VorbisAudioDecoder.Companion.aFloatArray6722)!!
            val fs_63_: FloatArray = (if (bool) VorbisAudioDecoder.Companion.aFloatArray6726 else VorbisAudioDecoder.Companion.aFloatArray6720)!!
            val fs_64_: FloatArray = (if (bool) VorbisAudioDecoder.Companion.aFloatArray6700 else VorbisAudioDecoder.Companion.aFloatArray6708)!!
            val `is`: IntArray = (if (bool) VorbisAudioDecoder.Companion.anIntArray6705 else VorbisAudioDecoder.Companion.anIntArray6719)!!
    ...
    companion object {
        ...
        private var aBinaryBitReaderArray6710: Array<BinaryBitReader?>? = null
        ...
        private fun method2790(`is`: ByteArray?) {
            ...
            for (i in 0..1) {
                ...
                for (i_22_ in 0..<i_14_) is_20_[i_22_] = SkyBoxTypeList.method818(i_21_, 0, i_22_)
                if (i == 0) {
                    aFloatArray6722 = fs
