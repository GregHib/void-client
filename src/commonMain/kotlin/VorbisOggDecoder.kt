...
class VorbisOggDecoder internal constructor(oggstreamstate: OggStreamState) : OggBitstreamDecoder(oggstreamstate) {
    ...
    private var aAudioResampler_8994: AudioResampler? = null
    private var aClass348_Sub16_Sub2_8995: PcmStreamBuffer? = null
    ...
    fun method2971(i: Int): PcmStreamBuffer? {
        if (i > -6) return null
        anInt8997++
    ...
    fun method2973(i: Byte): Double {
        ...
        return -(256.0f / FloorUnderlayType.anInt339.toFloat()).toDouble() + d
    }
    ...
    override fun method2964(i: Byte, oggpacket: OggPacket) {
        ...
        if (this.anInt6868 < 3) {
            ...
            if (this.anInt6868 == 2) {
                ...
                aAudioResampler_8994 = AudioResampler(aVorbisInfo9006.rate, FloorUnderlayType.anInt339)
            ...
            for (i_8_ in 0..<aVorbisInfo9006.channels) class348_sub42_sub4.aShortArrayArray9518[i_8_] = aAudioResampler_8994!!.method1268(-56, (class348_sub42_sub4.aShortArrayArray9518[i_8_]!!))
    ...
    companion object {
        ...
        fun method2972(string: String?, i: Int, i_3_: Int): Boolean {
            ...
            val string_6_ = ("http://" + string + string_4_ + "/l=" + ChatCommandProcessor.language + "/a=" + SocketStreamWorker.anInt2670 + string_5_ + "/j" + (if (!RegionSceneLoader.aBoolean3697) "0" else "1") + ",o" + (if (Client.aBoolean6997) "1" else "0") + ",a2")
            try {
