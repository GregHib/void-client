    ...
    companion object {
        ...
        fun method1770(i: Byte): Int {
            ...
            if (FixedFunctionWaterPass.anInt7365 == 1) {
                ...
                SlotBinding.aSlotBinding_3396!!.method2025(MapArchiveSource(FixedFunctionWaterPass.defaults!!), false)
                ...
                SlotBinding.aSlotBinding_3408!!.method2025(MapArchiveSource(SpriteLoadValidator.shaders!!), false)
                SlotBinding.aSlotBinding_3409!!.method2025(MapArchiveSource(KeyEventNode.textureMaterials!!), false)
                SlotBinding.aSlotBinding_3410!!.method2025(MapArchiveSource(DirectionUtil.config!!), false)
                SlotBinding.aSlotBinding_3411!!.method2025(MapArchiveSource(AnimationFrameState.objects!!), false)
                SlotBinding.aSlotBinding_3412!!.method2025(MapArchiveSource(VideoAdChecker.enums!!), false)
                SlotBinding.aSlotBinding_3413!!.method2025(MapArchiveSource(FloatGrid.npcs!!), false)
                SlotBinding.aSlotBinding_3414!!.method2025(MapArchiveSource(ScriptOpcodeHolder.items!!), false)
                SlotBinding.aSlotBinding_3415!!.method2025(MapArchiveSource(OpenGlRenderNode.animations!!), false)
                ...
                SlotBinding.aSlotBinding_3423!!.method2025(MapArchiveSource(ClientLoadStateMachine.interfaces!!), false)
                SlotBinding.aSlotBinding_3424!!.method2025(MapArchiveSource(CameraNodeList.clientScripts!!), false)
                SlotBinding.aSlotBinding_3425!!.method2025(MapArchiveSource(SoftwareSpriteRaster.aJs5Archive_1627!!), false)
                SlotBinding.aSlotBinding_3426!!.method2025(SpriteLoadValidator((TerrainShadowBuilderGl2.worldMap), "details"), false)
            ...
            if (bool) {
                ...
                if (!(SlotBinding.aSlotBinding_3407!!.method2027(i.toInt() xor 0x64.inv()) as ConfigVarProgress).method2313(103)) SkyboxSphereType.aBoolean510 = NpcType.aClient1367!!.method100(i.toInt() xor 0x12.inv())
