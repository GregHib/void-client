...
class SpriteComponent internal constructor(js5Archive: Js5Archive?, js5Archive_4_: Js5Archive, class369_sub1: WorldMapAreaLabel?) : WorldMapElement(js5Archive, js5Archive_4_, class369_sub1) {
    ...
    companion object {
        ...
        fun method199(i: Int): CameraSplineNode? {
            ...
            val class42 = MapRegionLoader.aWorldMapInfoTypeList_1238!!.method1225(class348_sub21.anInt6847, 50.toByte())
            if (i != 1) anInt8370 = -75
                        ...
                        while (i_6_ > i_7_) {
                            ...
                            if (player != null && (LocalPlayerState.aPlayer_1907 != player) && (player.aString10544 != null) && player.aString10544.equals(string, ignoreCase = true)) {
                                ...
                                if (i == 1) {
                                    ...
                                    val class348_sub47 = (method2148(RsaVarbitHandler.aFontMetaRef_4905, TheoraVideoStream.aIsaacCipher_9029, -88))
                                    ...
                                    FloatGrid.anInt4979++
                                    val class348_sub47 = (method2148(ParticleEmitterListNode.aFontMetaRef_9684, TheoraVideoStream.aIsaacCipher_9029, -83))
                                    ...
                                    val class348_sub47 = (method2148(ProceduralTextureGraph.aFontMetaRef_9533, TheoraVideoStream.aIsaacCipher_9029, -116))
        ...
        fun method3479(i: Int): CameraSplineNode? {
            ...
            while (class348_sub21 != null) {
                val class42 = MapRegionLoader.aWorldMapInfoTypeList_1238!!.method1225(class348_sub21.anInt6847, 92.toByte())
