...
import GfxType.Companion.method3561
...
class ParticleDetailOptionState : GraphicsOptionState {
    ...
    companion object {
        ...
        fun method1795(`is`: ByteArray, bool: Boolean): String {
            anInt6026++
            return ByteBuffer.method3546(`is`, 0, `is`.size, 0)
        }
        ...
        fun method1797(i: Int, i_11_: Int, widgetComponent: WidgetComponent, i_12_: Byte) {
            if (RenderNodeStatics.aBoolean9722) {
                ...
                if (Client.method105(widgetComponent)!!.method3303(1) && (SkyboxSphereType.anInt500 and 0x20) != 0 && (class254 == null || (widgetComponent.method428(class254.anInt3256, ParticleEmitterFactoryStatics.anInt3176, -128) != class254.anInt3256))) {
                    HitsplatType.anInt436++
            ...
            for (i_14_ in 4 downTo 0) {
                ...
                if (string_15_ != null) {
                    MinimapPolygonDrawer.method466(false, widgetComponent.aString752, widgetComponent.anInt830, (-67).toByte(), false, widgetComponent.anInt704, widgetComponent.anInt812, true, 18, ((widgetComponent.anInt704 shl 0) or widgetComponent.anInt830).toLong(), string_15_, (1 + i_14_).toLong(), MinimapRenderer.method888(57.toByte(), i_14_, widgetComponent))
                    TimingCounters.anInt4169++
                }
            }
            if (Client.method105(widgetComponent)!!.method3305(0)) {
                ...
                else MinimapPolygonDrawer.method466(false, "", widgetComponent.anInt830, (-79).toByte(), false, widgetComponent.anInt704, widgetComponent.anInt812, true, 16, (widgetComponent.anInt704 shl 0 or widgetComponent.anInt830).toLong(), LocalizedText.aLocalizedText_3492!!.method2063(ChatCommandProcessor.language, 544), 0L, -1)
