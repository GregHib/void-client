                ...
                if (modelDefinition!!.aByteArray1820 != null) {
                    ...
                    while (i_4_ > i_20_) {
                        ...
                        if (i_21_ > 0) {
                            ...
                            fs[i_20_] = (SizeBoundedSoftCache.method1347(modelDefinition.aShortArray1825[i_20_].toInt(), modelDefinition.aShortArray1849[i_20_].toInt(), f_22_, f_23_, 126, f, modelDefinition.aShortArray1829[i_20_].toInt(), WhirlpoolHash.method1166(255, (modelDefinition.aByteArray1833[i_20_]).toInt())))
                        }
                        i_20_++
                    }
                }
