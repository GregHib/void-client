...
class NormalMapGenerator internal constructor(private val aHa_Sub3_3457: NativeRenderer) {
    ...
    fun method2041(i: Byte): Boolean {
        ...
        if (this.anInterface18_Impl1_3455 == null) {
            if (NodeDequeStatics.anObject3331 == null) {
                ...
                NodeDequeStatics.anObject3331 = Js5Archive.method1357(`is`, false, 87.toByte())
            }
    ...
    init {
        ...
        if (this.aBoolean3458 || aHa_Sub3_3457.method3880(MovementDirection.aMovementDirection_1183, aTextureFormatInfo_2571, 123.toByte())) {
            ...
            if (this.aBoolean3458) {
                var `is` = method461(false, QuickChatMenuTypeList.anObject4366, 53146732)
                ...
                for (i in 0..15) {
                    val `is` = method1331(100.toByte(), QuickChatMenuTypeList.anObject4366, 128 * (i * 128 * 2), 32768)
