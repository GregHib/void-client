/* Class101_Sub1 - moved to commonMain; companion jvm fields extracted to Class101_Sub1Statics */
class Class101_Sub1 : Class101() {
    ...
    override fun method903(i: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int) {
        anInt5682++
        val f = TrigTables.cos[i_4_ and 0x3fff]
        val f_7_ = TrigTables.sin[0x3fff and i_4_]
        val f_8_ = TrigTables.cos[i_5_ and 0x3fff]
        val f_9_ = TrigTables.sin[0x3fff and i_5_]
        val f_10_ = TrigTables.cos[0x3fff and i_6_]
        val f_11_ = TrigTables.sin[0x3fff and i_6_]
    ...
    override fun method908(i: Int) {
        anInt5656++
        val f = TrigTables.cos[i and 0x3fff]
        val f_19_ = TrigTables.sin[i and 0x3fff]
    ...
    override fun method900(i: Int) {
        anInt5658++
        val f = TrigTables.cos[0x3fff and i]
        val f_24_ = TrigTables.sin[0x3fff and i]
    ...
    override fun method899(i: Int) {
        ...
        this.aFloat5664 = TrigTables.cos[i and 0x3fff]
        this.aFloat5678 = this.aFloat5664
        this.aFloat5680 = TrigTables.sin[0x3fff and i]
    ...
    override fun method902(i: Int) {
        anInt5667++
        this.aFloat5664 = 1.0f
        this.aFloat5678 = TrigTables.cos[0x3fff and i]
        this.aFloat5672 = this.aFloat5678
        this.aFloat5655 = TrigTables.sin[0x3fff and i]
        this.aFloat5681 = 0.0f
    ...
    override fun method895(i: Int) {
        ...
        anInt5676++
        this.aFloat5664 = TrigTables.cos[0x3fff and i]
        this.aFloat5672 = this.aFloat5664
        this.aFloat5669 = TrigTables.sin[i and 0x3fff]
        this.aFloat5681 = 0.0f
        this.aFloat5680 = this.aFloat5681
    ...
    override fun method896(i: Int) {
        anInt5659++
        val f = TrigTables.cos[0x3fff and i]
        val f_32_ = TrigTables.sin[i and 0x3fff]
