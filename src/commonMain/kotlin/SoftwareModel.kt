...
class SoftwareModel : AbstractModel {
    ...
    private var aIdentKitRecolorArray5361: Array<IdentKitRecolor?>? = null
    ...
    private fun method633(class64_sub1_7_: SoftwareModel, class64_sub1_8_: SoftwareModel, i: Int, bool: Boolean, bool_9_: Boolean): AbstractModel {
        ...
        class64_sub1_7_.aIdentKitRecolorArray5361 = aIdentKitRecolorArray5361
    ...
    public override fun method605(i: Int, `is`: IntArray, i_44_: Int, i_45_: Int, i_46_: Int, i_47_: Int, bool: Boolean) {
        ...
        if (i == 0) {
            ...
            if (anIntArrayArray5330 != null && aByteArray5325 != null) {
                ...
                if (aIdentKitRecolorArray5361 != null) {
                    for (i_98_ in 0..<anInt5389) {
                        val class6 = aIdentKitRecolorArray5361!![i_98_]!!
            ...
            if (anIntArrayArray5330 != null && aByteArray5325 != null) {
                ...
                if (aIdentKitRecolorArray5361 != null) {
                    for (i_260_ in 0..<anInt5389) {
                        val class6 = aIdentKitRecolorArray5361!![i_260_]!!
        ...
        for (i in 0..<anInt5351) {
            ...
            if (i_287_.toInt() == -1) {
                ...
                if (anIntArray5366!![i] == -1) {
                    ...
                    anIntArray5368!![i] = i_291_ or SoftwareTerrainTile.method2198(0, i_291_ shr 17, i_290_.toInt())
                } else if (anIntArray5366!![i] != -2) {
                    var i_292_ = anIntArray5368!![i] and 0x1ffff.inv()
                    anIntArray5368!![i] = i_292_ or SoftwareTerrainTile.method2198(0, i_292_ shr 17, i_290_.toInt())
                    i_292_ = anIntArray5337!![i] and 0x1ffff.inv()
                    anIntArray5337!![i] = i_292_ or SoftwareTerrainTile.method2198(0, i_292_ shr 17, i_290_.toInt())
                    i_292_ = anIntArray5366!![i] and 0x1ffff.inv()
                    anIntArray5366!![i] = i_292_ or SoftwareTerrainTile.method2198(0, i_292_ shr 17, i_290_.toInt())
                }
            }
        }
        anInt5354 = 2
        ...
        if (anIntArray5366!![i] != -2) {
            ...
            if (bool && (i_321_ == -5000 || i_322_ == -5000 || i_323_ == -5000)) {
                ...
                if (bool_317_) {
                    ...
                    if (i_336_ == -1 || !aIdentKitRecolorArray5361!![i_336_]!!.aBoolean145) method658(i)
                } else {
                    val i_337_ = anIntArray5400!![i]
                    if (i_337_ != -1) {
                        val class6 = aIdentKitRecolorArray5361!![i_337_]!!
        ...
        if (i == 0) {
            ...
            if (aIdentKitRecolorArray5361 != null) {
                for (i_357_ in 0..<anInt5389) {
                    val class6 = aIdentKitRecolorArray5361!![i_357_]!!
    ...
    private fun method650(bool: Boolean, bool_616_: Boolean, i: Int, i_617_: Int) {
        if (aIdentKitRecolorArray5361 != null) {
            for (i_618_ in 0..<anInt5389) {
                val class6 = aIdentKitRecolorArray5361!![i_618_]!!
                ...
                if (i == -1) {
                    ...
                    if (aIdentKitRecolorArray5361 != null) {
                        for (i_669_ in 0..<anInt5389) {
                            val class6 = aIdentKitRecolorArray5361!![i_669_]!!
                    ...
                    if (aIdentKitRecolorArray5361 != null) {
                        for (i_686_ in 0..<anInt5389) {
                            val class6 = aIdentKitRecolorArray5361!![i_686_]!!
            ...
            for (i_739_ in 0..<anInt5351) {
                ...
                if (i_742_.toInt() == -1) {
                    if (i_740_.toInt() == 0) {
                        ...
                        anIntArray5368!![i_739_] = i_748_ shl 17 or SoftwareTerrainTile.method2198(0, i_748_, i_745_.toInt())
                        ...
                        anIntArray5337!![i_739_] = i_748_ shl 17 or SoftwareTerrainTile.method2198(0, i_748_, i_745_.toInt())
                        ...
                        i_747_ = if (i_746_ > 256) i_737_ else i_738_
                        i_748_ = (i_736_ shr 1) + (i_747_ * i_746_ shr 17)
                        anIntArray5366!![i_739_] = i_748_ shl 17 or SoftwareTerrainTile.method2198(0, i_748_, i_745_.toInt())
                        ...
                        anIntArray5368!![i_739_] = i_754_ shl 17 or SoftwareTerrainTile.method2198(0, i_754_, i_751_.toInt())
    ...
    internal constructor(var_ha_Sub1: SoftwareRenderer, modelDefinition: ModelDefinition, i: Int, i_785_: Int, i_786_: Int, i_787_: Int) {
        ...
        if (modelDefinition.aRectangleBoundsArray1832 != null) {
            ...
            aIdentKitRecolorArray5361 = arrayOfNulls<IdentKitRecolor>(anInt5389)
