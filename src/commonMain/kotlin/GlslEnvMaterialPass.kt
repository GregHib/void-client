    ...
    init {
        do {
            try {
                ...
                throw TextureLoadException.method2929(runtimeexception, ("tia.<init>(" + (if (var_ha_Sub2 != null) "{...}" else "null") + ',' + (if (waterTextureSet != null) "{...}" else "null") + ')'))
            }
            break
        } while (false)
    }
        ...
        fun method2163(bool: Boolean): Boolean {
            ...
            try {
                if (SpriteDefinition.anInt7068 == 2) {
                    ...
                    if (MapSceneTypeList.aSpriteArchiveLoader_1977 == null) MapSceneTypeList.aSpriteArchiveLoader_1977 = SpriteArchiveLoader(MinimapTileEntry.aJs5Archive_611, MapElementLookup.aJs5Archive_4147)
                    ...
                    if (class348_sub16_sub3.method2866((MaterialPass.Companion.aClass348_Sub2_3683), 22050, MapSceneTypeList.aSpriteArchiveLoader_1977, GlEnvMappedWaterPass.aJs5Archive_7371, -35)) {
                        ...
                        MapSceneTypeList.aSpriteArchiveLoader_1977 = null
