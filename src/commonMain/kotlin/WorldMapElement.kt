...
abstract class WorldMapElement(js5Archive: Js5Archive?, js5Archive_15_: Js5Archive, worldMapLabel: WorldMapLabel?) : Lifecycle {
    ...
    override fun method7(i: Int) {
        anInt4639++
        if (i == 10286) {
            val class143 = BrightnessGraphicsOptionState.method1766((-85).toByte(), (this.aWorldMapLabel_4635!!.anInt4965), aJs5Archive_4631)
    ...
    companion object {
        ...
        @JvmStatic
        fun method180(i: Int) {
            ModelFacePriorityNode.aLruByteCache_4636 = null
