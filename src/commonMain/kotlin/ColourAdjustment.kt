        ...
        fun method449(string: String?, string_1_: String?, bool: Boolean, i: Int, bool_2_: Boolean) {
            do {
                try {
                    ...
                    class348_sub47.aClass348_Sub49_Sub2_7116!!.writeByte(bool, ChatCommandProcessor.language)
                    class348_sub47.aClass348_Sub49_Sub2_7116!!.writeByte(bool, (Client.mode!!.anInt2987))
