                ...
                if (MapRegionLoader.aClass348_Sub42_Sub14_1243 != null) {
                    ...
                    if (LinkedListNodeStatics.anInt4290 == 10) {
                        ...
                        if (SceneNodeDeque.aBoolean1500 || i_7_ < 0 || MapRegionLoader.anInt1259 <= i_7_ || i_8_ < 0 || MapRegionLoader.anInt1267 <= i_8_) {
                            if (SceneryShadowsOptionState.anInt5909 == -1 || MapRegionLoaderThread.anInt4202 == -1) {
                                ...
                                MapRegionLoader.aClass348_Sub42_Sub14_1243!!.method3242(`is`, 88, MapRegionLoaderThread.anInt4202, SceneryShadowsOptionState.anInt5909)
                                MapRegionLoaderThread.anInt4202 = -1
                                SceneryShadowsOptionState.anInt5909 = MapRegionLoaderThread.anInt4202
                                if (`is` != null) {
                        ...
                        MapRegionLoader.aWorldMapInfoTypeList_1238!!.method1220(73.toByte(), 256, 1024)
                        MapRegionLoader.aMapSceneTypeList_1242!!.method1178(256, 1, 256)
                        MapRegionLoader.aObjectTypeList_1245!!.method2014(4096, true)
                        RenderConfigFactory.aVarbitTypeList_2981!!.method1444(256, 123)
