...
class FogOptionState : GraphicsOptionState {
    ...
    companion object {
                ...
                try {
                    ...
                    if ((player!!.anIntArray10236) != null) {
                        ...
                        if (bool && player.anInt10286 != -1) {
                            val class17 = (ParticleEmitterNode.aAnimationTypeList_191!!.method835(player.anInt10286, 7))
                    ...
                    while (`is`!!.size > i_11_) {
                        ...
                        if (player.anIntArray10236 == null || (player.anIntArray10236!![i_11_]) == -1 || (ParticleEmitterNode.aAnimationTypeList_191!!.method835((player.anIntArray10236!![i_11_]), 7).anInt239 <= (ParticleEmitterNode.aAnimationTypeList_191!!.method835(`is`[i_11_], i xor 0x5d8d).anInt239))) {
                            player.anInt10218 = i_8_
        ...
        fun method1792(i: Int, i_12_: Int, i_13_: Int, i_14_: Int, i_15_: Byte, i_16_: Int) {
            anInt6013++
            val i_17_ = WhirlpoolHash.method831(SkyboxSphereType.anInt513, i, LocalPlayerState.anInt1910, -90)
            val i_18_ = WhirlpoolHash.method831(SkyboxSphereType.anInt513, i_13_, LocalPlayerState.anInt1910, -94)
            ...
            for (i_22_ in i_17_..i_18_) GlElementArrayBuffer.method1156(-27, i_20_, AnimationType.anIntArrayArray255!![i_22_]!!, i_19_, i_16_)
        }
    }
}
