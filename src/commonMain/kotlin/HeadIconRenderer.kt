    ...
    companion object {
        ...
        fun method1212(i: Int, i_13_: Int, i_14_: Int, i_15_: Int) {
            ...
            if (i_14_ == i_13_ && !RgbColorPalette.aBoolean1236) method960(1)
                ...
                method368(i, 18002, false, i_13_, CachedRgbNoiseTexture.music, 0, i_15_)
                method3093(93)
            }
        ...
        fun method368(i: Int, i_0_: Int, bool: Boolean, i_1_: Int, js5Archive: Js5Archive?, i_2_: Int, i_3_: Int) {
            ...
            if (i_3_ > 0) {
                ...
                RemoveRoofLightingDetailOptionState.anInt5994 = (NodeDequeHolder.aClass348_Sub16_Sub3_1564!!.method2844(103.toByte()) / i_3_)
                if (RemoveRoofLightingDetailOptionState.anInt5994 < 1) RemoveRoofLightingDetailOptionState.anInt5994 = 1
