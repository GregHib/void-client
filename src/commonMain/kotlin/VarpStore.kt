...
class VarpStore : VarResolver {
    ...
    companion object {
        ...
        fun method1308(i: Int, i_14_: Int, i_15_: Int, i_16_: Int, i_17_: Byte, i_18_: Int, i_19_: Int, i_20_: Int) {
            anInt5072++
            if (WorldMapLabel.anInt4960 <= i_15_ && i_19_ <= CameraNodeList.anInt1745 && i_14_ >= LocalPlayerState.anInt1910 && SkyboxSphereType.anInt513 >= i_20_) method1730(i_16_, i_20_, i_14_, i_19_, i, i_18_, -128, i_15_)
