...
object AbstractCameraTransformStatics {
    ...
    fun method909(i: Int) {
        ...
        if (HslAdjustTextureNode.aBoolean9403 && i == 3553) {
            while (GameDisplayManager.anInt2834 < StructTypeList.aClass110_Sub1Array1146!!.size) {
                val class110_sub1 = StructTypeList.aClass110_Sub1Array1146!![GameDisplayManager.anInt2834]
