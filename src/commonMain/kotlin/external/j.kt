...
* NativeCamera
*/
expect class j : AbstractModelRenderer, Disposable {
    var nativeid: Long

    fun R(l: Long, bool: Boolean)

    fun P(l: Long, i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int)

    public override fun method964(i: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int)

    fun RA(l: Long, i: Int, i_10_: Int, i_11_: Int, i_12_: Int, i_13_: Int, i_14_: Int, i_15_: Int, i_16_: Int)

    fun UA(l: Long, f: Float, f_17_: Float, f_18_: Float, f_19_: Float, f_20_: Float, f_21_: Float, i: Int, l_22_: Long, i_23_: Int, i_24_: Int)
    ...
    fun EA(var_oa: oa?, i: Int, i_28_: Int)

    public override fun method985(i: Int, i_29_: Int, i_30_: Int, i_31_: Int)

    fun ma(var_oa: oa?, `is`: IntArray?, is_32_: ByteArray?, is_33_: ByteArray?, i: Int, i_34_: Int, i_35_: Int, i_36_: Int)
    ...
    fun CA(l: Long, `is`: IntArray?)

    fun W(l: Long, i: Int, i_46_: Int, i_47_: Int, i_48_: Int, i_49_: Int)
    ...
    fun b(l: Long, f: Float, f_58_: Float, f_59_: Float, f_60_: Float, f_61_: Float, f_62_: Float, i: Int, i_63_: Int, i_64_: Int, i_65_: Int)

    constructor(var_oa: oa?, `is`: IntArray?, i: Int, i_66_: Int, i_67_: Int, i_68_: Int, bool: Boolean)

    fun A(l: Long, i: Int, i_69_: Int, i_70_: Int, i_71_: Int)

    fun V(l: Long, i: Int, i_72_: Int, l_73_: Long, i_74_: Int, i_75_: Int)

    constructor(var_oa: oa?, `is`: IntArray?, is_76_: ByteArray?, is_77_: ByteArray?, i: Int, i_78_: Int, i_79_: Int, i_80_: Int)

    fun N(l: Long, i: Int, i_81_: Int, i_82_: Int)

    fun YA(l: Long, i: Int, i_83_: Int, i_84_: Int, i_85_: Int, i_86_: Int, i_87_: Int)
    ...
    fun ua(var_oa: oa?, `is`: IntArray?, i: Int, i_91_: Int, i_92_: Int, i_93_: Int, bool: Boolean)

    public override fun method979(i: Int, i_94_: Int, i_95_: Int, i_96_: Int, i_97_: Int, i_98_: Int)

    fun h(var_oa: oa?, i: Int, i_99_: Int, i_100_: Int, i_101_: Int, bool: Boolean)
