object Config {
    ...
    // Dev auto-login: when both are non-empty the client logs in unattended as soon as the
    // title screen is up (see DevAutoLogin). Leave empty for normal manual login.
