...
class WidgetDefinition {
    ...
    var aAnimationTypeList_251: AnimationTypeList? = null
    ...
    fun method263(i: Int, i_0_: Int, i_1_: Int, bool: Boolean): Int {
        ...
        val class348_sub42_sub17_5_ = this.aAnimationTypeList_251!!.method839(i_4_ shr 16, 3)
        ...
        if ((this.aBoolean241 || ItemNameResolver.aBoolean5002) && i != -1 && i < this.anIntArray237.size) {
            ...
            class348_sub42_sub17 = this.aAnimationTypeList_251!!.method839(i_3_ shr 16, 3)
        ...
        if (anIntArray260 != null && bool) {
            if (anIntArray260!!.size > i_1_) {
                ...
                if (i_6_ != 65535) {
                    val class348_sub42_sub17_7_ = this.aAnimationTypeList_251!!.method839(i_6_ shr 16, 3)
            ...
            if ((this.aBoolean241 || ItemNameResolver.aBoolean5002) && i != -1 && anIntArray260!!.size > i) {
                ...
                if (i_8_ != 65535) {
                    val class348_sub42_sub17_9_ = this.aAnimationTypeList_251!!.method839(i_8_ shr 16, 3)
    ...
    fun method266(abstractModel: AbstractModel, i: Int, i_27_: Int, i_28_: Byte, i_29_: Int, i_30_: Int, i_31_: Int, i_32_: Int): AbstractModel? {
        ...
        val class348_sub42_sub17 = this.aAnimationTypeList_251!!.method839(i_29_ shr 16, 3)
        ...
        if ((this.aBoolean241 || ItemNameResolver.aBoolean5002) && i_27_ != -1 && this.anIntArray237.size > i_27_) {
            ...
            class348_sub42_sub17_34_ = this.aAnimationTypeList_251!!.method839(i_27_ shr 16, 3)
    ...
    fun method269(i: Int, abstractModel: AbstractModel, i_50_: Int, i_51_: Int, i_52_: Int, i_53_: Int): AbstractModel? {
        ...
        val class348_sub42_sub17 = this.aAnimationTypeList_251!!.method839(i_55_ shr 16, 3)
        ...
        if ((this.aBoolean241 || ItemNameResolver.aBoolean5002) && i_50_ != -1 && this.anIntArray237.size > i_50_) {
            ...
            class348_sub42_sub17_56_ = this.aAnimationTypeList_251!!.method839(i_50_ shr 16, 3)
        ...
        if (anIntArray260 != null) {
            if (anIntArray260!!.size > i_53_) {
                ...
                if (i_59_ != 65535) {
                    class348_sub42_sub17_57_ = this.aAnimationTypeList_251!!.method839(i_59_ shr 16, 3)
            ...
            if ((this.aBoolean241 || ItemNameResolver.aBoolean5002) && i_50_ != -1 && i_50_ < anIntArray260!!.size) {
                ...
                if (i_60_ != 65535) {
                    class348_sub42_sub17_58_ = this.aAnimationTypeList_251!!.method839(i_60_ shr 16, 3)
    ...
    companion object {
        ...
        fun method265(bool: Boolean) {
            anIntArray256 = null
            InboundPacketHeader.aInboundPacketHeader_250 = null
