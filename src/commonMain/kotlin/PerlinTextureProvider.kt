...
class PerlinTextureProvider internal constructor(i: Int) : TextureGenerator() {
    ...
    override fun method1398(i: Int, i_0_: Int, f: Float, f_1_: Float, i_2_: Int, f_3_: Float, i_4_: Int, f_5_: Float, i_6_: Int, i_7_: Int, fs: FloatArray) {
        ...
        val f_16_ = PerlinTextureProvider.method2684(6, f_14_)
        ...
        while (i_0_ > i_19_) {
            ...
            val f_25_ = PerlinTextureProvider.method2684(i_4_ xor 0x7, f_23_)
            ...
            for (i_30_ in 0..<i_6_) {
                ...
                val f_36_ = PerlinTextureProvider.method2684(i_4_ xor 0x7, f_34_)
    ...
    companion object {
        ...
        fun method1401(var_ha_Sub2: OpenGlRenderer, i: Int, i_37_: Int, i_38_: Int, i_39_: Int, i_40_: Int): GlTexture2DRegion {
            ...
            if (var_ha_Sub2.aBoolean7793 || ModelDefinition.method1436(-20, i_38_) && ModelDefinition.method1436(-119, i_40_)) return GlTexture2DRegion(var_ha_Sub2, 3553, i, i_39_, i_38_, i_40_, true)
            if (!var_ha_Sub2.aBoolean7837) return GlTexture2DRegion(var_ha_Sub2, i, i_39_, i_38_, i_40_, EnumTypeList.method340(i_38_, 108.toByte()), EnumTypeList.method340(i_40_, 108.toByte()), true)
        ...
        fun method1402(i: Int) {
            if (i == 1) {
                SpotAnimDefCache.aLruByteCache_8732!!.method590(0)
                anInt5811++
            }
        }
        ...
        fun method1403(i: Int, i_45_: Int, `is`: ByteArray, bool: Boolean, i_46_: Int, i_47_: Int, i_48_: Int) {
            ...
            var i_45_ = i_45_
            anInt5806++
            require(!(i_45_ > 0 && !ModelDefinition.method1436(69, i_45_))) { "" }
            require(!(i > 0 && !ModelDefinition.method1436(100, i))) { "" }
            val i_49_ = FloorUnderlayTypeList.method1382(i_46_, -6409)
            var i_50_ = 0
