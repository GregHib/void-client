...
*/
class WeaveTextureNode : AbstractProceduralTextureNode(0, true) {
    ...
    override fun method3042(i: Int, i_0_: Int): IntArray {
        ...
        if (this.aSpriteSheetCache_7032!!.aBoolean2570) {
            val i_1_ = -2048 + PerlinNoiseTextureNode.anIntArray6035!![i]
            var i_2_ = 0
            while ((i_2_ < PerlinNoiseTextureNode.Companion.anInt9139)) {
                val i_3_ = -2048 + PerlinNoiseTextureNode.anIntArray6432!![i_2_]
    ...
    companion object {
        ...
        fun method3107(i: Byte, renderTarget: RenderTarget, i_15_: Int, i_16_: Int): Long {
            ...
            val objectType: ObjectType = GradientLookupEffect.Companion.aObjectTypeList_9195!!.method2005(0, renderTarget.method42(-107))
            ...
            if (objectType.anInt874 == 0) l_18_ = l_18_ or l_17_
            if (objectType.anInt895 == 1) l_18_ = l_18_ or l
