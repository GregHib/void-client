...
class DefaultGraphicsOptionState : GraphicsOptionState {
    ...
    companion object {
        ...
        fun method1839(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int) {
            ...
            if (LocalPlayerState.anInt1910 <= i_1_ && SkyboxSphereType.anInt513 >= i_1_) {
                ...
                GlElementArrayBuffer.method1156(-27, i_19_, AnimationType.anIntArrayArray255!![i_1_]!!, i_20_, i_3_)
            }
            ...
            while (i_6_ > 0) {
                ...
                val i_22_ = i_1_ + -i_6_
                val i_23_ = i_6_ + i_1_
                if (i_23_ >= LocalPlayerState.anInt1910 && i_22_ <= SkyboxSphereType.anInt513) {
                    ...
                    if (LocalPlayerState.anInt1910 <= i_22_) GlElementArrayBuffer.method1156(i_2_ + -26, i_24_, AnimationType.anIntArrayArray255!![i_22_]!!, i_25_, i_3_)
                    if (SkyboxSphereType.anInt513 >= i_23_) GlElementArrayBuffer.method1156(-27, i_24_, AnimationType.anIntArrayArray255!![i_23_]!!, i_25_, i_3_)
                }
            }
        }
