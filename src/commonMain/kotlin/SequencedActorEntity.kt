...
*/
class SequencedActorEntity internal constructor(var_renderer: Renderer?, objectType: ObjectType?, i: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int, bool: Boolean, i_9_: Int, i_10_: Int, i_11_: Int) : ActorEntity(i_6_, i_7_, i_8_, i, i_5_, method868(i_9_, i_10_, false)), RenderTarget {
    ...
    override fun method39(i: Int): Int {
        anInt10105++
        val i_0_ = -66 / ((-91 - i) / 35)
        return (this.aSceneObjectAnimator_10115!!.anInt3079)
    }

    override fun method44(i: Int, var_renderer: Renderer?) {
        this.aSceneObjectAnimator_10115!!.method1667(116.toByte(), var_renderer)
    ...
    public override fun method2387(var_renderer: Renderer?, i: Int) {
        ...
        val class64 = this.aSceneObjectAnimator_10115!!.method1668(true, true, -128, 262144, var_renderer)
        if (class64 != null) {
            val i_1_ = this.x shr 9
            val i_2_ = this.y shr 9
            val class101 = var_renderer!!.method3705()
            class101.method894(this.x, this.anInt6382, this.y)
            this.aSceneObjectAnimator_10115!!.method1670(i_1_, class101, i_2_, var_renderer, i_1_, class64, false, (-73).toByte(), i_2_)
        }
    }
    ...
    public override fun method2394(bool: Boolean): Int {
        ...
        anInt10107++
        return this.aSceneObjectAnimator_10115!!.method1663(109)
    }

    public override fun method2391(var_renderer: Renderer?, i: Int, i_3_: Int, i_4_: Int): Boolean {
        anInt10101++
        val class64 = this.aSceneObjectAnimator_10115!!.method1668(false, false, -127, 131072, var_renderer)
    ...
    init {
        try {
            this.aSceneObjectAnimator_10115 = SceneObjectAnimator(var_renderer, objectType, i_9_, i_10_, this.plane.toInt(), i_5_, this, bool, i_11_)
            aBoolean10114 = objectType!!.anInt874 != 0 && !bool
        } catch (runtimeexception: RuntimeException) {
            throw TextureLoadException.method2929(runtimeexception, ("ju.<init>(" + (if (var_renderer != null) "{...}" else "null") + ',' + (if (objectType != null) "{...}" else "null") + ',' + i + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + bool + ',' + i_9_ + ',' + i_10_ + ',' + i_11_ + ')'))
        }
    }
    ...
    public override fun method2379(i: Int): Int {
        ...
        return this.aSceneObjectAnimator_10115!!.method1664(-71)
    }

    override fun method38(i: Int): Boolean {
        anInt10117++
        if (i != -18443) aBoolean10095 = true
        return this.aSceneObjectAnimator_10115!!.method1665(2)
    }
    ...
    override fun method43(var_renderer: Renderer?, i: Int) {
        anInt10110++
        this.aSceneObjectAnimator_10115!!.method1674(-1, var_renderer)
    ...
    override fun method41(i: Int): Int {
        anInt10100++
        if (i != -32228) this.aSceneObjectAnimator_10115 = null
        return (this.aSceneObjectAnimator_10115!!.anInt3052)
    }
