...
class TerrainChunkBuilder internal constructor(var_ha_Sub3: NativeRenderer?, videoStreamDecoder: VideoStreamDecoder?, var_s_Sub3: NativeTerrainTile?, i: Int, i_24_: Int, i_25_: Int, i_26_: Int, i_27_: Int) {
    ...
    companion object {
        ...
        fun method872(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int) {
            anInt1554++
            if (i_5_ >= WorldMapLabel.anInt4960 && CameraNodeList.anInt1745 >= i_4_ && LocalPlayerState.anInt1910 <= i_2_ && SkyboxSphereType.anInt513 >= i_3_) {
        ...
        fun method873(i: Int, i_6_: Int, var_renderer: Renderer?, i_7_: Int) {
            ...
            if (i_6_ == 21719) {
                anInt1549++
                if (FogState.anIntArray1432 != null) QuickChatMenuType.aCircleRasterizer_9571 = ModelLightingConfig.method1636(FogState.anIntArray1432!![4], FogState.anIntArray1432!![3], FogState.anIntArray1432!![0], FogState.anIntArray1432!![5], FogState.anIntArray1432!![1], -1, FogState.anIntArray1432!![2])
