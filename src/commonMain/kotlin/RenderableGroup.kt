...
class RenderableGroup internal constructor(typedRecordTable: TypedRecordTable?, dualMaterialContainer: DualMaterialContainer?) : CursorController {
    ...
    companion object {
        ...
        fun method1448(i: Int) {
            anInt5003++
            if (i <= -55) FlipTextureNode.aClass348_Sub42_Sub12_9144 = ContactEntry((LocalizedText.aLocalizedText_3487!!.method2063(ChatCommandProcessor.language, 544)), "", Tooltip.anInt4458, 1004, -1, 0L, 0, 0, true, false, 0L, true)
        }
