...
class TrackedGroundDecor internal constructor(i: Int, i_22_: Int, i_23_: Int, i_24_: Int, i_25_: Int, i_26_: Int, i_27_: Int, i_28_: Int, i_29_: Int, private val anInt10393: Int, i_31_: Int, var anInt10412: Int, i_33_: Int, private val aBoolean10398: Boolean, private val anInt10367: Int) :
    ...
    private val aAnimationType_10375: AnimationType?
    ...
    public override fun method2387(var_renderer: Renderer?, i: Int) {
        anInt10379++
        val class64 = method2476(0, var_renderer, 127.toByte())
        if (class64 != null) {
    ...
    public override fun method2380(var_renderer: Renderer?, i: Int, bool: Boolean, class318_sub1: SceneEntity?, i_6_: Int, i_7_: Byte, i_8_: Int) {
        try {
            ...
            throw TextureLoadException.method2929(runtimeexception, ("to.N(" + (if (var_renderer != null) "{...}" else "null") + ',' + i + ',' + bool + ',' + (if (class318_sub1 != null) "{...}" else "null") + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ')'))
        }
    }
    ...
    private fun method2473(abstractCameraTransform: AbstractCameraTransform?, abstractModel: AbstractModel?, var_renderer: Renderer?, i: Int) {
        do {
            try {
                ...
                throw TextureLoadException.method2929(runtimeexception, ("to.L(" + (if (abstractCameraTransform != null) "{...}" else "null") + ',' + (if (abstractModel != null) "{...}" else "null") + ',' + (if (var_renderer != null) "{...}" else "null") + ',' + i + ')'))
            }
            break
        } while (false)
    }
        ...
        if (!aBoolean10407 && i.toInt() == 121) {
            if (anInt10387 != 0) {
                ...
                if (anInt10387 < 0) {
                    ...
                    if (i_9_ == QuickChatType.anInt9591) class318_sub1_sub3_sub3 = LocalPlayerState.aPlayer_1907
    ...
    public override fun method2391(var_renderer: Renderer?, i: Int, i_19_: Int, i_20_: Int): Boolean {
    ...
    fun method2475(i: Byte, i_21_: Int) {
        ...
        if (aAnimationType_10375 != null) {
            anInt10403 += i_21_
            while (aAnimationType_10375.anIntArray267!![anInt10365] < anInt10403) {
                anInt10403 -= aAnimationType_10375.anIntArray267!![anInt10365]
                anInt10365++
                if (anInt10365 >= aAnimationType_10375.anIntArray237.size) {
                    anInt10365 -= aAnimationType_10375.anInt238
                    if (anInt10365 < 0 || anInt10365 >= (aAnimationType_10375.anIntArray237).size) anInt10365 = 0
                }
                anInt10369 = anInt10365 - -1
                if (aAnimationType_10375.anIntArray237.size <= anInt10369) {
                    anInt10369 -= aAnimationType_10375.anInt238
                    if (anInt10369 < 0 || anInt10369 >= aAnimationType_10375.anIntArray237.size) anInt10369 = -1
                }
            }
        }
    }
    ...
    init {
        ...
        anInt10387 = i_31_
        val i_35_ = (ConstantColourTextureNode.aGfxTypeList_9245!!.method2543(72.toByte(), anInt10391).anInt4503)
        if (i_35_ != -1) aAnimationType_10375 = ParticleEmitterNode.aAnimationTypeList_191!!.method835(i_35_, 7)
    ...
    private fun method2476(i: Int, var_renderer: Renderer?, i_36_: Byte): AbstractModel? {
        anInt10377++
        val class368 = ConstantColourTextureNode.aGfxTypeList_9245!!.method2543(75.toByte(), anInt10391)
        if (i_36_ < 126) aClass318_Sub10_10378 = null
        return class368.method3562(anInt10365, var_renderer, anInt10403, i, anInt10369, ParticleEmitterNode.aAnimationTypeList_191, 121.toByte())
    }
