...
abstract class WallEntity internal constructor(i: Int, i_11_: Int, i_12_: Int, i_13_: Int, i_14_: Int, i_15_: Int, i_16_: Int) : SceneEntity() {
    ...
    override fun method2378(i: Int): Boolean {
        ...
        anInt8767++
        return (ActorEntity.aBooleanArrayArray1572!![(-ActorEntity.anInt6111 + ((this.x shr ActorEntity.anInt4459) - -ActorEntity.anInt10084))]!![(ActorEntity.anInt10084 + (-ActorEntity.anInt8502 + (this.y shr ActorEntity.anInt4459)))])
    }

    override fun method2382(i: Byte): Boolean {
        anInt8774++
        if (i >= -51) method2486(-102, 81, -103, -31, -95, -90)
        return MinimapSpriteRenderer.method1110((this.y shr ActorEntity.anInt4459), this.method2394(true), this.aByte6376.toInt(), (-79).toByte(), (this.x shr ActorEntity.anInt4459))
    }
    ...
    companion object {
        ...
        fun method2483(i: Int, i_0_: Int): Int {
            if (FlickeringGraphicsOptionState.aShortArrayArray5847 != null) return FlickeringGraphicsOptionState.aShortArrayArray5847!![i]!![i_0_].toInt() and 0xffff
            return 0
        }
        ...
        fun method2486(i: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int) {
            if (i_8_ >= WorldMapLabel.anInt4960 && i_5_ <= CameraNodeList.anInt1745 && LocalPlayerState.anInt1910 <= i_9_ && WidgetTextConfig.anInt513 >= i_7_) MinimapSpriteRenderer.method1111(i_7_, i, i_5_, i_8_, i_9_, i_6_)
            else FogOptionState.method1792(i_9_, i_8_, i_7_, i_5_, (-114).toByte(), i_6_)
            if (i != 0) anInt8780 = 42
            anInt8777++
        }
