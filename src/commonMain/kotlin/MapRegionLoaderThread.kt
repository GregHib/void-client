...
class MapRegionLoaderThread : Runnable {
    ...
    fun method2668(i: Int): Boolean {
        ...
        if (aLinkedQueueNode_4201 == null) {
            try {
                ...
                aLinkedQueueNode_4201 = (VorbisOggDecoder.aPrivilegedOperationWorker_8992!!.method2237(URL("http://" + (GlElementArrayBuffer.aServerConnectionInfo_4839!!.aString2147) + ":" + i_15_ + "/news.ws?game=" + Client.mode!!.anInt2987), 8362))
    ...
    companion object {
        ...
        fun method2665(i: Int, i_0_: Byte, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int) {
            ...
            } else if (SkyboxSphereType.anInt513 < i_12_) {
                i_11_ = (SkyboxSphereType.anInt513 - i_8_ shl 12) / i_7_
                i_12_ = SkyboxSphereType.anInt513
            }
            if (LocalPlayerState.anInt1910 <= i_9_) {
                if (SkyboxSphereType.anInt513 < i_9_) {
                    i_10_ = (SkyboxSphereType.anInt513 - i_8_ shl 12) / i_7_
                    i_9_ = SkyboxSphereType.anInt513
                }
            } else {
        ...
        fun method2666(i: Int, i_13_: Int, widgetComponent: WidgetComponent?, i_14_: Byte) {
            ...
            if (widgetComponent != null) {
                ...
                SkyboxSphereType.anInt500 = i_13_
