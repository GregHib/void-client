...
*/
class SoundBankPatch : LinkedListNode {
    ...
    lateinit var aClass348_Sub19_Sub1Array6800: Array<PcmSampleData?>
                ...
                try {
                    ...
                    if ((npc!!.anIntArray10236) != null) {
                        ...
                        if (bool && npc.anInt10286 != -1) {
                            val class17 = (ParticleEmitterNode.aAnimationTypeList_191!!.method835(npc.anInt10286, 7))
                    ...
                    while (`is`!!.size > i_4_) {
                        ...
                        if (npc.anIntArray10236 == null || (npc.anIntArray10236!![i_4_]) == -1 || (ParticleEmitterNode.aAnimationTypeList_191!!.method835(`is`[i_4_], 7).anInt239 >= ParticleEmitterNode.aAnimationTypeList_191!!.method835((npc.anIntArray10236!![i_4_]), 7).anInt239)) {
                            npc.anInt10218 = i
