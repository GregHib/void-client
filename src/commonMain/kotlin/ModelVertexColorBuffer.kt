...
class ModelVertexColorBuffer internal constructor(private val aS_Sub3_6566: NativeTerrainTile, var anInt6567: Int, i_43_: Int, var anInt6571: Int, var anInt6575: Int, var anInt6569: Int) : LinkedListNode() {
    ...
    fun method2737(i: Byte, `is`: IntArray, i_1_: Int) {
        ...
        if (buffer != null) {
            ...
            if (interface5_impl2.method22(i + 7) && i_2_ > 0) {
                ...
                aHa_Sub3_6590.method3853(i + -2, WaterDetailOptionState.aConfigFlagUtil_6030)
    ...
    fun method2742(i: Int, i_38_: Int, i_39_: Int, i_40_: Byte) {
        anInt6570++
        anIntArray6573[i_38_ * aS_Sub3_6566.anInt4587 - -i_39_] = WhirlpoolHash.method2057((anIntArray6573[(i_38_ * aS_Sub3_6566.anInt4587 - -i_39_)]), 1 shl i)
