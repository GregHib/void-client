...
class Player : ProjectedGroundDecor() {
    ...
    private fun method2459(i: Int, var_renderer: Renderer?, i_69_: Int): Boolean {
        ...
        val class64 =
            (this.aCompositeNpcModelBuilder_10536!!.method1226(aVarpStore_10209, class17_71_, this.aLoadProgressCountersArray10308, true, ClientException.aItemTypeList_112, i_74_, class17, this.anInt10244, true, this.anInt10312, this.anIntArray10296, i, RadialTextureNode.aIDKTypeList_9342, this.anInt10232, var_renderer, MapAreaDefinition.aNpcTypeList_2529, ParticleEmitterNode.aAnimationTypeList_191, this.anInt10245, this.anInt10267, this.anInt10203, OpenGlModel.aRenderAnimTypeList_5558).also { this.aAbstractModelArray10323[0] = it })
