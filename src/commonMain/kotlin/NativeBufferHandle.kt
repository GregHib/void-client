...
//        super.finalize()
    ...
    companion object {
        ...
        fun method849(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int) {
            ...
            val i_6_ = i_0_ + i
            val i_7_ = -i + i_3_
            for (i_8_ in i_0_..<i_6_) GlElementArrayBuffer.method1156(-27, i_2_, AnimationType.anIntArrayArray255!![i_8_]!!, i_1_, i_5_)
            val i_9_ = -i + i_2_
            for (i_10_ in i_3_ downTo i_7_ + 1) GlElementArrayBuffer.method1156(-27, i_2_, AnimationType.anIntArrayArray255!![i_10_]!!, i_1_, i_5_)
            val i_11_ = i + i_1_
            var i_12_ = i_6_
            while (i_7_ >= i_12_) {
                val `is`: IntArray = AnimationType.anIntArrayArray255!![i_12_]!!
