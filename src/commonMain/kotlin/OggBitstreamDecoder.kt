        ...
        fun method2965(string: String?, i: Int, bool: Boolean, i_1_: Int) {
            ...
            if (i == 0) {
                ...
                if (string != null) {
                    ...
                    val class143 = method1819(AnimationType.anInt235, 0, -117, SoftwareSpriteRaster.aJs5Archive_1627!!)
                    val class324 = (FacingDirectionNode.aRenderer6654!!.method3686(class143, SpriteImage.method1519(CameraRotationStub.sprites!!, AnimationType.anInt235, 0), true))
                ...
                if (string != null) {
                    ...
                    var_renderer.GA(0)
                    val class143 = method1819(AnimationType.anInt235, 0, -115, SoftwareSpriteRaster.aJs5Archive_1627!!)
                    val class324 = var_renderer.method3686(class143, SpriteImage.method1519((CameraRotationStub.sprites!!), AnimationType.anInt235, 0), true)
                ...
                try {
                    ...
                    if (string != null) {
                        var_renderer!!.GA(0)
                        val class143 = method1819(AnimationType.anInt235, 0, -51, SoftwareSpriteRaster.aJs5Archive_1627!!)
                        val class324 = (var_renderer.method3686(class143, SpriteImage.method1519(CameraRotationStub.sprites!!, AnimationType.anInt235, 0), true))
