...
class GlArrayBufferObject : GlVertexBufferBase, ByteBufferReader {
    ...
    companion object {
        ...
        fun method1153(var_renderer: Renderer, i: Int) {
            ...
            val i_10_ = 20
            method2270(SceneTileBounds.anInt1117, i_4_ + anInt4717, var_renderer, LocalizedText.aLocalizedText_3507!!.method2063(ChatCommandProcessor.language, i + 528), false, i_5_ + ProceduralTextureGraph.anInt9532, WorldMapSceneSoftware.anInt5819, i_10_)
            ...
            if (ChatScriptListNode.aBoolean9535) {
                ...
                while (class348_sub42_sub13 != null) {
                    ...
                    i_20_++
                    if (class348_sub42_sub13.anInt9615 == 1) SceneModelBuilder.method2494(ProceduralTextureGraph.anInt9532 - -i_5_, 0xffffff.inv() or SolidFillComponent.anInt8363, i_21_, var_renderer, (class348_sub42_sub13.aLinkedNodeListIterator_9621.aClass348_Sub42_1647.aClass348_Sub42_7063 as ContactEntry?), SceneTileBounds.anInt1117, i_12_, QuickChatType.anInt9586 or 0xffffff.inv(), 125.toByte(), WorldMapSceneSoftware.anInt5819, anInt4717 - -i_4_, i_11_)
                    else method2431(0xffffff.inv() or QuickChatType.anInt9586, i_21_, class348_sub42_sub13, i_11_, SceneTileBounds.anInt1117, 0xffffff.inv() or SolidFillComponent.anInt8363, i_12_, var_renderer, ProceduralTextureGraph.anInt9532 - -i_5_, i xor 0x60, i_4_ + anInt4717, WorldMapSceneSoftware.anInt5819)
                ...
                if (ManagedGlResource.aClass348_Sub42_Sub13_3152 != null) {
                    ...
                    while (class348_sub42_sub12 != null) {
                        ...
                        i_20_++
                        SceneModelBuilder.method2494(InputTracker.anInt4534, SolidFillComponent.anInt8363 or 0xffffff.inv(), i_22_, var_renderer, class348_sub42_sub12, TerrainTileShape.anInt8806, i_12_, (QuickChatType.anInt9586 or 0xffffff.inv()), 127.toByte(), ClickFeedbackTask.anInt4669, MinimapPolygonDrawer.anInt5252, i_11_)
                ...
                while (class348_sub42_sub12 != null) {
                    ...
                    i_18_++
                    SceneModelBuilder.method2494(i_7_, 0xffffff.inv() or SolidFillComponent.anInt8363, i_19_, var_renderer, class348_sub42_sub12, i_8_, i_12_, (0xffffff.inv() or QuickChatType.anInt9586), 125.toByte(), i_9_, i_6_, i_11_)
