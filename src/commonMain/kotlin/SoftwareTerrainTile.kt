...
*/
class SoftwareTerrainTile(private val aHa_Sub1_8217: SoftwareRasterHost, i: Int, private val anInt8223: Int, i_486_: Int, i_487_: Int, `is`: Array<IntArray?>, is_488_: Array<IntArray?>, i_489_: Int) : TerrainTile(i_486_, i_487_, i_489_, `is`) {
    ...
    override fun U(i: Int, i_0_: Int, `is`: IntArray?, is_1_: IntArray?, is_2_: IntArray, is_3_: IntArray?, is_4_: IntArray, is_5_: IntArray?, is_6_: IntArray, is_7_: IntArray, i_8_: Int, i_9_: Int, i_10_: Int, bool: Boolean) {
        ...
        if (`is` != null && `is`.size != 0) {
            for (i_12_ in is_4_.indices) {
                ...
                else is_4_[i_12_] = ((SoundEnvelope.anIntArray4983!![SoundEnvelope.method303(is_4_[i_12_], 30).toInt() and 0xffff]) shl 8) or 0xff
            }
            if (is_5_ != null) {
                for (i_13_ in is_5_.indices) {
                    if (is_5_[i_13_] == -1) is_5_[i_13_] = 0
                    else is_5_[i_13_] = ((SoundEnvelope.anIntArray4983!![SoundEnvelope.method303(is_5_[i_13_], 30).toInt() and 0xffff]) shl 8) or 0xff
                }
            }
            if (bool_11_) {
                    ...
                    for (i_53_ in 0..<terrainTileData.aShort2010) {
                        ...
                        if (bool_51_) {
                            ...
                            if (bool_58_) {
                                ...
                                if (bool_57_) {
                                    i_59_ = is_6_[i_54_]
                                    if (i_59_ != -1 && !(aHa_Sub1_8217.aRenderConfig4579!!.method3(i_59_, -6662)!!.aBoolean209)) terrainTileData.anIntArray2001!![i_54_] = (SoundEnvelope.anIntArray4983!![(SoundEnvelope.method303((aHa_Sub1_8217.aRenderConfig4579!!.method3(i_59_, -6662)!!.aShort208).toInt() and 0xffff, 30)).toInt() and 0xffff])
                                    i_59_ = is_6_[i_55_]
                                    if (i_59_ != -1 && !(aHa_Sub1_8217.aRenderConfig4579!!.method3(i_59_, -6662)!!.aBoolean209)) terrainTileData.anIntArray2001!![i_55_] = (SoundEnvelope.anIntArray4983!![(SoundEnvelope.method303((aHa_Sub1_8217.aRenderConfig4579!!.method3(i_59_, -6662)!!.aShort208).toInt() and 0xffff, 30)).toInt() and 0xffff])
                                    i_59_ = is_6_[i_56_]
                                    if (i_59_ != -1 && !(aHa_Sub1_8217.aRenderConfig4579!!.method3(i_59_, -6662)!!.aBoolean209)) terrainTileData.anIntArray2001!![i_56_] = (SoundEnvelope.anIntArray4983!![(SoundEnvelope.method303((aHa_Sub1_8217.aRenderConfig4579!!.method3(i_59_, -6662)!!.aShort208).toInt() and 0xffff, 30)).toInt() and 0xffff])
                                }
        ...
        if (!bool_74_) {
            ...
            for (i_91_ in 0..<i_79_) {
                if (is_67_[i_91_] >= 0 || is_68_ != null && is_68_[i_91_] >= 0) {
                    if (is_67_[i_91_] >= 0) modelVertexData.anIntArray3093!![modelVertexData.aShort3099.toInt()] = SoundEnvelope.method303(is_67_[i_91_], 30).toInt()
                    else modelVertexData.anIntArray3093!![modelVertexData.aShort3099.toInt()] = -1
                    if (is_68_ != null) {
                        if (is_68_[i_91_] != -1) modelVertexData.anIntArray3092!![modelVertexData.aShort3099.toInt()] = SoundEnvelope.method303(is_68_[i_91_], 30).toInt()
            ...
            val i_93_ = is_69_[0]
            if (is_68_ != null) {
                vertexNormal.anInt1600 = SoftwareTerrainTile.method2198(0, (aByteArrayArray8220!![i]!![i_60_] - aByteArrayArray8232!![i]!![i_60_]), SoundEnvelope.method303(is_68_[0], 30).toInt())
            ...
            if (npcAppearanceFlags != null && (vertexNormal.aByte1606.toInt() and 0x2) == 0 && !npcAppearanceFlags.aBoolean209) {
                ...
                val i_94_ = SoundEnvelope.method303(i_92_, 30)
                vertexNormal.aShort1601 = SoftwareTerrainTile.method2198(0, ((aByteArrayArray8220!![i]!![i_60_]) - (aByteArrayArray8232!![i]!![i_60_])), i_94_.toInt()).toShort()
                vertexNormal.aShort1603 = SoftwareTerrainTile.method2198(0, ((aByteArrayArray8220!![i + 1]!![i_60_]) - (aByteArrayArray8232!![i + 1]!![i_60_])), i_94_.toInt()).toShort()
                vertexNormal.aShort1602 = SoftwareTerrainTile.method2198(0, ((aByteArrayArray8220!![i + 1]!![i_60_ + 1]) - (aByteArrayArray8232!![i + 1]!![i_60_ + 1])), i_94_.toInt()).toShort()
                vertexNormal.aShort1604 = SoftwareTerrainTile.method2198(0, ((aByteArrayArray8220!![i]!![i_60_ + 1]) - (aByteArrayArray8232!![i]!![i_60_ + 1])), i_94_.toInt()).toShort()
    ...
    private fun method3990(i: Int, i_105_: Int, bool: Boolean, particleSystemState: ParticleSystemState, shadowProjector: ShadowProjector, `is`: IntArray, is_106_: IntArray, is_107_: IntArray, is_108_: IntArray, i_109_: Int) {
        ...
        if (class266 == null) {
            ...
            if (class145 != null) {
                ...
                if (anInt8228 == -1) {
                    for (i_187_ in 0..<class145.aShort2003) {
                        ...
                        is_108_[i_187_] = 0
                        if (bool) {
                            var i_191_ = (f - (particleSystemState.anInt2210).toFloat()).toInt()
                        ...
                        } else if (particleSystemState.aBoolean2201) {
                            val i_193_ = (f - (particleSystemState.anInt2210).toFloat()).toInt()
                            if (i_193_ > 0) {
                    ...
                    for (i_196_ in 0..<class145.aShort2003) {
                        ...
                        is_108_[i_196_] = 0
                        if (bool) {
                            var i_200_ = anInt8228 - particleSystemState.anInt2210
                            ...
                            val i_202_ = anInt8228 - particleSystemState.anInt2210
                            if (i_202_ > 0) {
                ...
                if (class145.aShortArray2008 == null) {
                    ...
                    for (i_205_ in 0..<class145.aShort2010) {
                        ...
                        if (((i_209_ - i_210_) * (i_214_ - i_213_) - (i_212_ - i_213_) * (i_211_ - i_210_)) > 0) {
                            ...
                            } else shadowProjector.method1018(i_212_.toFloat(), i_213_.toFloat(), i_214_.toFloat(), i_209_.toFloat(), i_210_.toFloat(), i_211_.toFloat(), is_107_[i_206_].toFloat(), is_107_[i_207_].toFloat(), is_107_[i_208_].toFloat(), particleSystemState.anInt2192)
                        }
                    }
                } else {
                    for (i_219_ in 0..<class145.aShort2010) {
                        ...
                        if (((i_223_ - i_224_) * (i_228_ - i_227_) - (i_226_ - i_227_) * (i_225_ - i_224_)) > 0) {
                            ...
                            if (i_229_ < 765) {
                                ...
                                shadowProjector.anInt1674 = 0
                            } else shadowProjector.method1018(i_226_.toFloat(), i_227_.toFloat(), i_228_.toFloat(), i_223_.toFloat(), i_224_.toFloat(), i_225_.toFloat(), is_107_[i_220_].toFloat(), is_107_[i_221_].toFloat(), is_107_[i_222_].toFloat(), particleSystemState.anInt2192)
                        }
                    }
                }
            }
            ...
            if ((class266.aByte3386.toInt() and 0x1) == 0 || bool) {
                ...
                if (bool) {
                    var i_154_ = (f - (particleSystemState.anInt2210).toFloat()).toInt()
                    ...
                    i_154_ = (f_118_ - (particleSystemState.anInt2210).toFloat()).toInt()
                    if (i_154_ > 255) i_154_ = 255
                    if (i_154_ > 0) {
                        i_115_ = i_154_
                    ...
                    i_154_ = (f_119_ - (particleSystemState.anInt2210).toFloat()).toInt()
                    if (i_154_ > 255) i_154_ = 255
                    if (i_154_ > 0) {
                        i_116_ = i_154_
                    ...
                    i_154_ = (f_120_ - (particleSystemState.anInt2210).toFloat()).toInt()
                    if (i_154_ > 255) i_154_ = 255
                    if (i_154_ > 0) {
                        i_117_ = i_154_
                    ...
                    var i_159_ = (f - (particleSystemState.anInt2210).toFloat()).toInt()
                    if (i_159_ > 0) {
                        i_114_ = i_159_
                        if (i_114_ > 255) i_114_ = 255
                    }
                    i_159_ = (f_118_ - (particleSystemState.anInt2210).toFloat()).toInt()
                    if (i_159_ > 0) {
                        i_115_ = i_159_
                        if (i_115_ > 255) i_115_ = 255
                    }
                    i_159_ = (f_119_ - (particleSystemState.anInt2210).toFloat()).toInt()
                    if (i_159_ > 0) {
                        i_116_ = i_159_
                        if (i_116_ > 255) i_116_ = 255
                    }
                    i_159_ = (f_120_ - (particleSystemState.anInt2210).toFloat()).toInt()
                    if (i_159_ > 0) {
                        i_117_ = i_159_
                ...
                if (particleSystemState.aBoolean2201) {
                    var i_131_ = (f - (particleSystemState.anInt2210).toFloat()).toInt()
                    if (i_131_ > 0) {
                        i_114_ = i_131_
                        if (i_114_ > 255) i_114_ = 255
                    }
                    i_131_ = (f_118_ - (particleSystemState.anInt2210).toFloat()).toInt()
                    if (i_131_ > 0) {
                        i_115_ = i_131_
                        if (i_115_ > 255) i_115_ = 255
                    }
                    i_131_ = (f_119_ - (particleSystemState.anInt2210).toFloat()).toInt()
                    if (i_131_ > 0) {
                        i_116_ = i_131_
                        if (i_116_ > 255) i_116_ = 255
                    }
                    i_131_ = (f_120_ - (particleSystemState.anInt2210).toFloat()).toInt()
                    if (i_131_ > 0) {
                        i_117_ = i_131_
                        if (i_117_ > 255) i_117_ = 255
                    }
            ...
            if (anInt8228 == -1) {
                ...
                if (((i_125_ - i_127_) * (i_124_ - i_128_) - (i_126_ - i_128_) * (i_123_ - i_127_)) > 0) {
                    ...
                    if (i_177_ < 765) {
                        if (i_177_ > 0) {
                            if (class266.aShort3379 >= 0) {
                                ...
                                shadowProjector.method1024(i_126_.toFloat(), i_128_.toFloat(), i_124_.toFloat(), i_125_.toFloat(), i_127_.toFloat(), i_123_.toFloat(), f_119_, f_120_, f_118_, 1.0f, 0.0f, 1.0f, 1.0f, 1.0f, 0.0f, i_178_ or ((class266.anInt3380) and 0xffffff), i_178_ or ((class266.anInt3381) and 0xffffff), i_178_ or ((class266.anInt3387) and 0xffffff), particleSystemState.anInt2192, i_116_, i_117_, i_115_, class266.aShort3379.toInt())
                            } else {
                    ...
                    } else shadowProjector.method1018(i_126_.toFloat(), i_128_.toFloat(), i_124_.toFloat(), i_125_.toFloat(), i_127_.toFloat(), i_123_.toFloat(), f_119_.toInt().toFloat(), f_120_.toInt().toFloat(), f_118_.toInt().toFloat(), (particleSystemState.anInt2192))
                }
                ...
                if (((i_121_ - i_123_) * (i_128_ - i_124_) - (i_122_ - i_124_) * (i_127_ - i_123_)) > 0) {
                    ...
                    if (i_177_ < 765) {
                        ...
                        if (i_177_ > 0) {
                            if (class266.aShort3379 >= 0) {
                                ...
                                shadowProjector.method1024(i_122_.toFloat(), i_124_.toFloat(), i_128_.toFloat(), i_121_.toFloat(), i_123_.toFloat(), i_127_.toFloat(), f, f_118_, f_120_, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f, 1.0f, i_180_ or ((class266.anInt3389) and 0xffffff), i_180_ or ((class266.anInt3387) and 0xffffff), i_180_ or ((class266.anInt3381) and 0xffffff), particleSystemState.anInt2192, i_114_, i_115_, i_117_, class266.aShort3379.toInt())
                            } else {
                                if (bool_176_) shadowProjector.anInt1674 = 100
                                shadowProjector.method1027(
                                    i_122_.toFloat(),
                    ...
                    } else shadowProjector.method1018(i_122_.toFloat(), i_124_.toFloat(), i_128_.toFloat(), i_121_.toFloat(), i_123_.toFloat(), i_127_.toFloat(), f.toInt().toFloat(), f_118_.toInt().toFloat(), f_120_.toInt().toFloat(), (particleSystemState.anInt2192))
                }
            } else {
                    ...
                    if (i_182_ < 765) {
                        ...
                        if (i_182_ > 0) {
                            if (class266.aShort3379 >= 0) {
                                ...
                                shadowProjector.method1024(i_126_.toFloat(), i_128_.toFloat(), i_124_.toFloat(), i_125_.toFloat(), i_127_.toFloat(), i_123_.toFloat(), f_119_, f_120_, f_118_, 1.0f, 0.0f, 1.0f, 1.0f, 1.0f, 0.0f, i_183_ or ((class266.anInt3380) and 0xffffff), i_183_ or ((class266.anInt3381) and 0xffffff), i_183_ or ((class266.anInt3387) and 0xffffff), particleSystemState.anInt2192, i_116_, i_117_, i_115_, class266.aShort3379.toInt())
                            } else {
                                if (bool_176_) shadowProjector.anInt1674 = 100
                                shadowProjector.method1027(
                                    i_126_.toFloat(),
                    ...
                    if (i_182_ < 765) {
                        ...
                        if (i_182_ > 0) {
                            if (class266.aShort3379 >= 0) {
                                ...
                                shadowProjector.method1024(i_122_.toFloat(), i_124_.toFloat(), i_128_.toFloat(), i_121_.toFloat(), i_123_.toFloat(), i_127_.toFloat(), f, f_118_, f_120_, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f, 1.0f, i_185_ or ((class266.anInt3389) and 0xffffff), i_185_ or ((class266.anInt3387) and 0xffffff), i_185_ or ((class266.anInt3381) and 0xffffff), particleSystemState.anInt2192, i_114_, i_115_, i_117_, class266.aShort3379.toInt())
                            } else {
                                if (bool_176_) shadowProjector.anInt1674 = 100
                                shadowProjector.method1027(
                                    i_122_.toFloat(),
    ...
    private fun method3993(i: Int, i_260_: Int, i_261_: Int, i_262_: Int, i_263_: Int, i_264_: Int, i_265_: Int, bools: Array<BooleanArray?>, particleSystemState: ParticleSystemState, shadowProjector: ShadowProjector, `is`: IntArray, is_266_: IntArray) {
        val i_267_ = (i_265_ - i_263_) * i_261_ / 256
        val i_268_ = i_261_ shr 8
        val bool = particleSystemState.aBoolean2202
                    ...
                    if (aModelVertexNormalArrayArray8230 != null) {
                        if (aModelVertexNormalArrayArray8230!![i_271_]!![i_272_] != null) {
                            ...
                            if (class266.aShort3379.toInt() != -1 && (class266.aByte3386.toInt() and 0x2) == 0 && class266.anInt3388 == 0) {
                                ...
                                shadowProjector.method1022((i_270_ - i_268_).toFloat(), (i_270_ - i_268_).toFloat(), i_270_.toFloat(), (i_269_ + i_268_).toFloat(), i_269_.toFloat(), (i_269_ + i_268_).toFloat(), 100.0f, 100.0f, 100.0f, SoftwareTerrainTile.method2198(0, (class266.anInt3380), i_273_).toFloat(), SoftwareTerrainTile.method2198(0, (class266.anInt3381), i_273_).toFloat(), SoftwareTerrainTile.method2198(0, (class266.anInt3387), i_273_).toFloat())
                                shadowProjector.method1022(i_270_.toFloat(), i_270_.toFloat(), (i_270_ - i_268_).toFloat(), i_269_.toFloat(), (i_269_ + i_268_).toFloat(), i_269_.toFloat(), 100.0f, 100.0f, 100.0f, SoftwareTerrainTile.method2198(0, (class266.anInt3389), i_273_).toFloat(), SoftwareTerrainTile.method2198(0, (class266.anInt3387), i_273_).toFloat(), SoftwareTerrainTile.method2198(0, (class266.anInt3381), i_273_).toFloat())
                        ...
                        if (((i_400_ - i_401_) * (i_405_ - i_404_) - (i_403_ - i_404_) * (i_402_ - i_401_)) > 0) {
                            ...
                            if (i_406_ != -1) {
                                ...
                                shadowProjector.method1022(
                                    ...
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_397_.toInt()]).toInt(), i_406_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_398_.toInt()]).toInt(), i_406_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_399_.toInt()]).toInt(), i_406_)).toFloat()
                                )
                            }
                        }
                    }
                        ...
                        if (((i_376_ - i_377_) * (i_381_ - i_380_) - (i_379_ - i_380_) * (i_378_ - i_377_)) > 0) {
                            ...
                            if (i_382_.toInt() == -1) {
                                ...
                                if (i_383_ != -1) shadowProjector.method1022(
                                    ...
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_373_.toInt()]).toInt(), i_383_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_374_.toInt()]).toInt(), i_383_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_375_.toInt()]).toInt(), i_383_)).toFloat()
                                )
                                ...
                                0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class236.aShortArray3088!![i_373_.toInt()]).toInt() and 0xffff]) and 0xffffff),
                                0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class236.aShortArray3088!![i_374_.toInt()]).toInt() and 0xffff]) and 0xffffff),
                                0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class236.aShortArray3088!![i_375_.toInt()]).toInt() and 0xffff]) and 0xffffff),
                                0,
                                0,
                                0,
                                0,
                        ...
                        if (((i_388_ - i_389_) * (i_393_ - i_392_) - (i_391_ - i_392_) * (i_390_ - i_389_)) > 0) {
                            ...
                            if (i_394_.toInt() == -1) {
                                ...
                                if (i_395_ != -1) shadowProjector.method1022(
                                    ...
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_385_.toInt()]).toInt(), i_395_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_386_.toInt()]).toInt(), i_395_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_387_.toInt()]).toInt(), i_395_)).toFloat()
                                )
                            } else shadowProjector.method1024(
                                i_391_.toFloat(),
                                i_392_.toFloat(),
                                ...
                                0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class236.aShortArray3088!![i_385_.toInt()]).toInt() and 0xffff]) and 0xffffff),
                                0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class236.aShortArray3088!![i_386_.toInt()]).toInt() and 0xffff]) and 0xffffff),
                                0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class236.aShortArray3088!![i_387_.toInt()]).toInt() and 0xffff]) and 0xffffff),
                                0,
                                0,
                                0,
                                0,
            ...
            if (anInt8228 == -1) {
                if (((i_316_ - i_318_) * (i_315_ - i_319_) - (i_317_ - i_319_) * (i_314_ - i_318_)) > 0) {
                    ...
                    if (class102.aShort1605 >= 0) shadowProjector.method1024(
                        ...
                        1.0f,
                        0.0f,
                        (0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class102.aShort1602.toInt() and 0xffff)]) and 0xffffff)),
                        (0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class102.aShort1604.toInt() and 0xffff)]) and 0xffffff)),
                        (0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class102.aShort1603.toInt() and 0xffff)]) and 0xffffff)),
                        0,
                        0,
                        0,
                        0,
                ...
                if (((i_312_ - i_314_) * (i_319_ - i_315_) - (i_313_ - i_315_) * (i_318_ - i_314_)) > 0) {
                    ...
                    if (class102.aShort1605 >= 0) shadowProjector.method1024(
                        ...
                        0.0f,
                        1.0f,
                        (0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class102.aShort1601.toInt() and 0xffff)]) and 0xffffff)),
                        (0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class102.aShort1603.toInt() and 0xffff)]) and 0xffffff)),
                        (0xffffff.inv() or ((SoundEnvelope.anIntArray4983!![(class102.aShort1604.toInt() and 0xffff)]) and 0xffffff)),
                        0,
                        0,
            ...
            if (class198 != null) {
                if (anInt8228 == -1) {
                    for (i_422_ in 0..<class198.aShort2620) {
                        ...
                        is_420_[i_422_] = 0
                        if (bool) {
                            var i_426_ = (f - (particleSystemState.anInt2210).toFloat()).toInt()
                            ...
                            val i_428_ = (f - (particleSystemState.anInt2210).toFloat()).toInt()
                            if (i_428_ > 0) {
                    ...
                    for (i_431_ in 0..<class198.aShort2620) {
                        ...
                        is_420_[i_431_] = 0
                        if (bool) {
                            var i_435_ = anInt8228 - particleSystemState.anInt2210
                            ...
                            val i_437_ = anInt8228 - particleSystemState.anInt2210
                            if (i_437_ > 0) {
                ...
                for (i_440_ in 0..<class198.aShort2619) {
                    ...
                    if (((i_444_ - i_445_) * (i_449_ - i_448_) - (i_447_ - i_448_) * (i_446_ - i_445_)) > 0) {
                        ...
                        } else shadowProjector.method1018(i_447_.toFloat(), i_448_.toFloat(), i_449_.toFloat(), i_444_.toFloat(), i_445_.toFloat(), i_446_.toFloat(), is_419_[i_441_].toFloat(), is_419_[i_442_].toFloat(), is_419_[i_443_].toFloat(), (particleSystemState.anInt2192))
                    }
                }
            }
        }
    ...
    private fun method3996(i: Int, i_453_: Int, i_454_: Int, i_455_: Int, i_456_: Int, i_457_: Int, i_458_: Int, bools: Array<BooleanArray?>, particleSystemState: ParticleSystemState, shadowProjector: ShadowProjector, `is`: IntArray, is_459_: IntArray) {
        ...
        for (i_464_ in i_455_..<i_457_) {
            for (i_465_ in i_456_..<i_458_) {
                if (bools[i_464_ - i_455_]!![i_465_ - i_456_]) {
                    if (aVertexNormalArrayArray8215!![i_464_]!![i_465_] != null) {
                        ...
                        if (class102.aShort1605.toInt() != -1 && (class102.aByte1606.toInt() and 0x2) == 0 && class102.anInt1600 == -1) {
                            ...
                            shadowProjector.method1022(
                                ...
                                100.0f,
                                100.0f,
                                SoftwareTerrainTile.method2198(0, ((class102.aShort1602).toInt() and 0xffff), i_466_).toFloat(),
                                SoftwareTerrainTile.method2198(0, ((class102.aShort1604).toInt() and 0xffff), i_466_).toFloat(),
                                SoftwareTerrainTile.method2198(0, ((class102.aShort1603).toInt() and 0xffff), i_466_).toFloat()
                            )
                            shadowProjector.method1022(
                                i_463_.toFloat(),
                                i_463_.toFloat(),
                                ...
                                100.0f,
                                100.0f,
                                SoftwareTerrainTile.method2198(0, ((class102.aShort1601).toInt() and 0xffff), i_466_).toFloat(),
                                SoftwareTerrainTile.method2198(0, ((class102.aShort1603).toInt() and 0xffff), i_466_).toFloat(),
                                SoftwareTerrainTile.method2198(0, ((class102.aShort1604).toInt() and 0xffff), i_466_).toFloat()
                            )
                        ...
                        for (i_469_ in 0..<class236.aShort3099) {
                            ...
                            if (class236.anIntArray3092 != null && (class236.anIntArray3092!![i_469_]) != -1) {
                                ...
                                shadowProjector.method1022(
                                    ...
                                    100.0f,
                                    100.0f,
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_470_.toInt()]).toInt(), i_479_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_471_.toInt()]).toInt(), i_479_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_472_.toInt()]).toInt(), i_479_)).toFloat()
                                )
                                ...
                                shadowProjector.method1022(
                                    ...
                                    100.0f,
                                    100.0f,
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_470_.toInt()]).toInt(), i_480_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_471_.toInt()]).toInt(), i_480_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_472_.toInt()]).toInt(), i_480_)).toFloat()
                                )
                            } else {
                                ...
                                shadowProjector.method1022(
                                    ...
                                    100.0f,
                                    100.0f,
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_470_.toInt()]).toInt(), i_481_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_471_.toInt()]).toInt(), i_481_)).toFloat(),
                                    (SoftwareTerrainTile.method2198(0, (class236.aShortArray3088!![i_472_.toInt()]).toInt(), i_481_)).toFloat()
                                )
                            }
                        }
                    }
