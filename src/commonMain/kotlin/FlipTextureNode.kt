...
class FlipTextureNode : AbstractProceduralTextureNode(1, false) {
    ...
    companion object {
                            ...
                            if (!Client.method111(class46)) {
                                ...
                                if (class46 == RegionSceneLoader.aWidgetComponent_3701) {
                                    ...
                                    if (ParticleConfigParser.aBoolean3819 && ScrollingWidgetComponentNode.aBoolean8386) {
                                        ...
                                        i_30_ -= HitsplatTypeList.anInt2872
                                        ...
                                        if (class46.anInt774 == 3) {
                                            ...
                                            if (class324 == null) {
                                                ...
                                                if (class46.anInt812 != -1) {
                                                    val class213 = (ClientException.aItemTypeList_112!!.method1940(-67, (class46.anInt812)))
                                                ...
                                                if (SpriteRenderable.aWidgetComponent_4730 == class46) {
                                                    string = (LocalizedText.aLocalizedText_3514!!.method2063((ChatCommandProcessor.language), 544))
                                            ...
                                            if (class46.anInt705 >= 0) class46.method444(bool_15_, HoverActionEntry.aSkyboxSphereTypeList_1813, Client.aSkyBoxTypeList_413)!!.method2293(0, FacingDirectionNode.aRenderer6654!!, (-35).toByte(), i_24_, class46.anInt709, i_25_, (class46.anInt835 shl 3), (class46.anInt759 shl 3), 0, class46.anInt789)
                                            else {
                                                ...
                                                if (class46.anInt812 != -1) {
                                                    ...
                                                    abstractModelRenderer = (ClientException.aItemTypeList_112!!.method1941((class46.anInt672), (-74).toByte(), (class46.anInt812), (class46.anInt781), (0xffffff.inv() or (class46.anInt809)), (class46.anInt678), FacingDirectionNode.aRenderer6654, class154))
                                            ...
                                            var i_60_ = 0
                                            if (class46.anInt812 != -1) {
                                                var class213 = (ClientException.aItemTypeList_112!!.method1940(103, (class46.anInt812)))
                                                if (class213 != null) {
                                                ...
                                                abstractModel = (class46.method430((RadialTextureNode.Companion.aIDKTypeList_9342), ParticleEmitterNode.aAnimationTypeList_191, 2048, FacingDirectionNode.aRenderer6654, -1, 0, (ClientException.aItemTypeList_112), (ProjectedGroundDecor.aVarpStore_10209), 255, (LocalPlayerState.aPlayer_1907!!.aCompositeNpcModelBuilder_10536), null, (OpenGlModel.aRenderAnimTypeList_5558), (MapAreaDefinition.aNpcTypeList_2529), -1))
                                                if (abstractModel == null && (ContactList.aBoolean9616)) ConfigFlagUtil.method1916(-9343, class46)
                                            } else {
                                                val class17 = (ParticleEmitterNode.aAnimationTypeList_191!!.method835((class46.anInt699), 7))
                                                abstractModel = (class46.method430((RadialTextureNode.Companion.aIDKTypeList_9342), ParticleEmitterNode.aAnimationTypeList_191, 2048, FacingDirectionNode.aRenderer6654, (class46.anInt795), (class46.anInt841), (ClientException.aItemTypeList_112), (ProjectedGroundDecor.aVarpStore_10209), 255, (LocalPlayerState.aPlayer_1907!!.aCompositeNpcModelBuilder_10536), class17, (OpenGlModel.aRenderAnimTypeList_5558), (MapAreaDefinition.aNpcTypeList_2529), (class46.anInt730)))
                                                if (abstractModel == null && (ContactList.aBoolean9616)) ConfigFlagUtil.method1916(-9343, class46)
                                            }
        ...
        fun method356(i: Int, i_0_: Int): String? {
            ...
            if (string.length > 9) return (" <col=00ff80>" + string.substring(0, string.length + -8) + LocalizedText.aLocalizedText_3516!!.method2063(ChatCommandProcessor.language, 544) + " (" + string + ")</col>")
            if (string.length > 6) return (" <col=ffffff>" + string.substring(0, -4 + string.length) + LocalizedText.aLocalizedText_3518!!.method2063(ChatCommandProcessor.language, 544) + " (" + string + ")</col>")
        ...
        fun method2385(widgetComponent: WidgetComponent?, i: Int, var_sprite: Sprite?, i_4_: Int, i_5_: Int, i_6_: Int, i_7_: Byte, i_8_: Int, var_renderer: Renderer?) {
            do {
                try {
                    anInt6390++
                    val class42 = TheoraVideoStream.aWorldMapInfoTypeList_9031!!.method1225(i_4_, 98.toByte())
                    if (i_7_ < -52) {
        ...
        fun method1007(widgetComponent: WidgetComponent?, var_renderer: Renderer?, i: Int, i_1_: Int, i_2_: Int) {
            try {
                ...
                if (var_aa != null) {
                    ...
                    if (VarcTypeList.anInt3306 != 2 && VarcTypeList.anInt3306 != 5 && GroundItemRenderState.aAbstractModelRenderer_1664 != null) {
                        val i_3_: Int
                        val i_4_: Int
                        val i_5_: Int
                        val i_6_: Int
                        ...
                        while ((LongKeyNode.anInt9479 > i_14_)) {
                            ...
                            var objectType: ObjectType? = (GradientLookupEffect.aObjectTypeList_9195!!.method2005(0, ObjectTypeList.anIntArray3347!![i_14_]))
                            if (objectType!!.anIntArray945 != null) {
                                objectType = objectType.method480((ProjectedGroundDecor.aVarpStore_10209!!), 47.toByte())
                                if (objectType == null || (objectType.anInt921 == -1)) {
                                    i_14_++
                                    continue
                                }
                            }
                            method2385(widgetComponent, i_1_, var_aa, objectType.anInt921, i_15_, i, ((-113).toByte()).toByte(), i_16_, var_renderer)
                            i_14_++
                        }
                        ...
                        var i_22_ = 0
                        while ((i_22_ < IDKTypeList.anInt2057)) {
                        ...
                        if (WeaveTextureNode.anInt9282 != 4) {
                            if (MediaStreamClient.anInt3203 != 0) {
                                ...
                                HeadIconRenderer.method1211(i_1_, (SkyboxSphereTypeList.aAbstractModelRendererArray367!![(if (!ModelKeyBuilder.aBoolean6759) 0 else 1)]), i, widgetComponent, var_aa, i_41_, 2, i_40_)
                            }
