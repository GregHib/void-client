...
*/
class FloatGrid internal constructor(var anInt4974: Int, var anInt4978: Int) : Marker {
    ...
    companion object {
        ...
        fun method1583(i: Byte) {
            ...
            if (RenderNodeStatics.anInt9721 != -1) {
                ...
                method1373(RenderNodeStatics.anInt9721, i_2_, i_2_, QuestType.anInt4017 + i_2_, i_1_, i_0_, -1391, i_0_ + i_2_, GameDisplayManager.anInt10432 + i_3_, i_3_, i_3_ + i_1_, i_3_)
