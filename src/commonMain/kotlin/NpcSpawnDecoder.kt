...
object NpcSpawnDecoder {
    ...
    fun method858(bool: Boolean, player: Player) {
        ...
        if (bool == true) {
            if (class348_sub9 == null) IdentKitRecolor.method1614(979190089, null, player.plane.toInt(), (player.anIntArray10317!![0]), (player.anIntArray10320!![0]), player, null, 0)
            ...
            while (i_0_ > i_1_) {
                if (StringCacheNode.aByteArrayArray7212!![i_1_] != null) {
                    ...
                    while (class348_sub49.anInt7197 < StringCacheNode.aByteArrayArray7212!![i_1_]!!.size) {
                        ...
                        val class79 = (MapAreaDefinition.aNpcTypeList_2529!!.method2079(class348_sub49.readUnsignedShort(842397944), -1))
