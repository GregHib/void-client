...
class ModelDefinitionLoader internal constructor(sceneProjector: SceneProjector?, i: Int, js5Archive: Js5Archive?, js5Archive_9_: Js5Archive?) {
    ...
    companion object {
        ...
        fun method1202(i: Int) {
            anInt2052++
            val `is` = IntArray(ClientException.aItemTypeList_112!!.anInt3271)
            var i_0_ = i
            var i_1_ = 0
            while (ClientException.aItemTypeList_112!!.anInt3271 > i_1_) {
                val class213 = ClientException.aItemTypeList_112!!.method1940(-104, i_1_)
