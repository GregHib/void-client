...
class AnimatedModelRenderer : AbstractModelRenderer {
    ...
    internal constructor(var_ha_Sub3: NativeRenderer, i: Int, i_118_: Int, bool: Boolean) {
        ...
        anInterface18_Impl3_8403 = var_ha_Sub3.method3861(i_118_, ((-84).toByte()).toByte(), i, MovementDirection.aMovementDirection_1183, (if (bool) GroundItemRenderState.aTextureFormatInfo_1662 else TextureFormatInfo.aTextureFormatInfo_7103))
