...
class AnimatedModelRenderer : AbstractModelRenderer {
    ...
    override fun method962(f: Float, f_12_: Float, f_13_: Float, f_14_: Float, f_15_: Float, f_16_: Float, i: Int, i_17_: Int, i_18_: Int, i_19_: Int) {
        ...
        aHa_Sub3_8407.method3853(-32, WaterDetailOptionState.aConfigFlagUtil_6030)
    ...
    internal constructor(var_ha_Sub3: NativeRenderer, i: Int, i_118_: Int, bool: Boolean) {
        ...
        anInterface18_Impl3_8403 = var_ha_Sub3.method3861(i_118_, ((-84).toByte()).toByte(), i, MovementDirection.aMovementDirection_1183, (if (bool) GroundItemRenderState.aTextureFormatInfo_1662 else TimedRecordAccessor.aTextureFormatInfo_7103))
