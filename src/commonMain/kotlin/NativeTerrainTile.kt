...
class NativeTerrainTile(var_ha_Sub3: NativeRenderer?, i: Int, i_139_: Int, i_140_: Int, i_141_: Int, `is`: Array<IntArray?>, is_142_: Array<IntArray?>?, i_143_: Int) : TerrainTile(i_140_, i_141_, i_143_, `is`) {
        ...
        if (i_151_ == -1) {
            if (aClass348_Sub3Array8328 != null) {
                ...
                if (!aNodeDeque_8286.method2002(18.toByte())) {
                    ...
                    this.aHa_Sub3_8322!!.method3849(47.toByte(), 0, LoadingBarRenderer.aTrigLookupTables_4247)
                    this.aHa_Sub3_8322!!.method3885(0, true, LoadingBarRenderer.aTrigLookupTables_4247)
    ...
    companion object {
        ...
        fun method4004(i: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int) {
            anInt8292++
            val i_10_ = WhirlpoolHash.method831(SkyboxSphereType.anInt513, i_4_, LocalPlayerState.anInt1910, -118)
            val i_11_ = WhirlpoolHash.method831(SkyboxSphereType.anInt513, i, LocalPlayerState.anInt1910, 72)
            ...
            val i_14_ = WhirlpoolHash.method831(SkyboxSphereType.anInt513, i_4_ + i_6_, LocalPlayerState.anInt1910, -110)
            val i_15_ = WhirlpoolHash.method831(SkyboxSphereType.anInt513, i + -i_6_, LocalPlayerState.anInt1910, 28)
            if (i_7_ < -33) {
                for (i_16_ in i_10_..<i_14_) GlElementArrayBuffer.method1156(-27, i_13_, AnimationType.anIntArrayArray255!![i_16_]!!, i_12_, i_9_)
                for (i_17_ in i_11_ downTo i_15_ + 1) GlElementArrayBuffer.method1156(-27, i_13_, AnimationType.anIntArrayArray255!![i_17_]!!, i_12_, i_9_)
                ...
                for (i_20_ in i_14_..i_15_) {
                    val `is` = AnimationType.anIntArrayArray255!![i_20_]!!
