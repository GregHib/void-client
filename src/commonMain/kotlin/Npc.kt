...
class Npc : ProjectedGroundDecor() {
    ...
    fun method2443(i: Int, i_15_: Int, i_16_: Int) {
        ...
        if (this.anInt10269 != -1) {
            val class368 = (ConstantColourTextureNode.aGfxTypeList_9245!!.method2543(118.toByte(), this.anInt10269))
            if (class368.aBoolean4487 && class368.anInt4503 != -1 && (ParticleEmitterNode.aAnimationTypeList_191!!.method835(class368.anInt4503, 7).anInt245) == 1) this.anInt10269 = -1
        }
        if (this.anInt10291 != -1) {
            val class368 = (ConstantColourTextureNode.aGfxTypeList_9245!!.method2543(77.toByte(), this.anInt10291))
    ...
    public override fun method2386(i: Int, var_renderer: Renderer?): SceneEntityModel? {
        ...
        if (IntHashSetStatics.aClass348_Sub51_3959!!.aClass239_Sub21_7270!!.method1812(-32350) == i && class79!!.aBoolean1369 && class225.aBoolean2913) {
            ...
            val class17_22_ = (if (this.anInt10268 == -1 || (this.aBoolean10213 && class17 != null)) null else ParticleEmitterNode.aAnimationTypeList_191!!.method835(this.anInt10268, 7))
    ...
    fun method2444(i: Int, bool: Boolean, i_26_: Int, i_27_: Int, i_28_: Int, i_29_: Int) {
        ...
        if (this.anInt10269 != -1) {
            val class368 = (ConstantColourTextureNode.aGfxTypeList_9245!!.method2543(117.toByte(), this.anInt10269))
            if (class368.aBoolean4487 && class368.anInt4503 != -1 && (ParticleEmitterNode.aAnimationTypeList_191!!.method835(class368.anInt4503, 7).anInt245) == 1) this.anInt10269 = -1
        }
        if (this.anInt10291 != -1) {
            val class368 = (ConstantColourTextureNode.aGfxTypeList_9245!!.method2543(56.toByte(), this.anInt10291))
            if (class368.aBoolean4487 && class368.anInt4503 != -1 && (ParticleEmitterNode.aAnimationTypeList_191!!.method835(class368.anInt4503, 7).anInt245) == 1) this.anInt10291 = -1
        }
        if (!bool) {
    ...
    private fun method2447(i: Int, i_34_: Int, var_renderer: Renderer?): Boolean {
        ...
        val class225 = this.method2422(72.toByte())
        val class17 = (if (this.anInt10286 == -1 || this.anInt10218 != 0) null else ParticleEmitterNode.aAnimationTypeList_191!!.method835(this.anInt10286, 7))
        val class17_36_ = (if (this.anInt10268 != -1 && (!this.aBoolean10213 || class17 == null)) ParticleEmitterNode.aAnimationTypeList_191!!.method835(this.anInt10268, 7) else null)
        ...
        if (this.anInt10269 == -1 || this.anInt10240 == -1) this.aAbstractModelArray10323[1] = null
            ...
            val class368 = (ConstantColourTextureNode.aGfxTypeList_9245!!.method2543(56.toByte(), this.anInt10269))
            ...
            val class64_42_ = (class368.method3562(this.anInt10240, var_renderer, this.anInt10243, i_41_, this.anInt10283, ParticleEmitterNode.aAnimationTypeList_191, 78.toByte()).also { this.aAbstractModelArray10323[1] = it })
            if (class64_42_ != null) {
                if (this.anInt10278 < 0) {
                    ...
                    if (i_45_ != 0 || i_43_ != 0) {
                        ...
                        val i_48_ = SpotAnimVector.anIntArray1207!![i_47_]
                        val i_49_ = SpotAnimVector.anIntArray1204!![i_47_]
        ...
        if (this.anInt10291 == -1 || this.anInt10224 == -1) this.aAbstractModelArray10323[2] = null
            ...
            val class368 = (ConstantColourTextureNode.aGfxTypeList_9245!!.method2543(98.toByte(), this.anInt10291))
            ...
            val class64_53_ = (class368.method3558(this.anInt10273, this.anInt10276, var_renderer, i_52_, 3172, ParticleEmitterNode.aAnimationTypeList_191, this.anInt10224).also { this.aAbstractModelArray10323[2] = it })
            if (class64_53_ != null) {
                if (this.anInt10289 >= 0 && class225.anIntArrayArray2939 != null && ((class225.anIntArrayArray2939!![this.anInt10289]) != null)) {
                    ...
                    if (i_56_ != 0 || i_54_ != 0) {
                        ...
                        val i_59_ = SpotAnimVector.anIntArray1207!![i_58_]
                        val i_60_ = SpotAnimVector.anIntArray1204!![i_58_]
    ...
    companion object {
        ...
        fun method2441(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int) {
            ...
            if (i_5_ - i_0_ >= WorldMapLabel.anInt4960 && CameraNodeList.anInt1745 >= i_0_ + i_5_ && -i_0_ + i_3_ >= LocalPlayerState.anInt1910 && i_3_ + i_0_ <= SkyboxSphereType.anInt513) CircleRasterizer.method2255(i_0_, i_5_, (-68).toByte(), i_1_, i_3_, i_4_, i)
