...
class ChatEffectsOptionState : GraphicsOptionState {
    ...
    companion object {
        ...
        fun method1730(i: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int, i_10_: Int, i_11_: Int) {
            ...
            val i_12_ = -i_9_ + i_5_
            val i_13_ = i_9_ + i_6_
            for (i_14_ in i_6_..<i_13_) GlElementArrayBuffer.method1156(-27, i_7_, AnimationType.anIntArrayArray255!![i_14_]!!, i_11_, i)
            val i_15_ = i_7_ + -i_9_
            val i_16_ = i_9_ + i_11_
            var i_17_ = i_5_
            while (i_12_ < i_17_) {
                GlElementArrayBuffer.method1156(i_10_ + 101, i_7_, AnimationType.anIntArrayArray255!![i_17_]!!, i_11_, i)
                i_17_--
            }
            for (i_18_ in i_13_..i_12_) {
                val `is` = AnimationType.anIntArrayArray255!![i_18_]!!
        ...
        fun method1731(i: Int) {
            ...
            if (!bool) SpriteMaskShape.method2599(109.toByte(), IntHashSetStatics.aClass348_Sub42_Sub12_3963, i_20_, i_19_)
            else SolidFillComponent.aClass348_Sub42_Sub12_1946 = IntHashSetStatics.aClass348_Sub42_Sub12_3963
        ...
        fun method1732(i: Byte, i_21_: Int): Boolean {
            ...
            return i_21_ < (i_22_.inv()) || i_22_ >= 160 || ByteBuffer.aCharArray625!![i_22_ + -128].code != 0
        }
            ...
            try {
                ...
                if (renderableEntry != null) {
                    if (bool && renderableEntry.aFontDefinition_4333 == null) {
                        val class143 = BrightnessGraphicsOptionState.method1766((-76).toByte(), i, TerrainTileStatics.aJs5Archive_4585!!)
                ...
                val class143 = BrightnessGraphicsOptionState.method1766((-39).toByte(), i, TerrainTileStatics.aJs5Archive_4585!!)
                if (class143 == null) return null
