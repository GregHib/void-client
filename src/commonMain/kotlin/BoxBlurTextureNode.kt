        ...
        if (this.aSpriteSheetCache_7032!!.aBoolean2570) {
            ...
            while (i - -anInt9463 >= i_19_) {
                ...
                while (anInt9466 >= i_23_) {
                    i_22_ += is_20_[i_23_ and CustomCursorOptionState.anInt6076]
                    i_23_++
                }
                var i_24_ = 0
                while (i_24_ < PerlinNoiseTextureNode.Companion.anInt9139) {
                    is_21_[i_24_] = i_17_ * i_22_ shr 16
                    i_22_ -= (is_20_[-anInt9466 + i_24_ and CustomCursorOptionState.anInt6076])
                    i_24_++
                    i_22_ += (is_20_[i_24_ + anInt9466 and CustomCursorOptionState.anInt6076])
                }
        ...
        if (this.aImageFrameCache_7033!!.aBoolean4035) {
            ...
            for (i_34_ in i + -anInt9463..anInt9463 + i) {
                ...
                for (i_43_ in -anInt9466..anInt9466) {
                    val i_44_ = CustomCursorOptionState.anInt6076 and i_43_
                    i_39_ += is_42_[i_44_]
                    i_37_ += is_40_[i_44_]
                    i_38_ += is_41_[i_44_]
                }
                ...
                while (PerlinNoiseTextureNode.Companion.anInt9139 > i_48_) {
                    ...
                    var i_49_ = CustomCursorOptionState.anInt6076 and -anInt9466 + i_48_
                    i_37_ -= is_40_[i_49_]
                    i_48_++
                    i_38_ -= is_41_[i_49_]
                    i_39_ -= is_42_[i_49_]
                    i_49_ = i_48_ - -anInt9466 and CustomCursorOptionState.anInt6076
                    i_39_ += is_42_[i_49_]
                    i_38_ += is_41_[i_49_]
                    i_37_ += is_40_[i_49_]
                }
    ...
    companion object {
        ...
        fun method3146(i: Int, i_0_: Int, i_1_: Byte, i_2_: Int, i_3_: Int, i_4_: Int, `is`: ByteArray?, is_5_: ByteArray?, i_6_: Int) {
            ...
            try {
                ...
                throw TextureLoadException.method2929(runtimeexception, ("fd.D(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + (if (`is` != null) "{...}" else "null") + ',' + (if (is_5_ != null) "{...}" else "null") + ',' + i_6_ + ')'))
            }
        }
