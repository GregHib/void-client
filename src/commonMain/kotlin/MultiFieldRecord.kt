...
class MultiFieldRecord : LinkedListNode() {
    ...
    companion object {
        ...
        fun method3000(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int) {
            ...
            SkyboxSphereType.anInt513 = i_1_
        ...
        fun method3002(i: Byte): Array<RectangleRegion?> {
            ...
            anInt6901++
            return (arrayOf<RectangleRegion?>(RandomAccessFileOnDisk.aRectangleRegion_3044, Texture2DProvider.aRectangleRegion_6321, RSFont.aRectangleRegion_4062, CursorType.aRectangleRegion_2885, ProceduralTextureGraph.aRectangleRegion_9530, FloatBuffer.aRectangleRegion_9748, SpriteMaskShape.aRectangleRegion_4082, GlTexture1D.aRectangleRegion_8553, ShaderProgram.aRectangleRegion_7274, PlayerSequenceSelector.aRectangleRegion_1213, RsaVarbitHandler.aRectangleRegion_4901, DynamicSceneObjectEntity.aRectangleRegion_10194, ArbVertexProgram.aRectangleRegion_9781, GlRenderDevice.aRectangleRegion_9860))
        }
    }
}
