...
class DynamicSceneObjectEntity internal constructor(i: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int) : SceneObjectEntity(i, i_3_, i_4_, i_5_, i_6_) {
    ...
    public override fun method2393(i: Int): Int {
        ...
        val class213 = (ClientException.aItemTypeList_112!!.method1940(-115, this.anInt10181))
        var i_0_ = class213.anInt2784
        if (this.anInt10189 != -1) {
            val class213_1_ = (ClientException.aItemTypeList_112!!.method1940(74, this.anInt10189))
            if (class213_1_.anInt2784 > i_0_) i_0_ = class213_1_.anInt2784
        }
        if (this.anInt10180 != -1) {
            val class213_2_ = (ClientException.aItemTypeList_112!!.method1940(-88, this.anInt10180))
    ...
    public override fun method2391(var_renderer: Renderer?, i: Int, i_7_: Int, i_8_: Int): Boolean {
        ...
        val class213 = (ClientException.aItemTypeList_112!!.method1940(i_8_ xor 0x6b, this.anInt10181))
        ...
        if ((this.anInt10189.inv()) != i_8_) {
            val class213_9_ = (ClientException.aItemTypeList_112!!.method1940(-88, this.anInt10189))
        ...
        if (this.anInt10180 != -1) {
            val class213_10_ = (ClientException.aItemTypeList_112!!.method1940(-99, this.anInt10180))
    ...
    public override fun method2386(i: Int, var_renderer: Renderer?): SceneEntityModel {
        ...
        if (class148 == null || !(class148.aClass318_Sub1_Sub3_2040!!.aBoolean8741)) {
            ...
            val bool_12_ = false
            val bool_13_ = false
            val var_s = ActorEntity.aTerrainTileArray5191!![this.aByte6376.toInt()]
        ...
        anInt10184 = 0
        if (this.anInt10180 != -1) {
            val class64 = (ClientException.aItemTypeList_112!!.method1940(i xor 0x6c, this.anInt10180).method1559(null, null, var_renderer, 2048, 0, this.anInt10186, 0, 88.toByte(), -1))
            if (class64 != null) {
        ...
        if (this.anInt10189 != -1) {
            val class64 = (ClientException.aItemTypeList_112!!.method1940(i xor 0x3b.inv(), this.anInt10189).method1559(null, null, var_renderer, 2048, 0, this.anInt10190, 0, 88.toByte(), -1))
            if (class64 != null) {
        ...
        val class64 = (ClientException.aItemTypeList_112!!.method1940(-48, this.anInt10181).method1559(null, null, var_renderer, 2048, 0, this.anInt10185, 0, 88.toByte(), -1))
        if (class64 != null) {
