...
class MapSceneIconDef {
    ...
    fun method1593(i: Int): Boolean {
        if (i != 106) this.aMapSceneTypeList_2851 = null
        anInt2858++
        return this.aMapSceneTypeList_2851!!.aJs5Archive_1965!!.method421(false, this.anInt2853)
    }
    ...
    fun method1596(i: Int, bool: Boolean, i_18_: Int, var_renderer: Renderer): AbstractModelRenderer? {
        ...
        var abstractModelRenderer = this.aMapSceneTypeList_2851!!.aLruByteCache_1976.method583(l, -87) as AbstractModelRenderer?
        if (abstractModelRenderer != null) return abstractModelRenderer
        if (!this.aMapSceneTypeList_2851!!.aJs5Archive_1965!!.method421(false, this.anInt2853)) return null
        val spriteImage = SpriteImage.method1521(this.aMapSceneTypeList_2851!!.aJs5Archive_1965!!, this.anInt2853, 0)
        if (spriteImage != null) {
        ...
        if (abstractModelRenderer != null) this.aMapSceneTypeList_2851!!.aLruByteCache_1976.method582(abstractModelRenderer, l, (-101).toByte())
