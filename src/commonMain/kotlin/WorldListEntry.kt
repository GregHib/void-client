...
class WorldListEntry {
    ...
    companion object {
        ...
        fun method285(i: Int): Array<ProjectileFactory?> {
            anInt309++
            return (arrayOf<ProjectileFactory?>(HitsplatTypeList.aProjectileFactory_2868, ByteBufferStatics.aProjectileFactory_7175, SkyboxGradient.aProjectileFactory_3934, LightTypeList.aProjectileFactory_2489, MatrixCameraTransform.aProjectileFactory_5689, WeaveTextureNode.aProjectileFactory_9274, ItemNameResolver.aProjectileFactory_4997, TypedRecordTable.aProjectileFactory_2307, OrientationRotator.aProjectileFactory_2045, QuestTypeList.aProjectileFactory_2507))
        }
