...
class MinimapSquareDrawer internal constructor(private var anInt5214: Int, private val anInt5212: Int, private val anInt5213: Int, private val anInt5222: Int, i_9_: Int, i_10_: Int, i_11_: Int) : MinimapShapeDrawer(i_9_, i_10_, i_11_) {
    ...
    companion object {
        ...
        fun method2267(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int) {
            ...
            else if (WorldMapLabel.anInt4960 > -i_6_ + i_1_ || i_6_ + i_1_ > CameraNodeList.anInt1745 || -i_0_ + i_5_ < LocalPlayerState.anInt1910 || i_0_ + i_5_ > SkyboxSphereType.anInt513) method3041(i_6_, i_1_, i_5_, i xor 0x2903.inv(), i_0_, i_3_, i_2_, i_4_)
        ...
        fun method3041(i: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int, i_10_: Int, i_11_: Int) {
            ...
            if (i_6_ >= LocalPlayerState.anInt1910 && SkyboxSphereType.anInt513 >= i_6_) {
            ...
            while (i_13_ > 0) {
                ...
                if (i_48_ >= LocalPlayerState.anInt1910 && SkyboxSphereType.anInt513 >= i_47_) {
                    ...
                    if (bool) {
                        ...
                        if (LocalPlayerState.anInt1910 <= i_47_) {
                            val `is` = AnimationType.anIntArrayArray255!![i_47_]!!
                        ...
                        if (SkyboxSphereType.anInt513 >= i_48_) {
                            val `is` = AnimationType.anIntArrayArray255!![i_48_]!!
                        ...
                        if (i_47_ >= LocalPlayerState.anInt1910) GlElementArrayBuffer.method1156(-27, i_49_, (AnimationType.anIntArrayArray255!![i_47_]!!), i_50_, i_10_)
                        if (i_48_ <= SkyboxSphereType.anInt513) GlElementArrayBuffer.method1156(-27, i_49_, (AnimationType.anIntArrayArray255!![i_48_]!!), i_50_, i_10_)
                    }
                }
            }
        }
        ...
        fun method3641(i: Int, i_35_: Int, i_36_: Byte, i_37_: Int, i_38_: Int, i_39_: Int) {
            ...
            else if (WorldMapLabel.anInt4960 <= i_39_ + -i_38_ && CameraNodeList.anInt1745 >= i_39_ - -i_38_ && -i_35_ + i >= LocalPlayerState.anInt1910 && SkyboxSphereType.anInt513 >= i + i_35_) method515(i_37_, i_39_, i, i_35_, i_38_, -122)
