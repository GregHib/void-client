...
object MinimapRectClipper {
    ...
    fun method225(i: Byte) {
        if (i > 54) {
            InboundPacketHeader.aInboundPacketHeader_220 = null
            anIntArray224 = null
            anIntArray222 = null
    ...
    fun method226(i: Int, i_0_: Int, i_1_: Int, i_2_: Int, i_3_: Int) {
        ...
        while (TerrainShadowBuilderGl3.anInt7008 > i_4_) {
            ...
            if (i < rectangle.w + rectangle.left && i_0_ + i > rectangle.left && (i_1_ < rectangle.top - -rectangle.h) && rectangle.top < i_1_ + i_3_) OpenGlModel.aBooleanArray2076!![i_4_] = true
            i_4_++
        }
        anInt219++
    ...
    fun method227(class318_sub1: SceneEntity, bool: Boolean, bool_5_: Boolean) {
        ...
        } else SkyboxSphereType.method365(class318_sub1, OverlayColorTable.aClass348_Sub1Array1752)
    }
