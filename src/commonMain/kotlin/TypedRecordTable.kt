...
class TypedRecordTable {
    ...
    companion object {
        ...
        @JvmStatic
        fun method2178(class318_sub1: SceneEntity?, i: Int, animationType: AnimationType?, i_0_: Int) {
            try {
                anInt3694++
                if (HintArrowOrMessage.anInt2021 < 50 && (animationType != null && animationType.anIntArrayArray264 != null && (animationType.anIntArrayArray264!!.size > i) && animationType.anIntArrayArray264!![i] != null)) {
                    val i_1_ = animationType.anIntArrayArray264!![i]!![0]
                    var i_2_ = i_1_ shr 8
                    val i_3_ = (i_1_ and 0xf1) shr 5
                    if (i_0_ > -13) anInt3695 = 0
                    if (animationType.anIntArrayArray264!![i]!!.size > 1) {
                        val i_4_ = ((animationType.anIntArrayArray264!![i])!!.size.toDouble() * random()).toInt()
                        if (i_4_ > 0) i_2_ = animationType.anIntArrayArray264!![i]!![i_4_]
                    }
                    val i_5_ = i_1_ and 0x1f
                    var i_6_ = 256
                    if (animationType.anIntArray236 != null && animationType.anIntArray265 != null) i_6_ = ((random() * (-(animationType.anIntArray236!![i]) + (animationType.anIntArray265!![i])).toDouble()).toInt() + animationType.anIntArray236!![i])
                    val i_7_ = (if (animationType.anIntArray253 == null) 255 else animationType.anIntArray253!![i])
                    if (i_5_ == 0) {
                        if (LocalPlayerState.aPlayer_1907 == class318_sub1) {
                            if (!animationType.aBoolean268) TextureTileRenderer.method2947(true, i_7_, i_2_, i_3_, 0, i_6_)
                        ...
                        GlTextureCubeMap.aParticleEmitterNodeArray8531s!![HintArrowOrMessage.anInt2021++] = ParticleEmitterNode((if (animationType.aBoolean268) 2.toByte() else 1.toByte()), i_2_, i_3_, 0, i_7_, i_10_, i_6_, class318_sub1)
                    }
                }
            } catch (runtimeexception: RuntimeException) {
                throw TextureLoadException.method2929(runtimeexception, ("vp.A(" + (if (class318_sub1 != null) "{...}" else "null") + ',' + i + ',' + (if (animationType != null) "{...}" else "null") + ',' + i_0_ + ')'))
            }
        }
