...
class ScatterTextureNode : AbstractProceduralTextureNode(0, true) {
            ...
            while (anInt9362 > i_5_) {
                ...
                if (i_12_ != 0 || i_11_ != 0) {
                    ...
                    for (i_24_ in i_7_..<i_9_) {
                        ...
                        val i_26_ = CustomCursorOptionState.anInt6076 and i_24_
    ...
    companion object {
        ...
        fun method3122(i: Byte): Array<NamedIdRecord?> {
            ...
            anInt9361++
            return (arrayOf<NamedIdRecord?>(OggCacheStream.aNamedIdRecord_5271, FixedFunctionWaterPass.aNamedIdRecord_7361, SpriteArchiveLoader.aNamedIdRecord_382, GroundItemRenderState.aNamedIdRecord_1657, SceneObjectSpawner.aNamedIdRecord_1279, LoadingBarRenderer.aNamedIdRecord_4246))
        }
