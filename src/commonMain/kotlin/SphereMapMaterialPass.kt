...
class SphereMapMaterialPass internal constructor(var_ha_Sub2: OpenGlRenderer) : MaterialPass(var_ha_Sub2) {
    ...
    companion object {
        ...
        fun method2175(i: Int, i_3_: Byte, i_4_: Int): Int {
            ...
            return SkyBoxTypeList.anIntArray1450!![0x3 and i]
        }
        ...
        fun method2177(i: Int, i_22_: Int, class348_sub49_sub2: CipheredPacketBuffer) {
            ...
            if (i_23_ == 0) {
                if (bool) player.aBoolean10539 = false
                    ...
                    if (QuickChatType.anInt9591 == i_22_) throw RuntimeException("s:lr")
                    ...
                    if (class348_sub49_sub2.readBits((-24).toByte(), 1) != 0) ConstantColourTextureNode.method1538(i_22_, 105.toByte(), class348_sub49_sub2)
                }
            } else if (i_23_ == 1) {
                ...
                if (i_30_ == 0) {
                    ...
                    if (QuickChatType.anInt9591 == i_22_) {
                        if ((player.plane).toInt() != QuickChatMenuTypeList.anInt4372) PcmStreamBuffer.aBoolean8870 = true
                        QuickChatMenuTypeList.anInt4372 = (player.plane).toInt()
                    }
                } else {
                    ...
                    if (QuickChatType.anInt9591 == i_22_) QuickChatMenuTypeList.anInt4372 = (player.plane).toInt()
                }
            }
        }
    }
