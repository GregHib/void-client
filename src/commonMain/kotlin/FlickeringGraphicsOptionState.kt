...
class FlickeringGraphicsOptionState : GraphicsOptionState {
    ...
    companion object {
        ...
        fun method1721(string: String?, i: Byte) {
            anInt5849++
            if (RenderNodeStatics.aBoolean9722 && (0x18 and SkyboxSphereType.anInt500) != 0) {
                val i_2_ = -88 / ((i - -33) / 37)
                var bool = false
                ...
                while (i_3_ > i_4_) {
                    ...
                    if (player.aString10544 != null && player.aString10544.equals(string, ignoreCase = true) && (((player == LocalPlayerState.aPlayer_1907) && (0x10 and SkyboxSphereType.anInt500) != 0) || (player != null && (SkyboxSphereType.anInt500 and 0x8) != 0))) {
                ...
                if (!bool) method544((LocalizedText.aLocalizedText_3504!!.method2063(ChatCommandProcessor.language, 544)) + string, false, 4)
