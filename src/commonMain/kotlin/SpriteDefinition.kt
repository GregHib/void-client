...
*/
class SpriteDefinition : LinkedListNode() {
    var anInt7066: Int = 0
    var anInt7067: Int = 0
    var anInt7069: Int = 0
    var anInt7070: Int = 0
    ...
    var anInt7076: Int = 0
    var aClass348_Sub19_Sub1_7077: PcmSampleData? = null
    var anInt7080: Int = 0
    var aClass348_Sub16_Sub5_7081: SampledVoice? = null
    var anInt7082: Int = 0
    var anInt7083: Int = 0
    var anInt7084: Int = 0
    var aClass348_Sub17_7085: SoundBankPatch? = null
    var anInt7086: Int = 0
    var anInt7087: Int = 0
    var anInt7088: Int = 0
    var anInt7089: Int = 0
        ...
        fun method3298(i: Byte, bool: Boolean, player: Player) {
            ...
            if (FileExistsCondition.anInt4776 < 400) {
                if (LocalPlayerState.aPlayer_1907 == player) {
                    if (RenderNodeStatics.aBoolean9722 && (SkyboxSphereType.anInt500 and 0x10) != 0) {
                        LongHashTable.anInt450++
                        MinimapPolygonDrawer.method466(false, (ItemNameResolver.aString5000 + " -> <col=ffffff>" + LocalizedText.aLocalizedText_3520!!.method2063(ChatCommandProcessor.language, 544)), 0, (-109).toByte(), false, 0, -1, true, 50, player.anInt10290.toLong(), ItemNameResolver.aString5001, 0L, FloatBuffer.Companion.anInt9747)
                    }
                } else {
                    val string: String?
                    if (player.anInt10564 == 0) {
                        ...
                        val string_5_ = (if (GlRectangleTexture.aSceneProjector_8638 == Client.mode) LocalizedText.aLocalizedText_3513!!.method2063(ChatCommandProcessor.language, 544) else LocalizedText.aLocalizedText_3511!!.method2063(ChatCommandProcessor.language, 544))
                    ...
                    else string = (player.method2456(true, 255) + " (" + LocalizedText.aLocalizedText_3512!!.method2063(ChatCommandProcessor.language, 544) + player.anInt10564 + ")")
                    if (RenderNodeStatics.aBoolean9722 && !bool && (0x8 and SkyboxSphereType.anInt500) != 0) {
                    ...
                    if (bool) MinimapPolygonDrawer.method466(true, "", 0, (-115).toByte(), false, 0, 0, false, -1, player.anInt10290.toLong(), "<col=cccccc>" + string, 0L, -1)
                        ...
                        for (i_6_ in 7 downTo 0) {
                            if (DynamicSceneObjectEntity.aStringArray10195!![i_6_] != null) {
                                var i_7_: Short = 0
                                if ((Client.mode != ParticleEmitterNode.aSceneProjector_186) || !(DynamicSceneObjectEntity.aStringArray10195!![i_6_].equals(LocalizedText.aLocalizedText_3506!!.method2063(ChatCommandProcessor.language, 544), ignoreCase = true))) {
                                ...
                                val i_9_ = (if (DelegatingRenderCanvas.anIntArray60!![i_6_] == -1) SkyboxSphereType.anInt506 else DelegatingRenderCanvas.anIntArray60!![i_6_])
                    ...
                    if (!bool) {
                        ...
                        while (class348_sub42_sub12 != null) {
                            ...
                            class348_sub42_sub12 = (SourceRowTextureNode.aNodeDeque_9111!!.method1990(105.toByte()) as ContactEntry?)
                        }
                    }
                }
            }
