...
class GlowPostProcessor internal constructor(private val aHa_Sub2_2511: OpenGlRenderer) {
    ...
    companion object {
        ...
        fun method1416(i: Int) {
            ...
            anInt2515++
            Tooltip.aFloorUnderlayTypeList_4460!!.method1383(i xor 0x804c, 5)
            RadialTextureNode.aIDKTypeList_9342!!.method1207(-17452, 5)
            ...
            RenderConfigFactory.aVarbitTypeList_2981!!.method1442(5, 1.toByte())
            NormalMapGenerator.aVarPlayerTypeList_3453!!.method1587(5, i xor 0xeab)
            OpenGlModel.aRenderAnimTypeList_5558!!.method1984(119.toByte(), 5)
            TheoraVideoStream.aWorldMapInfoTypeList_9031!!.method1224(5, (-98).toByte())
            ModelOrSpriteHolder.aMapSceneTypeList_117!!.method1176(5, 52.toByte())
            ProjectionCameraTransform.aParamTypeList_5764!!.method2603(5, 11)
            TheoraVideoStream.aQuestTypeList_9036!!.method1409(5, -20721)
            Client.aSkyBoxTypeList_413!!.method819(74.toByte(), 5)
            HoverActionEntry.aSkyboxSphereTypeList_1813!!.method299(5, 16)
            AbstractTileShapeStatics.aLightTypeList_6559!!.method1392(88, 5)
            EnumTypeList.aCursorTypeList_3147!!.method1285(i, 8)
            SpriteLoadValidator.aStructTypeList_4787!!.method697(5, 26)
            FileExistsCondition.aHitsplatTypeList_4782!!.method1603(5, -66)
            method876(5, 0)
            method545(50, -1)
            method174(50, -30742)
            method865(-8186, 5)
            ...
            IdentityKitType.aLruByteCache_463!!.method578(2, 5)
