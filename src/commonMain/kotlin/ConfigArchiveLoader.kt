                ...
                if (NpcAnimationResolver.aNamedIdRecord_165 != OggCacheStream.aNamedIdRecord_5271 || AsyncTaskHandle.anInt2581 >= 2) {
                    ...
                    try {
                        ...
                        if (string.equals("gc", ignoreCase = true)) {
                            method427(i + 180)
                            for (i_1_ in 0..9) gc()
                            val i_2_ = ((PlatformRuntime.totalMemory() + -PlatformRuntime.freeMemory()) / 1024L).toInt()
                        ...
                        if (string.equals("compact", ignoreCase = true)) {
                            method427(-41)
                            for (i_3_ in 0..9) gc()
                            var i_4_ = ((PlatformRuntime.totalMemory() + -PlatformRuntime.freeMemory()) / 1024L).toInt()
                            method94(("Memory before cleanup=" + i_4_ + "k"), 115)
                            method2271(31268)
                            method427(96)
                            for (i_5_ in 0..9) gc()
                            i_4_ = ((PlatformRuntime.totalMemory() + -PlatformRuntime.freeMemory()) / 1024L).toInt()
