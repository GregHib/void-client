...
object ProjectileConfigUtil {
    ...
    fun method317(string: String?, i: Int, bool: Boolean) {
        anInt391++
        if (string != null) {
            if (ContactEntry.anInt9604 >= 100) method544((LocalizedText.aLocalizedText_3522!!.method2063(ChatCommandProcessor.language, 544)), false, 4)
            else {
                val string_6_ = method2127(2, string)
                if (string_6_ != null) {
                    var i_7_ = 0
                    while ((i_7_ < ContactEntry.anInt9604)) {
                        val string_8_ = method2127(2, (ObjectType.aStringArray932!![i_7_]))
                        if (string_8_ != null && string_8_ == string_6_) {
                            method544((string + (LocalizedText.aLocalizedText_3523!!.method2063(ChatCommandProcessor.language, 544))), false, 4)
                            return
                        }
                    ...
                    if (i >= 90) {
                        for (i_10_ in 0..<HslAdjustTextureNode.anInt9383) {
                            ...
                            if (string_11_ != null && string_11_ == string_6_) {
                                method544(((LocalizedText.aLocalizedText_3528!!.method2063(ChatCommandProcessor.language, 544)) + string + (LocalizedText.aLocalizedText_3529!!.method2063(ChatCommandProcessor.language, 544))), false, 4)
                                return
                            }
                        ...
                        if (method2127(2, (LocalPlayerState.aPlayer_1907!!.aString10544)) == string_6_) method544((LocalizedText.aLocalizedText_3525!!.method2063(ChatCommandProcessor.language, 544)), false, 4)
                        else {
