...
class RenderListTextureNode : AbstractProceduralTextureNode(0, true) {
    ...
    private fun method3151(`is`: Array<IntArray?>?, i: Byte) {
        ...
        MultiFieldRecord.method3000(CustomCursorOptionState.anInt6076, 0, TextureCubeProvider.anInt6325, 0, i.toInt() xor 0x28)
    ...
    override fun method3047(i: Int, i_10_: Int): Array<IntArray?>? {
        ...
        if (this.aImageFrameCache_7033!!.aBoolean4035) {
            val i_11_: Int = PerlinNoiseTextureNode.anInt9139
            ...
            while (FixedFunctionMaterialPass.anInt6212 > i_15_) {
                ...
                val is_19_ = is_17_[1]!!
                val is_20_ = is_17_[2]!!
                for (i_21_ in 0..<PerlinNoiseTextureNode.anInt9139) {
        ...
        fun method3153(i: Int) {
            ...
            while (class348_sub42_sub13 != null) {
                if (class348_sub42_sub13.anInt9615 > 1) {
                    ...
                    VarcTypeList.aLruByteCache_3301!!.method582(class348_sub42_sub13, (class348_sub42_sub13.aLinkedNodeListIterator_9621.aClass348_Sub42_1647.aClass348_Sub42_7063 as ContactEntry).aLong9600, (-108).toByte())
