...
abstract class AbstractFrameBufferSurface : LinkedListNode() {
    ...
    companion object {
        ...
        fun method3007(i: Int, i_0_: Int) {
            ...
            RemoveRoofLightingDetailOptionState.anInt5994 = i
        ...
        fun method3012(i: Int, i_44_: Int, i_45_: Int, i_46_: Int, i_47_: Int, i_48_: Byte, i_49_: Int, i_50_: Int) {
            ...
            val `is` = AnimationType.anIntArrayArray255!![i_49_]!!
            ...
            while (i_52_ > 0) {
                ...
                if (bool) {
                    ...
                    GlElementArrayBuffer.method1156(-27, i_88_, AnimationType.anIntArrayArray255!![i_83_]!!, i_86_, i_46_)
                    GlElementArrayBuffer.method1156(-27, i_87_, AnimationType.anIntArrayArray255!![i_83_]!!, i_88_, i_44_)
                    GlElementArrayBuffer.method1156(-27, i_85_, AnimationType.anIntArrayArray255!![i_83_]!!, i_87_, i_46_)
                    GlElementArrayBuffer.method1156(-27, i_88_, AnimationType.anIntArrayArray255!![i_84_]!!, i_86_, i_46_)
                    GlElementArrayBuffer.method1156(-27, i_87_, AnimationType.anIntArrayArray255!![i_84_]!!, i_88_, i_44_)
                    GlElementArrayBuffer.method1156(-27, i_85_, AnimationType.anIntArrayArray255!![i_84_]!!, i_87_, i_46_)
                } else {
                    GlElementArrayBuffer.method1156(-27, i_85_, AnimationType.anIntArrayArray255!![i_83_]!!, i_86_, i_46_)
                    GlElementArrayBuffer.method1156(-27, i_85_, AnimationType.anIntArrayArray255!![i_84_]!!, i_86_, i_46_)
                }
            }
        }
                ...
                if (i_89_ >= 0 && i_89_ <= 1 && (class348_sub49.aByteArray7154!!.size - class348_sub49.anInt7197) >= 2) {
                    ...
                    if (i_90_ * 6 <= (-class348_sub49.anInt7197 + (class348_sub49.aByteArray7154)!!.size)) {
                        for (i_91_ in 0..<i_90_) {
                            ...
                            if ((IsaacCipher.anIntArray1303!!.size > i_92_) && GlslEnvMaterialPass.aBooleanArray6270!![i_92_] && ((RemoveRoofLightingDetailOptionState.aVarcTypeList_5995!!.method1976(i_92_, -107).aChar2132) != '1' || i_93_ >= -1 && i_93_ <= 1)) IsaacCipher.anIntArray1303!![i_92_] = i_93_
                        }
                    }
                }
            }
