...
*/
class DirectionalLightTextureNode : AbstractProceduralTextureNode(1, true) {
    ...
    override fun method3042(i: Int, i_4_: Int): IntArray? {
        ...
        if (this.aSpriteSheetCache_7032!!.aBoolean2570) {
            ...
            while (PerlinNoiseTextureNode.Companion.anInt9139 > i_9_) {
                ...
                val i_11_ = (i_5_ * (-is_7_[CustomCursorOptionState.anInt6076 and i_9_ - -1] + is_7_[-1 + i_9_ and CustomCursorOptionState.anInt6076]) shr 12)
