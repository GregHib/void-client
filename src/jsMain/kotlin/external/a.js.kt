...
actual class a : Disposable {
    ...
    actual fun R(l: Long, l_1_: Long, i: Int, i_2_: Int, l_3_: Long, bool: Boolean): Boolean {
    ...
    actual fun E(l: Long, bool: Boolean) {
    }

    actual fun e(l: Long, l_9_: Long, `is`: IntArray?, l_10_: Long) {
    }
    ...
    actual fun n(l: Long, l_11_: Long, i: Int, i_12_: Int, l_13_: Long, bool: Boolean, i_14_: Int): Boolean {
        TODO("Not yet implemented")
    }
    ...
    actual fun na(l: Long, var_renderer: Renderer?, i: Int, i_25_: Int, i_26_: Int, i_27_: Int, i_28_: Int, i_29_: Int, i_30_: Int) {
    }

    actual fun O(l: Long, var_renderer: Renderer?, `is`: IntArray?, is_31_: IntArray?, is_32_: IntArray?, is_33_: ShortArray?, i: Int) {
    }

    actual fun method150(var_renderer: Renderer?, i: Int, i_34_: Int, i_35_: Int, i_36_: Int, i_37_: Int, i_38_: Int, i_39_: Int) {
    }

    actual fun f(l: Long, l_40_: Long, l_41_: Long, `is`: IntArray?, i: Int, i_42_: Int) {
    }

    actual fun r(l: Long, l_43_: Long, l_44_: Long, i: Int, i_45_: Int, i_46_: Int, bool: Boolean) {
    }
    ...
    actual fun ta(l: Long, l_50_: Long, i: Int, i_51_: Int, i_52_: Int, i_53_: Int, i_54_: Int, i_55_: Int, i_56_: Int, bools: Array<BooleanArray?>?) {
    }

    actual fun Z(l: Long, l_57_: Long, i: Int, i_58_: Int, i_59_: Int) {
    }
    ...
    actual fun H(l: Long, l_60_: Long, i: Int, i_61_: Int) {
    }

    actual fun UA(l: Long, l_62_: Long, l_63_: Long, `is`: IntArray?, i: Int) {
    }

    actual fun method155(var_renderer: Renderer?, `is`: IntArray?, is_64_: IntArray?, is_65_: IntArray?, is_66_: ShortArray?, i: Int) {
    }

    actual fun HA(l: Long, var_renderer: Renderer?, i: Int, i_67_: Int) {
    }
